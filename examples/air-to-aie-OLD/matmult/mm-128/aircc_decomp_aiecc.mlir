...
module {
  aie.device(ipu) {
    ...
    %buf14 = aie.buffer(%tile_0_1) {sym_name = "buf14"} : memref<64x64xi32, 1> 
    %buf13 = aie.buffer(%tile_0_1) {sym_name = "buf13"} : memref<64x64xi32, 1> 
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf14 : memref<64x64xi32, 1>, 0, 4096)
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf13 : memref<64x64xi32, 1>, 0, 4096)
    ...
    ^bb16:  // 2 preds: ^bb15, ^bb16
      ...
      aie.dma_bd(%buf14 : memref<64x64xi32, 1>, 0, 1024, [<size = 32, stride = 64>, <size = 32, stride = 1>])
    ...
    ^bb18:  // 2 preds: ^bb17, ^bb18
      aie.use_lock(%lock_0_1_4, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf14 : memref<64x64xi32, 1>, 2048, 1024, [<size = 32, stride = 64>, <size = 32, stride = 1>])
      aie.use_lock(%lock_0_1_3, Release, 1)
      aie.next_bd ^bb18
    ^bb19:  // pred: ^bb21
    ...
    ^bb20:  // 2 preds: ^bb19, ^bb20
      ...
      aie.dma_bd(%buf13 : memref<64x64xi32, 1>, 0, 1024, [<size = 32, stride = 64>, <size = 32, stride = 1>])
    ...
    ^bb22:  // 2 preds: ^bb21, ^bb22
      aie.use_lock(%lock_0_1_2, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf13 : memref<64x64xi32, 1>, 32, 1024, [<size = 32, stride = 64>, <size = 32, stride = 1>])
      aie.use_lock(%lock_0_1_1, Release, 1)
      aie.next_bd ^bb22
    }
    ...
    memref.global "public" @airMemcpyId4 : memref<64x64xi32, 1>
    aie.shim_dma_allocation @airMemcpyId5(MM2S, 1, 0)
    memref.global "public" @airMemcpyId5 : memref<64x64xi32, 1>
  } {sym_name = "segment_0"}
  ...
  func.func @forward(%arg0: memref<128x128xi32>, %arg1: memref<128x128xi32>, %arg2: memref<128x128xi32>) {
    ...
    %0 = air.launch async [%async_token] (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) args(%arg7=%results, %arg8=%arg0, %arg9=%arg1) : memref<128x128xi32>, memref<128x128xi32>, memref<128x128xi32> attributes {id = 1 : i32} {
      ...
      %1 = scf.for %arg10 = %c0 to %c128 step %c64 iter_args(%arg11 = %async_token_1) -> (!air.async.token) {
        %5 = air.channel.put async [%arg11]  @channel_4[] (%arg8[%results_2, %arg10] [%c64, %c64] [%c128, %c1]) {id = 1 : i32, metadata = @airMemcpyId4} : (memref<128x128xi32>)
      ...
      %2 = scf.for %arg10 = %c0 to %c128 step %c64 iter_args(%arg11 = %async_token_3) -> (!air.async.token) {
        %5 = air.channel.put async [%arg11]  @channel_5[] (%arg9[%arg10, %results_4] [%c64, %c64] [%c128, %c1]) {id = 2 : i32, metadata = @airMemcpyId5} : (memref<128x128xi32>)
        scf.yield %5 : !air.async.token
      }
      ...
      %3 = air.channel.get async [%async_token_5, %async_token_7]  @channel_7[] (%arg7[%results_6, %results_8] [%c64, %c64] [%c128, %c1]) {id = 3 : i32, metadata = @airMemcpyId16} : (memref<128x128xi32>)
