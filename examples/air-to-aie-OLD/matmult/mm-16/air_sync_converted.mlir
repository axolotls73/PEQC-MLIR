      ...
      %2 = scf.for %arg5 = %c0 to %c4 step %c1 iter_args(%arg6 = %arg4) -> (index) {
        %token = async.execute {
          ...
          scf.for %arg7 = %c0 to %c16 step %c8 {
            ...
            %subview_3 = memref.subview %arg0[%5, %arg7] [4, 8] [1, 1] : memref<16x16xi32> to memref<4x8xi32, strided<[16, 1], offset: ?>>
            memref.copy %subview_3, %alloc_1 : memref<4x8xi32, strided<[16, 1], offset: ?>> to memref<4x8xi32, 1>
            %subview_4 = memref.subview %arg1[%arg7, %6] [8, 4] [1, 1] : memref<16x16xi32> to memref<8x4xi32, strided<[16, 1], offset: ?>>
            memref.copy %subview_4, %alloc_2 : memref<8x4xi32, strided<[16, 1], offset: ?>> to memref<8x4xi32, 1>
              ...
              %9 = scf.for %arg10 = %c0 to %c2 step %c1 iter_args(%arg11 = %arg9) -> (index) {
                %token_5 = async.execute {
                  ...
                  scf.for %arg12 = %c0 to %c8 step %c2 {
                    ...
                    %subview_10 = memref.subview %alloc_1[%12, %arg12] [2, 2] [1, 1] : memref<4x8xi32, 1> to memref<2x2xi32, strided<[8, 1], offset: ?>, 1>
                    memref.copy %subview_10, %alloc_8 : memref<2x2xi32, strided<[8, 1], offset: ?>, 1> to memref<2x2xi32, 2>
                    %subview_11 = memref.subview %alloc_2[%arg12, %13] [2, 2] [1, 1] : memref<8x4xi32, 1> to memref<2x2xi32, strided<[4, 1], offset: ?>, 1>
                    memref.copy %subview_11, %alloc_9 : memref<2x2xi32, strided<[4, 1], offset: ?>, 1> to memref<2x2xi32, 2>
                    scf.for %arg13 = %c0 to %c2 step %c1 {
                      scf.for %arg14 = %c0 to %c2 step %c1 {
                        scf.for %arg15 = %c0 to %c2 step %c1 {
                          %14 = memref.load %alloc_8[%arg13, %arg15] : memref<2x2xi32, 2>
                          %15 = memref.load %alloc_9[%arg15, %arg14] : memref<2x2xi32, 2>
                          %16 = memref.load %alloc_6[%arg13, %arg14] : memref<2x2xi32, 2>
                          %17 = arith.muli %14, %15 : i32
                          %18 = arith.addi %16, %17 : i32
                          memref.store %18, %alloc_6[%arg13, %arg14] : memref<2x2xi32, 2>
                        }
                      }
                    }
                  ...
                  %subview_7 = memref.subview %alloc_0[%12, %13] [2, 2] [1, 1] : memref<4x4xi32, 1> to memref<2x2xi32, strided<[4, 1], offset: ?>, 1>
                  memref.copy %alloc_6, %subview_7 : memref<2x2xi32, 2> to memref<2x2xi32, strided<[4, 1], offset: ?>, 1>
          ...
          %subview = memref.subview %alloc[%5, %6] [4, 4] [1, 1] : memref<16x16xi32> to memref<4x4xi32, strided<[16, 1], offset: ?>>
