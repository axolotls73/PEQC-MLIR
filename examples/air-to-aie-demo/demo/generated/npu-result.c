...
block_24:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_767, arith_const_1_768); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_791, arith_const_1_792); 
  goto block_24; 
  return; 
...
block_25:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_795, arith_const_1_796); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_821, arith_const_1_822); 
  goto block_25; 
  return; 
...
block_26:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_825, arith_const_1_826); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_851, arith_const_1_852); 
  goto block_26; 
  return; 
...
block_27:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_855, arith_const_1_856); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_881, arith_const_1_882); 
  goto block_27; 
  return; 
...
block_28:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_885, arith_const_4_886); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_904, arith_const_4_905); 
  goto block_28; 
  return; 
...
block_29:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_908, arith_const_2_909); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_927, arith_const_2_928); 
  goto block_29; 
  return; 
...
block_30:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_931, arith_const_1_932); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_984, arith_const_1_985); 
  goto block_30; 
  return; 
...
block_31:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_988, arith_const_1_989); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_1045, arith_const_1_1046); 
  goto block_31; 
  return; 
...
block_32:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_1049, arith_const_2_1050); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_1068, arith_const_2_1069); 
  goto block_32; 
  return; 
...
block_33:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_1072, arith_const_1_1073); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_1115, arith_const_1_1116); 
  goto block_33; 
  return; 
...
block_34:
  ...
  COUNTING_SEMAPHORE_ACQUIRE(memref_load_1119, arith_const_1_1120); 
  ...
  COUNTING_SEMAPHORE_RELEASE(memref_load_1166, arith_const_1_1167); 
  goto block_34; 
  return; 
