  ...
  func.func @forward(%arg0: memref<128x256xi32>, %arg1: memref<256x128xi32>, %arg2: memref<128x128xi32>) {
    ...
    air.launch (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) args(%arg7=%arg0, %arg8=%arg1, %arg9=%alloc) : memref<128x256xi32>, memref<256x128xi32>, memref<128x128xi32> {
      air.segment @forward_0  args(%arg10=%arg3, %arg11=%arg4, %arg12=%arg7, %arg13=%arg8, %arg14=%arg9) : index, index, memref<128x256xi32>, memref<256x128xi32>, memref<128x128xi32> {
        ...
        %0 = arith.muli %arg11, %c64_1 overflow<nsw> : index
        %c64_2 = arith.constant 64 : index
        %1 = arith.muli %arg10, %c64_2 overflow<nsw> : index
        %alloc_3 = memref.alloc() : memref<64x64xi32, 1>
        %alloc_4 = memref.alloc() : memref<64x256xi32, 1>
        %alloc_5 = memref.alloc() : memref<256x64xi32, 1>
        air.dma_memcpy_nd (%alloc_4[] [] [], %arg12[%1, %c0] [%c64, %c256] [%c256, %c1]) {id = 1 : i32} : (memref<64x256xi32, 1>, memref<128x256xi32>)
        air.dma_memcpy_nd (%alloc_5[] [] [], %arg13[%c0, %0] [%c256, %c64] [%c128, %c1]) {id = 2 : i32} : (memref<256x64xi32, 1>, memref<256x128xi32>)
        air.herd @herd_0  tile (%arg15, %arg16) in (%arg17=%c2_0, %arg18=%c2_0) args(%arg19=%alloc_3, %arg20=%alloc_4, %arg21=%alloc_5) : memref<64x64xi32, 1>, memref<64x256xi32, 1>, memref<256x64xi32, 1> {
          ...
          %2 = arith.muli %arg16, %c32_10 overflow<nsw> : index
          %c32_11 = arith.constant 32 : index
          %3 = arith.muli %arg15, %c32_11 overflow<nsw> : index
          ...
          scf.for %arg22 = %c0_8 to %c256_9 step %c32 {
            %alloc_16 = memref.alloc() : memref<32x32xi32, 2>
            %alloc_17 = memref.alloc() : memref<32x32xi32, 2>
            air.dma_memcpy_nd (%alloc_16[] [] [], %arg20[%3, %arg22] [%c32, %c32] [%c256_9, %c1_7]) {id = 3 : i32} : (memref<32x32xi32, 2>, memref<64x256xi32, 1>)
            air.dma_memcpy_nd (%alloc_17[] [] [], %arg21[%arg22, %2] [%c32, %c32] [%c64_6, %c1_7]) {id = 4 : i32} : (memref<32x32xi32, 2>, memref<256x64xi32, 1>)
        ...
        memref.dealloc %alloc_4 : memref<64x256xi32, 1>
        memref.dealloc %alloc_5 : memref<256x64xi32, 1>
