module {
  aie.device(npu1_4col) {
    ...
    %buf22 = aie.buffer(%mem_tile_0_1) {sym_name = "buf22"} : memref<64x64xi32, 1> 
    %buf21 = aie.buffer(%mem_tile_1_1) {sym_name = "buf21"} : memref<64x256xi32, 1> 
    %buf20 = aie.buffer(%mem_tile_2_1) {sym_name = "buf20"} : memref<256x64xi32, 1> 
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      scf.for %arg0 = %c0 to %c256 step %c64 {
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf21 : memref<64x256xi32, 1>, 0, 16384) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf21 : memref<64x256xi32, 1>, 0, 8192, [<size = 8, stride = 32>, <size = 32, stride = 256>, <size = 32, stride = 1>]) {task_id = 0 : i32}
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%lock_1_1_1, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf21 : memref<64x256xi32, 1>, 8192, 8192, [<size = 8, stride = 32>, <size = 32, stride = 256>, <size = 32, stride = 1>]) {task_id = 0 : i32}
      aie.use_lock(%lock_1_1, Release, 1)
      aie.next_bd ^bb6
    }
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb1
      ...
      aie.dma_bd(%buf20 : memref<256x64xi32, 1>, 0, 16384) {task_id = 0 : i32}
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb4
      ...
      aie.dma_bd(%buf20 : memref<256x64xi32, 1>, 0, 8192, [<size = 256, stride = 64>, <size = 32, stride = 1>]) {task_id = 0 : i32}
    ...
    ^bb6:  // 2 preds: ^bb5, ^bb6
      aie.use_lock(%lock_2_1_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%buf20 : memref<256x64xi32, 1>, 32, 8192, [<size = 256, stride = 64>, <size = 32, stride = 1>]) {task_id = 0 : i32}
      aie.use_lock(%lock_2_1, Release, 1)
      aie.next_bd ^bb6
    }
    aie.packet_flow(0) {
    ...
    aiex.runtime_sequence @forward(%arg0: memref<128x256xi32>, %arg1: memref<256x128xi32>, %arg2: memref<128x128xi32>) {
      ...
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][2, 1, 32, 512][0, 0, 512, 1]) {id = 0 : i64, metadata = @airMemcpyId4} : memref<128x256xi32>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 16384][2, 1, 32, 512][0, 0, 512, 1]) {id = 1 : i64, metadata = @airMemcpyId4} : memref<128x256xi32>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][2, 2, 256, 64][0, 64, 128, 1]) {id = 0 : i64, metadata = @airMemcpyId5} : memref<256x128xi32>
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][2, 2, 64, 64][8192, 64, 128, 1]) {id = 0 : i64, metadata = @airMemcpyId23} : memref<128x128xi32>
