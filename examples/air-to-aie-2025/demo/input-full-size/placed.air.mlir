...
module {
  ...
  func.func @forward(%arg0: memref<128x256xi32>, %arg1: memref<256x128xi32>, %arg2: memref<128x128xi32>) {
    ...
    %0 = air.launch async [%async_token] (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) args(%arg7=%arg0, %arg8=%arg1, %arg9=%results) : memref<128x256xi32>, memref<256x128xi32>, memref<128x128xi32> attributes {id = 1 : i32} {
      ...
      %1 = air.channel.put async [%async_token_1]  @channel_4[] (%arg7[%results_2, %c0] [%c64, %c256] [%c256, %c1]) {id = 1 : i32} : (memref<128x256xi32>)
      %async_token_3, %results_4 = air.execute -> (index) {
        %5 = affine.apply #map()[%arg4]
        air.execute_terminator %5 : index
      }
      %2 = air.channel.put async [%async_token_3]  @channel_5[] (%arg8[%c0, %results_4] [%c256, %c64] [%c128, %c1]) {id = 2 : i32} : (memref<256x128xi32>)
      ...
      %4 = air.segment @forward_0 async  attributes {id = 2 : i32, x_loc = 1 : i64, x_size = 4 : i64, y_loc = 2 : i64, y_size = 6 : i64} {
        ...
        %async_token_15, %results_16 = air.execute -> (memref<64x256xi32, 1>) {
          %alloc = memref.alloc() : memref<64x256xi32, 1>
          air.execute_terminator %alloc : memref<64x256xi32, 1>
        }
        %async_token_17, %results_18 = air.execute -> (memref<256x64xi32, 1>) {
          %alloc = memref.alloc() : memref<256x64xi32, 1>
          air.execute_terminator %alloc : memref<256x64xi32, 1>
        }
        %5 = air.channel.get async [%async_token_15]  @channel_4[] (%results_16[] [] []) {id = 4 : i32} : (memref<64x256xi32, 1>)
        %6 = air.channel.get async [%async_token_17]  @channel_5[] (%results_18[] [] []) {id = 5 : i32} : (memref<256x64xi32, 1>)
        %7 = air.channel.put async [%5]  @channel_0[] (%results_16[%c0_12, %c0_12, %c0_12] [%c8, %c32, %c32] [%c32, %c256_10, %c1_9]) {id = 6 : i32} : (memref<64x256xi32, 1>)
        %8 = air.channel.put async [%5]  @channel_1[] (%results_16[%c0_12, %c32, %c0_12] [%c8, %c32, %c32] [%c32, %c256_10, %c1_9]) {id = 7 : i32} : (memref<64x256xi32, 1>)
        %9 = air.channel.put async [%6]  @channel_2[] (%results_18[%c0_12, %c0_12] [%c256_10, %c32] [%c64_11, %c1_9]) {id = 8 : i32} : (memref<256x64xi32, 1>)
        %10 = air.channel.put async [%6]  @channel_3[] (%results_18[%c0_12, %c32] [%c256_10, %c32] [%c64_11, %c1_9]) {id = 9 : i32} : (memref<256x64xi32, 1>)
        ...
        %15 = air.herd @herd_0 async [%async_token_13, %5, %6]  tile (%arg10, %arg11) in (%arg12=%c1_9, %arg13=%c4) attributes {id = 3 : i32, x_loc = 1 : i64, y_loc = 2 : i64} {
          ...
          %async_token_30 = air.execute [%async_token_28] {
            scf.for %arg14 = %c0_23 to %c32_25 step %c1_26 {
              scf.for %arg15 = %c0_23 to %c32_25 step %c1_26 {
          ...
          %19:3 = scf.for %arg14 = %c0_23 to %c256_22 step %c64_24 iter_args(%arg15 = %async_token_35, %arg16 = %async_token_37, %arg17 = %async_token_37) -> (!air.async.token, !air.async.token, !air.async.token) {
            %21 = affine.if #set()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_35]  @channel_0[%18, %17] (%results_36[] [] []) {id = 14 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_35]  @channel_1[%18, %17] (%results_36[] [] []) {id = 15 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %22 = affine.if #set1()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_37]  @channel_2[%18, %17] (%results_38[] [] []) {id = 16 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_37]  @channel_3[%18, %17] (%results_38[] [] []) {id = 17 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %async_token_44 = air.execute [%arg16, %22, %21] {
              scf.for %arg18 = %c0_23 to %c32_25 step %c1_26 {
                scf.for %arg19 = %c0_23 to %c32_25 step %c1_26 {
                  scf.for %arg20 = %c0_23 to %c32_25 step %c1_26 {
                    %26 = memref.load %results_36[%arg18, %arg20] : memref<32x32xi32, 2>
                    %27 = memref.load %results_38[%arg20, %arg19] : memref<32x32xi32, 2>
                    %28 = memref.load %results_29[%arg18, %arg19] : memref<32x32xi32, 2>
                    %29 = arith.muli %26, %27 : i32
                    %30 = arith.addi %28, %29 : i32
                    memref.store %30, %results_29[%arg18, %arg19] : memref<32x32xi32, 2>
                  }
                }
              }
            }
            %23 = affine.if #set()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg16]  @channel_0[%18, %17] (%results_34[] [] []) {id = 18 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg16]  @channel_1[%18, %17] (%results_34[] [] []) {id = 19 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %24 = affine.if #set1()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg16]  @channel_2[%18, %17] (%results_32[] [] []) {id = 20 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg16]  @channel_3[%18, %17] (%results_32[] [] []) {id = 21 : i32} : (memref<32x32xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %async_token_45 = air.execute [%async_token_44, %24, %23] {
              scf.for %arg18 = %c0_23 to %c32_25 step %c1_26 {
                scf.for %arg19 = %c0_23 to %c32_25 step %c1_26 {
                  scf.for %arg20 = %c0_23 to %c32_25 step %c1_26 {
                    %26 = memref.load %results_34[%arg18, %arg20] : memref<32x32xi32, 2>
                    %27 = memref.load %results_32[%arg20, %arg19] : memref<32x32xi32, 2>
                    %28 = memref.load %results_29[%arg18, %arg19] : memref<32x32xi32, 2>
                    %29 = arith.muli %26, %27 : i32
                    %30 = arith.addi %28, %29 : i32
                    memref.store %30, %results_29[%arg18, %arg19] : memref<32x32xi32, 2>
        ...
        %async_token_19 = air.execute {
          memref.dealloc %results_16 : memref<64x256xi32, 1>
        }
        %async_token_20 = air.execute {
          memref.dealloc %results_18 : memref<256x64xi32, 1>
        }
        %16 = air.channel.put async  @channel_7[] (%results_14[] [] []) {id = 23 : i32} : (memref<64x64xi32, 1>)
