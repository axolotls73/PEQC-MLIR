      ...
      scf.for %arg4 = %c0 to %c2048 step %c256 {
        ...
        scf.parallel (%arg5, %arg6) = (%c0, %c0) to (%c64, %c64) step (%c32, %c32) {
          ...
          scf.for %arg7 = %c0 to %c256 step %c32 {
            %subview_9 = memref.subview %alloc_3[%arg5, %arg7] [32, 32] [1, 1] : memref<64x256xi32, 1> to memref<32x32xi32, strided<[256, 1], offset: ?>, 1>
            %subview_10 = memref.subview %alloc_4[%arg7, %arg6] [32, 32] [1, 1] : memref<256x64xi32, 1> to memref<32x32xi32, strided<[64, 1], offset: ?>, 1>
            %alloc_11 = memref.alloc() : memref<32x32xi32, 2>
            %alloc_12 = memref.alloc() : memref<32x32xi32, 2>
            memref.copy %subview_9, %alloc_11 : memref<32x32xi32, strided<[256, 1], offset: ?>, 1> to memref<32x32xi32, 2>
