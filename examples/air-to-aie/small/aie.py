...
with air.ir.Context() as ctx, Location.unknown():
    air_module = matmul_on_tensors(16, 16, 16, IntegerType.get_signless(width = 32))
    ...
    ^bb0(%arg0: !pdl.operation):
        ...
        ^bb1(%arg1: !pdl.operation):
            ...
            %matmul_1, %loops:2 = transform.air.linalg_tile %matmul [4, 4, 0]
            ...
            %matmul_2, %reduction_loop_1 = transform.air.linalg_tile %matmul_1 [0, 0, 8]
            transform.air.linalg_promote %matmul_2 {"operands_to_promote"=[0,1], "memory_space"="L2"}
            %matmul_3, %loops_2:2 = transform.air.linalg_tile %matmul_2 [2, 2, 0]
            ...
            %matmul_4, %reduction_loop_2 = transform.air.linalg_tile %matmul_3 [0, 0, 2]
