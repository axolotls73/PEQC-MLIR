...
with air.ir.Context() as ctx, Location.unknown():
    air_module = matmul_on_tensors(128, 128, 128, IntegerType.get_signless(width = 32))
    ...
    ^bb0(%arg0: !pdl.operation):
        ...
        ^bb1(%arg1: !pdl.operation):
            ...
            %matmul_2, %reduction_loop_1 = transform.air.linalg_tile %matmul_1 [0, 0, 128]
            ...
            %matmul_4, %reduction_loop_2 = transform.air.linalg_tile %matmul_3 [0, 0, 1]
