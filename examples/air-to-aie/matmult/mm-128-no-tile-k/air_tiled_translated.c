  ...
  for (int for_iter_13 = arith_const_7; for_iter_13 < arith_const_6; for_iter_13 += arith_const_8) {
    ...
    for (int for_iter_15 = arith_const_7; for_iter_15 < arith_const_6; for_iter_15 += arith_const_8) {
      ...
      #pragma peqc async_execute
      {
        ...
        int* memref_alloc_21; 
        for (int for_iter_22 = arith_const_7; for_iter_22 < arith_const_6; for_iter_22 += arith_const_6) {
          int* memref_alloc_23; 
          int* memref_alloc_24; 
          _past_array_copy_2d(subview_18, 0, 0, 1, 1, memref_alloc_23, 0, 0, 1, 1, 64, 128); 
          _past_array_copy_2d(subview_19, 0, 0, 1, 1, memref_alloc_24, 0, 0, 1, 1, 128, 64); 
          int* async_group_25; 
          ...
          for (int for_iter_27 = arith_const_7; for_iter_27 < arith_const_8; for_iter_27 += arith_const_5) {
            ...
            for (int for_iter_29 = arith_const_7; for_iter_29 < arith_const_8; for_iter_29 += arith_const_5) {
              ...
              {
                int* subview_32; 
                _past_array_copy_2d(memref_alloc_21, for_iter_27, for_iter_29, 1, 1, subview_32, 0, 0, 1, 1, 32, 32); 
                int* memref_alloc_33; 
                ...
                for (int for_iter_36 = arith_const_7; for_iter_36 < arith_const_6; for_iter_36 += arith_const_4) {
                  int* subview_37; 
                  _past_array_copy_2d(memref_alloc_23, for_iter_27, for_iter_36, 1, 1, subview_37, 0, 0, 1, 1, 32, 1); 
                  int* subview_38; 
                  _past_array_copy_2d(memref_alloc_24, for_iter_36, for_iter_29, 1, 1, subview_38, 0, 0, 1, 1, 1, 32); 
                  int* memref_alloc_39; 
                  int* memref_alloc_40; 
                  _past_array_copy_2d(subview_37, 0, 0, 1, 1, memref_alloc_39, 0, 0, 1, 1, 32, 1); 
                  _past_array_copy_2d(subview_38, 0, 0, 1, 1, memref_alloc_40, 0, 0, 1, 1, 1, 32); 
                  for (int for_iter_41 = arith_const_7; for_iter_41 < arith_const_5; for_iter_41 += arith_const_4) {
                    for (int for_iter_42 = arith_const_7; for_iter_42 < arith_const_5; for_iter_42 += arith_const_4) {
                      for (int for_iter_43 = arith_const_7; for_iter_43 < arith_const_4; for_iter_43 += arith_const_4) {
                ...
                _past_array_copy_2d(subview_32, 0, 0, 1, 1, memref_alloc_21, for_iter_27, for_iter_29, 1, 1, 32, 32); 
