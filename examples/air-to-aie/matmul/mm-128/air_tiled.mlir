    ...
    scf.parallel (%arg2, %arg3) = (%c0, %c0) to (%c128, %c128) step (%c64, %c64) {
      ...
      scf.parallel (%arg4, %arg5) = (%c0, %c0) to (%c64, %c64) step (%c32, %c32) {
        ...
        scf.for %arg6 = %c0 to %c128 step %c32 {
          %subview_7 = memref.subview %alloc_3[%arg4, %arg6] [32, 32] [1, 1] : memref<64x128xi32, 1> to memref<32x32xi32, strided<[128, 1], offset: ?>, 1>
          %subview_8 = memref.subview %alloc_4[%arg6, %arg5] [32, 32] [1, 1] : memref<128x64xi32, 1> to memref<32x32xi32, strided<[64, 1], offset: ?>, 1>
          %alloc_9 = memref.alloc() : memref<32x32xi32, 2>
          %alloc_10 = memref.alloc() : memref<32x32xi32, 2>
          memref.copy %subview_7, %alloc_9 : memref<32x32xi32, strided<[128, 1], offset: ?>, 1> to memref<32x32xi32, 2>
