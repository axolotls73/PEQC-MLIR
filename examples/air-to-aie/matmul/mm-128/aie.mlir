module {
  aie.device(npu1_4col) {
    ...
    aiex.runtime_sequence @forward(%arg0: memref<128x128xi32>, %arg1: memref<128x128xi32>, %arg2: memref<128x128xi32>) {
      ...
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 0, 0][2, 1, 64, 128][0, 1, 128, 1]) {id = 0 : i64, metadata = @airMemcpyId4} : memref<128x128xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg0[0, 0, 64, 0][2, 1, 64, 128][0, 1, 128, 1]) {id = 1 : i64, metadata = @airMemcpyId4} : memref<128x128xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg1[0, 0, 0, 0][2, 2, 128, 64][0, 64, 128, 1]) {id = 2 : i64, metadata = @airMemcpyId5} : memref<128x128xi32>
      aiex.npu.dma_memcpy_nd(0, 0, %arg2[0, 0, 0, 0][2, 2, 64, 64][8192, 64, 128, 1]) {id = 3 : i64, metadata = @airMemcpyId23} : memref<128x128xi32>
