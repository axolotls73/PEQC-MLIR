      ...
      %4 = air.segment @forward_0 async  attributes {id = 2 : i32} {
        ...
        %15 = air.herd @herd_0 async [%async_token_14]  tile (%arg10, %arg11) in (%arg12=%c2_13, %arg13=%c2_13) attributes {id = 3 : i32} {
          ...
          %async_token_28 = air.execute [%async_token_26] {
            ...
            scf.for %arg14 = %c0_38 to %c4_39 step %c1_40 {
              %c0_41 = arith.constant 0 : index
              %c4_42 = arith.constant 4 : index
              %c1_43 = arith.constant 1 : index
              scf.for %arg15 = %c0_41 to %c4_42 step %c1_43 {
                memref.store %c0_i32, %results_27[%arg14, %arg15] : memref<4x4xi32, 2>
              }
            }
          }
          ...
          %17:4 = scf.for %arg14 = %c0_24 to %c16_25 step %c8_23 iter_args(%arg15 = %async_token_33, %arg16 = %async_token_35, %arg17 = %async_token_35, %arg18 = %async_token_35) -> (!air.async.token, !air.async.token, !air.async.token, !air.async.token) {
            ...
            %26 = scf.if %25 -> (!air.async.token) {
              %52 = air.channel.get async [%arg18, %arg15, %async_token_33]  @channel_0[%arg10, %arg11] (%results_34[] [] []) {id = 11 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            } else {
              %52 = air.channel.get async [%arg18, %arg15, %async_token_33]  @channel_1[%arg10, %arg11] (%results_34[] [] []) {id = 12 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            }
            ...
            %34 = scf.if %33 -> (!air.async.token) {
              %52 = air.channel.get async [%arg18, %arg15, %async_token_35]  @channel_2[%arg10, %arg11] (%results_36[] [] []) {id = 13 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            } else {
              %52 = air.channel.get async [%arg18, %arg15, %async_token_35]  @channel_3[%arg10, %arg11] (%results_36[] [] []) {id = 14 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            }
            %async_token_43 = air.execute [%arg17, %34, %26] {
              ...
              scf.for %arg19 = %c0_55 to %c4_56 step %c1_57 {
                %c0_58 = arith.constant 0 : index
                %c4_59 = arith.constant 4 : index
                %c1_60 = arith.constant 1 : index
                scf.for %arg20 = %c0_58 to %c4_59 step %c1_60 {
                  %c0_61 = arith.constant 0 : index
                  %c4_62 = arith.constant 4 : index
                  %c1_63 = arith.constant 1 : index
                  scf.for %arg21 = %c0_61 to %c4_62 step %c1_63 {
                    %52 = memref.load %results_34[%arg19, %arg21] : memref<4x4xi32, 2>
                    %53 = memref.load %results_36[%arg21, %arg20] : memref<4x4xi32, 2>
                    %54 = memref.load %results_27[%arg19, %arg20] : memref<4x4xi32, 2>
                    %55 = arith.muli %52, %53 : i32
                    %56 = arith.addi %54, %55 : i32
                    memref.store %56, %results_27[%arg19, %arg20] : memref<4x4xi32, 2>
                  }
                }
              }
            }
            ...
            %42 = scf.if %41 -> (!air.async.token) {
              %52 = air.channel.get async [%34, %26, %arg16]  @channel_0[%arg10, %arg11] (%results_32[] [] []) {id = 11 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            } else {
              %52 = air.channel.get async [%34, %26, %arg16]  @channel_1[%arg10, %arg11] (%results_32[] [] []) {id = 12 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            }
            ...
            %50 = scf.if %49 -> (!air.async.token) {
              %52 = air.channel.get async [%34, %26, %arg16]  @channel_2[%arg10, %arg11] (%results_30[] [] []) {id = 13 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            } else {
              %52 = air.channel.get async [%34, %26, %arg16]  @channel_3[%arg10, %arg11] (%results_30[] [] []) {id = 14 : i32} : (memref<4x4xi32, 2>)
              scf.yield %52 : !air.async.token
            }
            %async_token_52 = air.execute [%async_token_43, %50, %42] {
              ...
              scf.for %arg19 = %c0_55 to %c4_56 step %c1_57 {
                ...
                scf.for %arg20 = %c0_58 to %c4_59 step %c1_60 {
                  ...
                  %c1_63 = arith.constant 1 : index
                  scf.for %arg21 = %c0_61 to %c4_62 step %c1_63 {
                    %52 = memref.load %results_32[%arg19, %arg21] : memref<4x4xi32, 2>
                    %53 = memref.load %results_30[%arg21, %arg20] : memref<4x4xi32, 2>
                    %54 = memref.load %results_27[%arg19, %arg20] : memref<4x4xi32, 2>
                    %55 = arith.muli %52, %53 : i32
                    %56 = arith.addi %54, %55 : i32
                    memref.store %56, %results_27[%arg19, %arg20] : memref<4x4xi32, 2>
