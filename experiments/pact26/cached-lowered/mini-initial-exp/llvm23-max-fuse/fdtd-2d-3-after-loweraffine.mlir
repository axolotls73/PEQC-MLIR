  ...
  func.func @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>, %arg5: memref<?x30xf64>, %arg6: memref<?xf64>) {
    ...
    scf.for %arg7 = %c0 to %c20 step %c1 {
      ...
      scf.for %arg8 = %c0_1 to %c30 step %c1_2 {
        ...
        memref.store %0, %arg4[%c0_8, %arg8] : memref<?x30xf64>
      }
      %c0_3 = arith.constant 0 : index
      %c20_4 = arith.constant 20 : index
      %c1_5 = arith.constant 1 : index
      scf.for %arg8 = %c0_3 to %c20_4 step %c1_5 {
        %c1_8 = arith.constant 1 : index
        %c30_9 = arith.constant 30 : index
        %c1_10 = arith.constant 1 : index
        scf.for %arg9 = %c1_8 to %c30_9 step %c1_10 {
      ...
      scf.for %arg8 = %c0_6 to %c29 step %c1_7 {
        %c1_8 = arith.constant 1 : index
        %c20_9 = arith.constant 20 : index
        %c1_10 = arith.constant 1 : index
        scf.for %arg9 = %c1_8 to %c20_9 step %c1_10 {
          %0 = memref.load %arg4[%arg9, %arg8] : memref<?x30xf64>
          %1 = memref.load %arg5[%arg9, %arg8] : memref<?x30xf64>
          %c-1 = arith.constant -1 : index
          %2 = arith.addi %arg9, %c-1 : index
          %3 = memref.load %arg5[%2, %arg8] : memref<?x30xf64>
          %4 = arith.subf %1, %3 : f64
          %5 = arith.mulf %4, %cst_0 : f64
          %6 = arith.subf %0, %5 : f64
          memref.store %6, %arg4[%arg9, %arg8] : memref<?x30xf64>
        }
        %c0_11 = arith.constant 0 : index
        %c19 = arith.constant 19 : index
        %c1_12 = arith.constant 1 : index
        scf.for %arg9 = %c0_11 to %c19 step %c1_12 {
          %0 = memref.load %arg5[%arg9, %arg8] : memref<?x30xf64>
          %c1_13 = arith.constant 1 : index
          %1 = arith.addi %arg8, %c1_13 : index
          %2 = memref.load %arg3[%arg9, %1] : memref<?x30xf64>
          %3 = memref.load %arg3[%arg9, %arg8] : memref<?x30xf64>
          %4 = arith.subf %2, %3 : f64
          %c1_14 = arith.constant 1 : index
          %5 = arith.addi %arg9, %c1_14 : index
          %6 = memref.load %arg4[%5, %arg8] : memref<?x30xf64>
          %7 = arith.addf %4, %6 : f64
          %8 = memref.load %arg4[%arg9, %arg8] : memref<?x30xf64>
          %9 = arith.subf %7, %8 : f64
          %10 = arith.mulf %9, %cst : f64
          %11 = arith.subf %0, %10 : f64
          memref.store %11, %arg5[%arg9, %arg8] : memref<?x30xf64>
        }
      }
    }
    return
