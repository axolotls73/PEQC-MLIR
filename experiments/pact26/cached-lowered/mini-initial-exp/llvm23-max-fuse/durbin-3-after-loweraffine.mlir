module {
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    scf.for %arg3 = %c1 to %c40 step %c1_6 {
      %alloc = memref.alloc() : memref<40xf64>
      ...
      scf.for %arg4 = %c0_7 to %arg3 step %c1_8 {
        ...
        %15 = arith.muli %arg4, %c-1 overflow<nsw> : index
      ...
      scf.for %arg4 = %c0_11 to %arg3 step %c1_12 {
        ...
        %20 = arith.mulf %14, %19 : f64
        %21 = arith.addf %15, %20 : f64
        memref.store %21, %alloc[%arg4] : memref<40xf64>
        %22 = memref.load %alloc[%arg4] : memref<40xf64>
