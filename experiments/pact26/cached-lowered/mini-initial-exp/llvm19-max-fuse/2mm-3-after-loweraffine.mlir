module {
  func.func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x18xf64>, %arg7: memref<?x22xf64>, %arg8: memref<?x18xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x24xf64>) {
    ...
    scf.for %arg11 = %c0 to %c16 step %c1 {
      ...
      scf.for %arg12 = %c0_0 to %c24 step %c1_1 {
        ...
        scf.for %arg13 = %c0_2 to %c18 step %c1_3 {
          %c0_4 = arith.constant 0 : index
          %c0_5 = arith.constant 0 : index
          memref.store %cst, %alloc[%c0_4, %c0_5] : memref<1x1xf64>
          %c0_6 = arith.constant 0 : index
          %c22 = arith.constant 22 : index
          %c1_7 = arith.constant 1 : index
          scf.for %arg14 = %c0_6 to %c22 step %c1_7 {
            %c0_10 = arith.constant 0 : index
            %c18_11 = arith.constant 18 : index
            %c1_12 = arith.constant 1 : index
            scf.for %arg15 = %c0_10 to %c18_11 step %c1_12 {
              memref.store %cst, %arg6[%arg11, %arg15] : memref<?x18xf64>
              %c0_17 = arith.constant 0 : index
              %c22_18 = arith.constant 22 : index
              %c1_19 = arith.constant 1 : index
              scf.for %arg16 = %c0_17 to %c22_18 step %c1_19 {
                %13 = memref.load %arg7[%arg11, %arg16] : memref<?x22xf64>
                %14 = arith.mulf %arg4, %13 : f64
                %15 = memref.load %arg8[%arg16, %arg15] : memref<?x18xf64>
                %16 = arith.mulf %14, %15 : f64
                %17 = memref.load %arg6[%arg11, %arg15] : memref<?x18xf64>
                %18 = arith.addf %17, %16 : f64
                memref.store %18, %arg6[%arg11, %arg15] : memref<?x18xf64>
              }
            }
          ...
          %2 = memref.load %alloc[%c0_8, %c0_9] : memref<1x1xf64>
