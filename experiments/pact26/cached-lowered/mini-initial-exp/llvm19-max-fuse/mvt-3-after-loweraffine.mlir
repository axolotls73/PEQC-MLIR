module {
  func.func @kernel_mvt(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?x40xf64>) {
    ...
    scf.for %arg6 = %c0 to %c40 step %c1 {
      ...
      scf.for %arg7 = %c0_0 to %c40_1 step %c1_2 {
        %c0_3 = arith.constant 0 : index
        %c40_4 = arith.constant 40 : index
        %c1_5 = arith.constant 1 : index
        scf.for %arg8 = %c0_3 to %c40_4 step %c1_5 {
          %5 = memref.load %arg1[%arg7] : memref<?xf64>
          %6 = memref.load %arg5[%arg7, %arg8] : memref<?x40xf64>
          %7 = memref.load %arg3[%arg8] : memref<?xf64>
          %8 = arith.mulf %6, %7 : f64
          %9 = arith.addf %5, %8 : f64
          memref.store %9, %arg1[%arg7] : memref<?xf64>
        }
