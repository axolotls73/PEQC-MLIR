  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_21 to %c64_22 step %c1_23 {
        ...
        %36 = arith.muli %arg8, %c-1_24 : index
        %c63_25 = arith.constant 63 : index
        %37 = arith.addi %36, %c63_25 : index
        ...
        %39 = arith.muli %arg8, %c-1_26 : index
        %c63_27 = arith.constant 63 : index
        %40 = arith.addi %39, %c63_27 : index
    ...
    scf.for %arg7 = %c0_12 to %c64_13 step %c1_14 {
      ...
      scf.for %arg8 = %c0_21 to %c64_22 step %c1_23 {
        ...
        %c-1_24 = arith.constant -1 : index
        %49 = arith.muli %37, %c-1_24 : index
        %c63_25 = arith.constant 63 : index
        %50 = arith.addi %49, %c63_25 : index
        memref.store %48, %arg6[%arg7, %50] : memref<?x64xf32>
        memref.store %38, %alloca_6[] : memref<f32>
        %c-1_26 = arith.constant -1 : index
        %51 = arith.muli %37, %c-1_26 : index
        %c63_27 = arith.constant 63 : index
        %52 = arith.addi %51, %c63_27 : index
        ...
        %54 = arith.muli %37, %c-1_28 : index
        %c63_29 = arith.constant 63 : index
        %55 = arith.addi %54, %c63_29 : index
    ...
    scf.for %arg7 = %c0_15 to %c64_16 step %c1_17 {
      ...
      scf.for %arg8 = %c0_21 to %c64_22 step %c1_23 {
        ...
        memref.store %27, %alloc[%c0_24, %c0_25] : memref<1x1xf32>
        ...
        %c-1_28 = arith.constant -1 : index
        %41 = arith.muli %arg8, %c-1_28 : index
        %c63_29 = arith.constant 63 : index
        %42 = arith.addi %41, %c63_29 : index
        %c0_30 = arith.constant 0 : index
        %c0_31 = arith.constant 0 : index
        %43 = memref.load %alloc[%c0_30, %c0_31] : memref<1x1xf32>
        memref.store %43, %alloca_5[] : memref<f32>
        memref.store %33, %alloca[] : memref<f32>
        %c-1_32 = arith.constant -1 : index
        %44 = arith.muli %arg8, %c-1_32 : index
        %c63_33 = arith.constant 63 : index
        %45 = arith.addi %44, %c63_33 : index
