module {
  func.func @kernel_nussinov(%arg0: i32, %arg1: memref<?xi32>, %arg2: memref<?x60xi32>) {
    ...
    scf.for %arg3 = %c0 to %c60 step %c1 {
      ...
      %0 = arith.muli %arg3, %c-1 overflow<nsw> : index
      ...
      scf.for %arg4 = %1 to %c60_1 step %c1_2 {
        ...
        scf.if %3 {
          ...
          %33 = arith.muli %arg3, %c-1_23 overflow<nsw> : index
          ...
          %36 = arith.muli %arg3, %c-1_24 overflow<nsw> : index
          ...
          %42 = arith.muli %arg3, %c-1_27 overflow<nsw> : index
        ...
        scf.if %5 {
          ...
          %c-1_26 = arith.constant -1 : index
          %41 = arith.muli %arg3, %c-1_26 overflow<nsw> : index
        ...
        scf.if %10 {
          ...
          scf.if %35 {
            ...
            %39 = arith.muli %arg3, %c-1_25 overflow<nsw> : index
            ...
            %43 = arith.muli %arg3, %c-1_28 overflow<nsw> : index
            ...
            %53 = arith.muli %arg3, %c-1_30 overflow<nsw> : index
            ...
            %c-1_28 = arith.constant -1 : index
            %45 = arith.muli %arg3, %c-1_28 overflow<nsw> : index
            %c59_29 = arith.constant 59 : index
        ...
        %11 = arith.muli %arg3, %c-1_10 overflow<nsw> : index
        %c60_11 = arith.constant 60 : index
        %12 = arith.addi %11, %c60_11 : index
        %c-1_12 = arith.constant -1 : index
        %13 = arith.muli %arg3, %c-1_12 overflow<nsw> : index
        ...
        %21 = arith.muli %20, %c4_15 overflow<nsw> : index
        ...
        scf.for %arg5 = %12 to %22 step %c4_16 {
          ...
          %c-1_27 = arith.constant -1 : index
          %44 = arith.muli %arg3, %c-1_27 overflow<nsw> : index
          %c59_28 = arith.constant 59 : index
          ...
          %58 = arith.muli %arg3, %c-1_35 overflow<nsw> : index
          ...
          %61 = arith.muli %arg3, %c-1_37 overflow<nsw> : index
          ...
          %64 = arith.muli %arg3, %c-1_39 overflow<nsw> : index
          ...
          %72 = arith.muli %arg3, %c-1_42 overflow<nsw> : index
          ...
          %75 = arith.muli %arg3, %c-1_44 overflow<nsw> : index
          ...
          %78 = arith.muli %arg3, %c-1_46 overflow<nsw> : index
          ...
          %86 = arith.muli %arg3, %c-1_49 overflow<nsw> : index
        ...
        %23 = arith.muli %arg3, %c-1_17 overflow<nsw> : index
        ...
        %31 = arith.muli %30, %c4_21 overflow<nsw> : index
