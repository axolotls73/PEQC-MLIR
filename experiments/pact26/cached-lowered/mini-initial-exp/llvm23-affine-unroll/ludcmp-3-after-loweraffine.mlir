  ...
  func.func @kernel_ludcmp(%arg0: i32, %arg1: memref<?x40xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) {
    ...
    scf.for %arg5 = %c0 to %c40 step %c1 {
      ...
      scf.for %arg6 = %c0_6 to %arg5 step %c1_7 {
        ...
        %8 = arith.muli %7, %c4_12 overflow<nsw> : index
        ...
        %15 = arith.muli %14, %c4_17 overflow<nsw> : index
    ...
    scf.for %arg5 = %c0_0 to %c40_1 step %c1_2 {
      ...
      %8 = arith.muli %7, %c4_8 overflow<nsw> : index
      ...
      %14 = arith.select %9, %13, %12 : index
      %c4_13 = arith.constant 4 : index
      %15 = arith.muli %14, %c4_13 overflow<nsw> : index
    ...
    scf.for %arg5 = %c0_3 to %c40_4 step %c1_5 {
      %c-1 = arith.constant -1 : index
      %1 = arith.muli %arg5, %c-1 overflow<nsw> : index
      ...
      %4 = arith.muli %arg5, %c-1_6 overflow<nsw> : index
      %c40_7 = arith.constant 40 : index
      %5 = arith.addi %4, %c40_7 : index
      %c-1_8 = arith.constant -1 : index
      %6 = arith.muli %arg5, %c-1_8 overflow<nsw> : index
      %c4 = arith.constant 4 : index
      ...
      %13 = arith.muli %12, %c4_11 overflow<nsw> : index
      ...
      scf.for %arg6 = %5 to %15 step %c4_13 {
        ...
        %35 = arith.muli %arg5, %c-1_28 overflow<nsw> : index
        ...
        %43 = arith.muli %arg5, %c-1_31 overflow<nsw> : index
        ...
        %51 = arith.muli %arg5, %c-1_33 overflow<nsw> : index
        ...
        %59 = arith.muli %arg5, %c-1_35 overflow<nsw> : index
      ...
      %16 = arith.muli %arg5, %c-1_14 overflow<nsw> : index
      ...
      %23 = arith.muli %22, %c4_18 overflow<nsw> : index
      ...
      %27 = arith.muli %arg5, %c-1_22 overflow<nsw> : index
      %c39_23 = arith.constant 39 : index
      %28 = arith.addi %27, %c39_23 : index
      %c-1_24 = arith.constant -1 : index
      %29 = arith.muli %arg5, %c-1_24 overflow<nsw> : index
      ...
      %33 = arith.muli %arg5, %c-1_26 overflow<nsw> : index
