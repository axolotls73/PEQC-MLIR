  ...
  func.func @kernel_symm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x30xf64>, %arg5: memref<?x20xf64>, %arg6: memref<?x30xf64>) {
    ...
    scf.for %arg7 = %c0 to %c20 step %c1 {
      ...
      scf.for %arg8 = %c0_0 to %c30 step %c1_1 {
        ...
        %0 = arith.cmpi slt, %arg7, %c0_3 : index
        ...
        %6 = arith.muli %5, %c4_4 overflow<nsw> : index
        %c4_5 = arith.constant 4 : index
        scf.for %arg9 = %c0_2 to %6 step %c4_5 {
          ...
          %35 = arith.addi %arg9, %c1_11 : index
        ...
        %7 = arith.cmpi slt, %arg7, %c0_7 : index
        %8 = arith.subi %c-1_8, %arg7 : index
        ...
        %13 = arith.muli %12, %c4_9 overflow<nsw> : index
        %c1_10 = arith.constant 1 : index
        scf.for %arg9 = %13 to %arg7 step %c1_10 {
          %24 = memref.load %arg6[%arg7, %arg8] : memref<?x30xf64>
          %25 = arith.mulf %arg2, %24 : f64
          %26 = memref.load %arg5[%arg7, %arg9] : memref<?x20xf64>
          %27 = arith.mulf %25, %26 : f64
