  ...
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    scf.for %arg3 = %c1 to %c40 step %c1_6 {
      ...
      scf.for %arg4 = %c0_7 to %16 step %c4_10 {
        ...
        %66 = arith.muli %65, %c-1_41 overflow<nsw> : index
        ...
        %75 = arith.muli %74, %c-1_43 overflow<nsw> : index
        ...
        %84 = arith.muli %83, %c-1_45 overflow<nsw> : index
      ...
      %23 = arith.muli %22, %c4_14 overflow<nsw> : index
      ...
      scf.for %arg4 = %c0_16 to %35 step %c4_21 {
        ...
        %c-1_41 = arith.constant -1 : index
        %66 = arith.muli %64, %c-1_41 overflow<nsw> : index
        %67 = arith.addi %arg3, %66 : index
        %c-1_42 = arith.constant -1 : index
        %68 = arith.addi %67, %c-1_42 : index
        ...
        %c-1_43 = arith.constant -1 : index
        %74 = arith.muli %72, %c-1_43 overflow<nsw> : index
        ...
        %c-1_45 = arith.constant -1 : index
        %82 = arith.muli %80, %c-1_45 overflow<nsw> : index
      ...
      %42 = arith.muli %41, %c4_25 overflow<nsw> : index
      ...
      %49 = arith.muli %48, %c4_31 overflow<nsw> : index
      ...
      %56 = arith.muli %55, %c4_36 overflow<nsw> : index
