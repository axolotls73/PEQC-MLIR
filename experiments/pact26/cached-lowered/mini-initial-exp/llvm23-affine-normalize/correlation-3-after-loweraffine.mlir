module {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.for %arg7 = %c0_7 to %c27 step %c1_8 {
      ...
      %1 = arith.muli %arg7, %c-1 overflow<nsw> : index
      %c27_12 = arith.constant 27 : index
      %2 = arith.addi %1, %c27_12 : index
      %c1_13 = arith.constant 1 : index
      scf.for %arg8 = %c0_11 to %2 step %c1_13 {
        %3 = arith.addi %arg7, %arg8 : index
        %c1_14 = arith.constant 1 : index
        %4 = arith.addi %3, %c1_14 : index
        memref.store %cst_0, %arg4[%arg7, %4] : memref<?x28xf64>
        %c0_15 = arith.constant 0 : index
        %c32_16 = arith.constant 32 : index
        %c1_17 = arith.constant 1 : index
        scf.for %arg9 = %c0_15 to %c32_16 step %c1_17 {
