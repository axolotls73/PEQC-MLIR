  ...
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x80xf64>, %arg4: memref<?x80xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    affine.for %arg7 = 0 to 80 {
      ...
      affine.for %arg8 = 0 to 100 {
        %3 = affine.load %arg3[%arg8, %arg7] : memref<?x80xf64>
    ...
    affine.for %arg7 = 0 to 100 {
      affine.for %arg8 = 0 to 80 {
        ...
        %2 = affine.load %arg3[%arg7, %arg8] : memref<?x80xf64>
        %3 = arith.subf %2, %1 : f64
        affine.store %3, %arg3[%arg7, %arg8] : memref<?x80xf64>
        %4 = affine.load %arg6[%arg8] : memref<?xf64>
        %5 = arith.mulf %0, %4 : f64
        %6 = arith.divf %3, %5 : f64
        affine.store %6, %arg3[%arg7, %arg8] : memref<?x80xf64>
      }
    }
    affine.for %arg7 = 0 to 79 {
      affine.store %cst, %arg4[%arg7, %arg7] : memref<?x80xf64>
      affine.for %arg8 = #map(%arg7) to 80 {
        affine.store %cst_0, %arg4[%arg7, %arg8] : memref<?x80xf64>
        affine.for %arg9 = 0 to 100 {
          %2 = affine.load %arg3[%arg9, %arg7] : memref<?x80xf64>
          %3 = affine.load %arg3[%arg9, %arg8] : memref<?x80xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = affine.load %arg4[%arg7, %arg8] : memref<?x80xf64>
          %6 = arith.addf %5, %4 : f64
          affine.store %6, %arg4[%arg7, %arg8] : memref<?x80xf64>
        }
        %1 = affine.load %arg4[%arg7, %arg8] : memref<?x80xf64>
        affine.store %1, %arg4[%arg8, %arg7] : memref<?x80xf64>
      }
    }
    affine.store %cst, %arg4[79, 79] : memref<?x80xf64>
    return
  }
}
