module {
  func.func @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x120xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>, %arg10: memref<?xf64>, %arg11: memref<?xf64>) {
    affine.for %arg12 = 0 to 120 {
      affine.for %arg13 = 0 to 120 {
        %0 = affine.load %arg3[%arg12, %arg13] : memref<?x120xf64>
        ...
        affine.store %8, %arg3[%arg12, %arg13] : memref<?x120xf64>
      }
    }
    affine.for %arg12 = 0 to 120 {
      affine.for %arg13 = 0 to 120 {
        %0 = affine.load %arg9[%arg12] : memref<?xf64>
        %1 = affine.load %arg3[%arg13, %arg12] : memref<?x120xf64>
    ...
    affine.for %arg12 = 0 to 120 {
      affine.for %arg13 = 0 to 120 {
        ...
        %1 = affine.load %arg3[%arg12, %arg13] : memref<?x120xf64>
