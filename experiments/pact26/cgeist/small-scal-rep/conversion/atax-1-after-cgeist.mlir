module {
  func.func @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<?x124xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) {
    ...
    affine.for %arg6 = 0 to 116 {
      ...
      affine.for %arg7 = 0 to 124 {
        ...
        %1 = affine.load %arg2[%arg6, %arg7] : memref<?x124xf64>
