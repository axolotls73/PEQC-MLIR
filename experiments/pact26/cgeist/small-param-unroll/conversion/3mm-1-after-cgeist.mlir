    ...
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %0 {
        ...
        affine.for %arg14 = 0 to %1 {
          %5 = affine.load %arg6[%arg12, %arg14] : memref<?x60xf64>
          %6 = affine.load %arg7[%arg14, %arg13] : memref<?x50xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg5[%arg12, %arg13] : memref<?x50xf64>
          %9 = arith.addf %8, %7 : f64
          affine.store %9, %arg5[%arg12, %arg13] : memref<?x50xf64>
        }
      }
    }
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %3 {
        ...
        affine.for %arg14 = 0 to %2 {
          %5 = affine.load %arg9[%arg12, %arg14] : memref<?x80xf64>
          %6 = affine.load %arg10[%arg14, %arg13] : memref<?x70xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg8[%arg12, %arg13] : memref<?x70xf64>
          %9 = arith.addf %8, %7 : f64
          affine.store %9, %arg8[%arg12, %arg13] : memref<?x70xf64>
        }
      }
    }
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %3 {
        ...
        affine.for %arg14 = 0 to %0 {
          %5 = affine.load %arg5[%arg12, %arg14] : memref<?x50xf64>
          %6 = affine.load %arg8[%arg14, %arg13] : memref<?x70xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg11[%arg12, %arg13] : memref<?x70xf64>
          %9 = arith.addf %8, %7 : f64
          affine.store %9, %arg11[%arg12, %arg13] : memref<?x70xf64>
        }
      }
    }
    return
