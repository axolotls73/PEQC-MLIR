...
module {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x80xf64>, %arg4: memref<?x80xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        %5 = affine.load %arg3[%arg8, %arg7] : memref<?x80xf64>
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        %8 = affine.load %arg3[%arg8, %arg7] : memref<?x80xf64>
    ...
    affine.for %arg7 = 0 to %0 {
      affine.for %arg8 = 0 to %1 {
        ...
        %4 = affine.load %arg3[%arg7, %arg8] : memref<?x80xf64>
        %5 = arith.subf %4, %3 : f64
        affine.store %5, %arg3[%arg7, %arg8] : memref<?x80xf64>
        %6 = affine.load %arg6[%arg8] : memref<?xf64>
        %7 = arith.mulf %2, %6 : f64
        %8 = arith.divf %5, %7 : f64
        affine.store %8, %arg3[%arg7, %arg8] : memref<?x80xf64>
      }
    }
    affine.for %arg7 = 0 to #map()[%1] {
      affine.store %cst_1, %arg4[%arg7, %arg7] : memref<?x80xf64>
      affine.for %arg8 = #map1(%arg7) to %1 {
        affine.store %cst_0, %arg4[%arg7, %arg8] : memref<?x80xf64>
        affine.for %arg9 = 0 to %0 {
          %4 = affine.load %arg3[%arg9, %arg7] : memref<?x80xf64>
          %5 = affine.load %arg3[%arg9, %arg8] : memref<?x80xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg4[%arg7, %arg8] : memref<?x80xf64>
          %8 = arith.addf %7, %6 : f64
          affine.store %8, %arg4[%arg7, %arg8] : memref<?x80xf64>
        }
        %3 = affine.load %arg4[%arg7, %arg8] : memref<?x80xf64>
        affine.store %3, %arg4[%arg8, %arg7] : memref<?x80xf64>
      }
    }
    affine.store %cst_1, %arg4[symbol(%1) - 1, symbol(%1) - 1] : memref<?x80xf64>
    return
  }
}
