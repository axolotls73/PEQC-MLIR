  ...
  func.func @kernel_ludcmp(%arg0: i32, %arg1: memref<?x120xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) {
    ...
    affine.for %arg5 = 0 to %0 {
      affine.for %arg6 = 0 to #map(%arg5) {
        %2 = affine.load %arg1[%arg5, %arg6] : memref<?x120xf64>
        affine.store %2, %alloca[] : memref<f64>
        affine.for %arg7 = 0 to #map(%arg6) {
          %6 = affine.load %arg1[%arg5, %arg7] : memref<?x120xf64>
          %7 = affine.load %arg1[%arg7, %arg6] : memref<?x120xf64>
        ...
        %4 = affine.load %arg1[%arg6, %arg6] : memref<?x120xf64>
        %5 = arith.divf %3, %4 : f64
        affine.store %5, %arg1[%arg5, %arg6] : memref<?x120xf64>
      }
      affine.for %arg6 = #map(%arg5) to %0 {
        %2 = affine.load %arg1[%arg5, %arg6] : memref<?x120xf64>
        affine.store %2, %alloca[] : memref<f64>
        affine.for %arg7 = 0 to #map(%arg5) {
          %4 = affine.load %arg1[%arg5, %arg7] : memref<?x120xf64>
          %5 = affine.load %arg1[%arg7, %arg6] : memref<?x120xf64>
        ...
        %3 = affine.load %alloca[] : memref<f64>
        affine.store %3, %arg1[%arg5, %arg6] : memref<?x120xf64>
      }
    }
    affine.for %arg5 = 0 to %0 {
      ...
      affine.store %2, %alloca[] : memref<f64>
      affine.for %arg6 = 0 to #map(%arg5) {
        %4 = affine.load %arg1[%arg5, %arg6] : memref<?x120xf64>
    ...
    affine.for %arg5 = 0 to %0 {
      ...
      affine.for %arg6 = #map1(%arg5)[%0] to %0 {
        %6 = affine.load %arg1[-%arg5 + symbol(%0) - 1, %arg6] : memref<?x120xf64>
      ...
      %3 = affine.load %alloca[] : memref<f64>
      %4 = affine.load %arg1[-%arg5 + symbol(%0) - 1, -%arg5 + symbol(%0) - 1] : memref<?x120xf64>
      %5 = arith.divf %3, %4 : f64
