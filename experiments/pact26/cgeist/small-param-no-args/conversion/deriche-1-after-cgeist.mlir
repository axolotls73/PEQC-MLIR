module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x128xf32>, %arg4: memref<?x128xf32>, %arg5: memref<?x128xf32>, %arg6: memref<?x128xf32>) {
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        %25 = affine.load %arg3[%arg7, %arg8] : memref<?x128xf32>
        ...
        affine.store %35, %arg5[%arg7, %arg8] : memref<?x128xf32>
        %36 = affine.load %arg3[%arg7, %arg8] : memref<?x128xf32>
        affine.store %36, %alloca_11[] : memref<f32>
        affine.store %30, %alloca_8[] : memref<f32>
        %37 = affine.load %arg5[%arg7, %arg8] : memref<?x128xf32>
    ...
    affine.for %arg7 = 0 to %1 {
      ...
      affine.for %arg8 = 0 to %0 {
        ...
        %34 = arith.mulf %24, %33 : f32
        %35 = arith.addf %32, %34 : f32
        affine.store %35, %arg6[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x128xf32>
        affine.store %25, %alloca_6[] : memref<f32>
        %36 = affine.load %arg3[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x128xf32>
        affine.store %36, %alloca_7[] : memref<f32>
        affine.store %30, %alloca[] : memref<f32>
        %37 = affine.load %arg6[%arg7, -%arg8 + symbol(%0) - 1] : memref<?x128xf32>
        affine.store %37, %alloca_3[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to %1 {
      affine.for %arg8 = 0 to %0 {
        %25 = affine.load %arg5[%arg7, %arg8] : memref<?x128xf32>
        %26 = affine.load %arg6[%arg7, %arg8] : memref<?x128xf32>
        %27 = arith.addf %25, %26 : f32
        affine.store %27, %arg4[%arg7, %arg8] : memref<?x128xf32>
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        %25 = affine.load %arg4[%arg8, %arg7] : memref<?x128xf32>
        %26 = arith.mulf %13, %25 : f32
        ...
        %34 = arith.mulf %24, %33 : f32
        %35 = arith.addf %32, %34 : f32
        affine.store %35, %arg5[%arg8, %arg7] : memref<?x128xf32>
        %36 = affine.load %arg4[%arg8, %arg7] : memref<?x128xf32>
        affine.store %36, %alloca_10[] : memref<f32>
        affine.store %30, %alloca_8[] : memref<f32>
        %37 = affine.load %arg5[%arg8, %arg7] : memref<?x128xf32>
        affine.store %37, %alloca_9[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to %0 {
      ...
      affine.for %arg8 = 0 to %1 {
        ...
        %34 = arith.mulf %24, %33 : f32
        %35 = arith.addf %32, %34 : f32
        affine.store %35, %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<?x128xf32>
        affine.store %25, %alloca_4[] : memref<f32>
        %36 = affine.load %arg4[-%arg8 + symbol(%1) - 1, %arg7] : memref<?x128xf32>
        affine.store %36, %alloca_5[] : memref<f32>
        affine.store %30, %alloca[] : memref<f32>
        %37 = affine.load %arg6[-%arg8 + symbol(%1) - 1, %arg7] : memref<?x128xf32>
        affine.store %37, %alloca_3[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to %1 {
