...
module {
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x120xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    affine.for %arg4 = 0 to 120 {
      ...
      affine.for %arg5 = 0 to #map(%arg4) {
        %4 = affine.load %arg1[%arg4, %arg5] : memref<?x120xf64>
      ...
      %2 = affine.load %arg1[%arg4, %arg4] : memref<?x120xf64>
