  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x128xf32>, %arg4: memref<?x128xf32>, %arg5: memref<?x128xf32>, %arg6: memref<?x128xf32>) {
    ...
    affine.for %arg7 = 0 to 192 {
      ...
      affine.for %arg8 = 0 to 128 {
        %23 = affine.load %arg3[%arg7, %arg8] : memref<?x128xf32>
        ...
        affine.store %33, %arg5[%arg7, %arg8] : memref<?x128xf32>
        %34 = affine.load %arg3[%arg7, %arg8] : memref<?x128xf32>
        affine.store %34, %alloca_11[] : memref<f32>
        affine.store %28, %alloca_8[] : memref<f32>
        %35 = affine.load %arg5[%arg7, %arg8] : memref<?x128xf32>
    ...
    affine.for %arg7 = 0 to 192 {
      ...
      affine.for %arg8 = 0 to 128 {
        ...
        %32 = arith.mulf %22, %31 : f32
        %33 = arith.addf %30, %32 : f32
        affine.store %33, %arg6[%arg7, -%arg8 + 127] : memref<?x128xf32>
        affine.store %23, %alloca_6[] : memref<f32>
        %34 = affine.load %arg3[%arg7, -%arg8 + 127] : memref<?x128xf32>
        affine.store %34, %alloca_7[] : memref<f32>
        affine.store %28, %alloca[] : memref<f32>
        %35 = affine.load %arg6[%arg7, -%arg8 + 127] : memref<?x128xf32>
        affine.store %35, %alloca_3[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to 192 {
      affine.for %arg8 = 0 to 128 {
        %23 = affine.load %arg5[%arg7, %arg8] : memref<?x128xf32>
        %24 = affine.load %arg6[%arg7, %arg8] : memref<?x128xf32>
        %25 = arith.addf %23, %24 : f32
        affine.store %25, %arg4[%arg7, %arg8] : memref<?x128xf32>
      }
    }
    affine.for %arg7 = 0 to 128 {
      ...
      affine.store %cst, %alloca_9[] : memref<f32>
      affine.store %cst, %alloca_8[] : memref<f32>
      affine.for %arg8 = 0 to 192 {
        %23 = affine.load %arg4[%arg8, %arg7] : memref<?x128xf32>
        %24 = arith.mulf %11, %23 : f32
        ...
        %32 = arith.mulf %22, %31 : f32
        %33 = arith.addf %30, %32 : f32
        affine.store %33, %arg5[%arg8, %arg7] : memref<?x128xf32>
        %34 = affine.load %arg4[%arg8, %arg7] : memref<?x128xf32>
        affine.store %34, %alloca_10[] : memref<f32>
        affine.store %28, %alloca_8[] : memref<f32>
        %35 = affine.load %arg5[%arg8, %arg7] : memref<?x128xf32>
        affine.store %35, %alloca_9[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to 128 {
      ...
      affine.for %arg8 = 0 to 192 {
        ...
        %32 = arith.mulf %22, %31 : f32
        %33 = arith.addf %30, %32 : f32
        affine.store %33, %arg6[-%arg8 + 191, %arg7] : memref<?x128xf32>
        affine.store %23, %alloca_4[] : memref<f32>
        %34 = affine.load %arg4[-%arg8 + 191, %arg7] : memref<?x128xf32>
        affine.store %34, %alloca_5[] : memref<f32>
        affine.store %28, %alloca[] : memref<f32>
        %35 = affine.load %arg6[-%arg8 + 191, %arg7] : memref<?x128xf32>
        affine.store %35, %alloca_3[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to 192 {
