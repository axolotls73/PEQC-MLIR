module {
  func.func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x116xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    %cst = arith.constant 0.000000e+00 : f64
    affine.for %arg7 = 0 to 116 {
      affine.store %cst, %arg3[%arg7] : memref<?xf64>
    }
    affine.for %arg7 = 0 to 124 {
      affine.store %cst, %arg4[%arg7] : memref<?xf64>
      affine.for %arg8 = 0 to 116 {
        %0 = affine.load %arg3[%arg8] : memref<?xf64>
        %1 = affine.load %arg6[%arg7] : memref<?xf64>
        %2 = affine.load %arg2[%arg7, %arg8] : memref<?x116xf64>
        %3 = arith.mulf %1, %2 : f64
        %4 = arith.addf %0, %3 : f64
        affine.store %4, %arg3[%arg8] : memref<?xf64>
        %5 = affine.load %arg4[%arg7] : memref<?xf64>
        %6 = affine.load %arg2[%arg7, %arg8] : memref<?x116xf64>
