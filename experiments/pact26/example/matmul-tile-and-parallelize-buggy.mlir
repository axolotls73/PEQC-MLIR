// BUGGY variant of matmul-tile-and-parallelize.mlir for the artifact smoke test:
// the A-matrix load below uses transposed indices, so this computes A^T x B
// instead of A x B. PEQC-MLIR must report NON-equivalence against matmul-linalg.mlir.
          ...
          scf.for %arg5 = %arg2 to %0 step %c1 {
            ...
            scf.for %arg6 = %arg3 to %1 step %c1_11 {
              ...
              scf.for %arg7 = %arg4 to %2 step %c1_13 {
                %3 = memref.load %arg0[%arg7, %arg5] : memref<32x32xi32>
