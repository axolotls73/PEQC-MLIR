module {
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x20xf64>, %arg3: memref<?x20xf64>, %arg4: memref<?x20xf64>, %arg5: memref<?x20xf64>) {
    ...
    scf.for %arg6 = %c0_27 to %c18 step %c1_28 {
      %c1_29 = arith.constant 1 : index
      %17 = arith.addi %arg6, %c1_29 : index
      %c1_30 = arith.constant 1 : index
      %c-1 = arith.constant -1 : index
      %18 = arith.muli %17, %c-1 : index
      %c19_31 = arith.constant 19 : index
      %19 = arith.addi %18, %c19_31 : index
      %20 = memref.load %arg4[%c1_30, %19] : memref<?x20xf64>
      %c-1_32 = arith.constant -1 : index
      %21 = arith.muli %17, %c-1_32 : index
      %c20 = arith.constant 20 : index
      %22 = arith.addi %21, %c20 : index
      %c1_33 = arith.constant 1 : index
      %23 = memref.load %arg3[%22, %c1_33] : memref<?x20xf64>
      %24 = arith.mulf %20, %23 : f64
      %c1_34 = arith.constant 1 : index
      %c-1_35 = arith.constant -1 : index
      %25 = arith.muli %17, %c-1_35 : index
      %c19_36 = arith.constant 19 : index
      %26 = arith.addi %25, %c19_36 : index
      %27 = memref.load %arg5[%c1_34, %26] : memref<?x20xf64>
      %28 = arith.addf %24, %27 : f64
      %c-1_37 = arith.constant -1 : index
      %29 = arith.muli %17, %c-1_37 : index
      %c19_38 = arith.constant 19 : index
      %30 = arith.addi %29, %c19_38 : index
      %c1_39 = arith.constant 1 : index
      memref.store %28, %arg3[%30, %c1_39] : memref<?x20xf64>
    }
    return
  }
}
