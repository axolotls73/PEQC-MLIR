    ...
    affine.for %arg7 = 0 to 20 {
      ...
      affine.for %arg8 = 0 to 19 {
        ...
        affine.for %arg9 = 0 to 30 {
          %1 = affine.load %arg4[%0, %arg9] : memref<?x30xf64>
          %2 = affine.load %arg5[%0, %arg9] : memref<?x30xf64>
          %3 = affine.load %arg5[%0 - 1, %arg9] : memref<?x30xf64>
          %4 = arith.subf %2, %3 : f64
          %5 = arith.mulf %4, %cst_0 : f64
          %6 = arith.subf %1, %5 : f64
          affine.store %6, %arg4[%0, %arg9] : memref<?x30xf64>
        }
      }
      affine.for %arg8 = 0 to 20 {
        affine.for %arg9 = 0 to 29 {
          %0 = affine.apply #map(%arg9)
          %1 = affine.load %arg3[%arg8, %0] : memref<?x30xf64>
          %2 = affine.load %arg5[%arg8, %0] : memref<?x30xf64>
          %3 = affine.load %arg5[%arg8, %0 - 1] : memref<?x30xf64>
          %4 = arith.subf %2, %3 : f64
          %5 = arith.mulf %4, %cst_0 : f64
          %6 = arith.subf %1, %5 : f64
          affine.store %6, %arg3[%arg8, %0] : memref<?x30xf64>
        }
      }
      affine.for %arg8 = 0 to 19 {
        affine.for %arg9 = 0 to 29 {
