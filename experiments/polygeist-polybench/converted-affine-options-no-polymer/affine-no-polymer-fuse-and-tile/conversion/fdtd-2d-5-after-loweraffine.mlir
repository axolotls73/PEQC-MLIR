  ...
  func.func @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>, %arg5: memref<?x30xf64>, %arg6: memref<?xf64>) {
    ...
    scf.for %arg7 = %c0 to %c20 step %c32 {
      ...
      scf.for %arg8 = %arg7 to %0 step %c1 {
        ...
        scf.for %arg9 = %c0_4 to %c19 step %c1_5 {
          %c0_12 = arith.constant 0 : index
          %c30_13 = arith.constant 30 : index
          %c1_14 = arith.constant 1 : index
          scf.for %arg10 = %c0_12 to %c30_13 step %c1_14 {
            %c1_15 = arith.constant 1 : index
            %1 = arith.addi %arg9, %c1_15 : index
            %2 = memref.load %arg4[%1, %arg10] : memref<?x30xf64>
            %c1_16 = arith.constant 1 : index
            %3 = arith.addi %arg9, %c1_16 : index
            %4 = memref.load %arg5[%3, %arg10] : memref<?x30xf64>
            %5 = memref.load %arg5[%arg9, %arg10] : memref<?x30xf64>
            %6 = arith.subf %4, %5 : f64
            %7 = arith.mulf %6, %cst_0 : f64
            %8 = arith.subf %2, %7 : f64
            %c1_17 = arith.constant 1 : index
            %9 = arith.addi %arg9, %c1_17 : index
            memref.store %8, %arg4[%9, %arg10] : memref<?x30xf64>
          }
        }
        %c0_6 = arith.constant 0 : index
        %c20_7 = arith.constant 20 : index
        %c1_8 = arith.constant 1 : index
        scf.for %arg9 = %c0_6 to %c20_7 step %c1_8 {
          %c0_12 = arith.constant 0 : index
          %c29 = arith.constant 29 : index
          %c1_13 = arith.constant 1 : index
          scf.for %arg10 = %c0_12 to %c29 step %c1_13 {
            %c1_14 = arith.constant 1 : index
            %1 = arith.addi %arg10, %c1_14 : index
            %2 = memref.load %arg3[%arg9, %1] : memref<?x30xf64>
            %c1_15 = arith.constant 1 : index
            %3 = arith.addi %arg10, %c1_15 : index
            ...
            %8 = arith.subf %2, %7 : f64
            %c1_16 = arith.constant 1 : index
            %9 = arith.addi %arg10, %c1_16 : index
            memref.store %8, %arg3[%arg9, %9] : memref<?x30xf64>
          }
        }
        %c0_9 = arith.constant 0 : index
        %c19_10 = arith.constant 19 : index
        %c1_11 = arith.constant 1 : index
        scf.for %arg9 = %c0_9 to %c19_10 step %c1_11 {
          %c0_12 = arith.constant 0 : index
          %c29 = arith.constant 29 : index
          %c1_13 = arith.constant 1 : index
          scf.for %arg10 = %c0_12 to %c29 step %c1_13 {
