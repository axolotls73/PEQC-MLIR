module {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.parallel (%arg7) = (%c0) to (%c28) step (%c1) {
      %c0_11 = arith.constant 0 : index
      %c1_12 = arith.constant 1 : index
      %c1_13 = arith.constant 1 : index
      scf.parallel (%arg8) = (%c0_11) to (%c1_12) step (%c1_13) {
    ...
    scf.parallel (%arg7) = (%c0_2) to (%c28_3) step (%c1_4) {
      %c0_11 = arith.constant 0 : index
      %c1_12 = arith.constant 1 : index
      %c1_13 = arith.constant 1 : index
      scf.parallel (%arg8) = (%c0_11) to (%c1_12) step (%c1_13) {
    ...
    scf.parallel (%arg7) = (%c0_5) to (%c32) step (%c1_6) {
      %c0_11 = arith.constant 0 : index
      %c7 = arith.constant 7 : index
      %c1_12 = arith.constant 1 : index
      scf.for %arg8 = %c0_11 to %c7 step %c1_12 {
        %c4 = arith.constant 4 : index
        %1 = arith.muli %arg8, %c4 : index
        %c0_13 = arith.constant 0 : index
        %c1_14 = arith.constant 1 : index
        %c1_15 = arith.constant 1 : index
        scf.parallel (%arg9) = (%c0_13) to (%c1_14) step (%c1_15) {
    ...
    scf.parallel (%arg7) = (%c0_7) to (%c27) step (%c1_8) {
      %c0_11 = arith.constant 0 : index
      %c1_12 = arith.constant 1 : index
      %c1_13 = arith.constant 1 : index
      scf.parallel (%arg8) = (%c0_11) to (%c1_12) step (%c1_13) {
        ...
        %c1_17 = arith.constant 1 : index
        scf.parallel (%arg9) = (%c0_14) to (%5) step (%c1_17) {
