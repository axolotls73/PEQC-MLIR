    ...
    %1 = scf.for %arg12 = %c0 to %c40 step %c1 iter_args(%arg13 = %c0) -> (index) {
      %token = async.execute {
        scf.for %arg14 = %c0 to %c10 step %c1 {
          ...
          %8 = scf.for %arg15 = %c0 to %c1 step %c1 iter_args(%arg16 = %c0) -> (index) {
            %token_0 = async.execute {
              %11 = arith.addi %arg12, %arg15 : index
              scf.for %arg17 = %c0 to %c1 step %c1 {
                %12 = arith.muli %arg17, %c4 : index
                %13 = arith.addi %6, %12 : index
                %14 = memref.load %arg9[%11] : memref<?xf64>
                %15 = memref.load %arg3[%13, %11] : memref<?x40xf64>
                %16 = arith.mulf %arg2, %15 : f64
                %17 = memref.load %arg10[%13] : memref<?xf64>
                %18 = arith.mulf %16, %17 : f64
                %19 = arith.addf %14, %18 : f64
                memref.store %19, %arg9[%11] : memref<?xf64>
                %20 = arith.addi %13, %c1 : index
                %21 = memref.load %arg9[%11] : memref<?xf64>
                %22 = memref.load %arg3[%20, %11] : memref<?x40xf64>
                %23 = arith.mulf %arg2, %22 : f64
                %24 = memref.load %arg10[%20] : memref<?xf64>
                %25 = arith.mulf %23, %24 : f64
                %26 = arith.addf %21, %25 : f64
                memref.store %26, %arg9[%11] : memref<?xf64>
                %27 = arith.addi %13, %c2 : index
                %28 = memref.load %arg9[%11] : memref<?xf64>
                %29 = memref.load %arg3[%27, %11] : memref<?x40xf64>
                %30 = arith.mulf %arg2, %29 : f64
                %31 = memref.load %arg10[%27] : memref<?xf64>
                %32 = arith.mulf %30, %31 : f64
                %33 = arith.addf %28, %32 : f64
                memref.store %33, %arg9[%11] : memref<?xf64>
                %34 = arith.addi %13, %c3 : index
                %35 = memref.load %arg9[%11] : memref<?xf64>
                %36 = memref.load %arg3[%34, %11] : memref<?x40xf64>
                %37 = arith.mulf %arg2, %36 : f64
                %38 = memref.load %arg10[%34] : memref<?xf64>
                %39 = arith.mulf %37, %38 : f64
                %40 = arith.addf %35, %39 : f64
                memref.store %40, %arg9[%11] : memref<?xf64>
              }
              async.yield
            }
            %9 = async.add_to_group %token_0, %7 : !async.token
            %10 = arith.addi %arg16, %c1 : index
            scf.yield %10 : index
          }
          async.await_all %7
        }
          ...
          %8 = scf.for %arg15 = %c0 to %c1 step %c1 iter_args(%arg16 = %c0) -> (index) {
            %token_0 = async.execute {
              ...
              scf.for %arg17 = %c0 to %c1 step %c1 {
                %12 = arith.muli %arg17, %c4 : index
                %13 = arith.addi %6, %12 : index
                %14 = memref.load %arg8[%11] : memref<?xf64>
                %15 = memref.load %arg3[%11, %13] : memref<?x40xf64>
                %16 = arith.mulf %arg1, %15 : f64
                %17 = memref.load %arg9[%13] : memref<?xf64>
                %18 = arith.mulf %16, %17 : f64
                %19 = arith.addf %14, %18 : f64
                memref.store %19, %arg8[%11] : memref<?xf64>
                %20 = arith.addi %13, %c1 : index
                %21 = memref.load %arg8[%11] : memref<?xf64>
                %22 = memref.load %arg3[%11, %20] : memref<?x40xf64>
                %23 = arith.mulf %arg1, %22 : f64
                %24 = memref.load %arg9[%20] : memref<?xf64>
                %25 = arith.mulf %23, %24 : f64
                %26 = arith.addf %21, %25 : f64
                memref.store %26, %arg8[%11] : memref<?xf64>
                %27 = arith.addi %13, %c2 : index
                %28 = memref.load %arg8[%11] : memref<?xf64>
                %29 = memref.load %arg3[%11, %27] : memref<?x40xf64>
                %30 = arith.mulf %arg1, %29 : f64
                %31 = memref.load %arg9[%27] : memref<?xf64>
                %32 = arith.mulf %30, %31 : f64
                %33 = arith.addf %28, %32 : f64
                memref.store %33, %arg8[%11] : memref<?xf64>
                %34 = arith.addi %13, %c3 : index
                %35 = memref.load %arg8[%11] : memref<?xf64>
                %36 = memref.load %arg3[%11, %34] : memref<?x40xf64>
                %37 = arith.mulf %arg1, %36 : f64
                %38 = memref.load %arg9[%34] : memref<?xf64>
                %39 = arith.mulf %37, %38 : f64
                %40 = arith.addf %35, %39 : f64
                memref.store %40, %arg8[%11] : memref<?xf64>
              }
              async.yield
            }
            %9 = async.add_to_group %token_0, %7 : !async.token
