...
void kernel_jacobi_1d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  int for_iter_arg_16 = arith_const_11; 
  for (int for_iter_15 = arith_const_11; for_iter_15 < arith_const_12; for_iter_15 += arith_const_12) {
    PAST_NEW_SEMAPHORE(execute_token_17); 
    #pragma peqc async_execute
    {
      for (int for_iter_18 = arith_const_11; for_iter_18 < arith_const_9; for_iter_18 += arith_const_12) {
        for (int for_iter_19 = arith_const_11; for_iter_19 < arith_const_8; for_iter_19 += arith_const_12) {
          ...
          double arith_mulf_29 = (arith_addf_28 * arith_const_10); 
          ...
          double arith_mulf_56 = (arith_addf_55 * arith_const_10); 
          func_arg_3[arith_addi_48] = arith_mulf_56; 
        }
        for (int for_iter_57 = arith_const_11; for_iter_57 < arith_const_8; for_iter_57 += arith_const_12) {
    ...
    int arith_addi_95 = (for_iter_arg_16 + arith_const_12); 
    for_iter_arg_16 = arith_addi_95; 
  }
