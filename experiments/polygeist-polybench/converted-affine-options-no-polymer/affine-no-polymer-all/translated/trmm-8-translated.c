...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_15 = arith_const_12; for_iter_15 < arith_const_13; for_iter_15 += arith_const_14) {
    ...
    for (int for_iter_18 = arith_const_12; for_iter_18 < arith_const_11; for_iter_18 += arith_const_14) {
      ...
      {
        for (int for_iter_21 = arith_const_12; for_iter_21 < arith_const_14; for_iter_21 += arith_const_14) {
          int arith_addi_22 = (for_iter_15 + for_iter_21); 
          for (int for_iter_23 = arith_const_12; for_iter_23 < arith_const_14; for_iter_23 += arith_const_14) {
            int arith_addi_24 = (for_iter_18 + for_iter_23); 
            int arith_muli_25 = (for_iter_15 * arith_const_10); 
            int arith_muli_26 = (for_iter_21 * arith_const_10); 
            int arith_addi_27 = (arith_muli_25 + arith_muli_26); 
            int arith_addi_28 = (arith_addi_27 + arith_const_9); 
            int arith_cmpi_29 = (arith_addi_28 < arith_const_12); 
            int arith_subi_30 = (arith_const_10 - arith_addi_28); 
            ...
            for (int for_iter_35 = arith_const_12; for_iter_35 < arith_select_34; for_iter_35 += arith_const_14) {
              int arith_muli_36 = (for_iter_35 * arith_const_8); 
              int arith_addi_37 = (arith_addi_22 + arith_muli_36); 
              int arith_addi_38 = (arith_addi_37 + arith_const_14); 
              ...
              int arith_addi_44 = (arith_addi_38 + arith_const_14); 
            ...
            int arith_muli_62 = (for_iter_15 * arith_const_10); 
            int arith_muli_63 = (for_iter_21 * arith_const_10); 
            int arith_addi_64 = (arith_muli_62 + arith_muli_63); 
            int arith_muli_65 = (for_iter_15 * arith_const_10); 
            int arith_muli_66 = (for_iter_21 * arith_const_10); 
            int arith_addi_67 = (arith_muli_65 + arith_muli_66); 
            int arith_addi_68 = (arith_addi_67 + arith_const_9); 
            int arith_cmpi_69 = (arith_addi_68 < arith_const_12); 
            int arith_subi_70 = (arith_const_10 - arith_addi_68); 
            int arith_select_71 = (arith_cmpi_69 ? arith_subi_70 : arith_addi_68); 
            int arith_divi_72 = (arith_select_71 / arith_const_8); 
            int arith_subi_73 = (arith_const_10 - arith_divi_72); 
            ...
            for (int for_iter_78 = arith_const_12; for_iter_78 < arith_addi_77; for_iter_78 += arith_const_14) {
              int arith_addi_79 = (arith_addi_22 + for_iter_78); 
              int arith_muli_80 = (arith_addi_22 * arith_const_10); 
              int arith_addi_81 = (arith_muli_80 + arith_const_9); 
              int arith_cmpi_82 = (arith_addi_81 < arith_const_12); 
              int arith_subi_83 = (arith_const_10 - arith_addi_81); 
              int arith_select_84 = (arith_cmpi_82 ? arith_subi_83 : arith_addi_81); 
              int arith_divi_85 = (arith_select_84 / arith_const_8); 
              int arith_subi_86 = (arith_const_10 - arith_divi_85); 
              ...
              int arith_addi_90 = (arith_addi_89 + arith_const_14); 
      ...
      int arith_addi_98 = (for_iter_arg_19 + arith_const_14); 
      for_iter_arg_19 = arith_addi_98; 
    }
