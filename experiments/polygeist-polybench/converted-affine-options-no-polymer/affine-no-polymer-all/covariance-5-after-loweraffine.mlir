module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    scf.parallel (%arg6) = (%c0_1) to (%c32) step (%c1_2) {
      %c0_6 = arith.constant 0 : index
      ...
      scf.for %arg7 = %c0_6 to %c7 step %c1_7 {
        ...
        %c1_10 = arith.constant 1 : index
        scf.parallel (%arg8) = (%c0_8) to (%c1_9) step (%c1_10) {
    ...
    scf.parallel (%arg6) = (%c0_3) to (%c28_4) step (%c1_5) {
      %c0_6 = arith.constant 0 : index
      ...
      %c1_8 = arith.constant 1 : index
      scf.parallel (%arg7) = (%c0_6) to (%2) step (%c1_8) {
