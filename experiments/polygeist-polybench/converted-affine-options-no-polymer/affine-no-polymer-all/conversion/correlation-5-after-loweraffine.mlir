module {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.parallel (%arg7) = (%c0_3) to (%c1_4) step (%c1_5) {
      %c32 = arith.constant 32 : index
      %1 = arith.muli %arg7, %c32 : index
      %c0_13 = arith.constant 0 : index
      %c28 = arith.constant 28 : index
    ...
    scf.parallel (%arg7) = (%c0_6) to (%c1_7) step (%c1_8) {
      %c32 = arith.constant 32 : index
      %1 = arith.muli %arg7, %c32 : index
      %c0_13 = arith.constant 0 : index
      %c1_14 = arith.constant 1 : index
      ...
      scf.for %arg8 = %c0_13 to %c1_14 step %c1_15 {
        ...
        scf.for %arg9 = %c0_16 to %c32_17 step %c1_18 {
          ...
          scf.for %arg10 = %c0_19 to %c7 step %c1_20 {
            %c4 = arith.constant 4 : index
    ...
    scf.parallel (%arg7) = (%c0_9) to (%c1_10) step (%c1_11) {
      %c32 = arith.constant 32 : index
      %1 = arith.muli %arg7, %c32 : index
      %c0_13 = arith.constant 0 : index
      %c27_14 = arith.constant 27 : index
      %c1_15 = arith.constant 1 : index
      scf.for %arg8 = %c0_13 to %c27_14 step %c1_15 {
        %2 = arith.addi %1, %arg8 : index
        ...
        %6 = arith.addi %5, %c27_17 : index
        %c1_18 = arith.constant 1 : index
        scf.for %arg9 = %c0_16 to %6 step %c1_18 {
          %7 = arith.addi %2, %arg9 : index
          %c1_19 = arith.constant 1 : index
          %8 = arith.addi %7, %c1_19 : index
          memref.store %cst_0, %arg4[%2, %8] : memref<?x28xf64>
          %c0_20 = arith.constant 0 : index
          %c8 = arith.constant 8 : index
          %c1_21 = arith.constant 1 : index
          scf.for %arg10 = %c0_20 to %c8 step %c1_21 {
            %c4 = arith.constant 4 : index
    ...
    memref.store %cst, %arg4[%c27, %c27_12] : memref<?x28xf64>
    return
  }
}
