module {
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x20xf64>, %arg3: memref<?x20xf64>, %arg4: memref<?x20xf64>, %arg5: memref<?x20xf64>) {
    ...
    scf.for %arg6 = %c0 to %c2 step %c1 {
      ...
      %18 = async.create_group %c1 : !async.group
      %19 = scf.for %arg7 = %c0 to %c1 step %c1 iter_args(%arg8 = %c0) -> (index) {
        %token = async.execute {
          %22 = arith.addi %17, %arg7 : index
          %23 = arith.muli %22, %c-1 : index
          %24 = arith.addi %23, %c19 : index
          %25 = memref.load %arg4[%c1, %24] : memref<?x20xf64>
          %26 = arith.muli %22, %c-1 : index
          %27 = arith.addi %26, %c20 : index
          %28 = memref.load %arg3[%27, %c1] : memref<?x20xf64>
          %29 = arith.mulf %25, %28 : f64
          %30 = arith.muli %22, %c-1 : index
          %31 = arith.addi %30, %c19 : index
          %32 = memref.load %arg5[%c1, %31] : memref<?x20xf64>
          %33 = arith.addf %29, %32 : f64
          %34 = arith.muli %22, %c-1 : index
          %35 = arith.addi %34, %c19 : index
          memref.store %33, %arg3[%35, %c1] : memref<?x20xf64>
          async.yield
        }
        %20 = async.add_to_group %token, %18 : !async.token
