...
void kernel_seidel_2d(int func_arg_0, int func_arg_1, double* func_arg_2)
{
  ...
  for (int for_iter_18 = arith_const_14; for_iter_18 < arith_const_15; for_iter_18 += arith_const_15) {
    ...
    {
      for (int for_iter_21 = arith_const_14; for_iter_21 < arith_const_11; for_iter_21 += arith_const_15) {
        int arith_muli_22 = (for_iter_21 * arith_const_12); 
        int arith_addi_23 = (arith_muli_22 + arith_const_15); 
        for (int for_iter_24 = arith_const_14; for_iter_24 < arith_const_10; for_iter_24 += arith_const_15) {
          int arith_muli_25 = (for_iter_21 * arith_const_9); 
          int arith_addi_26 = (arith_muli_25 + arith_const_8); 
          int arith_minsi_27 = min(arith_addi_26, arith_const_12); 
          for (int for_iter_28 = arith_const_14; for_iter_28 < arith_minsi_27; for_iter_28 += arith_const_15) {
            int arith_addi_29 = (arith_addi_23 + for_iter_28); 
            for (int for_iter_30 = arith_const_14; for_iter_30 < arith_const_7; for_iter_30 += arith_const_15) {
              int arith_muli_31 = (for_iter_30 * arith_const_6); 
              int arith_addi_32 = (arith_muli_31 + arith_const_15); 
              int arith_addi_33 = (arith_addi_29 + arith_const_5); 
              int arith_addi_34 = (arith_addi_32 + arith_const_5); 
              double memref_load_35 = func_arg_2[arith_addi_33][arith_addi_34]; 
              int arith_addi_36 = (arith_addi_29 + arith_const_5); 
              double memref_load_37 = func_arg_2[arith_addi_36][arith_addi_32]; 
              double arith_addf_38 = (memref_load_35 + memref_load_37); 
              int arith_addi_39 = (arith_addi_29 + arith_const_5); 
              int arith_addi_40 = (arith_addi_32 + arith_const_15); 
              double memref_load_41 = func_arg_2[arith_addi_39][arith_addi_40]; 
              double arith_addf_42 = (arith_addf_38 + memref_load_41); 
              int arith_addi_43 = (arith_addi_32 + arith_const_5); 
              ...
              int arith_addi_63 = (arith_addi_32 + arith_const_15); 
              int arith_addi_64 = (arith_addi_29 + arith_const_5); 
              int arith_addi_65 = (arith_addi_63 + arith_const_5); 
              double memref_load_66 = func_arg_2[arith_addi_64][arith_addi_65]; 
              int arith_addi_67 = (arith_addi_29 + arith_const_5); 
              double memref_load_68 = func_arg_2[arith_addi_67][arith_addi_63]; 
              double arith_addf_69 = (memref_load_66 + memref_load_68); 
              int arith_addi_70 = (arith_addi_29 + arith_const_5); 
              int arith_addi_71 = (arith_addi_63 + arith_const_15); 
              double memref_load_72 = func_arg_2[arith_addi_70][arith_addi_71]; 
              double arith_addf_73 = (arith_addf_69 + memref_load_72); 
              int arith_addi_74 = (arith_addi_63 + arith_const_5); 
              ...
              int arith_addi_94 = (arith_addi_32 + arith_const_11); 
              int arith_addi_95 = (arith_addi_29 + arith_const_5); 
              int arith_addi_96 = (arith_addi_94 + arith_const_5); 
              double memref_load_97 = func_arg_2[arith_addi_95][arith_addi_96]; 
              int arith_addi_98 = (arith_addi_29 + arith_const_5); 
              double memref_load_99 = func_arg_2[arith_addi_98][arith_addi_94]; 
              double arith_addf_100 = (memref_load_97 + memref_load_99); 
              int arith_addi_101 = (arith_addi_29 + arith_const_5); 
              int arith_addi_102 = (arith_addi_94 + arith_const_15); 
              double memref_load_103 = func_arg_2[arith_addi_101][arith_addi_102]; 
              double arith_addf_104 = (arith_addf_100 + memref_load_103); 
              int arith_addi_105 = (arith_addi_94 + arith_const_5); 
            ...
            for (int for_iter_156 = arith_const_14; for_iter_156 < arith_const_11; for_iter_156 += arith_const_15) {
              int arith_addi_157 = (for_iter_156 + arith_const_3); 
              int arith_addi_158 = (arith_addi_29 + arith_const_5); 
              int arith_addi_159 = (arith_addi_157 + arith_const_5); 
              double memref_load_160 = func_arg_2[arith_addi_158][arith_addi_159]; 
              int arith_addi_161 = (arith_addi_29 + arith_const_5); 
              double memref_load_162 = func_arg_2[arith_addi_161][arith_addi_157]; 
              double arith_addf_163 = (memref_load_160 + memref_load_162); 
              int arith_addi_164 = (arith_addi_29 + arith_const_5); 
              int arith_addi_165 = (arith_addi_157 + arith_const_15); 
              double memref_load_166 = func_arg_2[arith_addi_164][arith_addi_165]; 
              double arith_addf_167 = (arith_addf_163 + memref_load_166); 
              int arith_addi_168 = (arith_addi_157 + arith_const_5); 
    ...
    int arith_addi_188 = (for_iter_arg_19 + arith_const_15); 
    for_iter_arg_19 = arith_addi_188; 
  }
