module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.parallel (%arg8) = (%c0_27) to (%c1_28) step (%c1_29) {
    ...
    scf.parallel (%arg7) = (%c0_15) to (%c64_16) step (%c1_17) {
      ...
      %c16 = arith.constant 16 : index
      %c1_28 = arith.constant 1 : index
      scf.for %arg8 = %c0_27 to %c16 step %c1_28 {
        %c4 = arith.constant 4 : index
        %23 = arith.muli %arg8, %c4 : index
        %c0_29 = arith.constant 0 : index
        %c1_30 = arith.constant 1 : index
        %c1_31 = arith.constant 1 : index
        scf.for %arg9 = %c0_29 to %c1_30 step %c1_31 {
          ...
          scf.for %arg10 = %c0_32 to %c1_33 step %c1_34 {
            ...
            %27 = memref.load %arg5[%24, %26] : memref<?x64xf32>
            %28 = memref.load %arg6[%24, %26] : memref<?x64xf32>
            %29 = arith.addf %27, %28 : f32
            memref.store %29, %arg4[%24, %26] : memref<?x64xf32>
            %c1_36 = arith.constant 1 : index
            %30 = arith.addi %26, %c1_36 : index
            %31 = memref.load %arg5[%24, %30] : memref<?x64xf32>
            %32 = memref.load %arg6[%24, %30] : memref<?x64xf32>
            %33 = arith.addf %31, %32 : f32
            memref.store %33, %arg4[%24, %30] : memref<?x64xf32>
            %c2 = arith.constant 2 : index
            %34 = arith.addi %26, %c2 : index
            %35 = memref.load %arg5[%24, %34] : memref<?x64xf32>
            %36 = memref.load %arg6[%24, %34] : memref<?x64xf32>
            %37 = arith.addf %35, %36 : f32
            memref.store %37, %arg4[%24, %34] : memref<?x64xf32>
            %c3 = arith.constant 3 : index
            %38 = arith.addi %26, %c3 : index
            %39 = memref.load %arg5[%24, %38] : memref<?x64xf32>
            %40 = memref.load %arg6[%24, %38] : memref<?x64xf32>
            %41 = arith.addf %39, %40 : f32
            memref.store %41, %arg4[%24, %38] : memref<?x64xf32>
          }
        }
      }
      scf.reduce 
