  ...
  func.func @kernel_syr2k(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x30xf64>, %arg5: memref<?x20xf64>, %arg6: memref<?x20xf64>) {
    ...
    scf.parallel (%arg7) = (%c0) to (%c1) step (%c1_0) {
      ...
      scf.for %arg8 = %c0_1 to %c30 step %c1_2 {
        ...
        scf.for %arg9 = %c0_3 to %10 step %c1_7 {
          %c4_19 = arith.constant 4 : index
          %25 = arith.muli %arg9, %c4_19 : index
        ...
        %11 = arith.muli %arg7, %c32_9 : index
        %12 = arith.addi %arg8, %11 : index
        %c32_10 = arith.constant 32 : index
        %13 = arith.muli %arg7, %c32_10 : index
        ...
        scf.for %arg9 = %c0_8 to %24 step %c1_16 {
        ...
        scf.for %arg9 = %c0_17 to %c20 step %c1_18 {
          ...
          %33 = arith.muli %arg7, %c32_20 : index
          ...
          scf.for %arg10 = %c0_19 to %41 step %c1_25 {
            %c4_36 = arith.constant 4 : index
            %58 = arith.muli %arg10, %c4_36 : index
          ...
          %44 = arith.muli %arg7, %c32_27 : index
          %45 = arith.addi %arg8, %44 : index
          %c32_28 = arith.constant 32 : index
          %46 = arith.muli %arg7, %c32_28 : index
          ...
          scf.for %arg10 = %c0_26 to %57 step %c1_35 {
