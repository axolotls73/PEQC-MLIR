  ...
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.for %arg7 = %c0 to %c32 step %c1 {
      scf.for %arg8 = %c0 to %c28 step %c1 {
        ...
        scf.for %arg9 = %c0 to %c32 step %c1 {
          ...
          %16 = memref.load %alloc_2[%c0] : memref<1xf64>
          %17 = arith.addf %16, %15 : f64
          memref.store %17, %alloc_2[%c0] : memref<1xf64>
        }
        %1 = memref.load %alloc_2[%c0] : memref<1xf64>
        %2 = arith.divf %1, %arg2 : f64
        %3 = math.sqrt %2 : f64
        %4 = arith.cmpf ole, %3, %cst : f64
        %5 = arith.select %4, %cst_1, %3 : f64
        memref.store %5, %alloc_2[%c0] : memref<1xf64>
        ...
        %9 = memref.load %alloc_2[%c0] : memref<1xf64>
    ...
    scf.for %arg7 = %c0 to %c27 step %c1 {
      ...
      scf.for %arg8 = %1 to %c28 step %c1 {
        ...
        scf.for %arg9 = %c0 to %c32 step %c1 {
          scf.for %arg10 = %c0 to %c28 step %c1 {
            memref.store %cst_0, %alloc_2[%c0] : memref<1xf64>
            scf.for %arg11 = %c0 to %c32 step %c1 {
              ...
              %25 = memref.load %alloc_2[%c0] : memref<1xf64>
              %26 = arith.addf %25, %24 : f64
              memref.store %26, %alloc_2[%c0] : memref<1xf64>
            }
            %8 = memref.load %alloc_2[%c0] : memref<1xf64>
            %9 = arith.divf %8, %arg2 : f64
            %10 = math.sqrt %9 : f64
            %11 = arith.cmpf ole, %10, %cst : f64
            %12 = arith.select %11, %cst_1, %10 : f64
            memref.store %12, %alloc_2[%c0] : memref<1xf64>
            %13 = memref.load %arg5[%arg10] : memref<?xf64>
            %14 = memref.load %alloc[%c0, %arg10] : memref<1x28xf64>
            %15 = arith.subf %14, %13 : f64
            memref.store %15, %alloc[%c0, %arg10] : memref<1x28xf64>
            %16 = memref.load %alloc_2[%c0] : memref<1xf64>
            %17 = arith.mulf %0, %16 : f64
            %18 = arith.divf %15, %17 : f64
            memref.store %18, %alloc[%c0, %arg10] : memref<1x28xf64>
          }
          %3 = memref.load %alloc[%c0, %arg7] : memref<1x28xf64>
          %4 = memref.load %alloc[%c0, %arg8] : memref<1x28xf64>
