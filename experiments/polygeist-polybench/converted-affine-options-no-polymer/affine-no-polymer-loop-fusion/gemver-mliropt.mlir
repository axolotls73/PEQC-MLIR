  ...
  func.func @kernel_gemver(%arg0: i32, %arg1: f64, %arg2: f64, %arg3: memref<?x40xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>, %arg7: memref<?xf64>, %arg8: memref<?xf64>, %arg9: memref<?xf64>, %arg10: memref<?xf64>, %arg11: memref<?xf64>) {
    affine.for %arg12 = 0 to 40 {
      affine.for %arg13 = 0 to 40 {
        %3 = affine.load %arg3[%arg13, %arg12] : memref<?x40xf64>
        %4 = affine.load %arg4[%arg13] : memref<?xf64>
        %5 = affine.load %arg5[%arg12] : memref<?xf64>
        %6 = arith.mulf %4, %5 : f64
        %7 = arith.addf %3, %6 : f64
        %8 = affine.load %arg6[%arg13] : memref<?xf64>
        %9 = affine.load %arg7[%arg12] : memref<?xf64>
        %10 = arith.mulf %8, %9 : f64
        %11 = arith.addf %7, %10 : f64
        affine.store %11, %arg3[%arg13, %arg12] : memref<?x40xf64>
        %12 = affine.load %arg9[%arg12] : memref<?xf64>
        %13 = affine.load %arg3[%arg13, %arg12] : memref<?x40xf64>
        %14 = arith.mulf %arg2, %13 : f64
        %15 = affine.load %arg10[%arg13] : memref<?xf64>
        %16 = arith.mulf %14, %15 : f64
        %17 = arith.addf %12, %16 : f64
        affine.store %17, %arg9[%arg12] : memref<?xf64>
      }
