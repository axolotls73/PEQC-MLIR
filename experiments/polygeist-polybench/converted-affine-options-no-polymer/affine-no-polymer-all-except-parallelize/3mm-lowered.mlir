module {
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x18xf64>, %arg6: memref<?x20xf64>, %arg7: memref<?x18xf64>, %arg8: memref<?x22xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x22xf64>, %arg11: memref<?x22xf64>) {
    ...
    scf.parallel (%arg12) = (%c0) to (%c16) step (%c1) {
      ...
      scf.parallel (%arg13) = (%c0_5) to (%c18_6) step (%c1_7) {
        %c0_8 = arith.constant 0 : index
        %c1_9 = arith.constant 1 : index
        %c1_10 = arith.constant 1 : index
        scf.parallel (%arg14) = (%c0_8) to (%c1_9) step (%c1_10) {
          %0 = arith.addi %arg12, %arg14 : index
          %c0_11 = arith.constant 0 : index
          %c1_12 = arith.constant 1 : index
          %c1_13 = arith.constant 1 : index
          scf.parallel (%arg15) = (%c0_11) to (%c1_12) step (%c1_13) {
    ...
    scf.parallel (%arg12) = (%c0_0) to (%c18) step (%c1_1) {
      %c0_5 = arith.constant 0 : index
      %c22 = arith.constant 22 : index
      %c1_6 = arith.constant 1 : index
      scf.parallel (%arg13) = (%c0_5) to (%c22) step (%c1_6) {
        %c0_7 = arith.constant 0 : index
        %c1_8 = arith.constant 1 : index
        %c1_9 = arith.constant 1 : index
        scf.parallel (%arg14) = (%c0_7) to (%c1_8) step (%c1_9) {
          %0 = arith.addi %arg12, %arg14 : index
          %c0_10 = arith.constant 0 : index
          %c1_11 = arith.constant 1 : index
          %c1_12 = arith.constant 1 : index
          scf.parallel (%arg15) = (%c0_10) to (%c1_11) step (%c1_12) {
            %1 = arith.addi %arg13, %arg15 : index
    ...
    scf.parallel (%arg12) = (%c0_2) to (%c16_3) step (%c1_4) {
      %c0_5 = arith.constant 0 : index
      %c22 = arith.constant 22 : index
      %c1_6 = arith.constant 1 : index
      scf.parallel (%arg13) = (%c0_5) to (%c22) step (%c1_6) {
