...
void kernel_adi(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_101 = arith_const_21; for_iter_101 < arith_const_12; for_iter_101 += arith_const_22) {
    ...
    for (int for_iter_103 = arith_const_21; for_iter_103 < arith_const_22; for_iter_103 += arith_const_22) {
      int arith_addi_104 = (arith_addi_102 + for_iter_103); 
      int arith_muli_105 = (arith_addi_104 * arith_const_9); 
      int arith_addi_106 = (arith_muli_105 + arith_const_11); 
      double memref_load_107 = func_arg_4[arith_const_22][arith_addi_106]; 
      int arith_muli_108 = (arith_addi_104 * arith_const_9); 
      int arith_addi_109 = (arith_muli_108 + arith_const_8); 
      double memref_load_110 = func_arg_3[arith_addi_109][arith_const_22]; 
      double arith_mulf_111 = (memref_load_107 * memref_load_110); 
      int arith_muli_112 = (arith_addi_104 * arith_const_9); 
      int arith_addi_113 = (arith_muli_112 + arith_const_11); 
      double memref_load_114 = func_arg_5[arith_const_22][arith_addi_113]; 
      double arith_addf_115 = (arith_mulf_111 + memref_load_114); 
      int arith_muli_116 = (arith_addi_104 * arith_const_9); 
      int arith_addi_117 = (arith_muli_116 + arith_const_11); 
      func_arg_3[arith_addi_117][arith_const_22] = arith_addf_115; 
    }
  }
  return; 
