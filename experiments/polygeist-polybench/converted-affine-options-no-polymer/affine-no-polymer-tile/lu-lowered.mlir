module {
  func.func @kernel_lu(%arg0: i32, %arg1: memref<?x40xf64>) {
    ...
    scf.for %arg2 = %c0 to %c40 step %c4 {
      ...
      %0 = arith.addi %arg2, %c4_0 : index
      %c1 = arith.constant 1 : index
      scf.for %arg3 = %arg2 to %0 step %c1 {
        %c0_1 = arith.constant 0 : index
        %c1_2 = arith.constant 1 : index
        scf.for %arg4 = %c0_1 to %arg3 step %c1_2 {
          %c0_5 = arith.constant 0 : index
          %c1_6 = arith.constant 1 : index
          scf.for %arg5 = %c0_5 to %arg4 step %c1_6 {
        ...
        scf.for %arg4 = %arg3 to %c40_3 step %c1_4 {
          %c0_5 = arith.constant 0 : index
          %c1_6 = arith.constant 1 : index
          scf.for %arg5 = %c0_5 to %arg3 step %c1_6 {
