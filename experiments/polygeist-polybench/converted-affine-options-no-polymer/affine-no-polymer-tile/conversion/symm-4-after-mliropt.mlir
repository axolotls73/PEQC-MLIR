        ...
        affine.for %arg9 = #map(%arg7) to #map1(%arg7) {
          affine.for %arg10 = #map(%arg8) to #map2(%arg8) {
            ...
            affine.for %arg11 = 0 to #map(%arg9) {
              ...
              %12 = affine.load %arg5[%arg9, %arg11] : memref<?x20xf64>
              %13 = arith.mulf %11, %12 : f64
              %14 = affine.load %arg4[%arg11, %arg10] : memref<?x30xf64>
              %15 = arith.addf %14, %13 : f64
              affine.store %15, %arg4[%arg11, %arg10] : memref<?x30xf64>
              %16 = affine.load %arg6[%arg11, %arg10] : memref<?x30xf64>
              %17 = affine.load %arg5[%arg9, %arg11] : memref<?x20xf64>
            ...
            %2 = affine.load %arg6[%arg9, %arg10] : memref<?x30xf64>
            %3 = arith.mulf %arg2, %2 : f64
            %4 = affine.load %arg5[%arg9, %arg9] : memref<?x20xf64>
            %5 = arith.mulf %3, %4 : f64
            %6 = arith.addf %1, %5 : f64
            %7 = affine.load %alloca[] : memref<f64>
            %8 = arith.mulf %arg2, %7 : f64
            %9 = arith.addf %6, %8 : f64
            affine.store %9, %arg4[%arg9, %arg10] : memref<?x30xf64>
          }
        }
      }
    }
