      ...
      affine.for %arg8 = #map(%arg7) to #map3(%arg7) {
        ...
        affine.for %arg9 = #map4(%arg8) to 28 {
          ...
          affine.for %arg10 = 0 to 32 {
            ...
            %3 = affine.load %arg3[%arg10, %arg9] : memref<?x28xf64>
            %4 = arith.mulf %2, %3 : f64
            %5 = affine.load %arg4[%arg8, %arg9] : memref<?x28xf64>
            %6 = arith.addf %5, %4 : f64
            affine.store %6, %arg4[%arg8, %arg9] : memref<?x28xf64>
          }
          %1 = affine.load %arg4[%arg8, %arg9] : memref<?x28xf64>
          affine.store %1, %arg4[%arg9, %arg8] : memref<?x28xf64>
        }
      }
    }
