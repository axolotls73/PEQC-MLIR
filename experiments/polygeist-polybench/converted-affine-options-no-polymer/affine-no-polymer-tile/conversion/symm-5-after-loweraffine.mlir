module {
  func.func @kernel_symm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x30xf64>, %arg5: memref<?x20xf64>, %arg6: memref<?x30xf64>) {
    ...
    scf.for %arg7 = %c0 to %c20 step %c32 {
      ...
      scf.for %arg8 = %c0_0 to %c30 step %c32_1 {
        %c20_2 = arith.constant 20 : index
        %0 = arith.addi %arg7, %c20_2 : index
        %c1 = arith.constant 1 : index
        scf.for %arg9 = %arg7 to %0 step %c1 {
          %c30_3 = arith.constant 30 : index
          %1 = arith.addi %arg8, %c30_3 : index
          %c1_4 = arith.constant 1 : index
          scf.for %arg10 = %arg8 to %1 step %c1_4 {
            memref.store %cst, %alloca[] : memref<f64>
            %c0_5 = arith.constant 0 : index
            %c1_6 = arith.constant 1 : index
            scf.for %arg11 = %c0_5 to %arg9 step %c1_6 {
