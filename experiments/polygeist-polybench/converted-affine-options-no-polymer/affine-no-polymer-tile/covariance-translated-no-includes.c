...
void kernel_covariance(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_21 = arith_const_9; for_iter_21 < arith_const_6; for_iter_21 += arith_const_11) {
    for (int for_iter_22 = arith_const_9; for_iter_22 < arith_const_10; for_iter_22 += arith_const_11) {
      ...
      for (int for_iter_24 = for_iter_21; for_iter_24 < arith_addi_23; for_iter_24 += arith_const_11) {
        int arith_addi_25 = (for_iter_22 + arith_const_11); 
        for (int for_iter_26 = for_iter_22; for_iter_26 < arith_addi_25; for_iter_26 += arith_const_11) {
  ...
  for (int for_iter_31 = arith_const_9; for_iter_31 < arith_const_10; for_iter_31 += arith_const_11) {
    for (int for_iter_32 = for_iter_31; for_iter_32 < arith_const_10; for_iter_32 += arith_const_11) {
      func_arg_4[for_iter_31][for_iter_32] = arith_const_8; 
      for (int for_iter_33 = arith_const_9; for_iter_33 < arith_const_6; for_iter_33 += arith_const_11) {
