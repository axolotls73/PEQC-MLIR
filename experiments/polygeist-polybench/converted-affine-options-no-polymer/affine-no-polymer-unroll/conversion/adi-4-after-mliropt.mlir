...
module {
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x20xf64>, %arg3: memref<?x20xf64>, %arg4: memref<?x20xf64>, %arg5: memref<?x20xf64>) {
    ...
    affine.for %arg6 = 1 to 17 step 4 {
      ...
      %22 = affine.apply #map(%arg6)
      %23 = affine.load %arg4[1, -%22 + 19] : memref<?x20xf64>
      %24 = affine.load %arg3[-%22 + 20, 1] : memref<?x20xf64>
      %25 = arith.mulf %23, %24 : f64
      %26 = affine.load %arg5[1, -%22 + 19] : memref<?x20xf64>
      %27 = arith.addf %25, %26 : f64
      affine.store %27, %arg3[-%22 + 19, 1] : memref<?x20xf64>
      %28 = affine.apply #map1(%arg6)
      %29 = affine.load %arg4[1, -%28 + 19] : memref<?x20xf64>
      %30 = affine.load %arg3[-%28 + 20, 1] : memref<?x20xf64>
      %31 = arith.mulf %29, %30 : f64
      %32 = affine.load %arg5[1, -%28 + 19] : memref<?x20xf64>
      %33 = arith.addf %31, %32 : f64
      affine.store %33, %arg3[-%28 + 19, 1] : memref<?x20xf64>
      %34 = affine.apply #map2(%arg6)
      %35 = affine.load %arg4[1, -%34 + 19] : memref<?x20xf64>
      %36 = affine.load %arg3[-%34 + 20, 1] : memref<?x20xf64>
      %37 = arith.mulf %35, %36 : f64
      %38 = affine.load %arg5[1, -%34 + 19] : memref<?x20xf64>
      %39 = arith.addf %37, %38 : f64
      affine.store %39, %arg3[-%34 + 19, 1] : memref<?x20xf64>
    }
    affine.for %arg6 = 17 to 19 {
      %17 = affine.load %arg4[1, -%arg6 + 19] : memref<?x20xf64>
      %18 = affine.load %arg3[-%arg6 + 20, 1] : memref<?x20xf64>
      %19 = arith.mulf %17, %18 : f64
      %20 = affine.load %arg5[1, -%arg6 + 19] : memref<?x20xf64>
