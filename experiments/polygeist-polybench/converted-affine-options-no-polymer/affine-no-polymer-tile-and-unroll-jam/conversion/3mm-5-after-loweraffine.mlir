module {
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x18xf64>, %arg6: memref<?x20xf64>, %arg7: memref<?x18xf64>, %arg8: memref<?x22xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x22xf64>, %arg11: memref<?x22xf64>) {
    ...
    scf.for %arg12 = %c0 to %c16 step %c32 {
      ...
      scf.for %arg13 = %c0_5 to %c18_6 step %c32_7 {
        %c16_8 = arith.constant 16 : index
        %0 = arith.addi %arg12, %c16_8 : index
        %c1 = arith.constant 1 : index
        scf.for %arg14 = %arg12 to %0 step %c1 {
          %c18_9 = arith.constant 18 : index
          %1 = arith.addi %arg13, %c18_9 : index
          %c1_10 = arith.constant 1 : index
          scf.for %arg15 = %arg13 to %1 step %c1_10 {
            memref.store %cst, %arg5[%arg14, %arg15] : memref<?x18xf64>
            %c0_11 = arith.constant 0 : index
            %c20 = arith.constant 20 : index
            %c1_12 = arith.constant 1 : index
            scf.for %arg16 = %c0_11 to %c20 step %c1_12 {
    ...
    scf.for %arg12 = %c0_0 to %c18 step %c32_1 {
      %c0_5 = arith.constant 0 : index
      %c22 = arith.constant 22 : index
      %c32_6 = arith.constant 32 : index
      scf.for %arg13 = %c0_5 to %c22 step %c32_6 {
        %c18_7 = arith.constant 18 : index
        %0 = arith.addi %arg12, %c18_7 : index
        %c1 = arith.constant 1 : index
        scf.for %arg14 = %arg12 to %0 step %c1 {
          %c22_8 = arith.constant 22 : index
          %1 = arith.addi %arg13, %c22_8 : index
          %c1_9 = arith.constant 1 : index
          scf.for %arg15 = %arg13 to %1 step %c1_9 {
            memref.store %cst, %arg8[%arg14, %arg15] : memref<?x22xf64>
            %c0_10 = arith.constant 0 : index
            %c24 = arith.constant 24 : index
            %c1_11 = arith.constant 1 : index
            scf.for %arg16 = %c0_10 to %c24 step %c1_11 {
    ...
    scf.for %arg12 = %c0_2 to %c16_3 step %c32_4 {
      %c0_5 = arith.constant 0 : index
      %c22 = arith.constant 22 : index
      %c32_6 = arith.constant 32 : index
      scf.for %arg13 = %c0_5 to %c22 step %c32_6 {
        %c16_7 = arith.constant 16 : index
        %0 = arith.addi %arg12, %c16_7 : index
        %c1 = arith.constant 1 : index
        scf.for %arg14 = %arg12 to %0 step %c1 {
          %c22_8 = arith.constant 22 : index
          %1 = arith.addi %arg13, %c22_8 : index
          ...
          scf.for %arg15 = %arg13 to %1 step %c1_9 {
            ...
            %c1_12 = arith.constant 1 : index
            scf.for %arg16 = %c0_10 to %c18_11 step %c1_12 {
