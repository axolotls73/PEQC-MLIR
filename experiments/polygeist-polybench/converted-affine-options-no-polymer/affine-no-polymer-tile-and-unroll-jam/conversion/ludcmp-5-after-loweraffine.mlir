module {
  func.func @kernel_ludcmp(%arg0: i32, %arg1: memref<?x40xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) {
    ...
    scf.for %arg5 = %c0 to %c40 step %c1 {
      ...
      %2 = arith.addi %1, %c40_8 : index
      %c1_9 = arith.constant 1 : index
      scf.for %arg6 = %c0_7 to %2 step %c1_9 {
    ...
    scf.for %arg5 = %c0_0 to %c40_1 step %c32 {
      %c32_5 = arith.constant 32 : index
      %1 = arith.addi %arg5, %c32_5 : index
      %c40_6 = arith.constant 40 : index
      %2 = arith.minsi %1, %c40_6 : index
      %c1_7 = arith.constant 1 : index
      scf.for %arg6 = %arg5 to %2 step %c1_7 {
    ...
    scf.for %arg5 = %c0_2 to %c40_3 step %c32_4 {
      %c32_5 = arith.constant 32 : index
      %1 = arith.addi %arg5, %c32_5 : index
      %c40_6 = arith.constant 40 : index
      %2 = arith.minsi %1, %c40_6 : index
      ...
      scf.for %arg6 = %arg5 to %2 step %c1_7 {
        ...
        %7 = arith.muli %arg6, %c-1_10 : index
        ...
        %13 = arith.muli %arg6, %c-1_14 : index
