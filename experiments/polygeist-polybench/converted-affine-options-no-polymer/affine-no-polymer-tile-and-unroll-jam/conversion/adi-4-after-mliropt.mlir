    ...
    affine.for %arg6 = 0 to 20 step 32 {
      affine.for %arg7 = #map(%arg6) to #map1(%arg6) {
        affine.for %arg8 = 0 to 18 {
          ...
          affine.for %arg9 = 0 to 18 {
            %1 = affine.load %arg4[%arg8 + 1, -%arg9 + 18] : memref<?x20xf64>
            %2 = affine.load %arg3[-%arg9 + 19, %arg8 + 1] : memref<?x20xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg5[%arg8 + 1, -%arg9 + 18] : memref<?x20xf64>
            %5 = arith.addf %3, %4 : f64
            affine.store %5, %arg3[-%arg9 + 18, %arg8 + 1] : memref<?x20xf64>
          }
        }
        affine.for %arg8 = 0 to 18 {
          ...
          affine.for %arg9 = 0 to 18 {
            %1 = affine.load %arg4[%arg8 + 1, -%arg9 + 18] : memref<?x20xf64>
            %2 = affine.load %arg2[%arg8 + 1, -%arg9 + 19] : memref<?x20xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg5[%arg8 + 1, -%arg9 + 18] : memref<?x20xf64>
            %5 = arith.addf %3, %4 : f64
            affine.store %5, %arg2[%arg8 + 1, -%arg9 + 18] : memref<?x20xf64>
          }
        }
      }
    }
