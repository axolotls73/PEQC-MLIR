...
module {
  func.func @kernel_adi(%arg0: i32, %arg1: i32, %arg2: memref<?x20xf64>, %arg3: memref<?x20xf64>, %arg4: memref<?x20xf64>, %arg5: memref<?x20xf64>) {
    ...
    affine.for %arg6 = 0 to 18 step 32 {
      affine.for %arg7 = #map(%arg6) to #map1(%arg6) {
        %17 = affine.load %arg4[1, -%arg7 + 18] : memref<?x20xf64>
        %18 = affine.load %arg3[-%arg7 + 19, 1] : memref<?x20xf64>
        %19 = arith.mulf %17, %18 : f64
        %20 = affine.load %arg5[1, -%arg7 + 18] : memref<?x20xf64>
        %21 = arith.addf %19, %20 : f64
        affine.store %21, %arg3[-%arg7 + 18, 1] : memref<?x20xf64>
      }
    }
    return
  }
