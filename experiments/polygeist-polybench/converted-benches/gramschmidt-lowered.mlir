module {
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x30xf64>, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>) {
    ...
    scf.parallel (%arg5) = (%c0) to (%c29) step (%c1) {
      %c1_2 = arith.constant 1 : index
      %1 = arith.addi %arg5, %c1_2 : index
      %c30_3 = arith.constant 30 : index
      %c1_4 = arith.constant 1 : index
      scf.parallel (%arg6) = (%1) to (%c30_3) step (%c1_4) {
    ...
    scf.for %arg5 = %c0_0 to %c30 step %c1_1 {
      ...
      scf.parallel (%arg6) = (%c0_2) to (%c2) step (%c1_3) {
        ...
        scf.parallel (%arg7) = (%15) to (%18) step (%c1_10) {
      ...
      scf.parallel (%arg6) = (%10) to (%c10) step (%c1_6) {
        %c0_7 = arith.constant 0 : index
        ...
        scf.for %arg7 = %c0_7 to %c2_8 step %c1_9 {
          ...
          scf.if %13 {
            ...
            scf.for %arg8 = %c0_15 to %c19 step %c1_16 {
              ...
              scf.parallel (%arg9) = (%23) to (%25) step (%c1_20) {
          ...
          scf.if %14 {
            ...
            scf.parallel (%arg8) = (%23) to (%25) step (%c1_18) {
          ...
          scf.parallel (%arg8) = (%16) to (%19) step (%c1_14) {
            %c32_15 = arith.constant 32 : index
            %20 = arith.muli %arg6, %c32_15 : index
            %c10_16 = arith.constant 10 : index
            %21 = arith.muli %arg5, %c10_16 : index
            ...
            %25 = arith.addi %24, %c31 : index
            %c1_18 = arith.constant 1 : index
            scf.parallel (%arg9) = (%23) to (%25) step (%c1_18) {
              %c0_19 = arith.constant 0 : index
              %c2_20 = arith.constant 2 : index
