  ...
  func.func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x38xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.parallel (%arg7) = (%c0_0) to (%c2_1) step (%c1_2) {
      ...
      scf.for %arg8 = %c0_9 to %c2_10 step %c1_11 {
        ...
        scf.parallel (%arg9) = (%0) to (%3) step (%c1_14) {
          ...
          %4 = arith.muli %arg8, %c32_15 : index
          %c38 = arith.constant 38 : index
          %c32_16 = arith.constant 32 : index
          %5 = arith.muli %arg8, %c32_16 : index
          %c32_17 = arith.constant 32 : index
          %6 = arith.addi %5, %c32_17 : index
          %7 = arith.minsi %c38, %6 : index
          %c1_18 = arith.constant 1 : index
          scf.for %arg10 = %4 to %7 step %c1_18 {
    ...
    scf.parallel (%arg7) = (%c0_6) to (%c2_7) step (%c1_8) {
      ...
      scf.for %arg8 = %c0_9 to %c2_10 step %c1_11 {
        ...
        %c42 = arith.constant 42 : index
        %c32_12 = arith.constant 32 : index
        %1 = arith.muli %arg8, %c32_12 : index
        %c32_13 = arith.constant 32 : index
        %2 = arith.addi %1, %c32_13 : index
        %3 = arith.minsi %c42, %2 : index
        %c1_14 = arith.constant 1 : index
        scf.for %arg9 = %0 to %3 step %c1_14 {
          %c32_15 = arith.constant 32 : index
          ...
          %7 = arith.minsi %c38, %6 : index
          %c1_18 = arith.constant 1 : index
          scf.parallel (%arg10) = (%4) to (%7) step (%c1_18) {
            %8 = memref.load %arg3[%arg10] : memref<?xf64>
            %9 = memref.load %arg6[%arg9] : memref<?xf64>
