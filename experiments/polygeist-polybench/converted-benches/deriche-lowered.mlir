module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %14, %alloca_11[%c0_27] : memref<1xf32>
    %c0_28 = arith.constant 0 : index
    %15 = memref.load %alloca_11[%c0_28] : memref<1xf32>
    %c0_29 = arith.constant 0 : index
    memref.store %15, %alloca_4[%c0_29] : memref<1xf32>
    %16 = arith.negf %arg2 : f32
    %17 = math.exp %16 : f32
    %18 = arith.mulf %15, %17 : f32
    %c0_30 = arith.constant 0 : index
    memref.store %18, %alloca_8[%c0_30] : memref<1xf32>
    %19 = arith.subf %arg2, %cst_0 : f32
    %20 = arith.mulf %18, %19 : f32
    %c0_31 = arith.constant 0 : index
    memref.store %20, %alloca_16[%c0_31] : memref<1xf32>
    %c0_32 = arith.constant 0 : index
    %21 = memref.load %alloca_4[%c0_32] : memref<1xf32>
    %22 = arith.negf %21 : f32
    %23 = arith.mulf %arg2, %cst_2 : f32
    %24 = math.exp %23 : f32
    %25 = arith.mulf %22, %24 : f32
    %c0_33 = arith.constant 0 : index
    memref.store %25, %alloca_14[%c0_33] : memref<1xf32>
    %c0_34 = arith.constant 0 : index
    %26 = memref.load %alloca_8[%c0_34] : memref<1xf32>
    %27 = arith.addf %arg2, %cst_0 : f32
    %28 = arith.mulf %26, %27 : f32
    %c0_35 = arith.constant 0 : index
    memref.store %28, %alloca_12[%c0_35] : memref<1xf32>
    %29 = llvm.mlir.undef : f32
    memref.store %29, %alloca_5[] : memref<f32>
    %30 = llvm.mlir.undef : f32
    memref.store %30, %alloca_7[] : memref<f32>
    %31 = llvm.mlir.undef : f32
    memref.store %31, %alloca_25[] : memref<f32>
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %42 = memref.load %alloca_16[%c0_55] : memref<1xf32>
        %43 = memref.load %alloca_5[] : memref<f32>
        %44 = arith.mulf %42, %43 : f32
        %45 = arith.addf %41, %44 : f32
        %c0_56 = arith.constant 0 : index
        %46 = memref.load %alloca_15[%c0_56] : memref<1xf32>
        %47 = memref.load %alloca_25[] : memref<f32>
        %c0_57 = arith.constant 0 : index
        memref.store %47, %alloca_9[%c0_57] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %c0_58 = arith.constant 0 : index
        %50 = memref.load %alloca_6[%c0_58] : memref<1xf32>
        %51 = memref.load %alloca_24[] : memref<f32>
        ...
        memref.store %54, %alloca_25[] : memref<f32>
        %c0_59 = arith.constant 0 : index
        %55 = memref.load %alloca_9[%c0_59] : memref<1xf32>
        memref.store %55, %alloca_24[] : memref<f32>
        %56 = memref.load %arg3[%arg7, %arg8] : memref<?x64xf32>
        memref.store %56, %alloca_5[] : memref<f32>
      }
    }
    %33 = llvm.mlir.undef : f32
    memref.store %33, %alloca_3[] : memref<f32>
    %34 = llvm.mlir.undef : f32
    memref.store %34, %alloca_21[] : memref<f32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        %c0_54 = arith.constant 0 : index
        %39 = memref.load %alloca_12[%c0_54] : memref<1xf32>
        %40 = memref.load %alloca_3[] : memref<f32>
        %c0_55 = arith.constant 0 : index
        memref.store %40, %alloca_13[%c0_55] : memref<1xf32>
        %41 = arith.mulf %39, %40 : f32
        %c0_56 = arith.constant 0 : index
        %42 = memref.load %alloca_14[%c0_56] : memref<1xf32>
        %43 = memref.load %alloca_21[] : memref<f32>
        %44 = arith.mulf %42, %43 : f32
        %45 = arith.addf %41, %44 : f32
        %c0_57 = arith.constant 0 : index
        %46 = memref.load %alloca_15[%c0_57] : memref<1xf32>
        %47 = memref.load %alloca_23[] : memref<f32>
        %c0_58 = arith.constant 0 : index
        memref.store %47, %alloca_18[%c0_58] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %c0_59 = arith.constant 0 : index
        %50 = memref.load %alloca_6[%c0_59] : memref<1xf32>
        ...
        %59 = memref.load %alloca_18[%c0_62] : memref<1xf32>
        ...
        memref.store %62, %alloca_3[] : memref<f32>
        %c0_65 = arith.constant 0 : index
        %63 = memref.load %alloca_13[%c0_65] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_42 to %c64_43 step %c1_44 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %47 = memref.load %alloca_25[] : memref<f32>
        %c0_57 = arith.constant 0 : index
        memref.store %47, %alloca_19[%c0_57] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %c0_58 = arith.constant 0 : index
        %50 = memref.load %alloca_6[%c0_58] : memref<1xf32>
        ...
        memref.store %54, %alloca_25[] : memref<f32>
        %c0_59 = arith.constant 0 : index
        %55 = memref.load %alloca_19[%c0_59] : memref<1xf32>
        memref.store %55, %alloca_24[] : memref<f32>
    ...
    scf.for %arg7 = %c0_45 to %c64_46 step %c1_47 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        %c0_54 = arith.constant 0 : index
        %39 = memref.load %alloca_12[%c0_54] : memref<1xf32>
        %40 = memref.load %alloca_10[] : memref<f32>
        %c0_55 = arith.constant 0 : index
        memref.store %40, %alloca_17[%c0_55] : memref<1xf32>
        %41 = arith.mulf %39, %40 : f32
        %c0_56 = arith.constant 0 : index
        %42 = memref.load %alloca_14[%c0_56] : memref<1xf32>
        ...
        %47 = memref.load %alloca_23[] : memref<f32>
        %c0_58 = arith.constant 0 : index
        memref.store %47, %alloca_20[%c0_58] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %c0_59 = arith.constant 0 : index
        %50 = memref.load %alloca_6[%c0_59] : memref<1xf32>
        ...
        memref.store %58, %alloca_23[] : memref<f32>
        %c0_62 = arith.constant 0 : index
        %59 = memref.load %alloca_20[%c0_62] : memref<1xf32>
        memref.store %59, %alloca[] : memref<f32>
        %c-1_63 = arith.constant -1 : index
        %60 = arith.muli %arg8, %c-1_63 : index
        %c63_64 = arith.constant 63 : index
        ...
        %c0_65 = arith.constant 0 : index
        %63 = memref.load %alloca_17[%c0_65] : memref<1xf32>
