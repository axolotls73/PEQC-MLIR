module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    scf.parallel (%arg6) = (%c0) to (%c28) step (%c1) {
      ...
      scf.parallel (%arg7) = (%arg6) to (%c28_19) step (%c1_20) {
    ...
    scf.for %arg6 = %c0_6 to %c32 step %c1_7 {
      ...
      scf.parallel (%arg7) = (%c0_19) to (%c28_20) step (%c1_21) {
    ...
    scf.parallel (%arg6) = (%c0_8) to (%c28_9) step (%c1_10) {
    ...
    scf.parallel (%arg6) = (%c0_11) to (%c32_12) step (%c1_13) {
      %c0_19 = arith.constant 0 : index
      %c28_20 = arith.constant 28 : index
      %c1_21 = arith.constant 1 : index
      scf.parallel (%arg7) = (%c0_19) to (%c28_20) step (%c1_21) {
    ...
    scf.parallel (%arg6) = (%c0_14) to (%c28_15) step (%c1_16) {
      %c0_19 = arith.constant 0 : index
      ...
      scf.for %arg7 = %c0_19 to %c32_20 step %c1_21 {
        ...
        scf.parallel (%arg8) = (%arg6) to (%c28_22) step (%c1_23) {
