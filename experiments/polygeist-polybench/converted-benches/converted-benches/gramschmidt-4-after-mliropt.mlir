...
module {
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x30xf64>, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>) {
    ...
    affine.parallel (%arg5) = (0) to (29) {
      affine.parallel (%arg6) = (%arg5 + 1) to (30) {
    ...
    affine.for %arg5 = 0 to 30 {
      affine.parallel (%arg6) = (0) to (2) {
        ...
        affine.parallel (%arg7) = (max(19, %arg6 * 32)) to (min(39, %arg6 * 32 + 32)) {
        ...
        affine.for %arg7 = 0 to 2 {
          affine.if #set(%arg7) {
            affine.for %arg8 = 0 to 19 {
              affine.parallel (%arg9) = (max(%arg6 * 32, %arg5 * 10 + 38)) to (%arg6 * 32 + 31) {
                affine.if #set1(%arg9) {
          ...
          affine.if #set(%arg7) {
            affine.parallel (%arg8) = (max(%arg6 * 32, %arg5 * 10 + 38)) to (%arg6 * 32 + 31) {
              affine.if #set1(%arg8) {
          ...
          affine.parallel (%arg8) = (max(20, %arg7 * 32)) to (min(39, %arg7 * 32 + 32)) {
            affine.parallel (%arg9) = (max(%arg6 * 32, %arg5 * 10 + 38)) to (%arg6 * 32 + 31) {
              affine.if #set1(%arg9) {
