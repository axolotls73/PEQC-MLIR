      ...
      scf.for %arg3 = %c0 to %0 step %c1 {
        ...
        scf.for %arg4 = %c0 to %1 step %c1 {
          ...
          scf.if %8 {
            ...
            %40 = scf.for %arg5 = %c33 to %c40 step %c1 iter_args(%arg6 = %c0) -> (index) {
              %token = async.execute {
                %43 = async.create_group %c42 : !async.group
                %44 = scf.for %arg7 = %c32 to %arg5 step %c1 iter_args(%arg8 = %c0) -> (index) {
                  %token_0 = async.execute {
                    scf.for %arg9 = %c1 to %c32 step %c1 {
                      %47 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                      %48 = arith.addi %arg9, %c-1 : index
                      %49 = memref.load %arg1[%arg5, %48] : memref<?x40xf64>
                      %50 = arith.addi %arg9, %c-1 : index
                      %51 = memref.load %arg1[%arg7, %50] : memref<?x40xf64>
                      %52 = arith.mulf %49, %51 : f64
                      %53 = arith.subf %47, %52 : f64
                      memref.store %53, %arg1[%arg5, %arg7] : memref<?x40xf64>
                    }
                    async.yield
                  }
                  %45 = async.add_to_group %token_0, %43 : !async.token
          ...
          scf.if %30 {
            ...
            %40 = scf.for %arg5 = %c33 to %c40 step %c1 iter_args(%arg6 = %c0) -> (index) {
              %token = async.execute {
                %43 = memref.load %arg1[%arg5, %c0] : memref<?x40xf64>
                %44 = memref.load %arg1[%c0, %c0] : memref<?x40xf64>
                %45 = arith.divf %43, %44 : f64
                memref.store %45, %arg1[%arg5, %c0] : memref<?x40xf64>
                scf.for %arg7 = %c1 to %c32 step %c1 {
                  scf.for %arg8 = %c1 to %arg7 step %c1 {
                    %61 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                    %62 = arith.addi %arg8, %c-1 : index
                    %63 = memref.load %arg1[%arg5, %62] : memref<?x40xf64>
                    %64 = arith.addi %arg8, %c-1 : index
                    %65 = memref.load %arg1[%arg7, %64] : memref<?x40xf64>
                    %66 = arith.mulf %63, %65 : f64
                    %67 = arith.subf %61, %66 : f64
                    memref.store %67, %arg1[%arg5, %arg7] : memref<?x40xf64>
                  }
                  %46 = memref.load %arg1[%arg5, %arg5] : memref<?x40xf64>
                  %47 = arith.addi %arg7, %c-1 : index
                  %48 = memref.load %arg1[%arg5, %47] : memref<?x40xf64>
                  %49 = arith.mulf %48, %48 : f64
                  %50 = arith.subf %46, %49 : f64
                  memref.store %50, %arg1[%arg5, %arg5] : memref<?x40xf64>
                  %51 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                  %52 = arith.addi %arg7, %c-1 : index
                  %53 = memref.load %arg1[%arg5, %52] : memref<?x40xf64>
                  %54 = arith.addi %arg7, %c-1 : index
                  %55 = memref.load %arg1[%arg7, %54] : memref<?x40xf64>
                  %56 = arith.mulf %53, %55 : f64
                  %57 = arith.subf %51, %56 : f64
                  memref.store %57, %arg1[%arg5, %arg7] : memref<?x40xf64>
                  %58 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                  %59 = memref.load %arg1[%arg7, %arg7] : memref<?x40xf64>
                  %60 = arith.divf %58, %59 : f64
                  memref.store %60, %arg1[%arg5, %arg7] : memref<?x40xf64>
                }
                async.yield
              }
              %41 = async.add_to_group %token, %39 : !async.token
