        ...
        affine.for %arg6 = 0 to 2 {
          affine.for %arg7 = max #map(%arg4, %arg5, %arg6) to min #map1(%arg4, %arg5, %arg6) {
            affine.if #set(%arg4, %arg7) {
              affine.parallel (%arg8) = (max(%arg5 * 32, %arg7 * 2 + 1)) to (min(%arg5 * 32 + 32, %arg7 * 2 + 9)) {
                affine.parallel (%arg9) = (max(%arg6 * 32, %arg7 * 2 + 1)) to (min(%arg6 * 32 + 32, %arg7 * 2 + 9)) {
            ...
            affine.for %arg8 = max #map2(%arg4, %arg7) to min #map3(%arg4, %arg7) {
              ...
              affine.for %arg9 = max #map2(%arg5, %arg7) to min #map3(%arg5, %arg7) {
                ...
                affine.parallel (%arg10) = (max(%arg6 * 32, %arg7 * 2 + 2)) to (min(%arg6 * 32 + 32, %arg7 * 2 + 9)) {
              ...
              affine.if #set1(%arg5, %arg7) {
                affine.parallel (%arg9) = (max(%arg6 * 32, %arg7 * 2 + 2)) to (min(%arg6 * 32 + 32, %arg7 * 2 + 10)) {
            ...
            affine.if #set1(%arg4, %arg7) {
              affine.parallel (%arg8) = (max(%arg5 * 32, %arg7 * 2 + 2)) to (min(%arg5 * 32 + 32, %arg7 * 2 + 10)) {
                affine.parallel (%arg9) = (max(%arg6 * 32, %arg7 * 2 + 2)) to (min(%arg6 * 32 + 32, %arg7 * 2 + 10)) {
          ...
          affine.if #set2(%arg4, %arg5, %arg6) {
            affine.parallel (%arg7) = (max(31, %arg4 * 32)) to (min(39, %arg4 * 32 + 32)) {
              affine.parallel (%arg8) = (max(31, %arg5 * 32)) to (min(39, %arg5 * 32 + 32)) {
                affine.parallel (%arg9) = (max(31, %arg6 * 32)) to (min(39, %arg6 * 32 + 32)) {
