#map = affine_map<(d0) -> (0, (d0 * 16 - 13) ceildiv 13)>
#map1 = affine_map<(d0) -> ((d0 * 32 + 31) floordiv 27 + 1)>
#map2 = affine_map<(d0, d1) -> (d0 * 32, d1 * 27)>
#map3 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 26 + 28)>
module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    affine.parallel (%arg6) = (0) to (28) {
      affine.parallel (%arg7) = (%arg6) to (28) {
    ...
    affine.parallel (%arg6) = (0) to (28) {
      affine.for %arg7 = 0 to 32 {
        affine.parallel (%arg8) = (%arg6) to (28) {
    ...
    affine.for %arg6 = 0 to 23 {
      affine.for %arg7 = max #map(%arg6) to #map1(%arg6) {
