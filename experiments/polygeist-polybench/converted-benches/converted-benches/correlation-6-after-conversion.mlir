  ...
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    %1 = scf.for %arg7 = %c0 to %c27 step %c1 iter_args(%arg8 = %c0) -> (index) {
      %token = async.execute {
        ...
        %21 = scf.for %arg9 = %19 to %c28 step %c1 iter_args(%arg10 = %c0) -> (index) {
    ...
    %12 = scf.for %arg7 = %c0 to %c32 step %c1 iter_args(%arg8 = %c0) -> (index) {
      %token = async.execute {
        %19 = async.create_group %c28 : !async.group
        %20 = scf.for %arg9 = %c0 to %c28 step %c1 iter_args(%arg10 = %c0) -> (index) {
          %token_2 = async.execute {
            %23 = memref.load %arg3[%arg7, %arg9] : memref<?x28xf64>
            %24 = memref.load %alloca[%c0] : memref<1xf64>
            %25 = memref.load %arg6[%arg9] : memref<?xf64>
            %26 = arith.mulf %24, %25 : f64
            %27 = arith.divf %23, %26 : f64
            memref.store %27, %arg3[%arg7, %arg9] : memref<?x28xf64>
            async.yield
          }
          %21 = async.add_to_group %token_2, %19 : !async.token
          %22 = arith.addi %arg10, %c1 : index
          scf.yield %22 : index
        }
        async.await_all %19
        async.yield
    ...
    %14 = scf.for %arg7 = %c0 to %c27 step %c1 iter_args(%arg8 = %c0) -> (index) {
      %token = async.execute {
        scf.for %arg9 = %c0 to %c32 step %c1 {
          %19 = arith.addi %arg7, %c1 : index
          %20 = async.create_group %c42 : !async.group
          %21 = scf.for %arg10 = %19 to %c28 step %c1 iter_args(%arg11 = %c0) -> (index) {
            %token_2 = async.execute {
              %24 = memref.load %arg4[%arg7, %arg10] : memref<?x28xf64>
              %25 = memref.load %arg3[%arg9, %arg7] : memref<?x28xf64>
              %26 = memref.load %arg3[%arg9, %arg10] : memref<?x28xf64>
              %27 = arith.mulf %25, %26 : f64
              %28 = arith.addf %24, %27 : f64
              memref.store %28, %arg4[%arg7, %arg10] : memref<?x28xf64>
              async.yield
            }
            %22 = async.add_to_group %token_2, %20 : !async.token
            %23 = arith.addi %arg11, %c1 : index
            scf.yield %23 : index
          }
          async.await_all %20
        }
      ...
      %token = async.execute {
        ...
        %21 = scf.for %arg9 = %19 to %c28 step %c1 iter_args(%arg10 = %c0) -> (index) {
          %token_2 = async.execute {
            ...
            memref.store %24, %arg4[%arg9, %arg7] : memref<?x28xf64>
            async.yield
          }
          %22 = async.add_to_group %token_2, %20 : !async.token
          %23 = arith.addi %arg10, %c1 : index
