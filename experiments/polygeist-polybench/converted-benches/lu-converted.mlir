        ...
        scf.for %arg4 = %arg2 to %c3 step %c1 {
          ...
          scf.if %8 {
            ...
            %44 = scf.for %arg5 = %c33 to %c40 step %c1 iter_args(%arg6 = %c0) -> (index) {
              %token = async.execute {
                %47 = async.create_group %c42 : !async.group
                %48 = scf.for %arg7 = %c32 to %arg5 step %c1 iter_args(%arg8 = %c0) -> (index) {
                  %token_0 = async.execute {
                    scf.for %arg9 = %arg5 to %c64 step %c1 {
                      %51 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                      %52 = arith.muli %arg5, %c-1 : index
                      %53 = arith.addi %52, %arg9 : index
                      %54 = memref.load %arg1[%arg5, %53] : memref<?x40xf64>
                      %55 = arith.muli %arg5, %c-1 : index
                      %56 = arith.addi %55, %arg9 : index
                      %57 = memref.load %arg1[%56, %arg7] : memref<?x40xf64>
                      %58 = arith.mulf %54, %57 : f64
                      %59 = arith.subf %51, %58 : f64
                      memref.store %59, %arg1[%arg5, %arg7] : memref<?x40xf64>
                    }
                    async.yield
                  }
                  %49 = async.add_to_group %token_0, %47 : !async.token
            ...
            %49 = scf.for %arg5 = %44 to %47 step %c1 iter_args(%arg6 = %c0) -> (index) {
              %token = async.execute {
                ...
                scf.for %arg7 = %c1 to %58 step %c1 {
                  %66 = arith.addi %arg5, %arg7 : index
                  scf.for %arg8 = %arg5 to %66 step %c1 {
                    %70 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                    %71 = arith.muli %arg5, %c-1 : index
                    %72 = arith.addi %71, %arg8 : index
                    %73 = memref.load %arg1[%arg5, %72] : memref<?x40xf64>
                    %74 = arith.muli %arg5, %c-1 : index
                    %75 = arith.addi %74, %arg8 : index
                    %76 = memref.load %arg1[%75, %arg7] : memref<?x40xf64>
                    %77 = arith.mulf %73, %76 : f64
                    %78 = arith.subf %70, %77 : f64
                    memref.store %78, %arg1[%arg5, %arg7] : memref<?x40xf64>
                  }
                  %67 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                  %68 = memref.load %arg1[%arg7, %arg7] : memref<?x40xf64>
                  %69 = arith.divf %67, %68 : f64
                  memref.store %69, %arg1[%arg5, %arg7] : memref<?x40xf64>
                }
                ...
                %65 = scf.for %arg7 = %62 to %63 step %c1 iter_args(%arg8 = %c0) -> (index) {
                  %token_0 = async.execute {
                    %68 = arith.muli %arg2, %c32 : index
                    %69 = arith.addi %68, %c32 : index
                    scf.for %arg9 = %arg5 to %69 step %c1 {
                      %70 = memref.load %arg1[%arg5, %arg7] : memref<?x40xf64>
                      %71 = arith.muli %arg5, %c-1 : index
                      %72 = arith.addi %71, %arg9 : index
                      %73 = memref.load %arg1[%arg5, %72] : memref<?x40xf64>
                      %74 = arith.muli %arg5, %c-1 : index
                      %75 = arith.addi %74, %arg9 : index
                      %76 = memref.load %arg1[%75, %arg7] : memref<?x40xf64>
                      %77 = arith.mulf %73, %76 : f64
                      %78 = arith.subf %70, %77 : f64
                      memref.store %78, %arg1[%arg5, %arg7] : memref<?x40xf64>
                  ...
                  %66 = async.add_to_group %token_0, %64 : !async.token
                  %67 = arith.addi %arg8, %c1 : index
                  scf.yield %67 : index
                }
                async.await_all %64
                async.yield
