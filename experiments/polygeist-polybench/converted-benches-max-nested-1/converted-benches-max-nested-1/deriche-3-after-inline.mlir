...
module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.store %15, %alloca_23[0] : memref<1xf32>
    ...
    %21 = affine.load %alloca_23[0] : memref<1xf32>
    %22 = arith.negf %21 : f32
    %23 = arith.mulf %arg2, %cst_2 : f32
    %24 = math.exp %23 : f32
    %25 = arith.mulf %22, %24 : f32
    affine.store %25, %alloca_8[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %47, %alloca_6[0] : memref<1xf32>
        ...
        %55 = affine.load %alloca_6[0] : memref<1xf32>
    ...
    affine.store %36, %alloca_21[] : memref<f32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        %41 = arith.mulf %39, %40 : f32
        %42 = affine.load %alloca_8[0] : memref<1xf32>
        %43 = affine.load %alloca_20[] : memref<f32>
        %44 = arith.mulf %42, %43 : f32
        %45 = arith.addf %41, %44 : f32
        %46 = affine.load %alloca_14[0] : memref<1xf32>
        %47 = affine.load %alloca_22[] : memref<f32>
        affine.store %47, %alloca_16[0] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %50 = affine.load %alloca_5[0] : memref<1xf32>
        ...
        %55 = affine.load %alloca_16[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %40, %alloca_15[0] : memref<1xf32>
        %41 = arith.mulf %39, %40 : f32
        %42 = affine.load %alloca_8[0] : memref<1xf32>
