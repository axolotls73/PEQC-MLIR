module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %15, %alloca_23[%c0_29] : memref<1xf32>
    ...
    %21 = memref.load %alloca_23[%c0_32] : memref<1xf32>
    %22 = arith.negf %21 : f32
    %23 = arith.mulf %arg2, %cst_2 : f32
    %24 = math.exp %23 : f32
    %25 = arith.mulf %22, %24 : f32
    %c0_33 = arith.constant 0 : index
    memref.store %25, %alloca_8[%c0_33] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        memref.store %47, %alloca_6[%c0_57] : memref<1xf32>
        ...
        %55 = memref.load %alloca_6[%c0_59] : memref<1xf32>
    ...
    memref.store %36, %alloca_21[] : memref<f32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %41 = arith.mulf %39, %40 : f32
        %c0_56 = arith.constant 0 : index
        %42 = memref.load %alloca_8[%c0_56] : memref<1xf32>
        %43 = memref.load %alloca_20[] : memref<f32>
        %44 = arith.mulf %42, %43 : f32
        %45 = arith.addf %41, %44 : f32
        %c0_57 = arith.constant 0 : index
        %46 = memref.load %alloca_14[%c0_57] : memref<1xf32>
        %47 = memref.load %alloca_22[] : memref<f32>
        %c0_58 = arith.constant 0 : index
        memref.store %47, %alloca_16[%c0_58] : memref<1xf32>
        %48 = arith.mulf %46, %47 : f32
        %49 = arith.addf %45, %48 : f32
        %c0_59 = arith.constant 0 : index
        ...
        memref.store %58, %alloca_22[] : memref<f32>
        %c0_62 = arith.constant 0 : index
        %59 = memref.load %alloca_16[%c0_62] : memref<1xf32>
    ...
    scf.parallel (%arg7) = (%c0_40) to (%c2) step (%c1_41) {
      ...
      scf.for %arg8 = %c0_51 to %c2_52 step %c1_53 {
        ...
        scf.for %arg9 = %39 to %41 step %c1_56 {
          ...
          scf.for %arg10 = %42 to %44 step %c1_60 {
    ...
    scf.for %arg7 = %c0_45 to %c64_46 step %c1_47 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_55 = arith.constant 0 : index
        memref.store %40, %alloca_15[%c0_55] : memref<1xf32>
        %41 = arith.mulf %39, %40 : f32
        %c0_56 = arith.constant 0 : index
        %42 = memref.load %alloca_8[%c0_56] : memref<1xf32>
        ...
        %c0_65 = arith.constant 0 : index
        %63 = memref.load %alloca_15[%c0_65] : memref<1xf32>
