...
void kernel_gramschmidt(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_14 = arith_const_0_10; for_iter_14 < arith_const_30_9; for_iter_14 += arith_const_1_8) {
    memref_alloca_13[0] = arith_const_0_12; 
    for (int for_iter_15 = arith_const_0_10; for_iter_15 < arith_const_20_7; for_iter_15 += arith_const_1_8) {
    ...
    for (int for_iter_22 = arith_const_0_10; for_iter_22 < arith_const_20_7; for_iter_22 += arith_const_1_8) {
    ...
    int arith_muli_26 = (for_iter_14 * arith_const_neg_1_6); 
    int arith_addi_27 = (arith_muli_26 + arith_const_29_5); 
    for (int for_iter_28 = arith_const_0_10; for_iter_28 < arith_addi_27; for_iter_28 += arith_const_1_8) {
      int arith_addi_29 = (for_iter_14 + for_iter_28); 
      int arith_addi_30 = (arith_addi_29 + arith_const_1_8); 
      func_arg_3[for_iter_14][arith_addi_30] = arith_const_0_12; 
      for (int for_iter_31 = arith_const_0_10; for_iter_31 < arith_const_20_7; for_iter_31 += arith_const_1_8) {
      ...
      for (int for_iter_37 = arith_const_0_10; for_iter_37 < arith_const_20_7; for_iter_37 += arith_const_1_8) {
