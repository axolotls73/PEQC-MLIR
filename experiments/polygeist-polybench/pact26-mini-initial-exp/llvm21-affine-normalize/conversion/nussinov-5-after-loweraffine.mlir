  ...
  func.func @kernel_nussinov(%arg0: i32, %arg1: memref<?xi32>, %arg2: memref<?x60xi32>) {
    ...
    scf.for %arg3 = %c0 to %c60 step %c1 {
      ...
      scf.for %arg4 = %c0_0 to %arg3 step %c1_1 {
        ...
        %3 = arith.muli %arg3, %c-1_4 overflow<nsw> : index
        ...
        scf.if %6 {
          ...
          %16 = arith.muli %arg3, %c-1_13 overflow<nsw> : index
          ...
          %19 = arith.muli %arg3, %c-1_15 overflow<nsw> : index
          ...
          %25 = arith.muli %arg3, %c-1_18 overflow<nsw> : index
        ...
        scf.if %8 {
          ...
          %c-1_17 = arith.constant -1 : index
          %24 = arith.muli %arg3, %c-1_17 overflow<nsw> : index
        ...
        %9 = arith.muli %arg3, %c-1_8 overflow<nsw> : index
        ...
        scf.if %15 {
          ...
          scf.if %17 {
            %c-1_15 = arith.constant -1 : index
            %18 = arith.muli %arg3, %c-1_15 overflow<nsw> : index
            %c59_16 = arith.constant 59 : index
            %19 = arith.addi %18, %c59_16 : index
            %20 = memref.load %arg2[%19, %2] : memref<?x60xi32>
            %c-1_17 = arith.constant -1 : index
            %21 = arith.muli %arg3, %c-1_17 overflow<nsw> : index
            ...
            %25 = arith.muli %arg3, %c-1_20 overflow<nsw> : index
            ...
            %35 = arith.muli %arg3, %c-1_22 overflow<nsw> : index
            ...
            %c-1_20 = arith.constant -1 : index
            %27 = arith.muli %arg3, %c-1_20 overflow<nsw> : index
            %c59_21 = arith.constant 59 : index
        ...
        scf.for %arg5 = %c0_11 to %arg4 step %c1_12 {
          ...
          %21 = memref.load %arg2[%20, %2] : memref<?x60xi32>
          %c-1_17 = arith.constant -1 : index
          %22 = arith.muli %arg3, %c-1_17 overflow<nsw> : index
          %c59_18 = arith.constant 59 : index
          ...
          %c-1_20 = arith.constant -1 : index
          %30 = arith.muli %arg3, %c-1_20 overflow<nsw> : index
          %c59_21 = arith.constant 59 : index
