...
void kernel_lu(int func_arg_0, double* func_arg_1)
{
  ...
  for (int for_iter_6 = arith_const_0_3; for_iter_6 < arith_const_40_4; for_iter_6 += arith_const_1_5) {
    ...
    int arith_muli_17 = (for_iter_6 * arith_const_neg_1_2); 
    int arith_addi_18 = (arith_muli_17 + arith_const_40_4); 
    for (int for_iter_19 = arith_const_0_3; for_iter_19 < arith_addi_18; for_iter_19 += arith_const_1_5) {
      int arith_addi_20 = (for_iter_6 + for_iter_19); 
      for (int for_iter_21 = arith_const_0_3; for_iter_21 < for_iter_6; for_iter_21 += arith_const_1_5) {
