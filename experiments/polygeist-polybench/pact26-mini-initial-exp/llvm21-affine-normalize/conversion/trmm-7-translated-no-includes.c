...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_11 = arith_const_0_8; for_iter_11 < arith_const_20_9; for_iter_11 += arith_const_1_10) {
    for (int for_iter_12 = arith_const_0_8; for_iter_12 < arith_const_30_7; for_iter_12 += arith_const_1_10) {
      int arith_muli_13 = (for_iter_11 * arith_const_neg_1_6); 
      int arith_addi_14 = (arith_muli_13 + arith_const_19_5); 
      for (int for_iter_15 = arith_const_0_8; for_iter_15 < arith_addi_14; for_iter_15 += arith_const_1_10) {
        int arith_addi_16 = (for_iter_11 + for_iter_15); 
        int arith_addi_17 = (arith_addi_16 + arith_const_1_10); 
