...
void kernel_gemm(int func_arg_0, int func_arg_1, int func_arg_2, double func_arg_3, double func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  for (int for_iter_16 = arith_const_0_13; for_iter_16 < arith_const_20_14; for_iter_16 += arith_const_1_15) {
    for (int for_iter_17 = arith_const_0_13; for_iter_17 < arith_const_24_12; for_iter_17 += arith_const_4_11) {
      ...
      int arith_addi_20 = (for_iter_17 + arith_const_1_15); 
      ...
      int arith_addi_23 = (for_iter_17 + arith_const_2_10); 
      ...
      int arith_addi_26 = (for_iter_17 + arith_const_3_9); 
    ...
    double memref_load_29 = func_arg_5[for_iter_16][arith_const_24_12]; 
    double arith_mulf_30 = (memref_load_29 * func_arg_4); 
    func_arg_5[for_iter_16][arith_const_24_12] = arith_mulf_30; 
    for (int for_iter_31 = arith_const_0_13; for_iter_31 < arith_const_30_8; for_iter_31 += arith_const_1_15) {
      for (int for_iter_32 = arith_const_0_13; for_iter_32 < arith_const_24_12; for_iter_32 += arith_const_4_11) {
        ...
        int arith_addi_39 = (for_iter_32 + arith_const_1_15); 
        ...
        int arith_addi_46 = (for_iter_32 + arith_const_2_10); 
        ...
        int arith_addi_53 = (for_iter_32 + arith_const_3_9); 
      ...
      double memref_load_62 = func_arg_7[for_iter_31][arith_const_24_12]; 
      double arith_mulf_63 = (arith_mulf_61 * memref_load_62); 
      double memref_load_64 = func_arg_5[for_iter_16][arith_const_24_12]; 
      double arith_addf_65 = (memref_load_64 + arith_mulf_63); 
      func_arg_5[for_iter_16][arith_const_24_12] = arith_addf_65; 
    }
  }
  return; 
