...
{
  int arith_const_38_6 = 38; 
  int arith_const_42_7 = 42; 
  int arith_const_3_8 = 3; 
  int arith_const_2_9 = 2; 
  int arith_const_1_10 = 1; 
  double arith_const_0_11 = 0.000000; 
  int arith_const_0_12 = 0; 
  int arith_const_40_13 = 40; 
  int arith_const_4_14 = 4; 
  for (int for_iter_15 = arith_const_0_12; for_iter_15 < arith_const_40_13; for_iter_15 += arith_const_4_14) {
    func_arg_4[for_iter_15] = arith_const_0_11; 
    int arith_addi_16 = (for_iter_15 + arith_const_1_10); 
    func_arg_4[arith_addi_16] = arith_const_0_11; 
    int arith_addi_17 = (for_iter_15 + arith_const_2_9); 
    func_arg_4[arith_addi_17] = arith_const_0_11; 
    int arith_addi_18 = (for_iter_15 + arith_const_3_8); 
    func_arg_4[arith_addi_18] = arith_const_0_11; 
  }
  for (int for_iter_19 = arith_const_40_13; for_iter_19 < arith_const_42_7; for_iter_19 += arith_const_1_10) {
    func_arg_4[for_iter_19] = arith_const_0_11; 
  }
  for (int for_iter_20 = arith_const_0_12; for_iter_20 < arith_const_38_6; for_iter_20 += arith_const_1_10) {
    func_arg_5[for_iter_20] = arith_const_0_11; 
    for (int for_iter_21 = arith_const_0_12; for_iter_21 < arith_const_40_13; for_iter_21 += arith_const_4_14) {
      ...
      int arith_addi_27 = (for_iter_21 + arith_const_1_10); 
      ...
      int arith_addi_33 = (for_iter_21 + arith_const_2_9); 
      ...
      int arith_addi_39 = (for_iter_21 + arith_const_3_8); 
    ...
    for (int for_iter_45 = arith_const_40_13; for_iter_45 < arith_const_42_7; for_iter_45 += arith_const_1_10) {
    ...
    for (int for_iter_51 = arith_const_0_12; for_iter_51 < arith_const_40_13; for_iter_51 += arith_const_4_14) {
      ...
      int arith_addi_57 = (for_iter_51 + arith_const_1_10); 
      ...
      int arith_addi_63 = (for_iter_51 + arith_const_2_9); 
      ...
      int arith_addi_69 = (for_iter_51 + arith_const_3_8); 
    ...
    for (int for_iter_75 = arith_const_40_13; for_iter_75 < arith_const_42_7; for_iter_75 += arith_const_1_10) {
