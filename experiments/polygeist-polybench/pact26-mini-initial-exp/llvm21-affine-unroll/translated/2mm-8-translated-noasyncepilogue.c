...
void kernel_2mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, double func_arg_4, double func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10)
{
  ...
  int arith_const_3_13 = 3; 
  int arith_const_2_14 = 2; 
  int arith_const_4_15 = 4; 
  int arith_const_20_16 = 20; 
  int arith_const_18_17 = 18; 
  double arith_const_0_18 = 0.000000; 
  int arith_const_0_19 = 0; 
  int arith_const_16_20 = 16; 
  int arith_const_1_21 = 1; 
  for (int for_iter_22 = arith_const_0_19; for_iter_22 < arith_const_16_20; for_iter_22 += arith_const_1_21) {
    for (int for_iter_23 = arith_const_0_19; for_iter_23 < arith_const_18_17; for_iter_23 += arith_const_1_21) {
      func_arg_6[for_iter_22][for_iter_23] = arith_const_0_18; 
      for (int for_iter_24 = arith_const_0_19; for_iter_24 < arith_const_20_16; for_iter_24 += arith_const_4_15) {
        ...
        int arith_addi_31 = (for_iter_24 + arith_const_1_21); 
        ...
        int arith_addi_38 = (for_iter_24 + arith_const_2_14); 
        ...
        int arith_addi_45 = (for_iter_24 + arith_const_3_13); 
      ...
      for (int for_iter_52 = arith_const_20_16; for_iter_52 < arith_const_22_12; for_iter_52 += arith_const_1_21) {
  ...
  for (int for_iter_59 = arith_const_0_19; for_iter_59 < arith_const_16_20; for_iter_59 += arith_const_1_21) {
    for (int for_iter_60 = arith_const_0_19; for_iter_60 < arith_const_24_11; for_iter_60 += arith_const_1_21) {
      ...
      for (int for_iter_63 = arith_const_0_19; for_iter_63 < arith_const_16_20; for_iter_63 += arith_const_4_15) {
        ...
        int arith_addi_69 = (for_iter_63 + arith_const_1_21); 
        ...
        int arith_addi_75 = (for_iter_63 + arith_const_2_14); 
        ...
        int arith_addi_81 = (for_iter_63 + arith_const_3_13); 
      ...
      for (int for_iter_87 = arith_const_16_20; for_iter_87 < arith_const_18_17; for_iter_87 += arith_const_1_21) {
