...
void kernel_floyd_warshall(int func_arg_0, int* func_arg_1)
{
  ...
  int arith_const_4_4 = 4; 
  int arith_const_0_5 = 0; 
  int arith_const_60_6 = 60; 
  int arith_const_1_7 = 1; 
  for (int for_iter_8 = arith_const_0_5; for_iter_8 < arith_const_60_6; for_iter_8 += arith_const_1_7) {
    for (int for_iter_9 = arith_const_0_5; for_iter_9 < arith_const_60_6; for_iter_9 += arith_const_1_7) {
      for (int for_iter_10 = arith_const_0_5; for_iter_10 < arith_const_60_6; for_iter_10 += arith_const_4_4) {
        ...
        int arith_addi_17 = (for_iter_10 + arith_const_1_7); 
        ...
        int arith_addi_24 = (for_iter_10 + arith_const_2_3); 
        ...
        int arith_addi_31 = (for_iter_10 + arith_const_3_2); 
