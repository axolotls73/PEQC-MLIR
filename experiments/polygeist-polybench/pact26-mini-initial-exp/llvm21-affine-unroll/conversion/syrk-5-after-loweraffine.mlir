module {
  func.func @kernel_syrk(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x30xf64>, %arg5: memref<?x20xf64>) {
    ...
    scf.for %arg6 = %c0 to %c30 step %c1 {
      ...
      %7 = arith.muli %6, %c4_3 overflow<nsw> : index
      ...
      %15 = arith.muli %14, %c4_9 overflow<nsw> : index
      ...
      scf.for %arg7 = %c0_12 to %c20 step %c1_13 {
        ...
        %24 = arith.muli %23, %c4_19 overflow<nsw> : index
        ...
        %32 = arith.muli %31, %c4_25 overflow<nsw> : index
