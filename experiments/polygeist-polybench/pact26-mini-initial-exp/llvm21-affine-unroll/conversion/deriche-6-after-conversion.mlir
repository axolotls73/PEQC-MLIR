  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c4 {
        ...
        %56 = arith.muli %42, %c-1 overflow<nsw> : index
        ...
        %59 = arith.muli %42, %c-1 overflow<nsw> : index
        ...
        %79 = arith.muli %62, %c-1 overflow<nsw> : index
        ...
        %94 = arith.muli %82, %c-1 overflow<nsw> : index
        %95 = arith.addi %94, %c63 : index
        memref.store %93, %arg6[%arg7, %95] : memref<?x64xf32>
        memref.store %83, %alloca_6[] : memref<f32>
        %96 = arith.muli %82, %c-1 overflow<nsw> : index
        ...
        %99 = arith.muli %82, %c-1 overflow<nsw> : index
