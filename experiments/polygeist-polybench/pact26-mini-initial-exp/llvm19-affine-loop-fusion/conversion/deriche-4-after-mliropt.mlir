  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.for %arg7 = 0 to 64 {
      affine.for %arg8 = 0 to 64 {
        ...
        %50 = affine.load %arg5[%arg7, %arg8] : memref<?x64xf32>
        %51 = affine.load %arg6[%arg7, %arg8] : memref<?x64xf32>
        %52 = arith.addf %50, %51 : f32
        affine.store %52, %arg4[%arg7, %arg8] : memref<?x64xf32>
      }
    }
    affine.for %arg7 = 0 to 64 {
      ...
      affine.store %cst, %alloca[] : memref<f32>
      affine.for %arg8 = 0 to 64 {
        %23 = affine.apply #map(%arg8)
        %24 = affine.load %arg5[%23, %arg7] : memref<?x64xf32>
        %25 = affine.load %arg6[%23, %arg7] : memref<?x64xf32>
        ...
        affine.store %37, %arg6[-%arg8 + 63, %arg7] : memref<?x64xf32>
        affine.store %27, %alloca_4[] : memref<f32>
        %38 = affine.apply #map1(%arg8, %arg7)
        %39 = affine.apply #map2(%arg8, %arg7)
        %40 = affine.load %alloc[0, 0] : memref<1x1xf32>
        affine.store %40, %alloca_5[] : memref<f32>
        affine.store %32, %alloca[] : memref<f32>
        %41 = affine.load %arg6[-%arg8 + 63, %arg7] : memref<?x64xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %cst, %alloca_9[] : memref<f32>
        affine.store %cst, %alloca_8[] : memref<f32>
        %23 = affine.load %arg4[%arg7, %arg8] : memref<?x64xf32>
        %24 = arith.mulf %11, %23 : f32
        ...
        %33 = arith.addf %30, %32 : f32
        affine.store %33, %arg5[%arg7, %arg8] : memref<?x64xf32>
        %34 = affine.load %arg4[%arg7, %arg8] : memref<?x64xf32>
        ...
        %46 = arith.mulf %22, %45 : f32
        %47 = arith.addf %44, %46 : f32
        affine.store %47, %arg6[-%36 + 63, %arg8] : memref<?x64xf32>
        affine.store %37, %alloca_4[] : memref<f32>
        %48 = affine.load %arg4[-%36 + 63, %arg8] : memref<?x64xf32>
        affine.store %48, %alloca_5[] : memref<f32>
        affine.store %42, %alloca[] : memref<f32>
        %49 = affine.load %arg6[-%36 + 63, %arg8] : memref<?x64xf32>
        affine.store %49, %alloca_3[] : memref<f32>
        %50 = affine.load %arg5[%arg7, %arg8] : memref<?x64xf32>
        %51 = affine.load %arg6[%arg7, %arg8] : memref<?x64xf32>
        %52 = arith.addf %50, %51 : f32
