  ...
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    scf.for %arg6 = %c0_1 to %c32 step %c1_2 {
      ...
      scf.for %arg7 = %c0_6 to %c28_7 step %c1_8 {
        ...
        memref.store %cst_0, %alloc[%c0_9] : memref<1xf64>
        ...
        scf.for %arg8 = %c0_10 to %c32_11 step %c1_12 {
          ...
          %7 = memref.load %alloc[%c0_16] : memref<1xf64>
          %8 = arith.addf %7, %6 : f64
          %c0_17 = arith.constant 0 : index
          memref.store %8, %alloc[%c0_17] : memref<1xf64>
        }
        %c0_13 = arith.constant 0 : index
        %1 = memref.load %alloc[%c0_13] : memref<1xf64>
        %2 = arith.divf %1, %arg2 : f64
        %c0_14 = arith.constant 0 : index
        memref.store %2, %alloc[%c0_14] : memref<1xf64>
        %c0_15 = arith.constant 0 : index
        %3 = memref.load %alloc[%c0_15] : memref<1xf64>
