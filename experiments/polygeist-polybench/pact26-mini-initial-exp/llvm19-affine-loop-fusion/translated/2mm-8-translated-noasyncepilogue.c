...
void kernel_2mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, double func_arg_4, double func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10)
{
  ...
  for (int for_iter_19 = arith_const_0_16; for_iter_19 < arith_const_16_15; for_iter_19 += arith_const_1_14) {
    for (int for_iter_20 = arith_const_0_16; for_iter_20 < arith_const_18_13; for_iter_20 += arith_const_1_14) {
      func_arg_6[for_iter_19][for_iter_20] = arith_const_0_17; 
      for (int for_iter_21 = arith_const_0_16; for_iter_21 < arith_const_22_12; for_iter_21 += arith_const_1_14) {
    ...
    for (int for_iter_28 = arith_const_0_16; for_iter_28 < arith_const_24_11; for_iter_28 += arith_const_1_14) {
      ...
      for (int for_iter_31 = arith_const_0_16; for_iter_31 < arith_const_18_13; for_iter_31 += arith_const_1_14) {
        memref_alloc_18[arith_const_0_16][arith_const_0_16] = arith_const_0_17; 
        for (int for_iter_32 = arith_const_0_16; for_iter_32 < arith_const_22_12; for_iter_32 += arith_const_1_14) {
          ...
          double memref_load_37 = memref_alloc_18[arith_const_0_16][arith_const_0_16]; 
          double arith_addf_38 = (memref_load_37 + arith_mulf_36); 
          memref_alloc_18[arith_const_0_16][arith_const_0_16] = arith_addf_38; 
        }
        double memref_load_39 = memref_alloc_18[arith_const_0_16][arith_const_0_16]; 
