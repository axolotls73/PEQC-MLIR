...
void kernel_bicg(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_14 = arith_const_0_9; for_iter_14 < arith_const_38_10; for_iter_14 += arith_const_1_11) {
    ...
    {
      func_arg_3[for_iter_14] = arith_const_0_8; 
    ...
    int arith_addi_17 = (for_iter_arg_15 + arith_const_1_11); 
    for_iter_arg_15 = arith_addi_17; 
  }
  PAST_WAIT_SEMAPHORE_ALL(async_group_12, async_group_index_13, PAST_TASK_FINISHED); 
  for (int for_iter_18 = arith_const_0_9; for_iter_18 < arith_const_42_7; for_iter_18 += arith_const_1_11) {
    func_arg_4[for_iter_18] = arith_const_0_8; 
    for (int for_iter_19 = arith_const_0_9; for_iter_19 < arith_const_38_10; for_iter_19 += arith_const_1_11) {
