...
{
  int arith_const_42_3 = 42; 
  int arith_const_neg_1_4 = -1; 
  int arith_const_40_5 = 40; 
  int arith_const_1_6 = 1; 
  int arith_const_0_7 = 0; 
  double _8; 
  double arith_const_0_9 = 0.000000; 
  ...
  double memref_load_15 = func_arg_1[arith_const_0_7]; 
  double arith_negf_16 = -(memref_load_15); 
  func_arg_2[arith_const_0_7] = arith_negf_16; 
  memref_alloca_12[0] = arith_const_0_10; 
  double memref_load_17 = func_arg_1[arith_const_0_7]; 
  double arith_negf_18 = -(memref_load_17); 
  memref_alloca_13[0] = arith_negf_18; 
  for (int for_iter_19 = arith_const_1_6; for_iter_19 < arith_const_40_5; for_iter_19 += arith_const_1_6) {
    double memref_load_20 = memref_alloca_13[0]; 
    double arith_mulf_21 = (memref_load_20 * memref_load_20); 
    double arith_subf_22 = (arith_const_0_10 - arith_mulf_21); 
    ...
    memref_alloca_11[0] = arith_const_0_9; 
    for (int for_iter_25 = arith_const_0_7; for_iter_25 < for_iter_19; for_iter_25 += arith_const_1_6) {
      int arith_muli_26 = (for_iter_25 * arith_const_neg_1_4); 
      int arith_addi_27 = (for_iter_19 + arith_muli_26); 
      int arith_addi_28 = (arith_addi_27 + arith_const_neg_1_4); 
    ...
    int for_iter_arg_42 = arith_const_0_7; 
    for (int for_iter_41 = arith_const_0_7; for_iter_41 < for_iter_19; for_iter_41 += arith_const_1_6) {
      PAST_NEW_SEMAPHORE(execute_token_43, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        double memref_load_44 = func_arg_2[for_iter_41]; 
        int arith_muli_45 = (for_iter_41 * arith_const_neg_1_4); 
        int arith_addi_46 = (for_iter_19 + arith_muli_45); 
        int arith_addi_47 = (arith_addi_46 + arith_const_neg_1_4); 
      ...
      int arith_addi_51 = (for_iter_arg_42 + arith_const_1_6); 
    ...
    int for_iter_arg_55 = arith_const_0_7; 
    for (int for_iter_54 = arith_const_0_7; for_iter_54 < for_iter_19; for_iter_54 += arith_const_1_6) {
      ...
      int arith_addi_58 = (for_iter_arg_55 + arith_const_1_6); 
