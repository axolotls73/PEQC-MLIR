...
void kernel_2mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, double func_arg_4, double func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10)
{
  ...
  int arith_const_18_13 = 18; 
  double arith_const_0_14 = 0.000000; 
  int arith_const_0_15 = 0; 
  int arith_const_16_16 = 16; 
  int arith_const_1_17 = 1; 
  int* async_group_18; 
  int async_group_index_19 = 0; 
  int for_iter_arg_21 = arith_const_0_15; 
  for (int for_iter_20 = arith_const_0_15; for_iter_20 < arith_const_16_16; for_iter_20 += arith_const_1_17) {
    PAST_NEW_SEMAPHORE(execute_token_22, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_23 = arith_const_0_15; for_iter_23 < arith_const_18_13; for_iter_23 += arith_const_1_17) {
        func_arg_6[for_iter_20][for_iter_23] = arith_const_0_14; 
        for (int for_iter_24 = arith_const_0_15; for_iter_24 < arith_const_22_12; for_iter_24 += arith_const_1_17) {
    ...
    int arith_addi_31 = (for_iter_arg_21 + arith_const_1_17); 
  ...
  int for_iter_arg_35 = arith_const_0_15; 
  for (int for_iter_34 = arith_const_0_15; for_iter_34 < arith_const_16_16; for_iter_34 += arith_const_1_17) {
    PAST_NEW_SEMAPHORE(execute_token_36, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_37 = arith_const_0_15; for_iter_37 < arith_const_24_11; for_iter_37 += arith_const_1_17) {
        ...
        for (int for_iter_40 = arith_const_0_15; for_iter_40 < arith_const_18_13; for_iter_40 += arith_const_1_17) {
    ...
    int arith_addi_46 = (for_iter_arg_35 + arith_const_1_17); 
