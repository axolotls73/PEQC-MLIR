...
void kernel_gemver(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  for (int for_iter_17 = arith_const_0_12; for_iter_17 < arith_const_40_13; for_iter_17 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_19, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_20 = arith_const_0_12; for_iter_20 < arith_const_40_13; for_iter_20 += arith_const_1_14) {
    ...
    int arith_addi_30 = (for_iter_arg_18 + arith_const_1_14); 
  ...
  int for_iter_arg_34 = arith_const_0_12; 
  for (int for_iter_33 = arith_const_0_12; for_iter_33 < arith_const_40_13; for_iter_33 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_35, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_36 = arith_const_0_12; for_iter_36 < arith_const_40_13; for_iter_36 += arith_const_1_14) {
    ...
    int arith_addi_43 = (for_iter_arg_34 + arith_const_1_14); 
  ...
  int for_iter_arg_47 = arith_const_0_12; 
  for (int for_iter_46 = arith_const_0_12; for_iter_46 < arith_const_40_13; for_iter_46 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_48, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
    ...
    int arith_addi_52 = (for_iter_arg_47 + arith_const_1_14); 
  ...
  int for_iter_arg_56 = arith_const_0_12; 
  for (int for_iter_55 = arith_const_0_12; for_iter_55 < arith_const_40_13; for_iter_55 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_57, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_58 = arith_const_0_12; for_iter_58 < arith_const_40_13; for_iter_58 += arith_const_1_14) {
    ...
    int arith_addi_65 = (for_iter_arg_56 + arith_const_1_14); 
