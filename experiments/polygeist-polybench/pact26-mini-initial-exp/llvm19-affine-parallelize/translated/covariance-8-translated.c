...
{
  int arith_const_32_6 = 32; 
  double arith_const_0_7 = 1.000000; 
  double arith_const_0_8 = 0.000000; 
  int arith_const_0_9 = 0; 
  int arith_const_28_10 = 28; 
  int arith_const_1_11 = 1; 
  int* async_group_12; 
  int async_group_index_13 = 0; 
  int for_iter_arg_15 = arith_const_0_9; 
  for (int for_iter_14 = arith_const_0_9; for_iter_14 < arith_const_28_10; for_iter_14 += arith_const_1_11) {
    PAST_NEW_SEMAPHORE(execute_token_16, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_5[for_iter_14] = arith_const_0_8; 
      for (int for_iter_17 = arith_const_0_9; for_iter_17 < arith_const_32_6; for_iter_17 += arith_const_1_11) {
    ...
    int arith_addi_23 = (for_iter_arg_15 + arith_const_1_11); 
  ...
  for (int for_iter_26 = arith_const_0_9; for_iter_26 < arith_const_32_6; for_iter_26 += arith_const_1_11) {
    PAST_NEW_SEMAPHORE(execute_token_28, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_29 = arith_const_0_9; for_iter_29 < arith_const_28_10; for_iter_29 += arith_const_1_11) {
    ...
    int arith_addi_33 = (for_iter_arg_27 + arith_const_1_11); 
    for_iter_arg_27 = arith_addi_33; 
  }
  PAST_WAIT_SEMAPHORE_ALL(async_group_24, async_group_index_25, PAST_TASK_FINISHED); 
  double arith_subf_34 = (func_arg_2 - arith_const_0_7); 
  int* async_group_35; 
  int async_group_index_36 = 0; 
  int for_iter_arg_38 = arith_const_0_9; 
  for (int for_iter_37 = arith_const_0_9; for_iter_37 < arith_const_28_10; for_iter_37 += arith_const_1_11) {
    PAST_NEW_SEMAPHORE(execute_token_39, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_40 = for_iter_37; for_iter_40 < arith_const_28_10; for_iter_40 += arith_const_1_11) {
        func_arg_4[for_iter_37][for_iter_40] = arith_const_0_8; 
        for (int for_iter_41 = arith_const_0_9; for_iter_41 < arith_const_32_6; for_iter_41 += arith_const_1_11) {
    ...
    int arith_addi_49 = (for_iter_arg_38 + arith_const_1_11); 
