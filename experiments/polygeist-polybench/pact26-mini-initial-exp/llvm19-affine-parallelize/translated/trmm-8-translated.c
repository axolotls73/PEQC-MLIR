...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_9 = arith_const_0_6; for_iter_9 < arith_const_20_7; for_iter_9 += arith_const_1_8) {
    ...
    int for_iter_arg_13 = arith_const_0_6; 
    for (int for_iter_12 = arith_const_0_6; for_iter_12 < arith_const_30_5; for_iter_12 += arith_const_1_8) {
      PAST_NEW_SEMAPHORE(execute_token_14, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        int arith_addi_15 = (for_iter_9 + arith_const_1_8); 
        for (int for_iter_16 = arith_addi_15; for_iter_16 < arith_const_20_7; for_iter_16 += arith_const_1_8) {
      ...
      int arith_addi_24 = (for_iter_arg_13 + arith_const_1_8); 
