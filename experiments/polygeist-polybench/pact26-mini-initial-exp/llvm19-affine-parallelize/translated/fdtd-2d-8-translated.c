...
void kernel_fdtd_2d(int func_arg_0, int func_arg_1, int func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_16 = arith_const_0_13; for_iter_16 < arith_const_20_14; for_iter_16 += arith_const_1_15) {
    ...
    int for_iter_arg_20 = arith_const_0_13; 
    for (int for_iter_19 = arith_const_0_13; for_iter_19 < arith_const_30_10; for_iter_19 += arith_const_1_15) {
      PAST_NEW_SEMAPHORE(execute_token_21, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        double memref_load_22 = func_arg_6[for_iter_16]; 
        func_arg_4[arith_const_0_13][for_iter_19] = memref_load_22; 
      ...
      int arith_addi_23 = (for_iter_arg_20 + arith_const_1_15); 
    ...
    int for_iter_arg_27 = arith_const_0_13; 
    for (int for_iter_26 = arith_const_1_15; for_iter_26 < arith_const_20_14; for_iter_26 += arith_const_1_15) {
      PAST_NEW_SEMAPHORE(execute_token_28, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        for (int for_iter_29 = arith_const_0_13; for_iter_29 < arith_const_30_10; for_iter_29 += arith_const_1_15) {
          double memref_load_30 = func_arg_4[for_iter_26][for_iter_29]; 
          double memref_load_31 = func_arg_5[for_iter_26][for_iter_29]; 
          int arith_addi_32 = (for_iter_26 + arith_const_neg_1_9); 
      ...
      int arith_addi_37 = (for_iter_arg_27 + arith_const_1_15); 
    ...
    int for_iter_arg_41 = arith_const_0_13; 
    for (int for_iter_40 = arith_const_0_13; for_iter_40 < arith_const_20_14; for_iter_40 += arith_const_1_15) {
      PAST_NEW_SEMAPHORE(execute_token_42, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        for (int for_iter_43 = arith_const_1_15; for_iter_43 < arith_const_30_10; for_iter_43 += arith_const_1_15) {
          double memref_load_44 = func_arg_3[for_iter_40][for_iter_43]; 
          double memref_load_45 = func_arg_5[for_iter_40][for_iter_43]; 
          int arith_addi_46 = (for_iter_43 + arith_const_neg_1_9); 
          double memref_load_47 = func_arg_5[for_iter_40][arith_addi_46]; 
          double arith_subf_48 = (memref_load_45 - memref_load_47); 
          double arith_mulf_49 = (arith_subf_48 * arith_const_16_12); 
      ...
      int arith_addi_51 = (for_iter_arg_41 + arith_const_1_15); 
    ...
    int for_iter_arg_55 = arith_const_0_13; 
    for (int for_iter_54 = arith_const_0_13; for_iter_54 < arith_const_19_8; for_iter_54 += arith_const_1_15) {
      PAST_NEW_SEMAPHORE(execute_token_56, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        for (int for_iter_57 = arith_const_0_13; for_iter_57 < arith_const_29_7; for_iter_57 += arith_const_1_15) {
          double memref_load_58 = func_arg_5[for_iter_54][for_iter_57]; 
          int arith_addi_59 = (for_iter_57 + arith_const_1_15); 
          ...
          int arith_addi_63 = (for_iter_54 + arith_const_1_15); 
          ...
          double arith_mulf_68 = (arith_subf_67 * arith_const_16_11); 
      ...
      int arith_addi_70 = (for_iter_arg_55 + arith_const_1_15); 
