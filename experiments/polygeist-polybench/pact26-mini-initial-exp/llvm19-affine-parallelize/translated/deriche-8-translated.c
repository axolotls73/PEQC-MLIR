...
void kernel_deriche(int func_arg_0, int func_arg_1, float func_arg_2, float* func_arg_3, float* func_arg_4, float* func_arg_5, float* func_arg_6)
{
  ...
  for (int for_iter_64 = arith_const_0_11; for_iter_64 < arith_const_64_10; for_iter_64 += arith_const_1_9) {
    ...
    for (int for_iter_65 = arith_const_0_11; for_iter_65 < arith_const_64_10; for_iter_65 += arith_const_1_9) {
      ...
      int arith_muli_77 = (for_iter_65 * arith_const_neg_1_8); 
      int arith_addi_78 = (arith_muli_77 + arith_const_63_7); 
      func_arg_6[for_iter_64][arith_addi_78] = arith_addf_76; 
      memref_alloca_21[0] = memref_load_66; 
      int arith_muli_79 = (for_iter_65 * arith_const_neg_1_8); 
      int arith_addi_80 = (arith_muli_79 + arith_const_63_7); 
      ...
      int arith_muli_82 = (for_iter_65 * arith_const_neg_1_8); 
  ...
  int for_iter_arg_88 = arith_const_0_11; 
  for (int for_iter_87 = arith_const_0_11; for_iter_87 < arith_const_64_10; for_iter_87 += arith_const_1_9) {
    PAST_NEW_SEMAPHORE(execute_token_89, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_90 = arith_const_0_11; for_iter_90 < arith_const_64_10; for_iter_90 += arith_const_1_9) {
    ...
    int arith_addi_94 = (for_iter_arg_88 + arith_const_1_9); 
    for_iter_arg_88 = arith_addi_94; 
  }
  PAST_WAIT_SEMAPHORE_ALL(async_group_85, async_group_index_86, PAST_TASK_FINISHED); 
  for (int for_iter_95 = arith_const_0_11; for_iter_95 < arith_const_64_10; for_iter_95 += arith_const_1_9) {
    memref_alloca_25[0] = arith_const_0_12; 
    memref_alloca_24[0] = arith_const_0_12; 
    memref_alloca_23[0] = arith_const_0_12; 
    for (int for_iter_96 = arith_const_0_11; for_iter_96 < arith_const_64_10; for_iter_96 += arith_const_1_9) {
  ...
  for (int for_iter_110 = arith_const_0_11; for_iter_110 < arith_const_64_10; for_iter_110 += arith_const_1_9) {
    ...
    for (int for_iter_111 = arith_const_0_11; for_iter_111 < arith_const_64_10; for_iter_111 += arith_const_1_9) {
      ...
      int arith_muli_123 = (for_iter_111 * arith_const_neg_1_8); 
      int arith_addi_124 = (arith_muli_123 + arith_const_63_7); 
      func_arg_6[arith_addi_124][for_iter_110] = arith_addf_122; 
      memref_alloca_19[0] = memref_load_112; 
      int arith_muli_125 = (for_iter_111 * arith_const_neg_1_8); 
      int arith_addi_126 = (arith_muli_125 + arith_const_63_7); 
  ...
  int for_iter_arg_134 = arith_const_0_11; 
  for (int for_iter_133 = arith_const_0_11; for_iter_133 < arith_const_64_10; for_iter_133 += arith_const_1_9) {
    PAST_NEW_SEMAPHORE(execute_token_135, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_136 = arith_const_0_11; for_iter_136 < arith_const_64_10; for_iter_136 += arith_const_1_9) {
    ...
    int arith_addi_140 = (for_iter_arg_134 + arith_const_1_9); 
