...
void kernel_correlation(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  int for_iter_arg_18 = arith_const_0_12; 
  for (int for_iter_17 = arith_const_0_12; for_iter_17 < arith_const_28_13; for_iter_17 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_19, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_5[for_iter_17] = arith_const_0_10; 
      for (int for_iter_20 = arith_const_0_12; for_iter_20 < arith_const_32_8; for_iter_20 += arith_const_1_14) {
    ...
    int arith_addi_26 = (for_iter_arg_18 + arith_const_1_14); 
  ...
  int for_iter_arg_30 = arith_const_0_12; 
  for (int for_iter_29 = arith_const_0_12; for_iter_29 < arith_const_28_13; for_iter_29 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_31, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_6[for_iter_29] = arith_const_0_10; 
      for (int for_iter_32 = arith_const_0_12; for_iter_32 < arith_const_32_8; for_iter_32 += arith_const_1_14) {
      ...
      int arith_cmpi_42 = (math_sqrt_41 <= arith_const_16_11); 
      double arith_select_43 = (arith_cmpi_42 ? arith_const_0_9 : math_sqrt_41); 
    ...
    int arith_addi_44 = (for_iter_arg_30 + arith_const_1_14); 
  ...
  int for_iter_arg_49 = arith_const_0_12; 
  for (int for_iter_48 = arith_const_0_12; for_iter_48 < arith_const_32_8; for_iter_48 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_50, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_51 = arith_const_0_12; for_iter_51 < arith_const_28_13; for_iter_51 += arith_const_1_14) {
    ...
    int arith_addi_58 = (for_iter_arg_49 + arith_const_1_14); 
  ...
  int for_iter_arg_62 = arith_const_0_12; 
  for (int for_iter_61 = arith_const_0_12; for_iter_61 < arith_const_27_7; for_iter_61 += arith_const_1_14) {
    PAST_NEW_SEMAPHORE(execute_token_63, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_4[for_iter_61][for_iter_61] = arith_const_0_9; 
      int arith_addi_64 = (for_iter_61 + arith_const_1_14); 
      for (int for_iter_65 = arith_addi_64; for_iter_65 < arith_const_28_13; for_iter_65 += arith_const_1_14) {
        func_arg_4[for_iter_61][for_iter_65] = arith_const_0_10; 
        for (int for_iter_66 = arith_const_0_12; for_iter_66 < arith_const_32_8; for_iter_66 += arith_const_1_14) {
    ...
    int arith_addi_73 = (for_iter_arg_62 + arith_const_1_14); 
