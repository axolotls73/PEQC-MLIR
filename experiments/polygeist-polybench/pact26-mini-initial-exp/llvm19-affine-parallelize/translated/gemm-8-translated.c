...
void kernel_gemm(int func_arg_0, int func_arg_1, int func_arg_2, double func_arg_3, double func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  for (int for_iter_15 = arith_const_0_10; for_iter_15 < arith_const_20_11; for_iter_15 += arith_const_1_12) {
    PAST_NEW_SEMAPHORE(execute_token_17, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_18 = arith_const_0_10; for_iter_18 < arith_const_25_9; for_iter_18 += arith_const_1_12) {
      ...
      for (int for_iter_21 = arith_const_0_10; for_iter_21 < arith_const_30_8; for_iter_21 += arith_const_1_12) {
        for (int for_iter_22 = arith_const_0_10; for_iter_22 < arith_const_25_9; for_iter_22 += arith_const_1_12) {
    ...
    int arith_addi_29 = (for_iter_arg_16 + arith_const_1_12); 
