...
void kernel_3mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, int func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  int arith_const_18_15 = 18; 
  double arith_const_0_16 = 0.000000; 
  int arith_const_0_17 = 0; 
  int arith_const_16_18 = 16; 
  int arith_const_1_19 = 1; 
  int* async_group_20; 
  int async_group_index_21 = 0; 
  int for_iter_arg_23 = arith_const_0_17; 
  for (int for_iter_22 = arith_const_0_17; for_iter_22 < arith_const_16_18; for_iter_22 += arith_const_1_19) {
    PAST_NEW_SEMAPHORE(execute_token_24, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_25 = arith_const_0_17; for_iter_25 < arith_const_18_15; for_iter_25 += arith_const_1_19) {
        func_arg_5[for_iter_22][for_iter_25] = arith_const_0_16; 
        for (int for_iter_26 = arith_const_0_17; for_iter_26 < arith_const_20_14; for_iter_26 += arith_const_1_19) {
    ...
    int arith_addi_32 = (for_iter_arg_23 + arith_const_1_19); 
  ...
  int for_iter_arg_36 = arith_const_0_17; 
  for (int for_iter_35 = arith_const_0_17; for_iter_35 < arith_const_18_15; for_iter_35 += arith_const_1_19) {
    PAST_NEW_SEMAPHORE(execute_token_37, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_38 = arith_const_0_17; for_iter_38 < arith_const_22_13; for_iter_38 += arith_const_1_19) {
        func_arg_8[for_iter_35][for_iter_38] = arith_const_0_16; 
        for (int for_iter_39 = arith_const_0_17; for_iter_39 < arith_const_24_12; for_iter_39 += arith_const_1_19) {
    ...
    int arith_addi_45 = (for_iter_arg_36 + arith_const_1_19); 
  ...
  int for_iter_arg_49 = arith_const_0_17; 
  for (int for_iter_48 = arith_const_0_17; for_iter_48 < arith_const_16_18; for_iter_48 += arith_const_1_19) {
    PAST_NEW_SEMAPHORE(execute_token_50, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_51 = arith_const_0_17; for_iter_51 < arith_const_22_13; for_iter_51 += arith_const_1_19) {
        func_arg_11[for_iter_48][for_iter_51] = arith_const_0_16; 
        for (int for_iter_52 = arith_const_0_17; for_iter_52 < arith_const_18_15; for_iter_52 += arith_const_1_19) {
    ...
    int arith_addi_58 = (for_iter_arg_49 + arith_const_1_19); 
