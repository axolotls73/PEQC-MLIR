...
{
  int arith_const_8_4 = 8; 
  int arith_const_0_5 = 0; 
  int arith_const_neg_1_6 = -1; 
  int arith_const_9_7 = 9; 
  double arith_const_16_8 = 0.125000; 
  double arith_const_0_9 = 2.000000; 
  int arith_const_1_10 = 1; 
  int arith_const_21_11 = 21; 
  for (int for_iter_12 = arith_const_1_10; for_iter_12 < arith_const_21_11; for_iter_12 += arith_const_1_10) {
    int* async_group_13; 
    int async_group_index_14 = 0; 
    int for_iter_arg_16 = arith_const_0_5; 
    for (int for_iter_15 = arith_const_1_10; for_iter_15 < arith_const_9_7; for_iter_15 += arith_const_1_10) {
      PAST_NEW_SEMAPHORE(execute_token_17, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        for (int for_iter_18 = arith_const_1_10; for_iter_18 < arith_const_9_7; for_iter_18 += arith_const_1_10) {
          for (int for_iter_19 = arith_const_1_10; for_iter_19 < arith_const_9_7; for_iter_19 += arith_const_1_10) {
            int arith_addi_20 = (for_iter_15 + arith_const_1_10); 
      ...
      int arith_addi_46 = (for_iter_arg_16 + arith_const_1_10); 
    ...
    int for_iter_arg_50 = arith_const_0_5; 
    for (int for_iter_49 = arith_const_1_10; for_iter_49 < arith_const_9_7; for_iter_49 += arith_const_1_10) {
      PAST_NEW_SEMAPHORE(execute_token_51, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        for (int for_iter_52 = arith_const_1_10; for_iter_52 < arith_const_9_7; for_iter_52 += arith_const_1_10) {
          for (int for_iter_53 = arith_const_1_10; for_iter_53 < arith_const_9_7; for_iter_53 += arith_const_1_10) {
            int arith_addi_54 = (for_iter_49 + arith_const_1_10); 
      ...
      int arith_addi_80 = (for_iter_arg_50 + arith_const_1_10); 
