...
void kernel_jacobi_1d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  double arith_const_16_7 = 0.333330; 
  ...
  for (int for_iter_11 = arith_const_0_8; for_iter_11 < arith_const_20_9; for_iter_11 += arith_const_1_10) {
    ...
    for (int for_iter_14 = arith_const_1_10; for_iter_14 < arith_const_29_6; for_iter_14 += arith_const_1_10) {
      ...
      {
        int arith_addi_17 = (for_iter_14 + arith_const_neg_1_5); 
        ...
        int arith_addi_21 = (for_iter_14 + arith_const_1_10); 
        double memref_load_22 = func_arg_2[arith_addi_21]; 
        double arith_addf_23 = (arith_addf_20 + memref_load_22); 
        double arith_mulf_24 = (arith_addf_23 * arith_const_16_7); 
      ...
      int arith_addi_25 = (for_iter_arg_15 + arith_const_1_10); 
    ...
    int for_iter_arg_29 = arith_const_0_8; 
    for (int for_iter_28 = arith_const_1_10; for_iter_28 < arith_const_29_6; for_iter_28 += arith_const_1_10) {
      PAST_NEW_SEMAPHORE(execute_token_30, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        int arith_addi_31 = (for_iter_28 + arith_const_neg_1_5); 
        ...
        int arith_addi_35 = (for_iter_28 + arith_const_1_10); 
        double memref_load_36 = func_arg_3[arith_addi_35]; 
        double arith_addf_37 = (arith_addf_34 + memref_load_36); 
        double arith_mulf_38 = (arith_addf_37 * arith_const_16_7); 
      ...
      int arith_addi_39 = (for_iter_arg_29 + arith_const_1_10); 
