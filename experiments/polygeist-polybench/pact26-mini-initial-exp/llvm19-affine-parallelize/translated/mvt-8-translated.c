...
void kernel_mvt(int func_arg_0, double* func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  int for_iter_arg_12 = arith_const_0_6; 
  for (int for_iter_11 = arith_const_0_6; for_iter_11 < arith_const_40_7; for_iter_11 += arith_const_1_8) {
    PAST_NEW_SEMAPHORE(execute_token_13, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_14 = arith_const_0_6; for_iter_14 < arith_const_40_7; for_iter_14 += arith_const_1_8) {
    ...
    int arith_addi_20 = (for_iter_arg_12 + arith_const_1_8); 
  ...
  int for_iter_arg_24 = arith_const_0_6; 
  for (int for_iter_23 = arith_const_0_6; for_iter_23 < arith_const_40_7; for_iter_23 += arith_const_1_8) {
    PAST_NEW_SEMAPHORE(execute_token_25, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      for (int for_iter_26 = arith_const_0_6; for_iter_26 < arith_const_40_7; for_iter_26 += arith_const_1_8) {
    ...
    int arith_addi_32 = (for_iter_arg_24 + arith_const_1_8); 
