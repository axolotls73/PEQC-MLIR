...
void kernel_syrk(int func_arg_0, int func_arg_1, double func_arg_2, double func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  int for_iter_arg_13 = arith_const_0_7; 
  for (int for_iter_12 = arith_const_0_7; for_iter_12 < arith_const_30_8; for_iter_12 += arith_const_1_9) {
    PAST_NEW_SEMAPHORE(execute_token_14, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      int arith_addi_15 = (for_iter_12 + arith_const_1_9); 
      for (int for_iter_16 = arith_const_0_7; for_iter_16 < arith_addi_15; for_iter_16 += arith_const_1_9) {
      ...
      for (int for_iter_19 = arith_const_0_7; for_iter_19 < arith_const_20_6; for_iter_19 += arith_const_1_9) {
        int arith_addi_20 = (for_iter_12 + arith_const_1_9); 
        for (int for_iter_21 = arith_const_0_7; for_iter_21 < arith_addi_20; for_iter_21 += arith_const_1_9) {
    ...
    int arith_addi_28 = (for_iter_arg_13 + arith_const_1_9); 
