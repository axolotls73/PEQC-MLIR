...
void kernel_covariance(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_12 = arith_const_0_9; for_iter_12 < arith_const_28_10; for_iter_12 += arith_const_32_11) {
    int arith_addi_13 = (for_iter_12 + arith_const_28_10); 
    for (int for_iter_14 = for_iter_12; for_iter_14 < arith_addi_13; for_iter_14 += arith_const_1_6) {
      func_arg_5[for_iter_14] = arith_const_0_8; 
      for (int for_iter_15 = arith_const_0_9; for_iter_15 < arith_const_32_11; for_iter_15 += arith_const_1_6) {
  ...
  for (int for_iter_21 = arith_const_0_9; for_iter_21 < arith_const_32_11; for_iter_21 += arith_const_32_11) {
    for (int for_iter_22 = arith_const_0_9; for_iter_22 < arith_const_28_10; for_iter_22 += arith_const_32_11) {
      int arith_addi_23 = (for_iter_21 + arith_const_32_11); 
      for (int for_iter_24 = for_iter_21; for_iter_24 < arith_addi_23; for_iter_24 += arith_const_1_6) {
        int arith_addi_25 = (for_iter_22 + arith_const_28_10); 
        for (int for_iter_26 = for_iter_22; for_iter_26 < arith_addi_25; for_iter_26 += arith_const_1_6) {
  ...
  double arith_subf_30 = (func_arg_2 - arith_const_0_7); 
  for (int for_iter_31 = arith_const_0_9; for_iter_31 < arith_const_28_10; for_iter_31 += arith_const_1_6) {
    for (int for_iter_32 = for_iter_31; for_iter_32 < arith_const_28_10; for_iter_32 += arith_const_1_6) {
      func_arg_4[for_iter_31][for_iter_32] = arith_const_0_8; 
      for (int for_iter_33 = arith_const_0_9; for_iter_33 < arith_const_32_11; for_iter_33 += arith_const_1_6) {
