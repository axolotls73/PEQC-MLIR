...
void kernel_syr2k(int func_arg_0, int func_arg_1, double func_arg_2, double func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_12 = arith_const_0_9; for_iter_12 < arith_const_30_10; for_iter_12 += arith_const_32_11) {
    int arith_addi_13 = (for_iter_12 + arith_const_30_10); 
    for (int for_iter_14 = for_iter_12; for_iter_14 < arith_addi_13; for_iter_14 += arith_const_1_8) {
      int arith_addi_15 = (for_iter_14 + arith_const_1_8); 
      for (int for_iter_16 = arith_const_0_9; for_iter_16 < arith_addi_15; for_iter_16 += arith_const_1_8) {
      ...
      for (int for_iter_19 = arith_const_0_9; for_iter_19 < arith_const_20_7; for_iter_19 += arith_const_1_8) {
        int arith_addi_20 = (for_iter_14 + arith_const_1_8); 
        for (int for_iter_21 = arith_const_0_9; for_iter_21 < arith_addi_20; for_iter_21 += arith_const_1_8) {
