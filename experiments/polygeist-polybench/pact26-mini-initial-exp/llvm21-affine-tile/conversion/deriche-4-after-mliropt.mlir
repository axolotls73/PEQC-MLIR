  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          %23 = affine.load %arg3[%arg8, %arg9] : memref<?x64xf32>
          ...
          affine.store %33, %arg5[%arg8, %arg9] : memref<?x64xf32>
          %34 = affine.load %arg3[%arg8, %arg9] : memref<?x64xf32>
          affine.store %34, %alloca_11[] : memref<f32>
          affine.store %28, %alloca_8[] : memref<f32>
          %35 = affine.load %arg5[%arg8, %arg9] : memref<?x64xf32>
      ...
      affine.for %arg8 = 0 to 64 step 32 {
        affine.for %arg9 = #map(%arg7) to #map1(%arg7) {
          affine.for %arg10 = #map(%arg8) to #map1(%arg8) {
            %23 = affine.load %arg5[%arg9, %arg10] : memref<?x64xf32>
            %24 = affine.load %arg6[%arg9, %arg10] : memref<?x64xf32>
            %25 = arith.addf %23, %24 : f32
            affine.store %25, %arg4[%arg9, %arg10] : memref<?x64xf32>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.store %cst, %alloca_8[] : memref<f32>
        affine.for %arg9 = 0 to 64 {
          %23 = affine.load %arg4[%arg9, %arg8] : memref<?x64xf32>
          %24 = arith.mulf %11, %23 : f32
          ...
          %32 = arith.mulf %22, %31 : f32
          %33 = arith.addf %30, %32 : f32
          affine.store %33, %arg5[%arg9, %arg8] : memref<?x64xf32>
          %34 = affine.load %arg4[%arg9, %arg8] : memref<?x64xf32>
          affine.store %34, %alloca_10[] : memref<f32>
          affine.store %28, %alloca_8[] : memref<f32>
          %35 = affine.load %arg5[%arg9, %arg8] : memref<?x64xf32>
          affine.store %35, %alloca_9[] : memref<f32>
        }
      }
    }
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          %32 = arith.mulf %22, %31 : f32
          %33 = arith.addf %30, %32 : f32
          affine.store %33, %arg6[-%arg9 + 63, %arg8] : memref<?x64xf32>
          affine.store %23, %alloca_4[] : memref<f32>
          %34 = affine.load %arg4[-%arg9 + 63, %arg8] : memref<?x64xf32>
          affine.store %34, %alloca_5[] : memref<f32>
          affine.store %28, %alloca[] : memref<f32>
          %35 = affine.load %arg6[-%arg9 + 63, %arg8] : memref<?x64xf32>
          affine.store %35, %alloca_3[] : memref<f32>
        }
      }
    }
