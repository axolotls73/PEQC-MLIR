...
void kernel_trisolv(int func_arg_0, double* func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  for (int for_iter_7 = arith_const_0_4; for_iter_7 < arith_const_40_5; for_iter_7 += arith_const_1_6) {
    double memref_load_8 = func_arg_3[for_iter_7]; 
    func_arg_2[for_iter_7] = memref_load_8; 
    for (int for_iter_9 = arith_const_0_4; for_iter_9 < for_iter_7; for_iter_9 += arith_const_1_6) {
