...
void kernel_atax(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  double arith_const_0_7 = 0.000000; 
  int arith_const_0_8 = 0; 
  int arith_const_42_9 = 42; 
  int arith_const_1_10 = 1; 
  int* async_group_11; 
  int async_group_index_12 = 0; 
  int for_iter_arg_14 = arith_const_0_8; 
  for (int for_iter_13 = arith_const_0_8; for_iter_13 < arith_const_42_9; for_iter_13 += arith_const_1_10) {
    PAST_NEW_SEMAPHORE(execute_token_15, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_4[for_iter_13] = arith_const_0_7; 
    ...
    int arith_addi_16 = (for_iter_arg_14 + arith_const_1_10); 
    for_iter_arg_14 = arith_addi_16; 
  }
  PAST_WAIT_SEMAPHORE_ALL(async_group_11, async_group_index_12, PAST_TASK_FINISHED); 
  for (int for_iter_17 = arith_const_0_8; for_iter_17 < arith_const_38_6; for_iter_17 += arith_const_1_10) {
    func_arg_5[for_iter_17] = arith_const_0_7; 
    for (int for_iter_18 = arith_const_0_8; for_iter_18 < arith_const_42_9; for_iter_18 += arith_const_1_10) {
    ...
    int for_iter_arg_27 = arith_const_0_8; 
    for (int for_iter_26 = arith_const_0_8; for_iter_26 < arith_const_42_9; for_iter_26 += arith_const_1_10) {
      ...
      int arith_addi_34 = (for_iter_arg_27 + arith_const_1_10); 
