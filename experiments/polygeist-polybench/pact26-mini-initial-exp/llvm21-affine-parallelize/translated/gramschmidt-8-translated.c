...
{
  int arith_const_42_5 = 42; 
  int arith_const_20_6 = 20; 
  int arith_const_1_7 = 1; 
  int arith_const_30_8 = 30; 
  int arith_const_0_9 = 0; 
  double _10; 
  double arith_const_0_11 = 0.000000; 
  double* memref_alloca_12; 
  memref_alloca_12[0] = _10; 
  for (int for_iter_13 = arith_const_0_9; for_iter_13 < arith_const_30_8; for_iter_13 += arith_const_1_7) {
    memref_alloca_12[0] = arith_const_0_11; 
    for (int for_iter_14 = arith_const_0_9; for_iter_14 < arith_const_20_6; for_iter_14 += arith_const_1_7) {
    ...
    int for_iter_arg_24 = arith_const_0_9; 
    for (int for_iter_23 = arith_const_0_9; for_iter_23 < arith_const_20_6; for_iter_23 += arith_const_1_7) {
      PAST_NEW_SEMAPHORE(execute_token_25, PAST_TASK_INIT); 
      ...
      int arith_addi_29 = (for_iter_arg_24 + arith_const_1_7); 
      for_iter_arg_24 = arith_addi_29; 
    }
    PAST_WAIT_SEMAPHORE_ALL(async_group_21, async_group_index_22, PAST_TASK_FINISHED); 
    int arith_addi_30 = (for_iter_13 + arith_const_1_7); 
    int* async_group_31; 
    int async_group_index_32 = 0; 
    int for_iter_arg_34 = arith_const_0_9; 
    for (int for_iter_33 = arith_addi_30; for_iter_33 < arith_const_30_8; for_iter_33 += arith_const_1_7) {
      PAST_NEW_SEMAPHORE(execute_token_35, PAST_TASK_INIT); 
      #pragma peqc async_execute
      {
        func_arg_3[for_iter_13][for_iter_33] = arith_const_0_11; 
        for (int for_iter_36 = arith_const_0_9; for_iter_36 < arith_const_20_6; for_iter_36 += arith_const_1_7) {
        ...
        for (int for_iter_42 = arith_const_0_9; for_iter_42 < arith_const_20_6; for_iter_42 += arith_const_1_7) {
      ...
      int arith_addi_48 = (for_iter_arg_34 + arith_const_1_7); 
