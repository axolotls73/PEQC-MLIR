...
void kernel_syr2k(int func_arg_0, int func_arg_1, double func_arg_2, double func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_13 = arith_const_0_8; for_iter_13 < arith_const_30_9; for_iter_13 += arith_const_1_10) {
    PAST_NEW_SEMAPHORE(execute_token_15, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      int arith_addi_16 = (for_iter_13 + arith_const_1_10); 
      for (int for_iter_17 = arith_const_0_8; for_iter_17 < arith_addi_16; for_iter_17 += arith_const_1_10) {
      ...
      for (int for_iter_20 = arith_const_0_8; for_iter_20 < arith_const_20_7; for_iter_20 += arith_const_1_10) {
        int arith_addi_21 = (for_iter_13 + arith_const_1_10); 
        for (int for_iter_22 = arith_const_0_8; for_iter_22 < arith_addi_21; for_iter_22 += arith_const_1_10) {
    ...
    int arith_addi_34 = (for_iter_arg_14 + arith_const_1_10); 
