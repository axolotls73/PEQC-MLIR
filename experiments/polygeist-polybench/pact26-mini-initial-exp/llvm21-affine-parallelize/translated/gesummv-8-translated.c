...
void kernel_gesummv(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  for (int for_iter_14 = arith_const_0_9; for_iter_14 < arith_const_30_10; for_iter_14 += arith_const_1_11) {
    PAST_NEW_SEMAPHORE(execute_token_16, PAST_TASK_INIT); 
    #pragma peqc async_execute
    {
      func_arg_5[for_iter_14] = arith_const_0_8; 
      func_arg_7[for_iter_14] = arith_const_0_8; 
      for (int for_iter_17 = arith_const_0_9; for_iter_17 < arith_const_30_10; for_iter_17 += arith_const_1_11) {
    ...
    int arith_addi_33 = (for_iter_arg_15 + arith_const_1_11); 
