...
{
  int arith_const_12_6 = 12; 
  int arith_const_8_7 = 8; 
  double arith_const_0_8 = 0.000000; 
  int arith_const_0_9 = 0; 
  int arith_const_10_10 = 10; 
  int arith_const_1_11 = 1; 
  for (int for_iter_12 = arith_const_0_9; for_iter_12 < arith_const_10_10; for_iter_12 += arith_const_1_11) {
    for (int for_iter_13 = arith_const_0_9; for_iter_13 < arith_const_8_7; for_iter_13 += arith_const_1_11) {
      int* async_group_14; 
      int async_group_index_15 = 0; 
      int for_iter_arg_17 = arith_const_0_9; 
      for (int for_iter_16 = arith_const_0_9; for_iter_16 < arith_const_12_6; for_iter_16 += arith_const_1_11) {
        PAST_NEW_SEMAPHORE(execute_token_18, PAST_TASK_INIT); 
        #pragma peqc async_execute
        {
          func_arg_5[for_iter_16] = arith_const_0_8; 
          for (int for_iter_19 = arith_const_0_9; for_iter_19 < arith_const_12_6; for_iter_19 += arith_const_1_11) {
        ...
        int arith_addi_25 = (for_iter_arg_17 + arith_const_1_11); 
      ...
      int for_iter_arg_29 = arith_const_0_9; 
      for (int for_iter_28 = arith_const_0_9; for_iter_28 < arith_const_12_6; for_iter_28 += arith_const_1_11) {
        ...
        int arith_addi_32 = (for_iter_arg_29 + arith_const_1_11); 
