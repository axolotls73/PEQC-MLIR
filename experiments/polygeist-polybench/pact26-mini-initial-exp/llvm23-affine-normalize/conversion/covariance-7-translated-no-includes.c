...
void kernel_covariance(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  int arith_const_32_7 = 32; 
  double arith_const_0_8 = 1.000000; 
  double arith_const_0_9 = 0.000000; 
  int arith_const_0_10 = 0; 
  int arith_const_28_11 = 28; 
  int arith_const_1_12 = 1; 
  for (int for_iter_13 = arith_const_0_10; for_iter_13 < arith_const_28_11; for_iter_13 += arith_const_1_12) {
    func_arg_5[for_iter_13] = arith_const_0_9; 
    for (int for_iter_14 = arith_const_0_10; for_iter_14 < arith_const_32_7; for_iter_14 += arith_const_1_12) {
  ...
  for (int for_iter_20 = arith_const_0_10; for_iter_20 < arith_const_32_7; for_iter_20 += arith_const_1_12) {
    for (int for_iter_21 = arith_const_0_10; for_iter_21 < arith_const_28_11; for_iter_21 += arith_const_1_12) {
  ...
  double arith_subf_25 = (func_arg_2 - arith_const_0_8); 
  for (int for_iter_26 = arith_const_0_10; for_iter_26 < arith_const_28_11; for_iter_26 += arith_const_1_12) {
    int arith_muli_27 = (for_iter_26 * arith_const_neg_1_6); 
    int arith_addi_28 = (arith_muli_27 + arith_const_28_11); 
    for (int for_iter_29 = arith_const_0_10; for_iter_29 < arith_addi_28; for_iter_29 += arith_const_1_12) {
      int arith_addi_30 = (for_iter_26 + for_iter_29); 
      func_arg_4[for_iter_26][arith_addi_30] = arith_const_0_9; 
      for (int for_iter_31 = arith_const_0_10; for_iter_31 < arith_const_32_7; for_iter_31 += arith_const_1_12) {
