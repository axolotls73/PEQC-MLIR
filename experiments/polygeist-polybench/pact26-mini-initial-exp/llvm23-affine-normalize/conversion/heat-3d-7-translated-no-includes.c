...
void kernel_heat_3d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  for (int for_iter_11 = arith_const_0_8; for_iter_11 < arith_const_20_9; for_iter_11 += arith_const_1_10) {
    for (int for_iter_12 = arith_const_0_8; for_iter_12 < arith_const_8_5; for_iter_12 += arith_const_1_10) {
      int arith_addi_13 = (for_iter_12 + arith_const_1_10); 
      for (int for_iter_14 = arith_const_0_8; for_iter_14 < arith_const_8_5; for_iter_14 += arith_const_1_10) {
        int arith_addi_15 = (for_iter_14 + arith_const_1_10); 
        for (int for_iter_16 = arith_const_0_8; for_iter_16 < arith_const_8_5; for_iter_16 += arith_const_1_10) {
          int arith_addi_17 = (for_iter_16 + arith_const_1_10); 
          int arith_addi_18 = (arith_addi_13 + arith_const_1_10); 
          ...
          double arith_mulf_21 = (memref_load_20 * arith_const_0_7); 
          ...
          double arith_mulf_26 = (arith_addf_25 * arith_const_16_6); 
          int arith_addi_27 = (arith_addi_15 + arith_const_1_10); 
          ...
          int arith_addi_30 = (arith_addi_15 + arith_const_neg_1_4); 
          ...
          double arith_mulf_33 = (arith_addf_32 * arith_const_16_6); 
          double arith_addf_34 = (arith_mulf_26 + arith_mulf_33); 
          int arith_addi_35 = (arith_addi_17 + arith_const_1_10); 
          ...
          int arith_addi_38 = (arith_addi_17 + arith_const_neg_1_4); 
          ...
          double arith_mulf_41 = (arith_addf_40 * arith_const_16_6); 
    ...
    for (int for_iter_44 = arith_const_0_8; for_iter_44 < arith_const_8_5; for_iter_44 += arith_const_1_10) {
      int arith_addi_45 = (for_iter_44 + arith_const_1_10); 
      for (int for_iter_46 = arith_const_0_8; for_iter_46 < arith_const_8_5; for_iter_46 += arith_const_1_10) {
        int arith_addi_47 = (for_iter_46 + arith_const_1_10); 
        for (int for_iter_48 = arith_const_0_8; for_iter_48 < arith_const_8_5; for_iter_48 += arith_const_1_10) {
          int arith_addi_49 = (for_iter_48 + arith_const_1_10); 
          int arith_addi_50 = (arith_addi_45 + arith_const_1_10); 
          ...
          double arith_mulf_53 = (memref_load_52 * arith_const_0_7); 
          double arith_subf_54 = (memref_load_51 - arith_mulf_53); 
          int arith_addi_55 = (arith_addi_45 + arith_const_neg_1_4); 
          ...
          int arith_addi_59 = (arith_addi_47 + arith_const_1_10); 
          ...
          int arith_addi_62 = (arith_addi_47 + arith_const_neg_1_4); 
          ...
          double arith_mulf_65 = (arith_addf_64 * arith_const_16_6); 
          double arith_addf_66 = (arith_mulf_58 + arith_mulf_65); 
          int arith_addi_67 = (arith_addi_49 + arith_const_1_10); 
          ...
          int arith_addi_70 = (arith_addi_49 + arith_const_neg_1_4); 
          ...
          double arith_mulf_73 = (arith_addf_72 * arith_const_16_6); 
