...
void kernel_gesummv(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  for (int for_iter_12 = arith_const_0_9; for_iter_12 < arith_const_30_10; for_iter_12 += arith_const_1_11) {
    func_arg_5[for_iter_12] = arith_const_0_8; 
    func_arg_7[for_iter_12] = arith_const_0_8; 
    for (int for_iter_13 = arith_const_0_9; for_iter_13 < arith_const_30_10; for_iter_13 += arith_const_1_11) {
