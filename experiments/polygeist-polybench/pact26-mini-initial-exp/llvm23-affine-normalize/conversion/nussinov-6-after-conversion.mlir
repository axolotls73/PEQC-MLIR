    ...
    scf.for %arg3 = %c0 to %c60 step %c1 {
      scf.for %arg4 = %c0 to %arg3 step %c1 {
        ...
        scf.if %6 {
          ...
          %25 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        scf.if %8 {
          ...
          %24 = arith.muli %arg3, %c-1 overflow<nsw> : index
          %25 = arith.addi %24, %c59 : index
          memref.store %23, %arg2[%25, %2] : memref<?x60xi32>
        }
        %9 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        scf.if %15 {
          ...
          scf.if %17 {
            %18 = arith.muli %arg3, %c-1 overflow<nsw> : index
            %19 = arith.addi %18, %c59 : index
            %20 = memref.load %arg2[%19, %2] : memref<?x60xi32>
            %21 = arith.muli %arg3, %c-1 overflow<nsw> : index
            ...
            %35 = arith.muli %arg3, %c-1 overflow<nsw> : index
            ...
            %27 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        scf.for %arg5 = %c0 to %arg4 step %c1 {
          ...
          %20 = arith.addi %19, %c59 : index
          %21 = memref.load %arg2[%20, %2] : memref<?x60xi32>
          %22 = arith.muli %arg3, %c-1 overflow<nsw> : index
          ...
          %30 = arith.muli %arg3, %c-1 overflow<nsw> : index
