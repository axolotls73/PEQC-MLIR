...
void kernel_syrk(int func_arg_0, int func_arg_1, double func_arg_2, double func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_11 = arith_const_0_8; for_iter_11 < arith_const_30_9; for_iter_11 += arith_const_32_10) {
    int arith_addi_12 = (for_iter_11 + arith_const_30_9); 
    for (int for_iter_13 = for_iter_11; for_iter_13 < arith_addi_12; for_iter_13 += arith_const_1_7) {
      int arith_addi_14 = (for_iter_13 + arith_const_1_7); 
      for (int for_iter_15 = arith_const_0_8; for_iter_15 < arith_addi_14; for_iter_15 += arith_const_1_7) {
      ...
      for (int for_iter_18 = arith_const_0_8; for_iter_18 < arith_const_20_6; for_iter_18 += arith_const_1_7) {
        int arith_addi_19 = (for_iter_13 + arith_const_1_7); 
        for (int for_iter_20 = arith_const_0_8; for_iter_20 < arith_addi_19; for_iter_20 += arith_const_1_7) {
