    ...
    affine.for %arg5 = 0 to 30 step 32 {
      affine.for %arg6 = #map(%arg5) to #map1(%arg5) {
        ...
        affine.for %arg7 = 0 to 20 {
          ...
          affine.store %5, %arg4[%arg7, %arg6] : memref<?x30xf64>
        }
        affine.for %arg7 = #map2(%arg6) to 30 {
          affine.store %cst, %arg3[%arg6, %arg7] : memref<?x30xf64>
          affine.for %arg8 = 0 to 20 {
            %3 = affine.load %arg4[%arg8, %arg6] : memref<?x30xf64>
            %4 = affine.load %arg2[%arg8, %arg7] : memref<?x30xf64>
            %5 = arith.mulf %3, %4 : f64
            %6 = affine.load %arg3[%arg6, %arg7] : memref<?x30xf64>
            %7 = arith.addf %6, %5 : f64
            affine.store %7, %arg3[%arg6, %arg7] : memref<?x30xf64>
          }
          affine.for %arg8 = 0 to 20 {
            %3 = affine.load %arg2[%arg8, %arg7] : memref<?x30xf64>
            %4 = affine.load %arg4[%arg8, %arg6] : memref<?x30xf64>
            %5 = affine.load %arg3[%arg6, %arg7] : memref<?x30xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = arith.subf %3, %6 : f64
            affine.store %7, %arg2[%arg8, %arg7] : memref<?x30xf64>
          }
        }
      }
    }
