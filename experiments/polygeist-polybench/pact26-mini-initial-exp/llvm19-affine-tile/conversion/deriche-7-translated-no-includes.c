...
void kernel_deriche(int func_arg_0, int func_arg_1, float func_arg_2, float* func_arg_3, float* func_arg_4, float* func_arg_5, float* func_arg_6)
{
  ...
  int arith_const_32_10 = 32; 
  int arith_const_64_11 = 64; 
  int arith_const_0_12 = 0; 
  float arith_const_0_13 = 0.000000; 
  float arith_const_0_14 = -2.000000; 
  float arith_const_0_15 = 2.000000; 
  float arith_const_0_16 = 1.000000; 
  float _17; 
  ...
  float arith_subf_30 = (arith_const_0_16 - math_exp_29); 
  float arith_mulf_31 = (arith_subf_30 * arith_subf_30); 
  float arith_mulf_32 = (func_arg_2 * math_exp_29); 
  float arith_mulf_33 = (arith_mulf_32 * arith_const_0_15); 
  float arith_addf_34 = (arith_mulf_33 + arith_const_0_16); 
  float arith_mulf_35 = (func_arg_2 * arith_const_0_15); 
  ...
  float arith_subf_40 = (func_arg_2 - arith_const_0_16); 
  float arith_mulf_41 = (arith_mulf_39 * arith_subf_40); 
  float arith_addf_42 = (func_arg_2 + arith_const_0_16); 
  float arith_mulf_43 = (arith_mulf_39 * arith_addf_42); 
  float arith_negf_44 = -(arith_divf_38); 
  float arith_mulf_45 = (func_arg_2 * arith_const_0_14); 
  float math_exp_46 = exp(arith_mulf_45); 
  float arith_mulf_47 = (arith_negf_44 * math_exp_46); 
  float math_powf_48 = pow(arith_const_0_15, arith_negf_28); 
  float arith_negf_49 = -(math_exp_46); 
  for (int for_iter_50 = arith_const_0_12; for_iter_50 < arith_const_64_11; for_iter_50 += arith_const_32_10) {
    int arith_addi_51 = (for_iter_50 + arith_const_32_10); 
    for (int for_iter_52 = for_iter_50; for_iter_52 < arith_addi_51; for_iter_52 += arith_const_1_9) {
      memref_alloca_25[0] = arith_const_0_13; 
      memref_alloca_24[0] = arith_const_0_13; 
      memref_alloca_27[0] = arith_const_0_13; 
      for (int for_iter_53 = arith_const_0_12; for_iter_53 < arith_const_64_11; for_iter_53 += arith_const_1_9) {
  ...
  for (int for_iter_67 = arith_const_0_12; for_iter_67 < arith_const_64_11; for_iter_67 += arith_const_32_10) {
    int arith_addi_68 = (for_iter_67 + arith_const_32_10); 
    for (int for_iter_69 = for_iter_67; for_iter_69 < arith_addi_68; for_iter_69 += arith_const_1_9) {
      memref_alloca_19[0] = arith_const_0_13; 
      memref_alloca_18[0] = arith_const_0_13; 
      memref_alloca_23[0] = arith_const_0_13; 
      memref_alloca_22[0] = arith_const_0_13; 
      for (int for_iter_70 = arith_const_0_12; for_iter_70 < arith_const_64_11; for_iter_70 += arith_const_1_9) {
        ...
        int arith_muli_82 = (for_iter_70 * arith_const_neg_1_8); 
        int arith_addi_83 = (arith_muli_82 + arith_const_63_7); 
        func_arg_6[for_iter_69][arith_addi_83] = arith_addf_81; 
        memref_alloca_22[0] = memref_load_71; 
        int arith_muli_84 = (for_iter_70 * arith_const_neg_1_8); 
        int arith_addi_85 = (arith_muli_84 + arith_const_63_7); 
        ...
        int arith_muli_87 = (for_iter_70 * arith_const_neg_1_8); 
        int arith_addi_88 = (arith_muli_87 + arith_const_63_7); 
        float memref_load_89 = func_arg_6[for_iter_69][arith_addi_88]; 
        memref_alloca_19[0] = memref_load_89; 
      }
    }
  }
  for (int for_iter_90 = arith_const_0_12; for_iter_90 < arith_const_64_11; for_iter_90 += arith_const_32_10) {
    for (int for_iter_91 = arith_const_0_12; for_iter_91 < arith_const_64_11; for_iter_91 += arith_const_32_10) {
      int arith_addi_92 = (for_iter_90 + arith_const_32_10); 
      for (int for_iter_93 = for_iter_90; for_iter_93 < arith_addi_92; for_iter_93 += arith_const_1_9) {
        int arith_addi_94 = (for_iter_91 + arith_const_32_10); 
        for (int for_iter_95 = for_iter_91; for_iter_95 < arith_addi_94; for_iter_95 += arith_const_1_9) {
  ...
  for (int for_iter_99 = arith_const_0_12; for_iter_99 < arith_const_64_11; for_iter_99 += arith_const_32_10) {
    int arith_addi_100 = (for_iter_99 + arith_const_32_10); 
    for (int for_iter_101 = for_iter_99; for_iter_101 < arith_addi_100; for_iter_101 += arith_const_1_9) {
      memref_alloca_26[0] = arith_const_0_13; 
      memref_alloca_25[0] = arith_const_0_13; 
      memref_alloca_24[0] = arith_const_0_13; 
      for (int for_iter_102 = arith_const_0_12; for_iter_102 < arith_const_64_11; for_iter_102 += arith_const_1_9) {
  ...
  for (int for_iter_116 = arith_const_0_12; for_iter_116 < arith_const_64_11; for_iter_116 += arith_const_32_10) {
    int arith_addi_117 = (for_iter_116 + arith_const_32_10); 
    for (int for_iter_118 = for_iter_116; for_iter_118 < arith_addi_117; for_iter_118 += arith_const_1_9) {
      memref_alloca_21[0] = arith_const_0_13; 
      memref_alloca_20[0] = arith_const_0_13; 
      memref_alloca_19[0] = arith_const_0_13; 
      memref_alloca_18[0] = arith_const_0_13; 
      for (int for_iter_119 = arith_const_0_12; for_iter_119 < arith_const_64_11; for_iter_119 += arith_const_1_9) {
        ...
        int arith_muli_131 = (for_iter_119 * arith_const_neg_1_8); 
        int arith_addi_132 = (arith_muli_131 + arith_const_63_7); 
        func_arg_6[arith_addi_132][for_iter_118] = arith_addf_130; 
        memref_alloca_20[0] = memref_load_120; 
        int arith_muli_133 = (for_iter_119 * arith_const_neg_1_8); 
        int arith_addi_134 = (arith_muli_133 + arith_const_63_7); 
        ...
        int arith_muli_136 = (for_iter_119 * arith_const_neg_1_8); 
        int arith_addi_137 = (arith_muli_136 + arith_const_63_7); 
        float memref_load_138 = func_arg_6[arith_addi_137][for_iter_118]; 
        memref_alloca_19[0] = memref_load_138; 
      }
    }
  }
  for (int for_iter_139 = arith_const_0_12; for_iter_139 < arith_const_64_11; for_iter_139 += arith_const_32_10) {
    for (int for_iter_140 = arith_const_0_12; for_iter_140 < arith_const_64_11; for_iter_140 += arith_const_32_10) {
      int arith_addi_141 = (for_iter_139 + arith_const_32_10); 
      for (int for_iter_142 = for_iter_139; for_iter_142 < arith_addi_141; for_iter_142 += arith_const_1_9) {
        int arith_addi_143 = (for_iter_140 + arith_const_32_10); 
        for (int for_iter_144 = for_iter_140; for_iter_144 < arith_addi_143; for_iter_144 += arith_const_1_9) {
