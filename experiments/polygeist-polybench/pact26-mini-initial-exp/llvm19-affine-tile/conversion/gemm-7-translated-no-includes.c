...
void kernel_gemm(int func_arg_0, int func_arg_1, int func_arg_2, double func_arg_3, double func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  int arith_const_32_13 = 32; 
  for (int for_iter_14 = arith_const_0_11; for_iter_14 < arith_const_20_12; for_iter_14 += arith_const_32_13) {
    int arith_addi_15 = (for_iter_14 + arith_const_20_12); 
    for (int for_iter_16 = for_iter_14; for_iter_16 < arith_addi_15; for_iter_16 += arith_const_1_10) {
      for (int for_iter_17 = arith_const_0_11; for_iter_17 < arith_const_25_9; for_iter_17 += arith_const_1_10) {
      ...
      for (int for_iter_20 = arith_const_0_11; for_iter_20 < arith_const_30_8; for_iter_20 += arith_const_1_10) {
        for (int for_iter_21 = arith_const_0_11; for_iter_21 < arith_const_25_9; for_iter_21 += arith_const_1_10) {
