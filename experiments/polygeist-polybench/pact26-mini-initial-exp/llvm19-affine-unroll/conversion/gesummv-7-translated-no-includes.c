...
void kernel_gesummv(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7)
{
  ...
  int arith_const_30_14 = 30; 
  int arith_const_1_15 = 1; 
  for (int for_iter_16 = arith_const_0_13; for_iter_16 < arith_const_30_14; for_iter_16 += arith_const_1_15) {
    func_arg_5[for_iter_16] = arith_const_0_12; 
    func_arg_7[for_iter_16] = arith_const_0_12; 
    for (int for_iter_17 = arith_const_0_13; for_iter_17 < arith_const_28_11; for_iter_17 += arith_const_4_10) {
      ...
      int arith_addi_28 = (for_iter_17 + arith_const_1_15); 
      ...
      int arith_addi_39 = (for_iter_17 + arith_const_2_9); 
      ...
      int arith_addi_50 = (for_iter_17 + arith_const_3_8); 
    ...
    for (int for_iter_61 = arith_const_28_11; for_iter_61 < arith_const_30_14; for_iter_61 += arith_const_1_15) {
