...
void kernel_fdtd_2d(int func_arg_0, int func_arg_1, int func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_16 = arith_const_0_13; for_iter_16 < arith_const_20_14; for_iter_16 += arith_const_1_15) {
    ...
    for (int for_iter_18 = arith_const_0_13; for_iter_18 < arith_const_30_10; for_iter_18 += arith_const_1_15) {
      func_arg_4[arith_const_0_13][for_iter_18] = memref_load_17; 
    }
    for (int for_iter_19 = arith_const_1_15; for_iter_19 < arith_const_20_14; for_iter_19 += arith_const_1_15) {
      for (int for_iter_20 = arith_const_0_13; for_iter_20 < arith_const_30_10; for_iter_20 += arith_const_1_15) {
        double memref_load_21 = func_arg_4[for_iter_19][for_iter_20]; 
        double memref_load_22 = func_arg_5[for_iter_19][for_iter_20]; 
        int arith_addi_23 = (for_iter_19 + arith_const_neg_1_9); 
    ...
    for (int for_iter_28 = arith_const_0_13; for_iter_28 < arith_const_20_14; for_iter_28 += arith_const_1_15) {
      for (int for_iter_29 = arith_const_1_15; for_iter_29 < arith_const_30_10; for_iter_29 += arith_const_1_15) {
    ...
    for (int for_iter_37 = arith_const_0_13; for_iter_37 < arith_const_19_8; for_iter_37 += arith_const_1_15) {
      for (int for_iter_38 = arith_const_0_13; for_iter_38 < arith_const_29_7; for_iter_38 += arith_const_1_15) {
        double memref_load_39 = func_arg_5[for_iter_37][for_iter_38]; 
        int arith_addi_40 = (for_iter_38 + arith_const_1_15); 
        ...
        int arith_addi_44 = (for_iter_37 + arith_const_1_15); 
        ...
        double arith_mulf_49 = (arith_subf_48 * arith_const_16_11); 
