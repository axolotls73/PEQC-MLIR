...
void kernel_mvt(int func_arg_0, double* func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_9 = arith_const_0_6; for_iter_9 < arith_const_40_7; for_iter_9 += arith_const_1_8) {
    for (int for_iter_10 = arith_const_0_6; for_iter_10 < arith_const_40_7; for_iter_10 += arith_const_1_8) {
  ...
  for (int for_iter_16 = arith_const_0_6; for_iter_16 < arith_const_40_7; for_iter_16 += arith_const_1_8) {
    for (int for_iter_17 = arith_const_0_6; for_iter_17 < arith_const_40_7; for_iter_17 += arith_const_1_8) {
