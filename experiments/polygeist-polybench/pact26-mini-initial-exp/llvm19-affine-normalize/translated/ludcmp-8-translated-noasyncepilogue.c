...
void kernel_ludcmp(int func_arg_0, double* func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  int arith_const_40_8 = 40; 
  int arith_const_0_9 = 0; 
  double _10; 
  double* memref_alloca_11; 
  memref_alloca_11[0] = _10; 
  for (int for_iter_12 = arith_const_0_9; for_iter_12 < arith_const_40_8; for_iter_12 += arith_const_1_7) {
    for (int for_iter_13 = arith_const_0_9; for_iter_13 < for_iter_12; for_iter_13 += arith_const_1_7) {
      double memref_load_14 = func_arg_1[for_iter_12][for_iter_13]; 
      memref_alloca_11[0] = memref_load_14; 
      for (int for_iter_15 = arith_const_0_9; for_iter_15 < for_iter_13; for_iter_15 += arith_const_1_7) {
    ...
    int arith_muli_24 = (for_iter_12 * arith_const_neg_1_6); 
    int arith_addi_25 = (arith_muli_24 + arith_const_40_8); 
    for (int for_iter_26 = arith_const_0_9; for_iter_26 < arith_addi_25; for_iter_26 += arith_const_1_7) {
      ...
      for (int for_iter_29 = arith_const_0_9; for_iter_29 < for_iter_12; for_iter_29 += arith_const_1_7) {
  ...
  for (int for_iter_36 = arith_const_0_9; for_iter_36 < arith_const_40_8; for_iter_36 += arith_const_1_7) {
    double memref_load_37 = func_arg_2[for_iter_36]; 
    memref_alloca_11[0] = memref_load_37; 
    for (int for_iter_38 = arith_const_0_9; for_iter_38 < for_iter_36; for_iter_38 += arith_const_1_7) {
  ...
  for (int for_iter_45 = arith_const_0_9; for_iter_45 < arith_const_40_8; for_iter_45 += arith_const_1_7) {
    int arith_muli_46 = (for_iter_45 * arith_const_neg_1_6); 
    int arith_addi_47 = (arith_muli_46 + arith_const_39_5); 
    double memref_load_48 = func_arg_4[arith_addi_47]; 
    memref_alloca_11[0] = memref_load_48; 
    for (int for_iter_49 = arith_const_0_9; for_iter_49 < for_iter_45; for_iter_49 += arith_const_1_7) {
      int arith_muli_50 = (for_iter_45 * arith_const_neg_1_6); 
      int arith_addi_51 = (arith_muli_50 + for_iter_49); 
      int arith_addi_52 = (arith_addi_51 + arith_const_40_8); 
      int arith_muli_53 = (for_iter_45 * arith_const_neg_1_6); 
    ...
    int arith_muli_61 = (for_iter_45 * arith_const_neg_1_6); 
    int arith_addi_62 = (arith_muli_61 + arith_const_39_5); 
    int arith_muli_63 = (for_iter_45 * arith_const_neg_1_6); 
    int arith_addi_64 = (arith_muli_63 + arith_const_39_5); 
    double memref_load_65 = func_arg_1[arith_addi_62][arith_addi_64]; 
    double arith_divf_66 = (memref_load_60 / memref_load_65); 
    int arith_muli_67 = (for_iter_45 * arith_const_neg_1_6); 
