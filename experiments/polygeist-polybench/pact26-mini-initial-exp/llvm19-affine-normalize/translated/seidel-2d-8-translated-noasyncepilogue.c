...
void kernel_seidel_2d(int func_arg_0, int func_arg_1, double* func_arg_2)
{
  ...
  int arith_const_38_4 = 38; 
  double arith_const_0_5 = 9.000000; 
  ...
  for (int for_iter_9 = arith_const_0_6; for_iter_9 < arith_const_20_7; for_iter_9 += arith_const_1_8) {
    for (int for_iter_10 = arith_const_0_6; for_iter_10 < arith_const_38_4; for_iter_10 += arith_const_1_8) {
      int arith_addi_11 = (for_iter_10 + arith_const_1_8); 
      for (int for_iter_12 = arith_const_0_6; for_iter_12 < arith_const_38_4; for_iter_12 += arith_const_1_8) {
        int arith_addi_13 = (for_iter_12 + arith_const_1_8); 
        int arith_addi_14 = (arith_addi_11 + arith_const_neg_1_3); 
        int arith_addi_15 = (arith_addi_13 + arith_const_neg_1_3); 
        double memref_load_16 = func_arg_2[arith_addi_14][arith_addi_15]; 
        int arith_addi_17 = (arith_addi_11 + arith_const_neg_1_3); 
        double memref_load_18 = func_arg_2[arith_addi_17][arith_addi_13]; 
        double arith_addf_19 = (memref_load_16 + memref_load_18); 
        int arith_addi_20 = (arith_addi_11 + arith_const_neg_1_3); 
        int arith_addi_21 = (arith_addi_13 + arith_const_1_8); 
        double memref_load_22 = func_arg_2[arith_addi_20][arith_addi_21]; 
        double arith_addf_23 = (arith_addf_19 + memref_load_22); 
        int arith_addi_24 = (arith_addi_13 + arith_const_neg_1_3); 
