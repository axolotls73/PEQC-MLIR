  ...
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    affine.for %arg7 = 0 to 27 {
      ...
      affine.for %arg8 = 0 to #map(%arg7) {
        %1 = affine.apply #map1(%arg7, %arg8)
        affine.store %cst_0, %arg4[%arg7, %1] : memref<?x28xf64>
        affine.for %arg9 = 0 to 32 {
          %3 = affine.load %arg3[%arg9, %arg7] : memref<?x28xf64>
          %4 = affine.load %arg3[%arg9, %1] : memref<?x28xf64>
          %5 = arith.mulf %3, %4 : f64
          %6 = affine.load %arg4[%arg7, %1] : memref<?x28xf64>
          %7 = arith.addf %6, %5 : f64
          affine.store %7, %arg4[%arg7, %1] : memref<?x28xf64>
        }
        %2 = affine.load %arg4[%arg7, %1] : memref<?x28xf64>
        affine.store %2, %arg4[%1, %arg7] : memref<?x28xf64>
      }
    }
