...
void kernel_jacobi_1d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  double arith_const_16_9 = 0.333330; 
  ...
  for (int for_iter_13 = arith_const_0_10; for_iter_13 < arith_const_20_11; for_iter_13 += arith_const_1_12) {
    for (int for_iter_14 = arith_const_1_12; for_iter_14 < arith_const_29_8; for_iter_14 += arith_const_4_7) {
      int arith_addi_15 = (for_iter_14 + arith_const_neg_1_6); 
      ...
      int arith_addi_28 = (arith_addi_23 + arith_const_1_12); 
      double memref_load_29 = func_arg_2[arith_addi_28]; 
      double arith_addf_30 = (arith_addf_27 + memref_load_29); 
      double arith_mulf_31 = (arith_addf_30 * arith_const_16_9); 
      func_arg_3[arith_addi_23] = arith_mulf_31; 
      int arith_addi_32 = (for_iter_14 + arith_const_2_5); 
      int arith_addi_33 = (arith_addi_32 + arith_const_neg_1_6); 
      ...
      int arith_addi_37 = (arith_addi_32 + arith_const_1_12); 
      ...
      int arith_addi_41 = (for_iter_14 + arith_const_3_4); 
      int arith_addi_42 = (arith_addi_41 + arith_const_neg_1_6); 
      ...
      int arith_addi_46 = (arith_addi_41 + arith_const_1_12); 
      double memref_load_47 = func_arg_2[arith_addi_46]; 
      double arith_addf_48 = (arith_addf_45 + memref_load_47); 
      double arith_mulf_49 = (arith_addf_48 * arith_const_16_9); 
      func_arg_3[arith_addi_41] = arith_mulf_49; 
    }
    for (int for_iter_50 = arith_const_1_12; for_iter_50 < arith_const_29_8; for_iter_50 += arith_const_4_7) {
      int arith_addi_51 = (for_iter_50 + arith_const_neg_1_6); 
      ...
      int arith_addi_55 = (for_iter_50 + arith_const_1_12); 
      double memref_load_56 = func_arg_3[arith_addi_55]; 
      double arith_addf_57 = (arith_addf_54 + memref_load_56); 
      double arith_mulf_58 = (arith_addf_57 * arith_const_16_9); 
      func_arg_2[for_iter_50] = arith_mulf_58; 
      int arith_addi_59 = (for_iter_50 + arith_const_1_12); 
      int arith_addi_60 = (arith_addi_59 + arith_const_neg_1_6); 
      ...
      int arith_addi_64 = (arith_addi_59 + arith_const_1_12); 
      ...
      int arith_addi_68 = (for_iter_50 + arith_const_2_5); 
      int arith_addi_69 = (arith_addi_68 + arith_const_neg_1_6); 
      ...
      int arith_addi_73 = (arith_addi_68 + arith_const_1_12); 
      double memref_load_74 = func_arg_3[arith_addi_73]; 
      double arith_addf_75 = (arith_addf_72 + memref_load_74); 
      double arith_mulf_76 = (arith_addf_75 * arith_const_16_9); 
      func_arg_2[arith_addi_68] = arith_mulf_76; 
      int arith_addi_77 = (for_iter_50 + arith_const_3_4); 
      int arith_addi_78 = (arith_addi_77 + arith_const_neg_1_6); 
      ...
      int arith_addi_82 = (arith_addi_77 + arith_const_1_12); 
      double memref_load_83 = func_arg_3[arith_addi_82]; 
      double arith_addf_84 = (arith_addf_81 + memref_load_83); 
      double arith_mulf_85 = (arith_addf_84 * arith_const_16_9); 
