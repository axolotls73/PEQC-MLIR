...
void kernel_covariance(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_15 = arith_const_0_12; for_iter_15 < arith_const_28_13; for_iter_15 += arith_const_1_14) {
    func_arg_5[for_iter_15] = arith_const_0_11; 
    for (int for_iter_16 = arith_const_0_12; for_iter_16 < arith_const_32_9; for_iter_16 += arith_const_4_8) {
      ...
      int arith_addi_20 = (for_iter_16 + arith_const_1_14); 
      ...
      int arith_addi_24 = (for_iter_16 + arith_const_2_7); 
      ...
      int arith_addi_28 = (for_iter_16 + arith_const_3_6); 
  ...
  for (int for_iter_34 = arith_const_0_12; for_iter_34 < arith_const_32_9; for_iter_34 += arith_const_1_14) {
    for (int for_iter_35 = arith_const_0_12; for_iter_35 < arith_const_28_13; for_iter_35 += arith_const_4_8) {
      ...
      int arith_addi_39 = (for_iter_35 + arith_const_1_14); 
      ...
      int arith_addi_43 = (for_iter_35 + arith_const_2_7); 
      ...
      int arith_addi_47 = (for_iter_35 + arith_const_3_6); 
  ...
  double arith_subf_51 = (func_arg_2 - arith_const_0_10); 
  for (int for_iter_52 = arith_const_0_12; for_iter_52 < arith_const_28_13; for_iter_52 += arith_const_1_14) {
    for (int for_iter_53 = for_iter_52; for_iter_53 < arith_const_28_13; for_iter_53 += arith_const_1_14) {
      func_arg_4[for_iter_52][for_iter_53] = arith_const_0_11; 
      for (int for_iter_54 = arith_const_0_12; for_iter_54 < arith_const_32_9; for_iter_54 += arith_const_4_8) {
        ...
        int arith_addi_60 = (for_iter_54 + arith_const_1_14); 
        ...
        int arith_addi_66 = (for_iter_54 + arith_const_2_7); 
        ...
        int arith_addi_72 = (for_iter_54 + arith_const_3_6); 
