module {
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    scf.for %arg3 = %c1 to %c40 step %c1 {
      ...
      %16 = arith.muli %15, %c4 overflow<nsw> : index
      scf.for %arg4 = %c0 to %16 step %c4 {
        %57 = arith.muli %arg4, %c-1 overflow<nsw> : index
        ...
        %66 = arith.muli %65, %c-1 overflow<nsw> : index
        ...
        %75 = arith.muli %74, %c-1 overflow<nsw> : index
        ...
        %84 = arith.muli %83, %c-1 overflow<nsw> : index
      ...
      %35 = arith.muli %34, %c4 overflow<nsw> : index
      scf.for %arg4 = %c0 to %35 step %c4 {
        %57 = memref.load %arg2[%arg4] : memref<?xf64>
        %58 = arith.muli %arg4, %c-1 overflow<nsw> : index
        ...
        %66 = arith.muli %64, %c-1 overflow<nsw> : index
        %67 = arith.addi %arg3, %66 : index
        %68 = arith.addi %67, %c-1 : index
        ...
        %74 = arith.muli %72, %c-1 overflow<nsw> : index
        ...
        %82 = arith.muli %80, %c-1 overflow<nsw> : index
      ...
      %42 = arith.muli %41, %c4 overflow<nsw> : index
      ...
      %49 = arith.muli %48, %c4 overflow<nsw> : index
      ...
      %56 = arith.muli %55, %c4 overflow<nsw> : index
