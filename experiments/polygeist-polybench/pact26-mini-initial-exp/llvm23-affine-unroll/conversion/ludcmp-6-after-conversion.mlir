  ...
  func.func @kernel_ludcmp(%arg0: i32, %arg1: memref<?x40xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) {
    ...
    scf.for %arg5 = %c0 to %c40 step %c1 {
      scf.for %arg6 = %c0 to %arg5 step %c1 {
        ...
        %15 = arith.muli %14, %c4 overflow<nsw> : index
    ...
    scf.for %arg5 = %c0 to %c40 step %c1 {
      ...
      %4 = arith.muli %arg5, %c-1 overflow<nsw> : index
      %5 = arith.addi %4, %c40 : index
      %6 = arith.muli %arg5, %c-1 overflow<nsw> : index
      ...
      %13 = arith.muli %12, %c4 overflow<nsw> : index
      %14 = arith.addi %6, %13 : index
      %15 = arith.addi %14, %c40 : index
      scf.for %arg6 = %5 to %15 step %c4 {
        %35 = arith.muli %arg5, %c-1 overflow<nsw> : index
        ...
        %43 = arith.muli %arg5, %c-1 overflow<nsw> : index
        ...
        %51 = arith.muli %arg5, %c-1 overflow<nsw> : index
        ...
        %59 = arith.muli %arg5, %c-1 overflow<nsw> : index
      ...
      %16 = arith.muli %arg5, %c-1 overflow<nsw> : index
      ...
      %23 = arith.muli %22, %c4 overflow<nsw> : index
      ...
      %26 = memref.load %alloca[] : memref<f64>
      %27 = arith.muli %arg5, %c-1 overflow<nsw> : index
      %28 = arith.addi %27, %c39 : index
      %29 = arith.muli %arg5, %c-1 overflow<nsw> : index
      %30 = arith.addi %29, %c39 : index
      %31 = memref.load %arg1[%28, %30] : memref<?x40xf64>
      %32 = arith.divf %26, %31 : f64
      %33 = arith.muli %arg5, %c-1 overflow<nsw> : index
