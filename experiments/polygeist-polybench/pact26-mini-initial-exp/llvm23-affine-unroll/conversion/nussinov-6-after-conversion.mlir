  ...
  func.func @kernel_nussinov(%arg0: i32, %arg1: memref<?xi32>, %arg2: memref<?x60xi32>) {
    ...
    scf.for %arg3 = %c0 to %c60 step %c1 {
      ...
      scf.for %arg4 = %1 to %c60 step %c1 {
        ...
        scf.if %3 {
          %33 = arith.muli %arg3, %c-1 overflow<nsw> : index
          %34 = arith.addi %33, %c59 : index
          %35 = memref.load %arg2[%34, %arg4] : memref<?x60xi32>
          %36 = arith.muli %arg3, %c-1 overflow<nsw> : index
          ...
          %42 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        scf.if %5 {
          ...
          %41 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        scf.if %10 {
          ...
          scf.if %35 {
            ...
            %53 = arith.muli %arg3, %c-1 overflow<nsw> : index
            ...
            %45 = arith.muli %arg3, %c-1 overflow<nsw> : index
            %46 = arith.addi %45, %c59 : index
            memref.store %44, %arg2[%46, %arg4] : memref<?x60xi32>
          }
        }
        %11 = arith.muli %arg3, %c-1 overflow<nsw> : index
        %12 = arith.addi %11, %c60 : index
        %13 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        %21 = arith.muli %20, %c4 overflow<nsw> : index
        ...
        scf.for %arg5 = %12 to %22 step %c4 {
          ...
          %86 = arith.muli %arg3, %c-1 overflow<nsw> : index
          %87 = arith.addi %86, %c59 : index
          memref.store %85, %arg2[%87, %arg4] : memref<?x60xi32>
        }
        %23 = arith.muli %arg3, %c-1 overflow<nsw> : index
        ...
        %31 = arith.muli %30, %c4 overflow<nsw> : index
