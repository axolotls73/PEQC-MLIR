...
void kernel_gemver(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  int arith_const_4_17 = 4; 
  for (int for_iter_18 = arith_const_0_15; for_iter_18 < arith_const_40_16; for_iter_18 += arith_const_4_17) {
    for (int for_iter_19 = arith_const_0_15; for_iter_19 < arith_const_40_16; for_iter_19 += arith_const_1_14) {
      ...
      int arith_addi_29 = (for_iter_18 + arith_const_1_14); 
      ...
      int arith_addi_39 = (for_iter_18 + arith_const_2_13); 
      ...
      int arith_addi_49 = (for_iter_18 + arith_const_3_12); 
  ...
  for (int for_iter_59 = arith_const_0_15; for_iter_59 < arith_const_40_16; for_iter_59 += arith_const_1_14) {
    for (int for_iter_60 = arith_const_0_15; for_iter_60 < arith_const_40_16; for_iter_60 += arith_const_1_14) {
  ...
  for (int for_iter_67 = arith_const_0_15; for_iter_67 < arith_const_40_16; for_iter_67 += arith_const_1_14) {
  ...
  for (int for_iter_71 = arith_const_0_15; for_iter_71 < arith_const_40_16; for_iter_71 += arith_const_1_14) {
    for (int for_iter_72 = arith_const_0_15; for_iter_72 < arith_const_40_16; for_iter_72 += arith_const_1_14) {
