...
void kernel_jacobi_1d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  for (int for_iter_10 = arith_const_0_7; for_iter_10 < arith_const_20_8; for_iter_10 += arith_const_1_9) {
    for (int for_iter_11 = arith_const_1_9; for_iter_11 < arith_const_29_5; for_iter_11 += arith_const_1_9) {
      int arith_addi_12 = (for_iter_11 + arith_const_neg_1_4); 
      ...
      int arith_addi_16 = (for_iter_11 + arith_const_1_9); 
      double memref_load_17 = func_arg_2[arith_addi_16]; 
      double arith_addf_18 = (arith_addf_15 + memref_load_17); 
      double arith_mulf_19 = (arith_addf_18 * arith_const_16_6); 
      func_arg_3[for_iter_11] = arith_mulf_19; 
    }
    for (int for_iter_20 = arith_const_1_9; for_iter_20 < arith_const_29_5; for_iter_20 += arith_const_1_9) {
      int arith_addi_21 = (for_iter_20 + arith_const_neg_1_4); 
      ...
      int arith_addi_25 = (for_iter_20 + arith_const_1_9); 
