...
void kernel_floyd_warshall(int func_arg_0, int* func_arg_1)
{
  ...
  int arith_const_60_6 = 60; 
  int arith_const_4_7 = 4; 
  for (int for_iter_8 = arith_const_0_5; for_iter_8 < arith_const_60_6; for_iter_8 += arith_const_4_7) {
    for (int for_iter_9 = arith_const_0_5; for_iter_9 < arith_const_60_6; for_iter_9 += arith_const_1_4) {
      for (int for_iter_10 = arith_const_0_5; for_iter_10 < arith_const_60_6; for_iter_10 += arith_const_1_4) {
        ...
        int arith_addi_17 = (for_iter_8 + arith_const_1_4); 
        int memref_load_18 = func_arg_1[for_iter_9][for_iter_10]; 
        int memref_load_19 = func_arg_1[for_iter_9][arith_addi_17]; 
        int memref_load_20 = func_arg_1[arith_addi_17][for_iter_10]; 
        ...
        func_arg_1[for_iter_9][for_iter_10] = arith_select_23; 
        int arith_addi_24 = (for_iter_8 + arith_const_2_3); 
        int memref_load_25 = func_arg_1[for_iter_9][for_iter_10]; 
        int memref_load_26 = func_arg_1[for_iter_9][arith_addi_24]; 
        int memref_load_27 = func_arg_1[arith_addi_24][for_iter_10]; 
        ...
        func_arg_1[for_iter_9][for_iter_10] = arith_select_30; 
        int arith_addi_31 = (for_iter_8 + arith_const_3_2); 
        int memref_load_32 = func_arg_1[for_iter_9][for_iter_10]; 
        int memref_load_33 = func_arg_1[for_iter_9][arith_addi_31]; 
        int memref_load_34 = func_arg_1[arith_addi_31][for_iter_10]; 
        ...
        func_arg_1[for_iter_9][for_iter_10] = arith_select_37; 
      }
    }
  }
  return; 
