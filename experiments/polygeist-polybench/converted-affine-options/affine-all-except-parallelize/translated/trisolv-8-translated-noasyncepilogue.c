...
void kernel_trisolv(int func_arg_0, double* func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  for (int for_iter_36 = arith_const_18; for_iter_36 < arith_const_19; for_iter_36 += arith_const_20) {
    ...
    for (int for_iter_38 = arith_const_18; for_iter_38 < arith_addi_37; for_iter_38 += arith_const_20) {
      ...
      int arith_cmpi_40 = (arith_addi_39 == arith_const_18); 
      int arith_addi_41 = (for_iter_38 + arith_const_11); 
      int arith_cmpi_42 = (arith_addi_41 == arith_const_18); 
      ...
      for (int for_iter_59 = arith_maxsi_52; for_iter_59 < arith_minsi_58; for_iter_59 += arith_const_20) {
        ...
        int arith_cmpi_71 = (for_iter_36 == arith_const_18); 
        int arith_cmpi_72 = (for_iter_38 == arith_const_18); 
        int arith_andi_73 = (arith_cmpi_71 & arith_cmpi_72); 
        int arith_addi_74 = (for_iter_59 + arith_const_11); 
        int arith_cmpi_75 = (arith_addi_74 == arith_const_18); 
        ...
        int arith_cmpi_98 = (arith_addi_97 == arith_const_18); 
        if (arith_cmpi_98) {
      ...
      int arith_cmpi_107 = (arith_addi_106 == arith_const_18); 
      int arith_cmpi_108 = (for_iter_38 == arith_const_18); 
      int arith_andi_109 = (arith_cmpi_107 & arith_cmpi_108); 
      if (arith_andi_109) {
        for (int for_iter_110 = arith_const_18; for_iter_110 < arith_const_6; for_iter_110 += arith_const_20) {
          int arith_addi_111 = (for_iter_110 + arith_const_8); 
          for (int for_iter_112 = arith_const_18; for_iter_112 < arith_const_6; for_iter_112 += arith_const_20) {
            int arith_muli_113 = (for_iter_112 * arith_const_13); 
            int arith_addi_114 = (arith_muli_113 + arith_const_20); 
            double memref_load_115 = func_arg_2[arith_addi_111]; 
            int arith_addi_116 = (arith_addi_114 + arith_const_11); 
            double memref_load_117 = func_arg_1[arith_addi_111][arith_addi_116]; 
            int arith_addi_118 = (arith_addi_114 + arith_const_11); 
            double memref_load_119 = func_arg_2[arith_addi_118]; 
            double arith_mulf_120 = (memref_load_117 * memref_load_119); 
            double arith_subf_121 = (memref_load_115 - arith_mulf_120); 
            func_arg_2[arith_addi_111] = arith_subf_121; 
            int arith_addi_122 = (arith_addi_114 + arith_const_20); 
            double memref_load_123 = func_arg_2[arith_addi_111]; 
            int arith_addi_124 = (arith_addi_122 + arith_const_11); 
            double memref_load_125 = func_arg_1[arith_addi_111][arith_addi_124]; 
            int arith_addi_126 = (arith_addi_122 + arith_const_11); 
            double memref_load_127 = func_arg_2[arith_addi_126]; 
            double arith_mulf_128 = (memref_load_125 * memref_load_127); 
            double arith_subf_129 = (memref_load_123 - arith_mulf_128); 
            func_arg_2[arith_addi_111] = arith_subf_129; 
            int arith_addi_130 = (arith_addi_114 + arith_const_19); 
            double memref_load_131 = func_arg_2[arith_addi_111]; 
            int arith_addi_132 = (arith_addi_130 + arith_const_11); 
            double memref_load_133 = func_arg_1[arith_addi_111][arith_addi_132]; 
            int arith_addi_134 = (arith_addi_130 + arith_const_11); 
            double memref_load_135 = func_arg_2[arith_addi_134]; 
            double arith_mulf_136 = (memref_load_133 * memref_load_135); 
            double arith_subf_137 = (memref_load_131 - arith_mulf_136); 
            func_arg_2[arith_addi_111] = arith_subf_137; 
            int arith_addi_138 = (arith_addi_114 + arith_const_12); 
            double memref_load_139 = func_arg_2[arith_addi_111]; 
            int arith_addi_140 = (arith_addi_138 + arith_const_11); 
            double memref_load_141 = func_arg_1[arith_addi_111][arith_addi_140]; 
            int arith_addi_142 = (arith_addi_138 + arith_const_11); 
            double memref_load_143 = func_arg_2[arith_addi_142]; 
            double arith_mulf_144 = (memref_load_141 * memref_load_143); 
            double arith_subf_145 = (memref_load_139 - arith_mulf_144); 
            func_arg_2[arith_addi_111] = arith_subf_145; 
          }
          for (int for_iter_146 = arith_const_18; for_iter_146 < arith_const_12; for_iter_146 += arith_const_20) {
            int arith_addi_147 = (for_iter_146 + arith_const_5); 
            double memref_load_148 = func_arg_2[arith_addi_111]; 
            int arith_addi_149 = (arith_addi_147 + arith_const_11); 
            double memref_load_150 = func_arg_1[arith_addi_111][arith_addi_149]; 
            int arith_addi_151 = (arith_addi_147 + arith_const_11); 
            double memref_load_152 = func_arg_2[arith_addi_151]; 
            double arith_mulf_153 = (memref_load_150 * memref_load_152); 
            double arith_subf_154 = (memref_load_148 - arith_mulf_153); 
            func_arg_2[arith_addi_111] = arith_subf_154; 
          }
        }
      }
      int arith_addi_155 = (for_iter_36 + arith_const_11); 
      int arith_cmpi_156 = (arith_addi_155 == arith_const_18); 
      int arith_addi_157 = (for_iter_38 + arith_const_11); 
      int arith_cmpi_158 = (arith_addi_157 == arith_const_18); 
      int arith_andi_159 = (arith_cmpi_156 & arith_cmpi_158); 
      if (arith_andi_159) {
        double memref_load_160 = func_arg_2[arith_const_4]; 
        double memref_load_161 = func_arg_1[arith_const_4][arith_const_4]; 
        double arith_divf_162 = (memref_load_160 / memref_load_161); 
        func_arg_2[arith_const_4] = arith_divf_162; 
      }
    }
  }
  return; 
