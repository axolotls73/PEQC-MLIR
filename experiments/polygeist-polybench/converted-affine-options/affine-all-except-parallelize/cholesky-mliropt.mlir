...
#map7 = affine_map<(d0, d1) -> (2, d0 * 32, d1 * 32 + 1)>
#map8 = affine_map<(d0, d1) -> (40, d0 * 32 + 32, d1 * 32 + 33)>
#map9 = affine_map<(d0) -> (1, d0 * 32)>
#map10 = affine_map<(d0) -> (d0 - 1)>
#map11 = affine_map<(d0) -> (d0)>
#map12 = affine_map<(d0) -> ((d0 - 1) floordiv 4)>
#map13 = affine_map<(d0) -> (d0 - ((d0 - 1) floordiv 4) * 4 - 1)>
#map14 = affine_map<(d0, d1) -> (d1 + ((d0 - 1) floordiv 4) * 4 + 1)>
        ...
        affine.for %arg4 = 0 to #map(%arg3) {
          affine.if #set(%arg2, %arg3, %arg4) {
            affine.parallel (%arg5) = (0) to (7) {
              ...
              affine.parallel (%arg6) = (0) to (%0 - 32) {
          ...
          affine.if #set3(%arg3, %arg4) {
            affine.for %arg5 = max #map7(%arg2, %arg3) to min #map8(%arg2, %arg3) {
              affine.if #set4(%arg3) {
              ...
              affine.for %arg6 = max #map9(%arg3) to #map10(%arg5) {
                affine.for %arg7 = max #map9(%arg3) to #map11(%arg6) {
