              ...
              scf.parallel (%arg9) = (%c0_13) to (%c1_14) step (%c1_15) {
                ...
                scf.for %arg10 = %17 to %32 step %c1_32 {
                  ...
                  scf.if %56 {
                    ...
                    scf.parallel (%arg11) = (%88) to (%95) step (%c1_68) {
                      ...
                      scf.parallel (%arg12) = (%101) to (%108) step (%c1_78) {
                  ...
                  scf.for %arg11 = %62 to %69 step %c1_53 {
                    ...
                    scf.if %93 {
                      ...
                      scf.parallel (%arg12) = (%125) to (%132) step (%c1_90) {
                        %c-2 = arith.constant -2 : index
                    ...
                    scf.for %arg12 = %99 to %106 step %c1_74 {
                      ...
                      %c1_96 = arith.constant 1 : index
                      scf.parallel (%arg13) = (%136) to (%143) step (%c1_96) {
                        %c-2 = arith.constant -2 : index
                        %157 = arith.muli %arg10, %c-2 : index
                        %158 = arith.addi %157, %arg11 : index
                        %c1_103 = arith.constant 1 : index
                    ...
                    scf.if %119 {
                      ...
                      scf.parallel (%arg12) = (%125) to (%132) step (%c1_89) {
                        %c-2 = arith.constant -2 : index
                        %133 = arith.muli %arg10, %c-2 : index
                        %134 = arith.addi %133, %arg11 : index
                        %c8 = arith.constant 8 : index
                  ...
                  scf.if %82 {
                    ...
                    scf.parallel (%arg11) = (%88) to (%95) step (%c1_67) {
                      ...
                      scf.parallel (%arg12) = (%101) to (%108) step (%c1_77) {
                ...
                scf.if %45 {
                  ...
                  scf.parallel (%arg10) = (%49) to (%54) step (%c1_44) {
                    ...
                    scf.parallel (%arg11) = (%58) to (%63) step (%c1_52) {
                      ...
                      scf.parallel (%arg12) = (%67) to (%72) step (%c1_60) {
