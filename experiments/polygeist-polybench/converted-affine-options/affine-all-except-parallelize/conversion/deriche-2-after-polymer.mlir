...
module {
  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    call @S11(%alloca_15, %arg2, %alloca_7, %alloca_4, %alloca_21) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S13(%alloca_10, %arg2, %alloca_21) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S19(%arg5, %arg7, %arg8, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_2, %alloca_15, %arg3, %alloca_7, %alloca_5) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S27(%arg6, %arg7, %arg8, %alloca, %alloca_3, %alloca_19, %alloca_12, %alloca_18, %alloca_10, %alloca_0, %alloca_8, %alloca_9, %alloca_13) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S36(%arg5, %arg8, %arg7, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_11, %alloca_15, %arg4, %alloca_7, %alloca_16) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S44(%arg6, %arg8, %arg7, %alloca, %alloca_3, %alloca_19, %alloca_12, %alloca_20, %alloca_10, %alloca_6, %alloca_8, %alloca_14, %alloca_17) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
