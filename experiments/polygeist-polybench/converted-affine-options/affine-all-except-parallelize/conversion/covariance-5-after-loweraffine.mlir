module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    scf.for %arg6 = %c0 to %c1 step %c1_2 {
    ...
    scf.for %arg6 = %c0_4 to %c1_5 step %c1_6 {
    ...
    scf.for %arg6 = %c0_7 to %c1_8 step %c1_9 {
      %c32 = arith.constant 32 : index
      %2 = arith.muli %arg6, %c32 : index
      %c0_22 = arith.constant 0 : index
      %c1_23 = arith.constant 1 : index
    ...
    scf.for %arg6 = %c0_10 to %c1_11 step %c1_12 {
      %c128 = arith.constant 128 : index
      %2 = arith.muli %arg6, %c128 : index
      %c0_22 = arith.constant 0 : index
      %c7 = arith.constant 7 : index
    ...
    scf.for %arg6 = %c0_13 to %c1_14 step %c1_15 {
      %c32 = arith.constant 32 : index
      %2 = arith.muli %arg6, %c32 : index
      %c0_22 = arith.constant 0 : index
      %c1_23 = arith.constant 1 : index
    ...
    scf.for %arg6 = %c0_16 to %c1_17 step %c1_18 {
      %c32 = arith.constant 32 : index
      %2 = arith.muli %arg6, %c32 : index
      %c0_22 = arith.constant 0 : index
      %c1_23 = arith.constant 1 : index
