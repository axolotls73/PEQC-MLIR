...
#map7 = affine_map<(d0, d1) -> (d1 + ((d0 - 1) floordiv 4) * 4 + 1)>
#map8 = affine_map<(d0) -> ((d0 - 2) floordiv 4)>
#map9 = affine_map<(d0) -> (d0 * 4 + 39)>
#map10 = affine_map<(d0) -> (d0 - ((d0 - 2) floordiv 4) * 4 - 2)>
#map11 = affine_map<(d0, d1) -> (d1 + ((d0 - 2) floordiv 4) * 4 + 39)>
#map12 = affine_map<(d0, d1) -> (d0 + d1 * 4 + 38)>
#map13 = affine_map<(d0, d1) -> (d0 + d1 + ((d0 - 1) floordiv 4) * 4 + 38)>
    ...
    affine.for %arg3 = 0 to 39 {
      ...
      affine.for %arg4 = 0 to 1 {
        ...
        affine.if #set(%8) {
          ...
          affine.store %30, %alloca[0] : memref<1xf64>
          %31 = affine.load %arg2[0] : memref<?xf64>
          %32 = affine.load %alloca[0] : memref<1xf64>
        ...
        affine.if #set1(%8) {
          ...
          %35 = arith.addf %31, %34 : f64
          affine.store %35, %alloca_2[0] : memref<40xf64>
          %36 = affine.load %alloca[0] : memref<1xf64>
