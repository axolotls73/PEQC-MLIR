...
#map3 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 1)>
#map4 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 2 + 9)>
#map5 = affine_map<(d0, d1) -> (d0 * 32, d1 * 2 + 2)>
#map6 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 2 + 10)>
#map7 = affine_map<(d0) -> (31, d0 * 32)>
#map8 = affine_map<(d0) -> (39, d0 * 32 + 32)>
              ...
              affine.for %arg9 = 0 to 1 {
                ...
                affine.for %arg10 = max #map1(%0, %1, %2) to min #map2(%0, %1, %2) {
                  affine.if #set(%0, %arg10) {
                    affine.for %arg11 = max #map3(%1, %arg10) to min #map4(%1, %arg10) {
                      affine.for %arg12 = max #map3(%2, %arg10) to min #map4(%2, %arg10) {
                  ...
                  affine.for %arg11 = max #map5(%0, %arg10) to min #map4(%0, %arg10) {
                    ...
                    affine.for %arg12 = max #map5(%1, %arg10) to min #map4(%1, %arg10) {
                      ...
                      affine.for %arg13 = max #map5(%2, %arg10) to min #map4(%2, %arg10) {
                    ...
                    affine.if #set1(%1, %arg10) {
                      affine.for %arg12 = max #map5(%2, %arg10) to min #map6(%2, %arg10) {
                  ...
                  affine.if #set1(%0, %arg10) {
                    affine.for %arg11 = max #map5(%1, %arg10) to min #map6(%1, %arg10) {
                      affine.for %arg12 = max #map5(%2, %arg10) to min #map6(%2, %arg10) {
                ...
                affine.if #set2(%0, %1, %2) {
                  affine.for %arg10 = max #map7(%0) to min #map8(%0) {
                    affine.for %arg11 = max #map7(%1) to min #map8(%1) {
                      affine.for %arg12 = max #map7(%2) to min #map8(%2) {
