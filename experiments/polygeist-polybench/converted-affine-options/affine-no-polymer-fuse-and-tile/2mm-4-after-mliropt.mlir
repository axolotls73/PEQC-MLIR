      ...
      affine.for %arg12 = #map(%arg11) to #map1(%arg11) {
        affine.for %arg13 = 0 to 18 {
          ...
          affine.for %arg14 = 0 to 22 {
            %0 = affine.load %arg7[%arg12, %arg14] : memref<?x22xf64>
            %1 = arith.mulf %arg4, %0 : f64
            %2 = affine.load %arg8[%arg14, %arg13] : memref<?x18xf64>
            %3 = arith.mulf %1, %2 : f64
            %4 = affine.load %arg6[%arg12, %arg13] : memref<?x18xf64>
        ...
        affine.for %arg13 = 0 to 24 {
          ...
          affine.for %arg14 = 0 to 18 {
            ...
            affine.for %arg15 = 0 to 22 {
              %7 = affine.load %arg7[%arg12, %arg15] : memref<?x22xf64>
              %8 = arith.mulf %arg4, %7 : f64
              %9 = affine.load %arg8[%arg15, %arg14] : memref<?x18xf64>
            ...
            %3 = affine.load %arg9[%arg14, %arg13] : memref<?x24xf64>
            %4 = arith.mulf %2, %3 : f64
            %5 = affine.load %arg10[%arg12, %arg13] : memref<?x24xf64>
            %6 = arith.addf %5, %4 : f64
            affine.store %6, %arg10[%arg12, %arg13] : memref<?x24xf64>
          }
        }
      }
    }
