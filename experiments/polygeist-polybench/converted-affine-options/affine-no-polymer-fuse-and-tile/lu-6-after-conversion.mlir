    ...
    scf.for %arg2 = %c0 to %c40 step %c1 {
      ...
      scf.for %arg3 = %c0 to %1 step %c1 {
        scf.for %arg4 = %c0 to %arg2 step %c1 {
          %2 = memref.load %arg1[%arg2, %arg4] : memref<?x40xf64>
          %3 = arith.addi %arg2, %arg3 : index
          %4 = memref.load %arg1[%arg4, %3] : memref<?x40xf64>
          %5 = arith.mulf %2, %4 : f64
          %6 = arith.addi %arg2, %arg3 : index
          %7 = memref.load %arg1[%arg2, %6] : memref<?x40xf64>
          %8 = arith.subf %7, %5 : f64
          %9 = arith.addi %arg2, %arg3 : index
          memref.store %8, %arg1[%arg2, %9] : memref<?x40xf64>
        }
      }
    }
    return
