...
void kernel_durbin(int func_arg_0, double* func_arg_1, double* func_arg_2)
{
  ...
  for (int for_iter_27 = arith_const_12; for_iter_27 < arith_const_11; for_iter_27 += arith_const_12) {
    ...
    int arith_addi_81 = (for_iter_27 + arith_const_7); 
    for (int for_iter_82 = arith_const_8; for_iter_82 < arith_addi_81; for_iter_82 += arith_const_12) {
      int arith_addi_83 = (for_iter_82 + arith_const_6); 
      double memref_load_84 = func_arg_2[arith_addi_83]; 
      double memref_load_85 = memref_alloca_17[arith_const_13]; 
      int arith_muli_86 = (for_iter_82 * arith_const_10); 
      ...
      int arith_addi_92 = (for_iter_82 + arith_const_6); 
