...
void kernel_correlation(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
  ...
  for (int for_iter_47 = arith_const_10; for_iter_47 < arith_const_7; for_iter_47 += arith_const_9) {
    for (int for_iter_48 = arith_const_10; for_iter_48 < arith_const_8; for_iter_48 += arith_const_9) {
      double memref_load_49 = func_arg_3[for_iter_47][for_iter_48]; 
      double memref_load_50 = memref_alloca_15[arith_const_10]; 
      double memref_load_51 = func_arg_6[for_iter_48]; 
      double arith_mulf_52 = (memref_load_50 * memref_load_51); 
      double arith_divf_53 = (memref_load_49 / arith_mulf_52); 
      func_arg_3[for_iter_47][for_iter_48] = arith_divf_53; 
    }
  }
  for (int for_iter_54 = arith_const_10; for_iter_54 < arith_const_11; for_iter_54 += arith_const_9) {
    for (int for_iter_55 = arith_const_10; for_iter_55 < arith_const_7; for_iter_55 += arith_const_9) {
      ...
      for (int for_iter_57 = arith_addi_56; for_iter_57 < arith_const_8; for_iter_57 += arith_const_9) {
        double memref_load_58 = func_arg_4[for_iter_54][for_iter_57]; 
        double memref_load_59 = func_arg_3[for_iter_55][for_iter_54]; 
        double memref_load_60 = func_arg_3[for_iter_55][for_iter_57]; 
        double arith_mulf_61 = (memref_load_59 * memref_load_60); 
        double arith_addf_62 = (memref_load_58 + arith_mulf_61); 
        func_arg_4[for_iter_54][for_iter_57] = arith_addf_62; 
      }
    }
  }
