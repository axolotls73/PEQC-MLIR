module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %16, %alloca_8[%c0] : memref<1xf32>
    %17 = memref.load %alloca_8[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        %31 = memref.load %alloca_8[%c0] : memref<1xf32>
        %32 = memref.load %arg3[%arg7, %arg8] : memref<?x64xf32>
        %33 = arith.mulf %31, %32 : f32
        %34 = memref.load %alloca_17[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %32, %alloca_15[%c0] : memref<1xf32>
        %33 = arith.mulf %31, %32 : f32
        %34 = memref.load %alloca_13[%c0] : memref<1xf32>
