module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %16, %alloca_8[%c0_27] : memref<1xf32>
    %c0_28 = arith.constant 0 : index
    %17 = memref.load %alloca_8[%c0_28] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %31 = memref.load %alloca_8[%c0_54] : memref<1xf32>
        ...
        memref.store %39, %alloca_7[%c0_57] : memref<1xf32>
        ...
        %47 = memref.load %alloca_7[%c0_59] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_58 = arith.constant 0 : index
        memref.store %39, %alloca_16[%c0_58] : memref<1xf32>
        %40 = arith.mulf %38, %39 : f32
        %41 = arith.addf %37, %40 : f32
        %c0_59 = arith.constant 0 : index
        ...
        memref.store %50, %alloca_21[] : memref<f32>
        %c0_62 = arith.constant 0 : index
        %51 = memref.load %alloca_16[%c0_62] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_45 to %c64_46 step %c1_47 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_55 = arith.constant 0 : index
        memref.store %32, %alloca_15[%c0_55] : memref<1xf32>
        %33 = arith.mulf %31, %32 : f32
        %c0_56 = arith.constant 0 : index
        %34 = memref.load %alloca_13[%c0_56] : memref<1xf32>
        ...
        %c0_65 = arith.constant 0 : index
        %55 = memref.load %alloca_15[%c0_65] : memref<1xf32>
