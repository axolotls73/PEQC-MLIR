...
#map5 = affine_map<(d0) -> (-((d0 * 5 + 4) ceildiv 16) + 10)>
#map6 = affine_map<(d0, d1) -> (d1 * 32 + ((d0 * 5 + 4) ceildiv 16) * 32, d0 * 10 + 38)>
#map7 = affine_map<(d0, d1) -> (d1 * 32 + ((d0 * 5 + 4) ceildiv 16) * 32 + 31)>
          ...
          affine.for %arg8 = 0 to 2 {
            affine.if #set(%arg8) {
              affine.for %arg9 = 0 to 19 {
                affine.for %arg10 = max #map6(%arg6, %arg7) to #map7(%arg6, %arg7) {
            ...
            affine.if #set(%arg8) {
              affine.for %arg9 = max #map6(%arg6, %arg7) to #map7(%arg6, %arg7) {
                affine.if #set1(%arg9) {
