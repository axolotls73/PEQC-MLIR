...
void kernel_durbin(int func_arg_0, double* func_arg_1, double* func_arg_2)
{
  ...
  for (int for_iter_23 = arith_const_7; for_iter_23 < arith_const_6; for_iter_23 += arith_const_5) {
    ...
    for (int for_iter_26 = for_iter_23; for_iter_26 < arith_minsi_25; for_iter_26 += arith_const_4) {
      ...
      double memref_load_27 = memref_alloca_11[0]; 
      ...
      memref_alloca_11[0] = arith_addf_31; 
      double memref_load_32 = memref_alloca_14[0]; 
      double memref_load_33 = memref_alloca_13[0]; 
      ...
      memref_alloca_14[0] = arith_mulf_37; 
      ...
      if (arith_cmpi_48) {
        ...
        double memref_load_61 = memref_alloca_10[arith_const_7]; 
        memref_alloca_15[arith_const_7] = memref_load_61; 
        memref_alloca_13[0] = memref_load_61; 
      ...
      if (arith_cmpi_64) {
        ...
        double memref_load_77 = memref_alloca_10[arith_const_7]; 
        memref_alloca_15[arith_const_7] = memref_load_77; 
        memref_alloca_13[0] = memref_load_77; 
      ...
      for (int for_iter_81 = arith_const_7; for_iter_81 < arith_addi_80; for_iter_81 += arith_const_4) {
        ...
        double memref_load_84 = memref_alloca_10[arith_const_7]; 
      ...
      if (arith_cmpi_93) {
        ...
        double memref_load_95 = memref_alloca_10[arith_const_7]; 
