...
module {
  ...
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    call @S2(%alloca_2) : (memref<f64>) -> ()
    call @S5(%alloca_2, %arg1) : (memref<f64>, memref<?xf64>) -> ()
    call @S1(%alloca_3) : (memref<f64>) -> ()
    call @S4(%alloca_3) : (memref<f64>) -> ()
    ...
    affine.for %arg3 = 1 to 40 {
      ...
      func.call @S6(%alloca_3, %alloca_2) : (memref<f64>, memref<f64>) -> ()
      affine.for %arg4 = 1 to #map(%arg3) {
        func.call @S8(%alloca_0, %arg2, %arg4, %arg1, %arg3) : (memref<f64>, memref<?xf64>, index, memref<?xf64>, index) -> ()
      }
      affine.if #set(%arg3) {
        func.call @S9(%alloca, %alloca_3, %alloca_0, %arg1, %c1) : (memref<1xf64>, memref<f64>, memref<f64>, memref<?xf64>, index) -> ()
        ...
        func.call @S10(%alloca_2, %alloca, %alloca_4) : (memref<f64>, memref<1xf64>, memref<1xf64>) -> ()
        func.call @S13(%arg2, %c1, %alloca_4) : (memref<?xf64>, index, memref<1xf64>) -> ()
      }
      affine.if #set1(%arg3) {
        func.call @S9(%alloca, %alloca_3, %alloca_0, %arg1, %arg3) : (memref<1xf64>, memref<f64>, memref<f64>, memref<?xf64>, index) -> ()
