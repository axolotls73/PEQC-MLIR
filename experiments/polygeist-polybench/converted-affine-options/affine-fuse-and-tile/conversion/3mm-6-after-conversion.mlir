module {
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x18xf64>, %arg6: memref<?x20xf64>, %arg7: memref<?x18xf64>, %arg8: memref<?x22xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x22xf64>, %arg11: memref<?x22xf64>) {
    ...
    scf.for %arg12 = %c0 to %c2 step %c32 {
      scf.for %arg13 = %c0 to %c22 step %c32 {
        %0 = arith.addi %arg12, %c2 : index
        scf.for %arg14 = %arg12 to %0 step %c1 {
          %1 = arith.addi %arg13, %c22 : index
          scf.for %arg15 = %arg13 to %1 step %c1 {
    ...
    scf.for %arg12 = %c0 to %c18 step %c32 {
      scf.for %arg13 = %c0 to %c22 step %c32 {
        scf.for %arg14 = %c0 to %c24 step %c32 {
          %0 = arith.addi %arg12, %c18 : index
          scf.for %arg15 = %arg12 to %0 step %c1 {
            %1 = arith.addi %arg13, %c22 : index
            scf.for %arg16 = %arg13 to %1 step %c1 {
              %2 = arith.addi %arg14, %c24 : index
              scf.for %arg17 = %arg14 to %2 step %c1 {
                %3 = memref.load %arg8[%arg15, %arg16] : memref<?x22xf64>
                %4 = memref.load %arg9[%arg15, %arg17] : memref<?x24xf64>
                %5 = memref.load %arg10[%arg17, %arg16] : memref<?x22xf64>
                %6 = arith.mulf %4, %5 : f64
                %7 = arith.addf %3, %6 : f64
                memref.store %7, %arg8[%arg15, %arg16] : memref<?x22xf64>
              }
            }
          }
        }
        ...
        scf.if %1 {
          scf.for %arg14 = %c0 to %c16 step %c1 {
            scf.for %arg15 = %c0 to %c18 step %c1 {
              ...
              scf.for %arg16 = %c0 to %c13 step %c1 {
