  ...
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    affine.for %arg7 = 0 to 27 {
      affine.for %arg8 = 0 to #map(%arg7) {
        affine.store %cst_0, %arg4[%arg7, %arg7 + %arg8 + 1] : memref<?x28xf64>
      }
    }
    affine.for %arg7 = 0 to 27 step 32 {
      affine.for %arg8 = #map1(%arg7) to #map2(%arg7) {
    ...
    affine.for %arg7 = 0 to 28 step 32 {
      affine.for %arg8 = #map1(%arg7) to #map3(%arg7) {
        ...
        affine.for %arg9 = 0 to 32 {
          ...
          %7 = affine.load %arg3[%arg9, %arg8] : memref<?x28xf64>
        ...
        affine.for %arg9 = 0 to 32 {
          ...
          %9 = affine.load %arg3[%arg9, %arg8] : memref<?x28xf64>
          ...
          affine.store %16, %arg3[%arg9, %arg8] : memref<?x28xf64>
        }
    ...
    affine.for %arg7 = 0 to 32 step 32 {
      affine.for %arg8 = 0 to 28 step 32 {
        affine.for %arg9 = #map1(%arg7) to #map4(%arg7) {
          affine.for %arg10 = #map1(%arg8) to #map3(%arg8) {
            affine.store %cst_0, %alloc[0] : memref<1xf64>
            affine.store %cst_0, %arg5[%arg10] : memref<?xf64>
            affine.for %arg11 = 0 to 32 {
              %11 = affine.load %arg5[%arg10] : memref<?xf64>
            ...
            affine.for %arg11 = 0 to 32 {
              ...
              affine.store %12, %arg5[%arg10] : memref<?xf64>
              %13 = affine.load %alloc[0] : memref<1xf64>
              %14 = affine.load %arg3[%arg11, %arg10] : memref<?x28xf64>
              %15 = affine.load %arg5[%arg10] : memref<?xf64>
              %16 = arith.subf %14, %15 : f64
              %17 = arith.mulf %16, %16 : f64
              %18 = arith.addf %13, %17 : f64
              affine.store %18, %alloc[0] : memref<1xf64>
              %19 = affine.load %arg3[%arg11, %arg10] : memref<?x28xf64>
              %20 = affine.load %arg5[%arg10] : memref<?xf64>
              %21 = arith.subf %19, %20 : f64
              affine.store %21, %arg3[%arg11, %arg10] : memref<?x28xf64>
            }
    ...
    affine.for %arg7 = 0 to 27 {
      affine.for %arg8 = 0 to #map(%arg7) {
        affine.for %arg9 = 0 to 32 {
          %1 = affine.load %arg4[%arg7, %arg7 + %arg8 + 1] : memref<?x28xf64>
          %2 = affine.load %arg3[%arg9, %arg7] : memref<?x28xf64>
          %3 = affine.load %arg3[%arg9, %arg7 + %arg8 + 1] : memref<?x28xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = arith.addf %1, %4 : f64
          affine.store %5, %arg4[%arg7, %arg7 + %arg8 + 1] : memref<?x28xf64>
        }
      }
    }
    affine.for %arg7 = 0 to 27 {
      affine.for %arg8 = 0 to #map(%arg7) {
        %1 = affine.load %arg4[%arg7, %arg7 + %arg8 + 1] : memref<?x28xf64>
        affine.store %1, %arg4[%arg7 + %arg8 + 1, %arg7] : memref<?x28xf64>
      }
    }
    return
  }
