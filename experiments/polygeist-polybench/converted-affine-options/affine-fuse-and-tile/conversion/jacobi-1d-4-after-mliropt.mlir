...
module {
  func.func @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    ...
    affine.for %arg4 = 0 to 3 step 32 {
      affine.for %arg5 = #map(%arg4) to #map1(%arg4) {
        affine.for %arg6 = max #map2(%arg5) to min #map3(%arg5) {
          ...
          affine.for %arg7 = max #map4(%arg5, %arg6) to min #map5(%arg5, %arg6) {
            %0 = affine.load %arg2[%arg6 * -2 + %arg7 - 1] : memref<?xf64>
            %1 = affine.load %arg2[%arg6 * -2 + %arg7] : memref<?xf64>
            %2 = arith.addf %0, %1 : f64
            %3 = affine.load %arg2[%arg6 * -2 + %arg7 + 1] : memref<?xf64>
            %4 = arith.addf %2, %3 : f64
            %5 = arith.mulf %4, %cst : f64
            affine.store %5, %arg3[%arg6 * -2 + %arg7] : memref<?xf64>
            %6 = affine.load %arg3[%arg6 * -2 + %arg7 - 2] : memref<?xf64>
            %7 = affine.load %arg3[%arg6 * -2 + %arg7 - 1] : memref<?xf64>
            %8 = arith.addf %6, %7 : f64
            %9 = affine.load %arg3[%arg6 * -2 + %arg7] : memref<?xf64>
            %10 = arith.addf %8, %9 : f64
            %11 = arith.mulf %10, %cst : f64
            affine.store %11, %arg2[%arg6 * -2 + %arg7 - 1] : memref<?xf64>
          }
