    ...
    affine.for %arg3 = 0 to 39 step 32 {
      affine.for %arg4 = #map(%arg3) to min #map1(%arg3) {
        ...
        affine.if #set(%arg4) {
          ...
          affine.store %30, %alloca_3[] : memref<f64>
          %31 = affine.load %alloca_5[0] : memref<1xf64>
          affine.store %31, %arg2[1] : memref<?xf64>
        }
        affine.if #set1(%arg4) {
          %18 = affine.load %arg1[%arg4 + 1] : memref<?xf64>
          %19 = affine.load %alloca_1[] : memref<f64>
          %20 = arith.addf %18, %19 : f64
          %21 = arith.negf %20 : f64
          %22 = affine.load %alloca_4[] : memref<f64>
          ...
          affine.store %29, %alloca_3[] : memref<f64>
          %30 = affine.load %alloca_5[0] : memref<1xf64>
          affine.store %30, %arg2[%arg4 + 1] : memref<?xf64>
        }
        affine.for %arg5 = 0 to #map2(%arg4) {
          %18 = affine.load %arg2[%arg5 + 1] : memref<?xf64>
          %19 = affine.load %alloca[0] : memref<1xf64>
          %20 = affine.load %arg2[-%arg5 + %arg4 - 1] : memref<?xf64>
          %21 = arith.mulf %19, %20 : f64
          %22 = arith.addf %18, %21 : f64
          affine.store %22, %alloca_2[%arg5 + 1] : memref<40xf64>
        }
        affine.if #set1(%arg4) {
          ...
          %21 = arith.mulf %19, %20 : f64
          %22 = arith.addf %18, %21 : f64
          affine.store %22, %alloca_2[%arg4] : memref<40xf64>
          %23 = affine.load %alloca_2[0] : memref<40xf64>
          affine.store %23, %arg2[0] : memref<?xf64>
        }
        affine.for %arg5 = 0 to #map(%arg4) {
          %18 = affine.load %alloca_2[%arg5 + 1] : memref<40xf64>
          affine.store %18, %arg2[%arg5 + 1] : memref<?xf64>
        }
      }
    }
    return
