...
module {
  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    call @S11(%alloca_13, %arg2, %alloca_8, %alloca_5, %alloca_2) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S13(%alloca_11, %arg2, %alloca_2) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S12(%alloca_9, %arg2, %alloca_5) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S9(%alloca_21) : (memref<f32>) -> ()
    call @S8(%alloca_6) : (memref<f32>) -> ()
    call @S7(%alloca_1) : (memref<f32>) -> ()
    call @S6(%alloca_22) : (memref<f32>) -> ()
    affine.for %arg7 = 0 to 64 {
      func.call @S18(%alloca_21) : (memref<f32>) -> ()
      func.call @S17(%alloca_22) : (memref<f32>) -> ()
      func.call @S16(%alloca_1) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S19(%arg5, %arg7, %arg8, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_21, %alloca_13, %arg3, %alloca_8, %alloca_4) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S22(%alloca_1, %arg5, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S21(%alloca_22, %alloca_4) : (memref<f32>, memref<1xf32>) -> ()
        func.call @S20(%alloca_21, %arg3, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
      }
    }
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      func.call @S23(%alloca_20) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S27(%arg6, %arg7, %arg8, %alloca, %alloca_3, %alloca_20, %alloca_12, %alloca_18, %alloca_11, %alloca_0, %alloca_9, %alloca_10, %alloca_15) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S31(%alloca_20, %arg6, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S30(%alloca, %alloca_15) : (memref<f32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      func.call @S33(%alloca_6) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S36(%arg5, %arg8, %arg7, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_6, %alloca_13, %arg4, %alloca_8, %alloca_16) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
        ...
        func.call @S37(%alloca_6, %arg4, %arg8, %arg7) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
      }
    }
    affine.for %arg7 = 0 to 64 {
      func.call @S43(%alloca) : (memref<f32>) -> ()
      func.call @S42(%alloca_20) : (memref<f32>) -> ()
      func.call @S41(%alloca_19) : (memref<f32>) -> ()
      func.call @S40(%alloca_7) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S44(%arg6, %arg8, %arg7, %alloca, %alloca_3, %alloca_20, %alloca_12, %alloca_19, %alloca_11, %alloca_7, %alloca_9, %alloca_14, %alloca_17) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S48(%alloca_20, %arg6, %arg8, %arg7) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        ...
        func.call @S45(%alloca_19, %alloca_14) : (memref<f32>, memref<1xf32>) -> ()
      }
    }
    affine.for %arg7 = 0 to 2 {
      affine.for %arg8 = 0 to 2 {
