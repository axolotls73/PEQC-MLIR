    ...
    scf.for %arg4 = %c0 to %c3 step %c32 {
      ...
      scf.for %arg5 = %arg4 to %0 step %c1 {
        ...
        scf.for %arg6 = %3 to %6 step %c1_3 {
          ...
          %17 = arith.muli %arg5, %c32_9 : index
        ...
        %7 = arith.cmpi eq, %arg5, %c0_4 : index
        scf.if %7 {
          %c0_5 = arith.constant 0 : index
          %8 = memref.load %arg2[%c0_5] : memref<?xf64>
          %c1_6 = arith.constant 1 : index
          %9 = memref.load %arg2[%c1_6] : memref<?xf64>
          ...
          memref.store %13, %arg3[%c1_7] : memref<?xf64>
        }
      }
    }
    return
