...
#map7 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 2 + 30)>
#map8 = affine_map<(d0) -> (31, d0 * 32)>
#map9 = affine_map<(d0) -> (59, d0 * 32 + 32)>
    ...
    affine.for %arg4 = 0 to 3 {
      affine.for %arg5 = max #map(%arg4) to min #map1(%arg4) {
        affine.for %arg6 = max #map2(%arg4, %arg5) to min #map3(%arg4, %arg5) {
          ...
          affine.for %arg7 = max #map6(%arg4, %arg6) to min #map5(%arg4, %arg6) {
            ...
            affine.for %arg8 = max #map6(%arg5, %arg6) to min #map5(%arg5, %arg6) {
          ...
          affine.if #set1(%arg4, %arg6) {
            affine.for %arg7 = max #map6(%arg5, %arg6) to min #map7(%arg5, %arg6) {
        ...
        affine.if #set2(%arg4, %arg5) {
          affine.for %arg6 = max #map8(%arg4) to min #map9(%arg4) {
            affine.for %arg7 = max #map8(%arg5) to min #map9(%arg5) {
