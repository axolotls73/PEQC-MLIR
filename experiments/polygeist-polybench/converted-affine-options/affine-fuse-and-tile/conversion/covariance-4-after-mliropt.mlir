...
#map2 = affine_map<(d0) -> (d0 + 28)>
#map3 = affine_map<(d0) -> (d0 + 32)>
#map4 = affine_map<(d0) -> (0, (d0 * 16 - 13) ceildiv 13)>
#map5 = affine_map<(d0) -> ((d0 * 32 + 31) floordiv 27 + 1)>
#map6 = affine_map<(d0, d1) -> (d0 * 32, d1 * 27)>
#map7 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 26 + 28)>
module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    affine.for %arg6 = 0 to 32 step 32 {
      affine.for %arg7 = 0 to 28 step 32 {
        affine.for %arg8 = #map1(%arg6) to #map3(%arg6) {
          affine.for %arg9 = #map1(%arg7) to #map2(%arg7) {
    ...
    affine.for %arg6 = 0 to 28 {
      affine.for %arg7 = 0 to #map(%arg6) {
        affine.for %arg8 = 0 to 32 {
          %1 = affine.load %arg4[%arg6, %arg6 + %arg7] : memref<?x28xf64>
          %2 = affine.load %arg3[%arg8, %arg6] : memref<?x28xf64>
          %3 = affine.load %arg3[%arg8, %arg6 + %arg7] : memref<?x28xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = arith.addf %1, %4 : f64
          affine.store %5, %arg4[%arg6, %arg6 + %arg7] : memref<?x28xf64>
        }
      }
    }
    affine.for %arg6 = 0 to 23 {
      affine.for %arg7 = max #map4(%arg6) to #map5(%arg6) {
        affine.for %arg8 = max #map6(%arg6, %arg7) to min #map7(%arg6, %arg7) {
          %1 = affine.load %arg4[%arg7, %arg7 - %arg8 * 26] : memref<?x28xf64>
          %2 = affine.load %alloca_1[0] : memref<1xf64>
          %3 = arith.divf %1, %2 : f64
          affine.store %3, %alloca[0] : memref<1xf64>
          affine.store %3, %arg4[%arg7, %arg7 - %arg8 * 26] : memref<?x28xf64>
