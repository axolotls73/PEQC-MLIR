...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_12 = arith_const_9; for_iter_12 < arith_const_10; for_iter_12 += arith_const_11) {
    for (int for_iter_13 = arith_const_9; for_iter_13 < arith_const_8; for_iter_13 += arith_const_11) {
      int arith_muli_14 = (for_iter_13 * arith_const_7); 
      int arith_addi_15 = (arith_muli_14 + arith_const_8); 
      for (int for_iter_16 = arith_const_9; for_iter_16 < arith_addi_15; for_iter_16 += arith_const_11) {
        double memref_load_17 = func_arg_4[for_iter_13][for_iter_12]; 
        int arith_addi_18 = (for_iter_13 + for_iter_16); 
        int arith_addi_19 = (arith_addi_18 + arith_const_11); 
        double memref_load_20 = func_arg_3[arith_addi_19][for_iter_13]; 
        int arith_addi_21 = (for_iter_13 + for_iter_16); 
        int arith_addi_22 = (arith_addi_21 + arith_const_11); 
        double memref_load_23 = func_arg_4[arith_addi_22][for_iter_12]; 
        double arith_mulf_24 = (memref_load_20 * memref_load_23); 
        double arith_addf_25 = (memref_load_17 + arith_mulf_24); 
        func_arg_4[for_iter_13][for_iter_12] = arith_addf_25; 
      }
    }
  }
  for (int for_iter_26 = arith_const_9; for_iter_26 < arith_const_6; for_iter_26 += arith_const_5) {
    for (int for_iter_27 = arith_const_9; for_iter_27 < arith_const_10; for_iter_27 += arith_const_5) {
