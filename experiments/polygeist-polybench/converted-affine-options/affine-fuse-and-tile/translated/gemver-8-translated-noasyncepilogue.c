...
void kernel_gemver(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  for (int for_iter_18 = arith_const_15; for_iter_18 < arith_const_16; for_iter_18 += arith_const_17) {
    ...
    for (int for_iter_22 = arith_const_15; for_iter_22 < arith_minsi_21; for_iter_22 += arith_const_17) {
      for (int for_iter_23 = arith_const_15; for_iter_23 < arith_const_16; for_iter_23 += arith_const_17) {
        ...
        for (int for_iter_27 = arith_const_15; for_iter_27 < arith_minsi_26; for_iter_27 += arith_const_17) {
          int arith_muli_28 = (for_iter_23 * arith_const_12); 
          ...
          int arith_muli_33 = (for_iter_23 * arith_const_12); 
          int arith_addi_34 = (arith_muli_33 + for_iter_27); 
          double memref_load_35 = func_arg_4[arith_addi_34]; 
          int arith_muli_36 = (for_iter_18 * arith_const_12); 
          int arith_addi_37 = (arith_muli_36 + for_iter_22); 
          ...
          int arith_muli_41 = (for_iter_23 * arith_const_12); 
          int arith_addi_42 = (arith_muli_41 + for_iter_27); 
          double memref_load_43 = func_arg_6[arith_addi_42]; 
          int arith_muli_44 = (for_iter_18 * arith_const_12); 
          int arith_addi_45 = (arith_muli_44 + for_iter_22); 
          ...
          int arith_muli_49 = (for_iter_23 * arith_const_12); 
          int arith_addi_50 = (arith_muli_49 + for_iter_27); 
          int arith_muli_51 = (for_iter_18 * arith_const_12); 
          int arith_addi_52 = (arith_muli_51 + for_iter_22); 
          func_arg_3[arith_addi_50][arith_addi_52] = arith_addf_48; 
          int arith_muli_53 = (for_iter_18 * arith_const_12); 
          int arith_addi_54 = (arith_muli_53 + for_iter_22); 
          double memref_load_55 = func_arg_9[arith_addi_54]; 
          int arith_muli_56 = (for_iter_23 * arith_const_12); 
          int arith_addi_57 = (arith_muli_56 + for_iter_27); 
          int arith_muli_58 = (for_iter_18 * arith_const_12); 
          int arith_addi_59 = (arith_muli_58 + for_iter_22); 
          double memref_load_60 = func_arg_3[arith_addi_57][arith_addi_59]; 
          double arith_mulf_61 = (func_arg_2 * memref_load_60); 
          int arith_muli_62 = (for_iter_23 * arith_const_12); 
          int arith_addi_63 = (arith_muli_62 + for_iter_27); 
          ...
          int arith_addi_68 = (arith_muli_67 + for_iter_22); 
  ...
  for (int for_iter_83 = arith_const_15; for_iter_83 < arith_const_16; for_iter_83 += arith_const_17) {
    int arith_muli_84 = (for_iter_83 * arith_const_14); 
    int arith_addi_85 = (arith_muli_84 + arith_const_13); 
    int arith_minsi_86 = min(arith_addi_85, arith_const_12); 
    for (int for_iter_87 = arith_const_15; for_iter_87 < arith_minsi_86; for_iter_87 += arith_const_17) {
      for (int for_iter_88 = arith_const_15; for_iter_88 < arith_const_16; for_iter_88 += arith_const_17) {
        ...
        for (int for_iter_92 = arith_const_15; for_iter_92 < arith_minsi_91; for_iter_92 += arith_const_17) {
          ...
          int arith_addi_94 = (arith_muli_93 + for_iter_87); 
          double memref_load_95 = func_arg_8[arith_addi_94]; 
          int arith_muli_96 = (for_iter_83 * arith_const_12); 
          int arith_addi_97 = (arith_muli_96 + for_iter_87); 
          int arith_muli_98 = (for_iter_88 * arith_const_12); 
          ...
          int arith_muli_102 = (for_iter_88 * arith_const_12); 
