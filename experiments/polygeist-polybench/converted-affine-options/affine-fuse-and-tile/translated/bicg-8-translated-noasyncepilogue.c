...
void kernel_bicg(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6)
{
    ...
    for (int for_iter_26 = arith_const_12; for_iter_26 < arith_minsi_25; for_iter_26 += arith_const_14) {
      for (int for_iter_27 = arith_const_12; for_iter_27 < arith_const_13; for_iter_27 += arith_const_14) {
        ...
        for (int for_iter_31 = arith_const_12; for_iter_31 < arith_minsi_30; for_iter_31 += arith_const_14) {
          ...
          int arith_addi_46 = (arith_muli_45 + for_iter_26); 
  ...
  for (int for_iter_54 = arith_const_12; for_iter_54 < arith_const_13; for_iter_54 += arith_const_14) {
    ...
    int arith_minsi_57 = min(arith_addi_56, arith_const_8); 
    for (int for_iter_58 = arith_const_12; for_iter_58 < arith_minsi_57; for_iter_58 += arith_const_14) {
      for (int for_iter_59 = arith_const_12; for_iter_59 < arith_const_13; for_iter_59 += arith_const_14) {
        int arith_muli_60 = (for_iter_59 * arith_const_10); 
        int arith_addi_61 = (arith_muli_60 + arith_const_9); 
        ...
        for (int for_iter_63 = arith_const_12; for_iter_63 < arith_minsi_62; for_iter_63 += arith_const_14) {
          ...
          int arith_addi_65 = (arith_muli_64 + for_iter_58); 
          double memref_load_66 = func_arg_3[arith_addi_65]; 
          int arith_muli_67 = (for_iter_59 * arith_const_8); 
          int arith_addi_68 = (arith_muli_67 + for_iter_63); 
          double memref_load_69 = func_arg_6[arith_addi_68]; 
          int arith_muli_70 = (for_iter_59 * arith_const_8); 
          int arith_addi_71 = (arith_muli_70 + for_iter_63); 
          int arith_muli_72 = (for_iter_54 * arith_const_8); 
          int arith_addi_73 = (arith_muli_72 + for_iter_58); 
          ...
          int arith_addi_78 = (arith_muli_77 + for_iter_58); 
