...
void kernel_syrk(int func_arg_0, int func_arg_1, double func_arg_2, double func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_15 = arith_const_7; for_iter_15 < arith_const_8; for_iter_15 += arith_const_9) {
    int arith_addi_16 = (for_iter_15 + arith_const_9); 
    for (int for_iter_17 = arith_const_7; for_iter_17 < arith_addi_16; for_iter_17 += arith_const_9) {
      for (int for_iter_18 = arith_const_7; for_iter_18 < arith_const_6; for_iter_18 += arith_const_9) {
        double memref_load_19 = func_arg_4[for_iter_15][for_iter_17]; 
        double memref_load_20 = func_arg_5[for_iter_15][for_iter_18]; 
        double arith_mulf_21 = (func_arg_2 * memref_load_20); 
        double memref_load_22 = func_arg_5[for_iter_17][for_iter_18]; 
        double arith_mulf_23 = (arith_mulf_21 * memref_load_22); 
        double arith_addf_24 = (memref_load_19 + arith_mulf_23); 
        func_arg_4[for_iter_15][for_iter_17] = arith_addf_24; 
      }
    }
  }
  return; 
