...
void kernel_jacobi_1d(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3)
{
  ...
  int arith_const_8 = 2; 
  int arith_const_9 = -1; 
  int arith_const_10 = 15; 
  int arith_const_11 = 20; 
  int arith_const_12 = -14; 
  ...
  for (int for_iter_19 = arith_const_16; for_iter_19 < arith_const_17; for_iter_19 += arith_const_18) {
    int arith_addi_20 = (for_iter_19 + arith_const_17); 
    for (int for_iter_21 = for_iter_19; for_iter_21 < arith_addi_20; for_iter_21 += arith_const_14) {
      ...
      int arith_minsi_27 = min(arith_addi_26, arith_const_11); 
      for (int for_iter_28 = arith_maxsi_24; for_iter_28 < arith_minsi_27; for_iter_28 += arith_const_14) {
        int arith_cmpi_29 = (for_iter_28 < arith_const_16); 
        int arith_subi_30 = (arith_const_9 - for_iter_28); 
        int arith_select_31 = (arith_cmpi_29 ? arith_subi_30 : for_iter_28); 
        int arith_divi_32 = (arith_select_31 / arith_const_13); 
        int arith_subi_33 = (arith_const_9 - arith_divi_32); 
        int arith_select_34 = (arith_cmpi_29 ? arith_subi_33 : arith_divi_32); 
        int arith_muli_35 = (for_iter_21 * arith_const_9); 
        int arith_addi_36 = (arith_select_34 + arith_muli_35); 
        int arith_cmpi_37 = (arith_addi_36 >= arith_const_16); 
        if (arith_cmpi_37) {
          double memref_load_38 = func_arg_2[arith_const_16]; 
          double memref_load_39 = func_arg_2[arith_const_14]; 
          double arith_addf_40 = (memref_load_38 + memref_load_39); 
          double memref_load_41 = func_arg_2[arith_const_8]; 
          double arith_addf_42 = (arith_addf_40 + memref_load_41); 
          double arith_mulf_43 = (arith_addf_42 * arith_const_15); 
          func_arg_3[arith_const_14] = arith_mulf_43; 
        }
        int arith_muli_44 = (for_iter_21 * arith_const_18); 
        ...
        int arith_muli_48 = (for_iter_21 * arith_const_18); 
        int arith_addi_49 = (arith_muli_48 + arith_const_18); 
        int arith_muli_50 = (for_iter_28 * arith_const_8); 
        int arith_addi_51 = (arith_muli_50 + arith_const_7); 
        int arith_minsi_52 = min(arith_addi_49, arith_addi_51); 
        for (int for_iter_53 = arith_maxsi_47; for_iter_53 < arith_minsi_52; for_iter_53 += arith_const_14) {
          int arith_muli_54 = (for_iter_28 * arith_const_6); 
          int arith_addi_55 = (arith_muli_54 + for_iter_53); 
          int arith_addi_56 = (arith_addi_55 + arith_const_9); 
          ...
          int arith_addi_64 = (arith_addi_63 + arith_const_14); 
          ...
          int arith_addi_86 = (arith_addi_85 + arith_const_9); 
          func_arg_2[arith_addi_86] = arith_mulf_83; 
        }
        int arith_addi_87 = (for_iter_28 + arith_const_9); 
        int arith_cmpi_88 = (arith_addi_87 <= arith_const_16); 
        int arith_subi_89 = (arith_const_16 - arith_addi_87); 
        int arith_subi_90 = (arith_addi_87 - arith_const_14); 
        int arith_select_91 = (arith_cmpi_88 ? arith_subi_89 : arith_subi_90); 
        int arith_divi_92 = (arith_select_91 / arith_const_13); 
        int arith_subi_93 = (arith_const_16 - arith_divi_92); 
        int arith_addi_94 = (arith_divi_92 + arith_const_14); 
        int arith_select_95 = (arith_cmpi_88 ? arith_subi_93 : arith_addi_94); 
        int arith_muli_96 = (arith_select_95 * arith_const_9); 
