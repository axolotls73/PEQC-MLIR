  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %56 = memref.load %alloca_8[%c0_59] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_55 = arith.constant 0 : index
        memref.store %41, %alloca_6[%c0_55] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %c0_56 = arith.constant 0 : index
        %43 = memref.load %alloca_12[%c0_56] : memref<1xf32>
        %44 = memref.load %alloca_20[] : memref<f32>
        %45 = arith.mulf %43, %44 : f32
        %46 = arith.addf %42, %45 : f32
        %c0_57 = arith.constant 0 : index
        %47 = memref.load %alloca_14[%c0_57] : memref<1xf32>
        %48 = memref.load %alloca_21[] : memref<f32>
        %c0_58 = arith.constant 0 : index
        memref.store %48, %alloca_16[%c0_58] : memref<1xf32>
        %49 = arith.mulf %47, %48 : f32
        %50 = arith.addf %46, %49 : f32
        %c0_59 = arith.constant 0 : index
        %51 = memref.load %alloca_5[%c0_59] : memref<1xf32>
        ...
        memref.store %60, %alloca_25[] : memref<f32>
        ...
        %64 = memref.load %alloca_6[%c0_65] : memref<1xf32>
        memref.store %64, %alloca_20[] : memref<f32>
      }
    }
    ...
    scf.for %arg7 = %c0_40 to %c2 step %c1_41 {
      ...
      scf.for %arg8 = %c0_51 to %c2_52 step %c1_53 {
        ...
        scf.for %arg9 = %c0_54 to %c32 step %c1_55 {
          ...
          scf.for %arg10 = %c0_57 to %c32_58 step %c1_59 {
            %c32_60 = arith.constant 32 : index
            %42 = arith.muli %arg8, %c32_60 : index
            %43 = arith.addi %42, %arg10 : index
            %44 = memref.load %arg5[%41, %43] : memref<?x64xf32>
            %45 = memref.load %arg6[%41, %43] : memref<?x64xf32>
            %46 = arith.addf %44, %45 : f32
            memref.store %46, %arg4[%41, %43] : memref<?x64xf32>
          }
        }
      }
    }
    ...
    scf.for %arg7 = %c0_42 to %c64_43 step %c1_44 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        memref.store %55, %alloca_3[] : memref<f32>
        %c0_59 = arith.constant 0 : index
        %56 = memref.load %alloca_18[%c0_59] : memref<1xf32>
        memref.store %56, %alloca_24[] : memref<f32>
    ...
    scf.for %arg7 = %c0_45 to %c64_46 step %c1_47 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        %c0_54 = arith.constant 0 : index
        %40 = memref.load %alloca_11[%c0_54] : memref<1xf32>
        %41 = memref.load %alloca_9[] : memref<f32>
        %c0_55 = arith.constant 0 : index
        memref.store %41, %alloca_15[%c0_55] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %c0_56 = arith.constant 0 : index
        %43 = memref.load %alloca_12[%c0_56] : memref<1xf32>
        ...
        %48 = memref.load %alloca_21[] : memref<f32>
        %c0_58 = arith.constant 0 : index
        memref.store %48, %alloca_19[%c0_58] : memref<1xf32>
        %49 = arith.mulf %47, %48 : f32
        %50 = arith.addf %46, %49 : f32
        %c0_59 = arith.constant 0 : index
        %51 = memref.load %alloca_5[%c0_59] : memref<1xf32>
        ...
        memref.store %59, %alloca_21[] : memref<f32>
        %c0_62 = arith.constant 0 : index
        %60 = memref.load %alloca_19[%c0_62] : memref<1xf32>
        memref.store %60, %alloca_25[] : memref<f32>
        %c-1_63 = arith.constant -1 : index
        %61 = arith.muli %arg8, %c-1_63 : index
        %c63_64 = arith.constant 63 : index
        ...
        %c0_65 = arith.constant 0 : index
        %64 = memref.load %alloca_15[%c0_65] : memref<1xf32>
