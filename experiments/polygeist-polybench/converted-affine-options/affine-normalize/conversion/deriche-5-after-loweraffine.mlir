module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %17, %alloca_3[%c0_29] : memref<1xf32>
    ...
    memref.store %22, %alloca_15[%c0_31] : memref<1xf32>
    %c0_32 = arith.constant 0 : index
    %23 = memref.load %alloca_3[%c0_32] : memref<1xf32>
    %24 = arith.negf %23 : f32
    %25 = arith.mulf %arg2, %cst_2 : f32
    %26 = math.exp %25 : f32
    %27 = arith.mulf %24, %26 : f32
    %c0_33 = arith.constant 0 : index
    memref.store %27, %alloca_8[%c0_33] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %34 = memref.load %alloca_15[%c0_55] : memref<1xf32>
        ...
        memref.store %39, %alloca_6[%c0_57] : memref<1xf32>
        ...
        %47 = memref.load %alloca_6[%c0_59] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %33 = arith.mulf %31, %32 : f32
        %c0_56 = arith.constant 0 : index
        %34 = memref.load %alloca_8[%c0_56] : memref<1xf32>
        ...
        %c0_58 = arith.constant 0 : index
        memref.store %39, %alloca_17[%c0_58] : memref<1xf32>
        %40 = arith.mulf %38, %39 : f32
        %41 = arith.addf %37, %40 : f32
        %c0_59 = arith.constant 0 : index
        ...
        %51 = memref.load %alloca_17[%c0_62] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_40 to %c2 step %c1_41 {
      ...
      scf.for %arg8 = %c0_51 to %c2_52 step %c1_53 {
        ...
        scf.for %arg9 = %c0_54 to %c32 step %c1_55 {
          ...
          %31 = arith.muli %arg7, %c32_56 : index
          ...
          scf.for %arg10 = %c0_57 to %c32_58 step %c1_59 {
            ...
            %33 = arith.muli %arg8, %c32_60 : index
