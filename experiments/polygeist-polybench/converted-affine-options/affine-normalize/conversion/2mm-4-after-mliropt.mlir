#map = affine_map<(d0) -> (d0 + 18)>
#map1 = affine_map<(d0) -> (d0 + 21)>
  ...
  func.func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x18xf64>, %arg7: memref<?x22xf64>, %arg8: memref<?x18xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x24xf64>) {
    ...
    affine.for %arg11 = 0 to 16 {
      ...
      affine.for %arg12 = 0 to 6 {
        ...
        %1 = affine.load %arg10[%arg11, %0] : memref<?x24xf64>
        %2 = arith.mulf %1, %arg5 : f64
        affine.store %2, %arg10[%arg11, %0] : memref<?x24xf64>
      }
    }
        ...
        affine.for %arg12 = 0 to 16 {
          affine.for %arg13 = 0 to 18 {
            ...
            affine.for %arg14 = 0 to 11 {
              %0 = affine.apply #map1(%arg14)
              %1 = affine.load %arg10[%arg12, %0 - 21] : memref<?x24xf64>
              %2 = affine.load %arg6[%arg12, %arg13] : memref<?x18xf64>
              %3 = affine.load %arg9[%arg13, %0 - 21] : memref<?x24xf64>
              %4 = arith.mulf %2, %3 : f64
              %5 = arith.addf %1, %4 : f64
              affine.store %5, %arg10[%arg12, %0 - 21] : memref<?x24xf64>
            }
          }
        }
      }
