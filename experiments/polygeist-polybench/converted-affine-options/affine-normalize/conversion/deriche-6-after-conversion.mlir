module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %26, %alloca_11[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        %40 = memref.load %alloca_9[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %48, %alloca_17[%c0] : memref<1xf32>
        %49 = arith.mulf %47, %48 : f32
        %50 = arith.addf %46, %49 : f32
        %51 = memref.load %alloca_6[%c0] : memref<1xf32>
        ...
        %60 = memref.load %alloca_17[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %41, %alloca_16[%c0] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %43 = memref.load %alloca_11[%c0] : memref<1xf32>
        ...
        %64 = memref.load %alloca_16[%c0] : memref<1xf32>
