  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        %40 = memref.load %alloca_10[%c0] : memref<1xf32>
        ...
        %47 = memref.load %alloca_14[%c0] : memref<1xf32>
        %48 = memref.load %alloca_3[] : memref<f32>
        memref.store %48, %alloca_8[%c0] : memref<1xf32>
        ...
        %56 = memref.load %alloca_8[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %41, %alloca_6[%c0] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        ...
        memref.store %48, %alloca_16[%c0] : memref<1xf32>
        %49 = arith.mulf %47, %48 : f32
        %50 = arith.addf %46, %49 : f32
        %51 = memref.load %alloca_5[%c0] : memref<1xf32>
        ...
        %60 = memref.load %alloca_16[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %55, %alloca_3[] : memref<f32>
        %56 = memref.load %alloca_18[%c0] : memref<1xf32>
        memref.store %56, %alloca_24[] : memref<f32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c1 {
        ...
        memref.store %41, %alloca_15[%c0] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %43 = memref.load %alloca_12[%c0] : memref<1xf32>
        ...
        memref.store %59, %alloca_21[] : memref<f32>
        %60 = memref.load %alloca_19[%c0] : memref<1xf32>
        memref.store %60, %alloca_25[] : memref<f32>
        %61 = arith.muli %arg8, %c-1 : index
        %62 = arith.addi %61, %c63 : index
