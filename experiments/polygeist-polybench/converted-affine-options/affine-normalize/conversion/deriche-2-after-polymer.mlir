...
module {
  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    call @S13(%alloca_8, %arg2, %alloca) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S19(%arg5, %arg7, %arg8, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_2, %alloca_15, %arg3, %alloca_6, %alloca_5) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S22(%alloca_1, %arg5, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S21(%alloca_22, %alloca_5) : (memref<f32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S27(%arg6, %arg7, %arg8, %alloca_21, %alloca_3, %alloca_20, %alloca_12, %alloca_18, %alloca_8, %alloca_0, %alloca_9, %alloca_10, %alloca_14) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S36(%arg5, %arg8, %arg7, %alloca_22, %alloca_3, %alloca_1, %alloca_12, %alloca_11, %alloca_15, %arg4, %alloca_6, %alloca_16) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S44(%arg6, %arg8, %arg7, %alloca_21, %alloca_3, %alloca_20, %alloca_12, %alloca_19, %alloca_8, %alloca_7, %alloca_9, %alloca_13, %alloca_17) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S48(%alloca_20, %arg6, %arg8, %arg7) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S47(%alloca_21, %alloca_17) : (memref<f32>, memref<1xf32>) -> ()
