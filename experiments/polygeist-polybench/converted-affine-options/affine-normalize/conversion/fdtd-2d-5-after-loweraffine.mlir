    ...
    scf.for %arg7 = %c0 to %c2 step %c1 {
      ...
      scf.for %arg8 = %c0_1 to %c2_2 step %c1_3 {
        ...
        scf.if %0 {
          ...
          scf.for %arg9 = %5 to %c20 step %c1_7 {
            ...
            scf.if %6 {
              ...
              memref.store %17, %arg4[%c0_17, %c0_18] : memref<?x30xf64>
            }
        ...
        scf.if %2 {
          ...
          %c1_7 = arith.constant 1 : index
          scf.for %arg9 = %c0_6 to %c7 step %c1_7 {
            %c13 = arith.constant 13 : index
            %3 = arith.addi %arg9, %c13 : index
            %c0_8 = arith.constant 0 : index
            %c1_9 = arith.constant 1 : index
            %4 = arith.addi %arg9, %c1_9 : index
            %c1_10 = arith.constant 1 : index
            scf.for %arg10 = %c0_8 to %4 step %c1_10 {
              %c32 = arith.constant 32 : index
              %5 = arith.addi %arg10, %c32 : index
              %c0_11 = arith.constant 0 : index
              %6 = arith.cmpi eq, %arg7, %c0_11 : index
              scf.if %6 {
                %c-1_16 = arith.constant -1 : index
                %14 = arith.muli %5, %c-1_16 : index
                %15 = arith.addi %14, %3 : index
                %c0_17 = arith.constant 0 : index
                %16 = memref.load %arg4[%15, %c0_17] : memref<?x30xf64>
                %c-1_18 = arith.constant -1 : index
                %17 = arith.muli %5, %c-1_18 : index
                %18 = arith.addi %17, %3 : index
                %c0_19 = arith.constant 0 : index
                %19 = memref.load %arg5[%18, %c0_19] : memref<?x30xf64>
                %c-1_20 = arith.constant -1 : index
                %20 = arith.muli %5, %c-1_20 : index
                %21 = arith.addi %20, %3 : index
                %c-1_21 = arith.constant -1 : index
                %22 = arith.addi %21, %c-1_21 : index
                %c0_22 = arith.constant 0 : index
                %23 = memref.load %arg5[%22, %c0_22] : memref<?x30xf64>
                %24 = arith.subf %19, %23 : f64
                %25 = arith.mulf %24, %cst_0 : f64
                %26 = arith.subf %16, %25 : f64
                %c-1_23 = arith.constant -1 : index
                %27 = arith.muli %5, %c-1_23 : index
                %28 = arith.addi %27, %3 : index
                %c0_24 = arith.constant 0 : index
                memref.store %26, %arg4[%28, %c0_24] : memref<?x30xf64>
              }
              %c32_12 = arith.constant 32 : index
              %7 = arith.muli %arg7, %c32_12 : index
              %c14 = arith.constant 14 : index
              %8 = arith.addi %arg9, %c14 : index
              %9 = arith.maxsi %7, %8 : index
              %c32_13 = arith.constant 32 : index
              %10 = arith.muli %arg7, %c32_13 : index
              %c32_14 = arith.constant 32 : index
              %11 = arith.addi %10, %c32_14 : index
              %c43 = arith.constant 43 : index
              %12 = arith.addi %arg9, %c43 : index
              %13 = arith.minsi %11, %12 : index
              %c1_15 = arith.constant 1 : index
              scf.for %arg11 = %9 to %13 step %c1_15 {
                %c-1_16 = arith.constant -1 : index
                %14 = arith.muli %5, %c-1_16 : index
                %15 = arith.addi %14, %3 : index
                %c-1_17 = arith.constant -1 : index
                %16 = arith.muli %3, %c-1_17 : index
                %17 = arith.addi %16, %arg11 : index
                %18 = memref.load %arg4[%15, %17] : memref<?x30xf64>
                %c-1_18 = arith.constant -1 : index
                %19 = arith.muli %5, %c-1_18 : index
                %20 = arith.addi %19, %3 : index
                %c-1_19 = arith.constant -1 : index
                %21 = arith.muli %3, %c-1_19 : index
                %22 = arith.addi %21, %arg11 : index
                %23 = memref.load %arg5[%20, %22] : memref<?x30xf64>
                %c-1_20 = arith.constant -1 : index
                %24 = arith.muli %5, %c-1_20 : index
                %25 = arith.addi %24, %3 : index
                %c-1_21 = arith.constant -1 : index
                %26 = arith.addi %25, %c-1_21 : index
                %c-1_22 = arith.constant -1 : index
                %27 = arith.muli %3, %c-1_22 : index
