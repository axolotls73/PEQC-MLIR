module {
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    scf.for %arg3 = %c0_8 to %c39 step %c1 {
      ...
      %11 = memref.load %arg2[%c0_10] : memref<?xf64>
      ...
      scf.for %arg4 = %c0_11 to %arg3 step %c1_12 {
        ...
        %28 = arith.muli %26, %c-1_24 : index
        %29 = arith.addi %7, %28 : index
        %c-1_25 = arith.constant -1 : index
        %30 = arith.addi %29, %c-1_25 : index
      ...
      %20 = arith.cmpi eq, %arg3, %c0_13 : index
      scf.if %20 {
        %c1_23 = arith.constant 1 : index
      ...
      %21 = arith.addi %arg3, %c-1_15 : index
      ...
      scf.if %22 {
        ...
        memref.store %31, %alloca[%c0_23] : memref<1xf64>
        %c0_24 = arith.constant 0 : index
        %32 = memref.load %arg2[%c0_24] : memref<?xf64>
        %c0_25 = arith.constant 0 : index
        %33 = memref.load %alloca[%c0_25] : memref<1xf64>
        %c-1_26 = arith.constant -1 : index
        %34 = arith.addi %7, %c-1_26 : index
      ...
      %23 = arith.addi %arg3, %c-1_17 : index
      %c1_18 = arith.constant 1 : index
      scf.for %arg4 = %c0_16 to %23 step %c1_18 {
        %c39_23 = arith.constant 39 : index
        %26 = arith.addi %arg4, %c39_23 : index
        %c-38 = arith.constant -38 : index
        %27 = arith.addi %26, %c-38 : index
        %28 = memref.load %arg2[%27] : memref<?xf64>
        %c0_24 = arith.constant 0 : index
        %29 = memref.load %alloca[%c0_24] : memref<1xf64>
        %c-1_25 = arith.constant -1 : index
        %30 = arith.muli %26, %c-1_25 : index
