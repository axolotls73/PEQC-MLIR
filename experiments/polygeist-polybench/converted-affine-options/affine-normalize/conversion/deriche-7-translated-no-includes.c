...
void kernel_deriche(int func_arg_0, int func_arg_1, float func_arg_2, float* func_arg_3, float* func_arg_4, float* func_arg_5, float* func_arg_6)
{
  ...
  memref_alloca_26[arith_const_13] = arith_divf_57; 
  float memref_load_58 = memref_alloca_26[arith_const_13]; 
  memref_alloca_39[arith_const_13] = memref_load_58; 
  ...
  float memref_load_64 = memref_alloca_39[arith_const_13]; 
  ...
  memref_alloca_28[arith_const_13] = arith_mulf_68; 
  ...
  for (int for_iter_76 = arith_const_13; for_iter_76 < arith_const_12; for_iter_76 += arith_const_11) {
    ...
    for (int for_iter_77 = arith_const_13; for_iter_77 < arith_const_12; for_iter_77 += arith_const_11) {
      float memref_load_78 = memref_alloca_26[arith_const_13]; 
      float memref_load_79 = func_arg_3[for_iter_76][for_iter_77]; 
      float arith_mulf_80 = (memref_load_78 * memref_load_79); 
      float memref_load_81 = memref_alloca_33[arith_const_13]; 
  ...
  for (int for_iter_102 = arith_const_13; for_iter_102 < arith_const_12; for_iter_102 += arith_const_11) {
    ...
    for (int for_iter_103 = arith_const_13; for_iter_103 < arith_const_12; for_iter_103 += arith_const_11) {
      ...
      memref_alloca_22[arith_const_13] = memref_load_105; 
      float arith_mulf_106 = (memref_load_104 * memref_load_105); 
      float memref_load_107 = memref_alloca_28[arith_const_13]; 
      ...
      float memref_load_128 = memref_alloca_22[arith_const_13]; 
  ...
  for (int for_iter_140 = arith_const_13; for_iter_140 < arith_const_12; for_iter_140 += arith_const_11) {
    ...
    for (int for_iter_141 = arith_const_13; for_iter_141 < arith_const_12; for_iter_141 += arith_const_11) {
      float memref_load_142 = memref_alloca_26[arith_const_13]; 
      float memref_load_143 = func_arg_4[for_iter_141][for_iter_140]; 
      float arith_mulf_144 = (memref_load_142 * memref_load_143); 
      float memref_load_145 = memref_alloca_33[arith_const_13]; 
      float memref_load_146 = memref_alloca_29[0]; 
      float arith_mulf_147 = (memref_load_145 * memref_load_146); 
      float arith_addf_148 = (arith_mulf_144 + arith_mulf_147); 
      float memref_load_149 = memref_alloca_30[arith_const_13]; 
      float memref_load_150 = memref_alloca_19[0]; 
      memref_alloca_34[arith_const_13] = memref_load_150; 
      float arith_mulf_151 = (memref_load_149 * memref_load_150); 
      float arith_addf_152 = (arith_addf_148 + arith_mulf_151); 
      float memref_load_153 = memref_alloca_21[arith_const_13]; 
      float memref_load_154 = memref_alloca_40[0]; 
  ...
  for (int for_iter_160 = arith_const_13; for_iter_160 < arith_const_12; for_iter_160 += arith_const_11) {
    ...
    for (int for_iter_161 = arith_const_13; for_iter_161 < arith_const_12; for_iter_161 += arith_const_11) {
      ...
      float memref_load_163 = memref_alloca_25[0]; 
      memref_alloca_31[arith_const_13] = memref_load_163; 
      float arith_mulf_164 = (memref_load_162 * memref_load_163); 
      float memref_load_165 = memref_alloca_28[arith_const_13]; 
      ...
      float memref_load_169 = memref_alloca_30[arith_const_13]; 
      float memref_load_170 = memref_alloca_37[0]; 
      memref_alloca_35[arith_const_13] = memref_load_170; 
      float arith_mulf_171 = (memref_load_169 * memref_load_170); 
      float arith_addf_172 = (arith_addf_168 + arith_mulf_171); 
      float memref_load_173 = memref_alloca_21[arith_const_13]; 
      float memref_load_174 = memref_alloca_41[0]; 
      ...
      memref_alloca_37[0] = memref_load_181; 
      float memref_load_182 = memref_alloca_35[arith_const_13]; 
      memref_alloca_41[0] = memref_load_182; 
      ...
      memref_alloca_25[0] = memref_load_185; 
      float memref_load_186 = memref_alloca_31[arith_const_13]; 
