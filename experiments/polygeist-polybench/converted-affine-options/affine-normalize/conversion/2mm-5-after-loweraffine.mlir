module {
  func.func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x18xf64>, %arg7: memref<?x22xf64>, %arg8: memref<?x18xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x24xf64>) {
    ...
    scf.for %arg11 = %c0 to %c16 step %c1 {
      ...
      scf.for %arg12 = %c0_4 to %c6 step %c1_5 {
        %c18_6 = arith.constant 18 : index
        %0 = arith.addi %arg12, %c18_6 : index
      ...
      scf.if %0 {
        ...
        scf.for %arg12 = %c0_4 to %c16_5 step %c1_6 {
          ...
          scf.for %arg13 = %c0_7 to %c18 step %c1_8 {
            ...
            scf.for %arg14 = %c0_11 to %c11 step %c1_12 {
      ...
      scf.if %2 {
        ...
        scf.for %arg12 = %c0_4 to %c16_5 step %c1_6 {
          ...
          scf.for %arg13 = %c0_7 to %c18 step %c1_8 {
            ...
            %c1_10 = arith.constant 1 : index
            scf.for %arg14 = %c0_9 to %c13 step %c1_10 {
              ...
              %7 = arith.addi %3, %c-21_11 : index
              %8 = memref.load %arg9[%arg13, %7] : memref<?x24xf64>
              %9 = arith.mulf %6, %8 : f64
              %10 = arith.addf %5, %9 : f64
              %c-21_12 = arith.constant -21 : index
              %11 = arith.addi %3, %c-21_12 : index
              memref.store %10, %arg10[%arg12, %11] : memref<?x24xf64>
            }
          }
        }
