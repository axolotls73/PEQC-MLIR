            ...
            scf.for %arg5 = %c33 to %c40 step %c1_21 {
              ...
              scf.for %arg6 = %c32 to %arg5 step %c1_22 {
                ...
                scf.for %arg7 = %c1_23 to %c29 step %c4 {
                  ...
                  %54 = arith.addi %arg7, %c2_32 : index
                  %55 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_33 = arith.constant -1 : index
                  %56 = arith.addi %54, %c-1_33 : index
                  %57 = memref.load %arg1[%arg5, %56] : memref<?x40xf64>
                  %c-1_34 = arith.constant -1 : index
                  %58 = arith.addi %54, %c-1_34 : index
                  %59 = memref.load %arg1[%arg6, %58] : memref<?x40xf64>
                  %60 = arith.mulf %57, %59 : f64
                  %61 = arith.subf %55, %60 : f64
                  memref.store %61, %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c3 = arith.constant 3 : index
                  %62 = arith.addi %arg7, %c3 : index
                  %63 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_35 = arith.constant -1 : index
                  %64 = arith.addi %62, %c-1_35 : index
                  %65 = memref.load %arg1[%arg5, %64] : memref<?x40xf64>
                  %c-1_36 = arith.constant -1 : index
                  %66 = arith.addi %62, %c-1_36 : index
                  %67 = memref.load %arg1[%arg6, %66] : memref<?x40xf64>
                  %68 = arith.mulf %65, %67 : f64
                  %69 = arith.subf %63, %68 : f64
                  memref.store %69, %arg1[%arg5, %arg6] : memref<?x40xf64>
                }
                %c29_24 = arith.constant 29 : index
                %c32_25 = arith.constant 32 : index
                %c1_26 = arith.constant 1 : index
                scf.for %arg7 = %c29_24 to %c32_25 step %c1_26 {
                  %39 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_27 = arith.constant -1 : index
                  %40 = arith.addi %arg7, %c-1_27 : index
                  %41 = memref.load %arg1[%arg5, %40] : memref<?x40xf64>
          ...
          scf.if %30 {
            ...
            scf.for %arg5 = %c33 to %c40 step %c1_21 {
              ...
              scf.for %arg6 = %c1_26 to %c32 step %c1_27 {
                ...
                %c0_30 = arith.constant 0 : index
                %c-1_31 = arith.constant -1 : index
                %43 = arith.cmpi slt, %42, %c0_30 : index
                %44 = arith.subi %c-1_31, %42 : index
                %45 = arith.select %43, %44, %42 : index
                %46 = arith.divsi %45, %c4 : index
                %47 = arith.subi %c-1_31, %46 : index
                %48 = arith.select %43, %47, %46 : index
                %c4_32 = arith.constant 4 : index
                %49 = arith.muli %48, %c4_32 : index
                %c1_33 = arith.constant 1 : index
                %50 = arith.addi %49, %c1_33 : index
                %c4_34 = arith.constant 4 : index
                scf.for %arg7 = %c1_28 to %50 step %c4_34 {
                  %75 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_45 = arith.constant -1 : index
                  %76 = arith.addi %arg7, %c-1_45 : index
                  %77 = memref.load %arg1[%arg5, %76] : memref<?x40xf64>
                  %c-1_46 = arith.constant -1 : index
                  %78 = arith.addi %arg7, %c-1_46 : index
                  %79 = memref.load %arg1[%arg6, %78] : memref<?x40xf64>
                  %80 = arith.mulf %77, %79 : f64
                  %81 = arith.subf %75, %80 : f64
                  memref.store %81, %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c1_47 = arith.constant 1 : index
                  %82 = arith.addi %arg7, %c1_47 : index
                  %83 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_48 = arith.constant -1 : index
                  %84 = arith.addi %82, %c-1_48 : index
                  %85 = memref.load %arg1[%arg5, %84] : memref<?x40xf64>
                  %c-1_49 = arith.constant -1 : index
                  %86 = arith.addi %82, %c-1_49 : index
                  ...
                  %90 = arith.addi %arg7, %c2_50 : index
                  %91 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_51 = arith.constant -1 : index
                  %92 = arith.addi %90, %c-1_51 : index
                  %93 = memref.load %arg1[%arg5, %92] : memref<?x40xf64>
                  %c-1_52 = arith.constant -1 : index
                  %94 = arith.addi %90, %c-1_52 : index
                  %95 = memref.load %arg1[%arg6, %94] : memref<?x40xf64>
                  %96 = arith.mulf %93, %95 : f64
                  %97 = arith.subf %91, %96 : f64
                  memref.store %97, %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c3 = arith.constant 3 : index
                  %98 = arith.addi %arg7, %c3 : index
                  %99 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_53 = arith.constant -1 : index
                  %100 = arith.addi %98, %c-1_53 : index
                  %101 = memref.load %arg1[%arg5, %100] : memref<?x40xf64>
                  %c-1_54 = arith.constant -1 : index
                  %102 = arith.addi %98, %c-1_54 : index
                  %103 = memref.load %arg1[%arg6, %102] : memref<?x40xf64>
                  %104 = arith.mulf %101, %103 : f64
                  %105 = arith.subf %99, %104 : f64
                  memref.store %105, %arg1[%arg5, %arg6] : memref<?x40xf64>
                }
                %c-1_35 = arith.constant -1 : index
                %51 = arith.addi %arg6, %c-1_35 : index
                %c4_36 = arith.constant 4 : index
                %c0_37 = arith.constant 0 : index
                %c-1_38 = arith.constant -1 : index
                %52 = arith.cmpi slt, %51, %c0_37 : index
                %53 = arith.subi %c-1_38, %51 : index
                %54 = arith.select %52, %53, %51 : index
                %55 = arith.divsi %54, %c4_36 : index
                %56 = arith.subi %c-1_38, %55 : index
                %57 = arith.select %52, %56, %55 : index
                %c4_39 = arith.constant 4 : index
                %58 = arith.muli %57, %c4_39 : index
                %c1_40 = arith.constant 1 : index
                %59 = arith.addi %58, %c1_40 : index
                %c1_41 = arith.constant 1 : index
                scf.for %arg7 = %59 to %arg6 step %c1_41 {
                  %75 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                  %c-1_45 = arith.constant -1 : index
                  %76 = arith.addi %arg7, %c-1_45 : index
                  %77 = memref.load %arg1[%arg5, %76] : memref<?x40xf64>
                ...
                %60 = memref.load %arg1[%arg5, %arg5] : memref<?x40xf64>
                %c-1_42 = arith.constant -1 : index
                %61 = arith.addi %arg6, %c-1_42 : index
                %62 = memref.load %arg1[%arg5, %61] : memref<?x40xf64>
                %63 = arith.mulf %62, %62 : f64
                %64 = arith.subf %60, %63 : f64
                memref.store %64, %arg1[%arg5, %arg5] : memref<?x40xf64>
                %65 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                %c-1_43 = arith.constant -1 : index
                %66 = arith.addi %arg6, %c-1_43 : index
                %67 = memref.load %arg1[%arg5, %66] : memref<?x40xf64>
                %c-1_44 = arith.constant -1 : index
                %68 = arith.addi %arg6, %c-1_44 : index
                %69 = memref.load %arg1[%arg6, %68] : memref<?x40xf64>
                %70 = arith.mulf %67, %69 : f64
                %71 = arith.subf %65, %70 : f64
                memref.store %71, %arg1[%arg5, %arg6] : memref<?x40xf64>
                %72 = memref.load %arg1[%arg5, %arg6] : memref<?x40xf64>
                %73 = memref.load %arg1[%arg6, %arg6] : memref<?x40xf64>
                %74 = arith.divf %72, %73 : f64
                memref.store %74, %arg1[%arg5, %arg6] : memref<?x40xf64>
              }
            }
          }
