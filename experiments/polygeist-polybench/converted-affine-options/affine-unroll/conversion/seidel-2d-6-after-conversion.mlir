module {
  func.func @kernel_seidel_2d(%arg0: i32, %arg1: i32, %arg2: memref<?x40xf64>) {
    ...
    scf.for %arg3 = %c0 to %c2 step %c1 {
      ...
      scf.for %arg4 = %arg3 to %0 step %c1 {
        ...
        scf.for %arg5 = %3 to %6 step %c1 {
          ...
          scf.for %arg6 = %14 to %23 step %c1 {
            ...
            scf.for %arg7 = %27 to %32 step %c1 {
              %33 = arith.muli %arg6, %c-1 : index
              %34 = arith.addi %33, %arg5 : index
              %35 = arith.addi %34, %c-1 : index
              %36 = arith.muli %arg6, %c-1 : index
              ...
              %61 = arith.muli %arg6, %c-1 : index
              %62 = arith.addi %61, %arg5 : index
              %63 = arith.muli %arg6, %c-1 : index
              ...
              %87 = arith.muli %arg6, %c-1 : index
              %88 = arith.addi %87, %arg5 : index
              %89 = arith.addi %88, %c1 : index
              %90 = arith.muli %arg6, %c-1 : index
              ...
              %97 = arith.muli %arg6, %c-1 : index
              %98 = arith.addi %97, %arg5 : index
              %99 = arith.addi %98, %c1 : index
              %100 = arith.muli %arg6, %c-1 : index
              ...
              %106 = arith.muli %arg6, %c-1 : index
              %107 = arith.addi %106, %arg5 : index
              %108 = arith.addi %107, %c1 : index
              %109 = arith.muli %arg6, %c-1 : index
