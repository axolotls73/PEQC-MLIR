  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c4 {
        ...
        %42 = arith.mulf %40, %41 : f32
        %c0_55 = arith.constant 0 : index
        %43 = memref.load %alloca_14[%c0_55] : memref<1xf32>
        ...
        %68 = arith.mulf %66, %67 : f32
        %c0_68 = arith.constant 0 : index
        %69 = memref.load %alloca_14[%c0_68] : memref<1xf32>
        ...
        %95 = memref.load %alloca_14[%c0_83] : memref<1xf32>
        ...
        %121 = memref.load %alloca_14[%c0_97] : memref<1xf32>
