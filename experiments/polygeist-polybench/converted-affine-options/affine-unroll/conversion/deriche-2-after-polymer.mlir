  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S19(%arg5, %arg7, %arg8, %alloca_21, %alloca_3, %alloca_1, %alloca_12, %alloca_22, %alloca_13, %arg3, %alloca_8, %alloca_6) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    call @S0(%alloca_0) : (memref<f32>) -> ()
    affine.for %arg7 = 0 to 64 {
      func.call @S26(%alloca_18) : (memref<f32>) -> ()
      func.call @S25(%alloca) : (memref<f32>) -> ()
      func.call @S24(%alloca_0) : (memref<f32>) -> ()
      func.call @S23(%alloca_19) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S27(%arg6, %arg7, %arg8, %alloca_0, %alloca_3, %alloca_19, %alloca_12, %alloca_18, %alloca_4, %alloca, %alloca_9, %alloca_10, %alloca_15) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S31(%alloca_19, %arg6, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S30(%alloca_0, %alloca_15) : (memref<f32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      func.call @S43(%alloca_0) : (memref<f32>) -> ()
      func.call @S42(%alloca_19) : (memref<f32>) -> ()
      func.call @S41(%alloca_20) : (memref<f32>) -> ()
      func.call @S40(%alloca_7) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S44(%arg6, %arg8, %arg7, %alloca_0, %alloca_3, %alloca_19, %alloca_12, %alloca_20, %alloca_4, %alloca_7, %alloca_9, %alloca_14, %alloca_17) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S48(%alloca_19, %arg6, %arg8, %arg7) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
        func.call @S47(%alloca_0, %alloca_17) : (memref<f32>, memref<1xf32>) -> ()
