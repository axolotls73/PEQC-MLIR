module {
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x30xf64>, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>) {
    ...
    scf.for %arg5 = %c0 to %c29 step %c1 {
      ...
      scf.for %arg6 = %23 to %c30 step %c1 {
        memref.store %cst, %arg3[%arg5, %arg6] : memref<?x30xf64>
      }
    }
    ...
    scf.for %arg5 = %c0 to %c30 step %c1 {
      scf.for %arg6 = %c0 to %c2 step %c1 {
        ...
        %15 = arith.maxsi %14, %c19 : index
        %16 = arith.muli %arg6, %c32 : index
        %17 = arith.addi %16, %c32 : index
        %18 = arith.minsi %17, %c39 : index
        scf.for %arg7 = %15 to %18 step %c1 {
      ...
      scf.for %arg6 = %10 to %c10 step %c1 {
        scf.for %arg7 = %c0 to %c2 step %c1 {
          %13 = arith.cmpi eq, %arg7, %c0 : index
          scf.if %13 {
