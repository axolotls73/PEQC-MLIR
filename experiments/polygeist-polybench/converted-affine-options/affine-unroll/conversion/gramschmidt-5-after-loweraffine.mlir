module {
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x30xf64>, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>) {
    ...
    scf.for %arg5 = %c0 to %c29 step %c1 {
      ...
      %3 = arith.addi %2, %c29_3 : index
      %c4 = arith.constant 4 : index
      %c0_4 = arith.constant 0 : index
      %c-1_5 = arith.constant -1 : index
      %4 = arith.cmpi slt, %3, %c0_4 : index
      %5 = arith.subi %c-1_5, %3 : index
      %6 = arith.select %4, %5, %3 : index
      %7 = arith.divsi %6, %c4 : index
      %8 = arith.subi %c-1_5, %7 : index
      %9 = arith.select %4, %8, %7 : index
      %c4_6 = arith.constant 4 : index
      %10 = arith.muli %9, %c4_6 : index
      %11 = arith.addi %arg5, %10 : index
      %c1_7 = arith.constant 1 : index
      %12 = arith.addi %11, %c1_7 : index
      %c4_8 = arith.constant 4 : index
      scf.for %arg6 = %1 to %12 step %c4_8 {
        memref.store %cst, %arg3[%arg5, %arg6] : memref<?x30xf64>
        %c1_18 = arith.constant 1 : index
        %24 = arith.addi %arg6, %c1_18 : index
        memref.store %cst, %arg3[%arg5, %24] : memref<?x30xf64>
        %c2 = arith.constant 2 : index
        %25 = arith.addi %arg6, %c2 : index
        memref.store %cst, %arg3[%arg5, %25] : memref<?x30xf64>
        %c3 = arith.constant 3 : index
        %26 = arith.addi %arg6, %c3 : index
        memref.store %cst, %arg3[%arg5, %26] : memref<?x30xf64>
      }
      %c-1_9 = arith.constant -1 : index
      %13 = arith.muli %arg5, %c-1_9 : index
      %c29_10 = arith.constant 29 : index
      %14 = arith.addi %13, %c29_10 : index
      %c4_11 = arith.constant 4 : index
      %c0_12 = arith.constant 0 : index
      %c-1_13 = arith.constant -1 : index
      %15 = arith.cmpi slt, %14, %c0_12 : index
      %16 = arith.subi %c-1_13, %14 : index
      %17 = arith.select %15, %16, %14 : index
      %18 = arith.divsi %17, %c4_11 : index
      %19 = arith.subi %c-1_13, %18 : index
      %20 = arith.select %15, %19, %18 : index
      %c4_14 = arith.constant 4 : index
      %21 = arith.muli %20, %c4_14 : index
      %22 = arith.addi %arg5, %21 : index
      %c1_15 = arith.constant 1 : index
      %23 = arith.addi %22, %c1_15 : index
      %c30_16 = arith.constant 30 : index
      %c1_17 = arith.constant 1 : index
      scf.for %arg6 = %23 to %c30_16 step %c1_17 {
        memref.store %cst, %arg3[%arg5, %arg6] : memref<?x30xf64>
      }
    }
    ...
    scf.for %arg5 = %c0_0 to %c30 step %c1_1 {
      ...
      scf.for %arg6 = %c0_2 to %c2 step %c1_3 {
        ...
        scf.if %13 {
          ...
          scf.for %arg7 = %c0_12 to %c20 step %c4_13 {
            ...
            %36 = memref.load %arg2[%34, %arg5] : memref<?x30xf64>
        ...
        %15 = arith.maxsi %c19, %14 : index
        %c39 = arith.constant 39 : index
        %c32_8 = arith.constant 32 : index
        %16 = arith.muli %arg6, %c32_8 : index
        %c32_9 = arith.constant 32 : index
        %17 = arith.addi %16, %c32_9 : index
        %18 = arith.minsi %c39, %17 : index
        %c1_10 = arith.constant 1 : index
        scf.for %arg7 = %15 to %18 step %c1_10 {
          %c-19 = arith.constant -19 : index
          %20 = arith.addi %arg7, %c-19 : index
          %21 = memref.load %arg2[%20, %arg5] : memref<?x30xf64>
          %22 = memref.load %arg3[%arg5, %arg5] : memref<?x30xf64>
        ...
        %19 = arith.cmpi eq, %arg6, %c0_11 : index
        scf.if %19 {
      ...
      %3 = arith.cmpi sle, %2, %c0_4 : index
      %4 = arith.subi %c0_4, %2 : index
      %5 = arith.subi %2, %c1_5 : index
      %6 = arith.select %3, %4, %5 : index
      %7 = arith.divsi %6, %c16 : index
      %8 = arith.subi %c0_4, %7 : index
      %9 = arith.addi %7, %c1_5 : index
      %10 = arith.select %3, %8, %9 : index
      %c10 = arith.constant 10 : index
      %c1_6 = arith.constant 1 : index
      scf.for %arg6 = %10 to %c10 step %c1_6 {
        %c0_7 = arith.constant 0 : index
        %c2_8 = arith.constant 2 : index
        %c1_9 = arith.constant 1 : index
        scf.for %arg7 = %c0_7 to %c2_8 step %c1_9 {
          %c0_10 = arith.constant 0 : index
          %13 = arith.cmpi eq, %arg7, %c0_10 : index
          scf.if %13 {
            ...
            scf.for %arg8 = %c0_15 to %c19 step %c1_16 {
              ...
              %20 = arith.muli %arg6, %c32_17 : index
              ...
              %24 = arith.muli %arg6, %c32_19 : index
          ...
          %c0_11 = arith.constant 0 : index
          %14 = arith.cmpi eq, %arg7, %c0_11 : index
          scf.if %14 {
            %c32_15 = arith.constant 32 : index
            %20 = arith.muli %arg6, %c32_15 : index
            ...
            %23 = arith.maxsi %20, %22 : index
            %c32_17 = arith.constant 32 : index
            %24 = arith.muli %arg6, %c32_17 : index
            %c31 = arith.constant 31 : index
            %25 = arith.addi %24, %c31 : index
            %c1_18 = arith.constant 1 : index
          ...
          %17 = arith.muli %arg7, %c32_12 : index
      ...
      %12 = math.sqrt %11 : f64
      memref.store %12, %arg3[%arg5, %arg5] : memref<?x30xf64>
    }
    return
  }
}
