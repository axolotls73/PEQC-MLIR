module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %27, %alloca_9[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c4 {
        ...
        %34 = memref.load %alloca_18[%c0] : memref<1xf32>
        ...
        memref.store %39, %alloca_7[%c0] : memref<1xf32>
        ...
        %47 = memref.load %alloca_7[%c0] : memref<1xf32>
        ...
        %50 = memref.load %alloca_11[%c0] : memref<1xf32>
        %51 = memref.load %arg3[%arg7, %49] : memref<?x64xf32>
        %52 = arith.mulf %50, %51 : f32
        %53 = memref.load %alloca_18[%c0] : memref<1xf32>
        ...
        memref.store %58, %alloca_7[%c0] : memref<1xf32>
        %59 = arith.mulf %57, %58 : f32
        %60 = arith.addf %56, %59 : f32
        %61 = memref.load %alloca_6[%c0] : memref<1xf32>
        ...
        memref.store %77, %alloca_7[%c0] : memref<1xf32>
        ...
        %85 = memref.load %alloca_7[%c0] : memref<1xf32>
        ...
        %91 = memref.load %alloca_18[%c0] : memref<1xf32>
        ...
        memref.store %96, %alloca_7[%c0] : memref<1xf32>
        %97 = arith.mulf %95, %96 : f32
        %98 = arith.addf %94, %97 : f32
        %99 = memref.load %alloca_6[%c0] : memref<1xf32>
        ...
        %104 = memref.load %alloca_7[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c4 {
        %31 = memref.load %alloca_12[%c0] : memref<1xf32>
        %32 = memref.load %alloca_3[] : memref<f32>
        memref.store %32, %alloca_13[%c0] : memref<1xf32>
        %33 = arith.mulf %31, %32 : f32
        %34 = memref.load %alloca_9[%c0] : memref<1xf32>
        %35 = memref.load %alloca_21[] : memref<f32>
        %36 = arith.mulf %34, %35 : f32
        %37 = arith.addf %33, %36 : f32
        %38 = memref.load %alloca_15[%c0] : memref<1xf32>
        %39 = memref.load %alloca_23[] : memref<f32>
        memref.store %39, %alloca_16[%c0] : memref<1xf32>
        %40 = arith.mulf %38, %39 : f32
        %41 = arith.addf %37, %40 : f32
        %42 = memref.load %alloca_6[%c0] : memref<1xf32>
        ...
        %55 = memref.load %alloca_13[%c0] : memref<1xf32>
        ...
        memref.store %58, %alloca_13[%c0] : memref<1xf32>
        %59 = arith.mulf %57, %58 : f32
        %60 = memref.load %alloca_9[%c0] : memref<1xf32>
        ...
        memref.store %65, %alloca_16[%c0] : memref<1xf32>
        ...
        %77 = memref.load %alloca_16[%c0] : memref<1xf32>
        ...
        %81 = memref.load %alloca_13[%c0] : memref<1xf32>
        memref.store %81, %alloca_21[] : memref<f32>
        %82 = arith.addi %arg8, %c2 : index
        %83 = memref.load %alloca_12[%c0] : memref<1xf32>
        %84 = memref.load %alloca_3[] : memref<f32>
        memref.store %84, %alloca_13[%c0] : memref<1xf32>
        %85 = arith.mulf %83, %84 : f32
        %86 = memref.load %alloca_9[%c0] : memref<1xf32>
        %87 = memref.load %alloca_21[] : memref<f32>
        %88 = arith.mulf %86, %87 : f32
        %89 = arith.addf %85, %88 : f32
        %90 = memref.load %alloca_15[%c0] : memref<1xf32>
        %91 = memref.load %alloca_23[] : memref<f32>
        memref.store %91, %alloca_16[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c4 {
        ...
        %57 = memref.load %alloca_15[%c0] : memref<1xf32>
        %58 = memref.load %alloca_4[] : memref<f32>
        memref.store %58, %alloca_19[%c0] : memref<1xf32>
        %59 = arith.mulf %57, %58 : f32
        %60 = arith.addf %56, %59 : f32
        %61 = memref.load %alloca_6[%c0] : memref<1xf32>
        %62 = memref.load %alloca_24[] : memref<f32>
        ...
        memref.store %65, %alloca_4[] : memref<f32>
        %66 = memref.load %alloca_19[%c0] : memref<1xf32>
        memref.store %66, %alloca_24[] : memref<f32>
        ...
        %76 = memref.load %alloca_15[%c0] : memref<1xf32>
        %77 = memref.load %alloca_4[] : memref<f32>
        memref.store %77, %alloca_19[%c0] : memref<1xf32>
        %78 = arith.mulf %76, %77 : f32
        %79 = arith.addf %75, %78 : f32
        %80 = memref.load %alloca_6[%c0] : memref<1xf32>
        %81 = memref.load %alloca_24[] : memref<f32>
        ...
        memref.store %84, %alloca_4[] : memref<f32>
        %85 = memref.load %alloca_19[%c0] : memref<1xf32>
        memref.store %85, %alloca_24[] : memref<f32>
        ...
        %95 = memref.load %alloca_15[%c0] : memref<1xf32>
        %96 = memref.load %alloca_4[] : memref<f32>
        memref.store %96, %alloca_19[%c0] : memref<1xf32>
        %97 = arith.mulf %95, %96 : f32
        %98 = arith.addf %94, %97 : f32
        %99 = memref.load %alloca_6[%c0] : memref<1xf32>
        %100 = memref.load %alloca_24[] : memref<f32>
        ...
        memref.store %103, %alloca_4[] : memref<f32>
        %104 = memref.load %alloca_19[%c0] : memref<1xf32>
        memref.store %104, %alloca_24[] : memref<f32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0 to %c64 step %c4 {
        ...
        memref.store %84, %alloca_17[%c0] : memref<1xf32>
        %85 = arith.mulf %83, %84 : f32
        %86 = memref.load %alloca_9[%c0] : memref<1xf32>
        ...
        %90 = memref.load %alloca_15[%c0] : memref<1xf32>
        %91 = memref.load %alloca_23[] : memref<f32>
        memref.store %91, %alloca_20[%c0] : memref<1xf32>
        %92 = arith.mulf %90, %91 : f32
        %93 = arith.addf %89, %92 : f32
        %94 = memref.load %alloca_6[%c0] : memref<1xf32>
        %95 = memref.load %alloca_25[] : memref<f32>
        ...
        memref.store %102, %alloca_23[] : memref<f32>
        %103 = memref.load %alloca_20[%c0] : memref<1xf32>
        memref.store %103, %alloca_25[] : memref<f32>
        %104 = arith.muli %82, %c-1 : index
        %105 = arith.addi %104, %c63 : index
        %106 = memref.load %arg4[%105, %arg7] : memref<?x64xf32>
        memref.store %106, %alloca_10[] : memref<f32>
        %107 = memref.load %alloca_17[%c0] : memref<1xf32>
        ...
        %116 = memref.load %alloca_15[%c0] : memref<1xf32>
        %117 = memref.load %alloca_23[] : memref<f32>
        memref.store %117, %alloca_20[%c0] : memref<1xf32>
        %118 = arith.mulf %116, %117 : f32
        %119 = arith.addf %115, %118 : f32
        %120 = memref.load %alloca_6[%c0] : memref<1xf32>
        %121 = memref.load %alloca_25[] : memref<f32>
        ...
        memref.store %128, %alloca_23[] : memref<f32>
        %129 = memref.load %alloca_20[%c0] : memref<1xf32>
        memref.store %129, %alloca_25[] : memref<f32>
        %130 = arith.muli %108, %c-1 : index
        %131 = arith.addi %130, %c63 : index
        %132 = memref.load %arg4[%131, %arg7] : memref<?x64xf32>
        memref.store %132, %alloca_10[] : memref<f32>
        %133 = memref.load %alloca_17[%c0] : memref<1xf32>
