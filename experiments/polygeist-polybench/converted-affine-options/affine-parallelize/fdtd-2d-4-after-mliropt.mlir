      ...
      affine.for %arg8 = 0 to 2 {
        affine.if #set(%arg8) {
          affine.for %arg9 = max #map(%arg7) to 20 {
            ...
            affine.parallel (%arg10) = (max(%arg7 * 32, %arg9 + 1)) to (min(%arg7 * 32 + 32, %arg9 + 30)) {
              %0 = affine.load %arg6[%arg9] : memref<?xf64>
            ...
            affine.for %arg10 = #map1(%arg9) to min #map2(%arg9) {
              affine.if #set(%arg7) {
              ...
              affine.for %arg11 = max #map3(%arg7, %arg9) to min #map4(%arg7, %arg9) {
