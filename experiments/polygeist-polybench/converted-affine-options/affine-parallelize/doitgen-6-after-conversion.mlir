    ...
    scf.for %arg6 = %c0 to %c3 step %c1 {
      ...
      scf.for %arg7 = %10 to %20 step %c1 {
        ...
        scf.for %arg8 = %23 to %28 step %c1 {
          %29 = async.create_group %c12 : !async.group
          %30 = scf.for %arg9 = %c0 to %c12 step %c1 iter_args(%arg10 = %c0) -> (index) {
            %token = async.execute {
          ...
          scf.for %arg9 = %c0 to %c12 step %c1 {
            %33 = async.create_group %c12 : !async.group
            %34 = scf.for %arg10 = %c0 to %c12 step %c1 iter_args(%arg11 = %c0) -> (index) {
              %token = async.execute {
                %37 = memref.load %arg5[%arg10] : memref<?xf64>
                %38 = arith.muli %arg7, %c-7 : index
                %39 = arith.addi %38, %arg8 : index
                %40 = memref.load %arg3[%arg7, %39, %arg9] : memref<?x8x12xf64>
                %41 = memref.load %arg4[%arg9, %arg10] : memref<?x12xf64>
                %42 = arith.mulf %40, %41 : f64
                %43 = arith.addf %37, %42 : f64
                memref.store %43, %arg5[%arg10] : memref<?xf64>
                async.yield
              }
          ...
          %31 = async.create_group %c12 : !async.group
          %32 = scf.for %arg9 = %c0 to %c12 step %c1 iter_args(%arg10 = %c0) -> (index) {
            %token = async.execute {
              %35 = memref.load %arg5[%arg9] : memref<?xf64>
              %36 = arith.muli %arg7, %c-7 : index
              %37 = arith.addi %36, %arg8 : index
              memref.store %35, %arg3[%arg7, %37, %arg9] : memref<?x8x12xf64>
              async.yield
            }
