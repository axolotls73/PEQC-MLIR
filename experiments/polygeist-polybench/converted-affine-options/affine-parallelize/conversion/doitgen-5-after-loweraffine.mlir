    ...
    scf.for %arg6 = %c0 to %c3 step %c1 {
      ...
      scf.for %arg7 = %10 to %20 step %c1_7 {
        ...
        scf.for %arg8 = %23 to %28 step %c1_13 {
          ...
          scf.parallel (%arg9) = (%c0_14) to (%c12) step (%c1_15) {
          ...
          scf.for %arg9 = %c0_16 to %c12_17 step %c1_18 {
            ...
            scf.parallel (%arg10) = (%c0_22) to (%c12_23) step (%c1_24) {
              %29 = memref.load %arg5[%arg10] : memref<?xf64>
              %c-7_25 = arith.constant -7 : index
              %30 = arith.muli %arg7, %c-7_25 : index
          ...
          scf.parallel (%arg9) = (%c0_19) to (%c12_20) step (%c1_21) {
