module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    memref.store %26, %alloca_6[%c0_33] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_36 to %c64 step %c1 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %43 = memref.load %alloca_15[%c0_55] : memref<1xf32>
        %44 = memref.load %alloca_3[] : memref<f32>
        ...
        %52 = memref.load %alloca_23[] : memref<f32>
        ...
        memref.store %57, %alloca_3[] : memref<f32>
      }
    }
    ...
    memref.store %39, %alloca_24[] : memref<f32>
    ...
    scf.for %arg7 = %c0_37 to %c64_38 step %c1_39 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_55 = arith.constant 0 : index
        memref.store %41, %alloca_12[%c0_55] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %c0_56 = arith.constant 0 : index
        %43 = memref.load %alloca_6[%c0_56] : memref<1xf32>
        ...
        %c0_58 = arith.constant 0 : index
        memref.store %48, %alloca_17[%c0_58] : memref<1xf32>
        %49 = arith.mulf %47, %48 : f32
        %50 = arith.addf %46, %49 : f32
        %c0_59 = arith.constant 0 : index
        ...
        %60 = memref.load %alloca_17[%c0_62] : memref<1xf32>
        ...
        %64 = memref.load %alloca_12[%c0_65] : memref<1xf32>
    ...
    scf.for %arg7 = %c0_45 to %c64_46 step %c1_47 {
      ...
      scf.for %arg8 = %c0_51 to %c64_52 step %c1_53 {
        ...
        %c0_55 = arith.constant 0 : index
        memref.store %41, %alloca_16[%c0_55] : memref<1xf32>
        %42 = arith.mulf %40, %41 : f32
        %c0_56 = arith.constant 0 : index
        %43 = memref.load %alloca_6[%c0_56] : memref<1xf32>
        ...
        %c0_65 = arith.constant 0 : index
        %64 = memref.load %alloca_16[%c0_65] : memref<1xf32>
