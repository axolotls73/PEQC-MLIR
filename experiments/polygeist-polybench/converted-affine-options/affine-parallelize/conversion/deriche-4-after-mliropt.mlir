...
module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.store %17, %alloca_25[0] : memref<1xf32>
    ...
    %23 = affine.load %alloca_25[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %32, %alloca_6[0] : memref<1xf32>
        %33 = arith.mulf %31, %32 : f32
    ...
    affine.for %arg7 = 0 to 64 {
      affine.store %cst, %alloca_23[] : memref<f32>
      affine.store %cst, %alloca_3[] : memref<f32>
      affine.store %cst, %alloca_12[] : memref<f32>
      affine.for %arg8 = 0 to 64 {
        %31 = affine.load %alloca_10[0] : memref<1xf32>
        %32 = affine.load %arg4[%arg8, %arg7] : memref<?x64xf32>
        %33 = arith.mulf %31, %32 : f32
        %34 = affine.load %alloca_17[0] : memref<1xf32>
        %35 = affine.load %alloca_12[] : memref<f32>
        %36 = arith.mulf %34, %35 : f32
        %37 = arith.addf %33, %36 : f32
        %38 = affine.load %alloca_14[0] : memref<1xf32>
        %39 = affine.load %alloca_3[] : memref<f32>
        ...
        affine.store %48, %alloca_12[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to 64 {
      affine.store %cst, %alloca_24[] : memref<f32>
