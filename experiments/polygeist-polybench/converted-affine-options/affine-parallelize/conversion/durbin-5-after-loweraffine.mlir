  ...
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    scf.for %arg3 = %c1 to %c40 step %c1_8 {
      ...
      scf.if %20 {
        ...
        memref.store %34, %alloca_1[%c0_21] : memref<1xf64>
        %c0_22 = arith.constant 0 : index
        %35 = memref.load %arg2[%c0_22] : memref<?xf64>
        %c0_23 = arith.constant 0 : index
        %36 = memref.load %alloca_1[%c0_23] : memref<1xf64>
      ...
      scf.if %22 {
        ...
        memref.store %34, %alloca_1[%c0_20] : memref<1xf64>
        %c0_21 = arith.constant 0 : index
        %35 = memref.load %arg2[%c0_21] : memref<?xf64>
        %c0_22 = arith.constant 0 : index
        %36 = memref.load %alloca_1[%c0_22] : memref<1xf64>
        ...
        %c0_25 = arith.constant 0 : index
        %41 = memref.load %alloca_1[%c0_25] : memref<1xf64>
        %c0_26 = arith.constant 0 : index
      ...
      scf.if %25 {
        ...
        %30 = memref.load %arg2[%29] : memref<?xf64>
        %c0_21 = arith.constant 0 : index
        %31 = memref.load %alloca_1[%c0_21] : memref<1xf64>
        %c0_22 = arith.constant 0 : index
      ...
      scf.parallel (%arg4) = (%26) to (%28) step (%c1_19) {
        %c-1_20 = arith.constant -1 : index
