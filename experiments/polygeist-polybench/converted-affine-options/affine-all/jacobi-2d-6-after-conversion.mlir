        ...
        scf.if %20 {
          ...
          %27 = scf.for %arg6 = %22 to %25 step %c1 iter_args(%arg7 = %c0) -> (index) {
            %token = async.execute {
              ...
              %35 = async.create_group %c42 : !async.group
              %36 = scf.for %arg8 = %31 to %34 step %c1 iter_args(%arg9 = %c0) -> (index) {
                %token_0 = async.execute {
                  %39 = arith.addi %arg6, %c-30 : index
                  %40 = arith.addi %arg8, %c-30 : index
                  %41 = memref.load %arg2[%39, %40] : memref<?x30xf64>
                  %42 = arith.addi %arg6, %c-30 : index
                  %43 = arith.addi %arg8, %c-31 : index
                  %44 = memref.load %arg2[%42, %43] : memref<?x30xf64>
                  %45 = arith.addf %41, %44 : f64
                  %46 = arith.addi %arg6, %c-30 : index
                  %47 = arith.addi %arg8, %c-29 : index
                  %48 = memref.load %arg2[%46, %47] : memref<?x30xf64>
                  %49 = arith.addf %45, %48 : f64
                  %50 = arith.addi %arg6, %c-29 : index
                  %51 = arith.addi %arg8, %c-30 : index
                  %52 = memref.load %arg2[%50, %51] : memref<?x30xf64>
                  %53 = arith.addf %49, %52 : f64
                  %54 = arith.addi %arg6, %c-31 : index
                  %55 = arith.addi %arg8, %c-30 : index
                  %56 = memref.load %arg2[%54, %55] : memref<?x30xf64>
                  %57 = arith.addf %53, %56 : f64
                  %58 = arith.mulf %57, %cst : f64
                  %59 = arith.addi %arg6, %c-30 : index
                  %60 = arith.addi %arg8, %c-30 : index
                  memref.store %58, %arg3[%59, %60] : memref<?x30xf64>
                  async.yield
                }
                %37 = async.add_to_group %token_0, %35 : !async.token
                %38 = arith.addi %arg9, %c1 : index
                scf.yield %38 : index
              }
              async.await_all %35
              async.yield
