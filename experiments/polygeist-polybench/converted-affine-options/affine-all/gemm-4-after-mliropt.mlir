    ...
    affine.parallel (%arg8) = (0) to (20) {
      affine.for %arg9 = 0 to 30 {
        affine.parallel (%arg10) = (0) to (1) {
          %0 = affine.apply #map(%arg8, %arg10)
          affine.parallel (%arg11) = (0) to (1) {
            %1 = affine.apply #map(%arg9, %arg11)
            affine.parallel (%arg12) = (0) to (6) {
              %8 = affine.apply #map1(%arg12)
              %9 = affine.load %arg5[%0, %8] : memref<?x25xf64>
              %10 = affine.load %arg6[%0, %1] : memref<?x30xf64>
              %11 = arith.mulf %arg3, %10 : f64
              %12 = affine.load %arg7[%1, %8] : memref<?x25xf64>
              %13 = arith.mulf %11, %12 : f64
              %14 = arith.addf %9, %13 : f64
              affine.store %14, %arg5[%0, %8] : memref<?x25xf64>
              %15 = affine.apply #map2(%8)
              %16 = affine.load %arg5[%0, %15] : memref<?x25xf64>
              %17 = affine.load %arg6[%0, %1] : memref<?x30xf64>
              %18 = arith.mulf %arg3, %17 : f64
              %19 = affine.load %arg7[%1, %15] : memref<?x25xf64>
              %20 = arith.mulf %18, %19 : f64
              %21 = arith.addf %16, %20 : f64
              affine.store %21, %arg5[%0, %15] : memref<?x25xf64>
              %22 = affine.apply #map3(%8)
              %23 = affine.load %arg5[%0, %22] : memref<?x25xf64>
              %24 = affine.load %arg6[%0, %1] : memref<?x30xf64>
              %25 = arith.mulf %arg3, %24 : f64
              %26 = affine.load %arg7[%1, %22] : memref<?x25xf64>
              %27 = arith.mulf %25, %26 : f64
              %28 = arith.addf %23, %27 : f64
              affine.store %28, %arg5[%0, %22] : memref<?x25xf64>
              %29 = affine.apply #map4(%8)
              %30 = affine.load %arg5[%0, %29] : memref<?x25xf64>
              %31 = affine.load %arg6[%0, %1] : memref<?x30xf64>
              %32 = arith.mulf %arg3, %31 : f64
              %33 = affine.load %arg7[%1, %29] : memref<?x25xf64>
              %34 = arith.mulf %32, %33 : f64
              %35 = arith.addf %30, %34 : f64
              affine.store %35, %arg5[%0, %29] : memref<?x25xf64>
            }
            %2 = affine.load %arg5[%0, %c24] : memref<?x25xf64>
            %3 = affine.load %arg6[%0, %1] : memref<?x30xf64>
            %4 = arith.mulf %arg3, %3 : f64
            %5 = affine.load %arg7[%1, %c24] : memref<?x25xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = arith.addf %2, %6 : f64
            affine.store %7, %arg5[%0, %c24] : memref<?x25xf64>
          }
        }
      }
    }
