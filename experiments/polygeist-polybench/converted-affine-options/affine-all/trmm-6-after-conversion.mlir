      ...
      %token = async.execute {
        ...
        %5 = scf.for %arg7 = %c0 to %c1 step %c1 iter_args(%arg8 = %c0) -> (index) {
          %token_0 = async.execute {
            ...
            %9 = async.create_group %c7 : !async.group
            %10 = scf.for %arg9 = %c0 to %c7 step %c1 iter_args(%arg10 = %c0) -> (index) {
              %token_1 = async.execute {
                %15 = arith.muli %arg9, %c4 : index
                %16 = memref.load %arg4[%8, %15] : memref<?x30xf64>
                %17 = arith.mulf %arg2, %16 : f64
                memref.store %17, %arg4[%8, %15] : memref<?x30xf64>
                %18 = arith.addi %15, %c1 : index
                %19 = memref.load %arg4[%8, %18] : memref<?x30xf64>
                %20 = arith.mulf %arg2, %19 : f64
                memref.store %20, %arg4[%8, %18] : memref<?x30xf64>
                %21 = arith.addi %15, %c2 : index
                %22 = memref.load %arg4[%8, %21] : memref<?x30xf64>
                %23 = arith.mulf %arg2, %22 : f64
                memref.store %23, %arg4[%8, %21] : memref<?x30xf64>
                %24 = arith.addi %15, %c3 : index
                %25 = memref.load %arg4[%8, %24] : memref<?x30xf64>
                %26 = arith.mulf %arg2, %25 : f64
                memref.store %26, %arg4[%8, %24] : memref<?x30xf64>
                async.yield
              }
            ...
            %12 = scf.for %arg9 = %c0 to %c2 step %c1 iter_args(%arg10 = %c0) -> (index) {
              %token_1 = async.execute {
                %15 = arith.addi %arg9, %c28 : index
                %16 = memref.load %arg4[%8, %15] : memref<?x30xf64>
                %17 = arith.mulf %arg2, %16 : f64
                memref.store %17, %arg4[%8, %15] : memref<?x30xf64>
                async.yield
