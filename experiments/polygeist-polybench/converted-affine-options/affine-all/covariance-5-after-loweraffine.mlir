module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    scf.parallel (%arg6) = (%c0) to (%c28) step (%c1) {
      %c0_19 = arith.constant 0 : index
      %c1_20 = arith.constant 1 : index
      %c1_21 = arith.constant 1 : index
      scf.parallel (%arg7) = (%c0_19) to (%c1_20) step (%c1_21) {
        ...
        scf.parallel (%arg8) = (%c0_28) to (%19) step (%c1_33) {
          %c-1_34 = arith.constant -1 : index
          %20 = arith.muli %2, %c-1_34 : index
          %c4_35 = arith.constant 4 : index
          %c0_36 = arith.constant 0 : index
          %c-1_37 = arith.constant -1 : index
          %21 = arith.cmpi slt, %20, %c0_36 : index
          %22 = arith.subi %c-1_37, %20 : index
          %23 = arith.select %21, %22, %20 : index
          %24 = arith.divsi %23, %c4_35 : index
          %25 = arith.subi %c-1_37, %24 : index
          %26 = arith.select %21, %25, %24 : index
          %c4_38 = arith.constant 4 : index
          %27 = arith.muli %26, %c4_38 : index
          %28 = arith.addi %2, %27 : index
    ...
    scf.for %arg6 = %c0_5 to %c32 step %c1_6 {
      ...
      scf.for %arg7 = %c0_19 to %c7_20 step %c1_21 {
        ...
        scf.parallel (%arg8) = (%c0_22) to (%c1_23) step (%c1_24) {
    ...
    scf.parallel (%arg6) = (%c0_10) to (%c32_11) step (%c1_12) {
      %c0_19 = arith.constant 0 : index
      %c7_20 = arith.constant 7 : index
      %c1_21 = arith.constant 1 : index
      scf.for %arg7 = %c0_19 to %c7_20 step %c1_21 {
    ...
    scf.parallel (%arg6) = (%c0_13) to (%c28_14) step (%c1_15) {
      %c0_19 = arith.constant 0 : index
      ...
      scf.for %arg7 = %c0_19 to %c32_20 step %c1_21 {
        ...
        %c1_24 = arith.constant 1 : index
        scf.parallel (%arg8) = (%c0_22) to (%c1_23) step (%c1_24) {
          %2 = arith.addi %arg6, %arg8 : index
          %c0_25 = arith.constant 0 : index
          %c1_26 = arith.constant 1 : index
          %c1_27 = arith.constant 1 : index
          scf.parallel (%arg9) = (%c0_25) to (%c1_26) step (%c1_27) {
            ...
            %c-1_29 = arith.constant -1 : index
            %9 = arith.muli %arg8, %c-1_29 : index
            ...
            scf.for %arg10 = %c0_28 to %17 step %c1_33 {
              ...
              %25 = arith.muli %arg10, %c4_40 : index
              %26 = arith.addi %2, %25 : index
              %27 = memref.load %arg4[%2, %26] : memref<?x28xf64>
              %28 = memref.load %arg3[%3, %26] : memref<?x28xf64>
              %29 = arith.mulf %4, %28 : f64
              %30 = arith.addf %27, %29 : f64
              memref.store %30, %arg4[%2, %26] : memref<?x28xf64>
              %c1_41 = arith.constant 1 : index
              %31 = arith.addi %26, %c1_41 : index
              %32 = memref.load %arg4[%2, %31] : memref<?x28xf64>
              %33 = memref.load %arg3[%3, %31] : memref<?x28xf64>
              %34 = arith.mulf %5, %33 : f64
              %35 = arith.addf %32, %34 : f64
              memref.store %35, %arg4[%2, %31] : memref<?x28xf64>
              %c2 = arith.constant 2 : index
              ...
              %42 = memref.load %arg4[%2, %41] : memref<?x28xf64>
              %43 = memref.load %arg3[%3, %41] : memref<?x28xf64>
              %44 = arith.mulf %7, %43 : f64
              %45 = arith.addf %42, %44 : f64
              memref.store %45, %arg4[%2, %41] : memref<?x28xf64>
            }
            %c0_34 = arith.constant 0 : index
            %c-1_35 = arith.constant -1 : index
            %18 = arith.muli %arg6, %c-1_35 : index
            %c-1_36 = arith.constant -1 : index
            %19 = arith.muli %arg8, %c-1_36 : index
            %20 = arith.addi %18, %19 : index
            %c4_37 = arith.constant 4 : index
            %21 = arith.remsi %20, %c4_37 : index
            %c0_38 = arith.constant 0 : index
            %22 = arith.cmpi slt, %21, %c0_38 : index
            %23 = arith.addi %21, %c4_37 : index
            %24 = arith.select %22, %23, %21 : index
            %c1_39 = arith.constant 1 : index
            scf.parallel (%arg10) = (%c0_34) to (%24) step (%c1_39) {
              %c-1_40 = arith.constant -1 : index
              %25 = arith.muli %2, %c-1_40 : index
              %c4_41 = arith.constant 4 : index
              %c0_42 = arith.constant 0 : index
              %c-1_43 = arith.constant -1 : index
              %26 = arith.cmpi slt, %25, %c0_42 : index
              %27 = arith.subi %c-1_43, %25 : index
              %28 = arith.select %26, %27, %25 : index
              %29 = arith.divsi %28, %c4_41 : index
              %30 = arith.subi %c-1_43, %29 : index
              %31 = arith.select %26, %30, %29 : index
              %c4_44 = arith.constant 4 : index
              %32 = arith.muli %31, %c4_44 : index
              %33 = arith.addi %2, %32 : index
              %34 = arith.addi %33, %arg10 : index
              %c28_45 = arith.constant 28 : index
              %35 = arith.addi %34, %c28_45 : index
              %36 = memref.load %arg4[%2, %35] : memref<?x28xf64>
              %37 = memref.load %arg3[%3, %2] : memref<?x28xf64>
              %38 = memref.load %arg3[%3, %35] : memref<?x28xf64>
              %39 = arith.mulf %37, %38 : f64
              %40 = arith.addf %36, %39 : f64
              memref.store %40, %arg4[%2, %35] : memref<?x28xf64>
              scf.reduce 
            }
            scf.reduce 
          }
