...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_65 = arith_const_12; for_iter_65 < arith_const_5; for_iter_65 += arith_const_14) {
    ...
    #pragma peqc async_execute
    {
      ...
      for (int for_iter_70 = arith_const_12; for_iter_70 < arith_const_14; for_iter_70 += arith_const_14) {
        PAST_NEW_SEMAPHORE(execute_token_72); 
        #pragma peqc async_execute
        {
          int arith_addi_73 = (for_iter_65 + for_iter_70); 
          int* async_group_74; 
          int async_group_index_75 = 0; 
          int for_iter_arg_77 = arith_const_12; 
          for (int for_iter_76 = arith_const_12; for_iter_76 < arith_const_10; for_iter_76 += arith_const_14) {
            PAST_NEW_SEMAPHORE(execute_token_78); 
            #pragma peqc async_execute
            {
              int arith_muli_79 = (for_iter_76 * arith_const_9); 
              double memref_load_80 = func_arg_4[arith_addi_73][arith_muli_79]; 
              double arith_mulf_81 = (func_arg_2 * memref_load_80); 
              func_arg_4[arith_addi_73][arith_muli_79] = arith_mulf_81; 
              int arith_addi_82 = (arith_muli_79 + arith_const_14); 
              double memref_load_83 = func_arg_4[arith_addi_73][arith_addi_82]; 
              double arith_mulf_84 = (func_arg_2 * memref_load_83); 
              func_arg_4[arith_addi_73][arith_addi_82] = arith_mulf_84; 
              int arith_addi_85 = (arith_muli_79 + arith_const_8); 
              double memref_load_86 = func_arg_4[arith_addi_73][arith_addi_85]; 
              double arith_mulf_87 = (func_arg_2 * memref_load_86); 
              func_arg_4[arith_addi_73][arith_addi_85] = arith_mulf_87; 
              int arith_addi_88 = (arith_muli_79 + arith_const_7); 
              double memref_load_89 = func_arg_4[arith_addi_73][arith_addi_88]; 
              double arith_mulf_90 = (func_arg_2 * memref_load_89); 
              func_arg_4[arith_addi_73][arith_addi_88] = arith_mulf_90; 
            ...
            int arith_addi_91 = (for_iter_arg_77 + arith_const_14); 
            for_iter_arg_77 = arith_addi_91; 
          }
          PAST_WAIT_SEMAPHORE_ALL(async_group_74, async_group_index_75, PAST_TASK_FINISHED); 
          int* async_group_92; 
          int async_group_index_93 = 0; 
          int for_iter_arg_95 = arith_const_12; 
          for (int for_iter_94 = arith_const_12; for_iter_94 < arith_const_8; for_iter_94 += arith_const_14) {
            PAST_NEW_SEMAPHORE(execute_token_96); 
            #pragma peqc async_execute
            {
              int arith_addi_97 = (for_iter_94 + arith_const_6); 
              double memref_load_98 = func_arg_4[arith_addi_73][arith_addi_97]; 
              double arith_mulf_99 = (func_arg_2 * memref_load_98); 
              func_arg_4[arith_addi_73][arith_addi_97] = arith_mulf_99; 
            ...
            int arith_addi_100 = (for_iter_arg_95 + arith_const_14); 
            for_iter_arg_95 = arith_addi_100; 
          }
        ...
        int arith_addi_101 = (for_iter_arg_71 + arith_const_14); 
    ...
    int arith_addi_102 = (for_iter_arg_66 + arith_const_14); 
    for_iter_arg_66 = arith_addi_102; 
  }
