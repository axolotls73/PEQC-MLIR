module {
  func.func @kernel_bicg(%arg0: i32, %arg1: i32, %arg2: memref<?x38xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
    ...
    scf.parallel (%arg7) = (%c0_0) to (%c2_1) step (%c1_2) {
      ...
      scf.for %arg8 = %c0_9 to %c2_10 step %c1_11 {
        ...
        scf.parallel (%arg9) = (%0) to (%3) step (%c1_14) {
          %c0_15 = arith.constant 0 : index
          %c-32 = arith.constant -32 : index
          %4 = arith.muli %arg8, %c-32 : index
          %c38 = arith.constant 38 : index
          %5 = arith.addi %4, %c38 : index
          %c32_16 = arith.constant 32 : index
          %6 = arith.minsi %5, %c32_16 : index
          %c1_17 = arith.constant 1 : index
          scf.for %arg10 = %c0_15 to %6 step %c1_17 {
            %c32_18 = arith.constant 32 : index
            %7 = arith.muli %arg8, %c32_18 : index
            %8 = arith.addi %7, %arg10 : index
            %9 = memref.load %arg4[%arg9] : memref<?xf64>
            %10 = memref.load %arg2[%arg9, %8] : memref<?x38xf64>
    ...
    scf.parallel (%arg7) = (%c0_3) to (%c2_4) step (%c1_5) {
      %c32 = arith.constant 32 : index
      %0 = arith.muli %arg7, %c32 : index
      %c38 = arith.constant 38 : index
      %c32_9 = arith.constant 32 : index
    ...
    scf.parallel (%arg7) = (%c0_6) to (%c2_7) step (%c1_8) {
      %c0_9 = arith.constant 0 : index
      %c2_10 = arith.constant 2 : index
      %c1_11 = arith.constant 1 : index
      scf.for %arg8 = %c0_9 to %c2_10 step %c1_11 {
        ...
        scf.for %arg9 = %c0_12 to %2 step %c1_13 {
          ...
          %5 = arith.muli %arg7, %c32_15 : index
          %c38 = arith.constant 38 : index
          %c32_16 = arith.constant 32 : index
          %6 = arith.muli %arg7, %c32_16 : index
          %c32_17 = arith.constant 32 : index
          %7 = arith.addi %6, %c32_17 : index
          %8 = arith.minsi %c38, %7 : index
          %c1_18 = arith.constant 1 : index
          scf.parallel (%arg10) = (%5) to (%8) step (%c1_18) {
            %9 = memref.load %arg3[%arg10] : memref<?xf64>
            %10 = memref.load %arg6[%4] : memref<?xf64>
            %11 = memref.load %arg2[%4, %arg10] : memref<?x38xf64>
            %12 = arith.mulf %10, %11 : f64
            %13 = arith.addf %9, %12 : f64
            memref.store %13, %arg3[%arg10] : memref<?xf64>
            scf.reduce 
          }
        }
      }
