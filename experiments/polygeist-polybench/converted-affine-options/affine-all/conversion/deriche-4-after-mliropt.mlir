...
module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    %34 = affine.load %alloca_11[0] : memref<1xf32>
    %35 = affine.load %alloca_18[0] : memref<1xf32>
    %36 = affine.load %alloca_15[0] : memref<1xf32>
    %37 = affine.load %alloca_6[0] : memref<1xf32>
    %38 = affine.load %alloca_11[0] : memref<1xf32>
    %39 = affine.load %alloca_18[0] : memref<1xf32>
    %40 = affine.load %alloca_15[0] : memref<1xf32>
    %41 = affine.load %alloca_6[0] : memref<1xf32>
    %42 = affine.load %alloca_11[0] : memref<1xf32>
    %43 = affine.load %alloca_18[0] : memref<1xf32>
    %44 = affine.load %alloca_15[0] : memref<1xf32>
    %45 = affine.load %alloca_6[0] : memref<1xf32>
    %46 = affine.load %alloca_11[0] : memref<1xf32>
    %47 = affine.load %alloca_18[0] : memref<1xf32>
    %48 = affine.load %alloca_15[0] : memref<1xf32>
    %49 = affine.load %alloca_6[0] : memref<1xf32>
    affine.for %arg7 = 0 to 2 {
      ...
      affine.for %arg8 = 0 to 32 {
        ...
        affine.for %arg9 = 0 to 16 {
          ...
          %112 = affine.load %alloca_25[] : memref<f32>
          affine.store %112, %alloca_9[0] : memref<1xf32>
          ...
          %119 = affine.load %alloca_9[0] : memref<1xf32>
          ...
          %127 = affine.load %alloca_25[] : memref<f32>
          affine.store %127, %alloca_9[0] : memref<1xf32>
          ...
          affine.store %133, %alloca_25[] : memref<f32>
          %134 = affine.load %alloca_9[0] : memref<1xf32>
          ...
          %142 = affine.load %alloca_25[] : memref<f32>
          affine.store %142, %alloca_9[0] : memref<1xf32>
          ...
          affine.store %148, %alloca_25[] : memref<f32>
          %149 = affine.load %alloca_9[0] : memref<1xf32>
          ...
          %157 = affine.load %alloca_25[] : memref<f32>
          affine.store %157, %alloca_9[0] : memref<1xf32>
          ...
          affine.store %163, %alloca_25[] : memref<f32>
          %164 = affine.load %alloca_9[0] : memref<1xf32>
    ...
    affine.store %51, %alloca_21[] : memref<f32>
    %52 = llvm.mlir.undef : f32
    affine.store %52, %alloca_10[] : memref<f32>
    %53 = llvm.mlir.undef : f32
    affine.store %53, %alloca_22[] : memref<f32>
    %54 = llvm.mlir.undef : f32
    affine.store %54, %alloca_23[] : memref<f32>
    %55 = llvm.mlir.undef : f32
    affine.store %55, %alloca[] : memref<f32>
    %56 = affine.load %alloca_12[0] : memref<1xf32>
    %57 = affine.load %alloca_13[0] : memref<1xf32>
    %58 = affine.load %alloca_15[0] : memref<1xf32>
    %59 = affine.load %alloca_6[0] : memref<1xf32>
    %60 = affine.load %alloca_12[0] : memref<1xf32>
    %61 = affine.load %alloca_13[0] : memref<1xf32>
    %62 = affine.load %alloca_15[0] : memref<1xf32>
    %63 = affine.load %alloca_6[0] : memref<1xf32>
    %64 = affine.load %alloca_12[0] : memref<1xf32>
    %65 = affine.load %alloca_13[0] : memref<1xf32>
    %66 = affine.load %alloca_15[0] : memref<1xf32>
    %67 = affine.load %alloca_6[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 2 {
      ...
      affine.for %arg8 = 0 to 32 {
        ...
        affine.for %arg9 = 0 to 16 {
          ...
          affine.store %134, %alloca_23[] : memref<f32>
          %135 = affine.load %alloca_17[0] : memref<1xf32>
          affine.store %135, %alloca[] : memref<f32>
          %136 = affine.load %arg3[%105, -%122 + 63] : memref<?x64xf32>
          affine.store %136, %alloca_3[] : memref<f32>
          %137 = affine.load %alloca_7[0] : memref<1xf32>
          affine.store %137, %alloca_21[] : memref<f32>
          %138 = affine.apply #map4(%106)
          %139 = affine.load %alloca_3[] : memref<f32>
          affine.store %139, %alloca_7[0] : memref<1xf32>
          ...
          %147 = affine.load %alloca[] : memref<f32>
          ...
          affine.store %166, %alloca_23[] : memref<f32>
          %167 = affine.load %alloca_17[0] : memref<1xf32>
          affine.store %167, %alloca[] : memref<f32>
          %168 = affine.load %arg3[%105, -%154 + 63] : memref<?x64xf32>
          affine.store %168, %alloca_3[] : memref<f32>
          %169 = affine.load %alloca_7[0] : memref<1xf32>
    ...
    affine.parallel (%arg7) = (0) to (2) {
      affine.for %arg8 = 0 to 2 {
        affine.for %arg9 = 0 to 32 {
          %104 = affine.apply #map6(%arg7, %arg9)
          affine.for %arg10 = 0 to 8 {
            %105 = affine.apply #map7(%arg8, %arg10)
    ...
    %72 = affine.load %alloca_11[0] : memref<1xf32>
    %73 = affine.load %alloca_18[0] : memref<1xf32>
    %74 = affine.load %alloca_15[0] : memref<1xf32>
    %75 = affine.load %alloca_6[0] : memref<1xf32>
    %76 = affine.load %alloca_11[0] : memref<1xf32>
    %77 = affine.load %alloca_18[0] : memref<1xf32>
    %78 = affine.load %alloca_15[0] : memref<1xf32>
    %79 = affine.load %alloca_6[0] : memref<1xf32>
    %80 = affine.load %alloca_11[0] : memref<1xf32>
    %81 = affine.load %alloca_18[0] : memref<1xf32>
    %82 = affine.load %alloca_15[0] : memref<1xf32>
    %83 = affine.load %alloca_6[0] : memref<1xf32>
    %84 = affine.load %alloca_11[0] : memref<1xf32>
    %85 = affine.load %alloca_18[0] : memref<1xf32>
    %86 = affine.load %alloca_15[0] : memref<1xf32>
    %87 = affine.load %alloca_6[0] : memref<1xf32>
    affine.for %arg7 = 0 to 2 {
      %104 = affine.apply #map(%arg7)
      affine.for %arg8 = 0 to 32 {
        %105 = affine.apply #map1(%104, %arg8)
        ...
        affine.for %arg9 = 0 to 16 {
          ...
          %109 = affine.load %alloca_14[] : memref<f32>
          ...
          affine.store %120, %alloca_14[] : memref<f32>
          %121 = affine.apply #map3(%106)
          %122 = affine.load %arg4[%121, %105] : memref<?x64xf32>
          %123 = arith.mulf %76, %122 : f32
          %124 = affine.load %alloca_14[] : memref<f32>
          ...
          affine.store %135, %alloca_14[] : memref<f32>
          %136 = affine.apply #map4(%106)
          %137 = affine.load %arg4[%136, %105] : memref<?x64xf32>
          %138 = arith.mulf %80, %137 : f32
          %139 = affine.load %alloca_14[] : memref<f32>
          %140 = arith.mulf %81, %139 : f32
          %141 = arith.addf %138, %140 : f32
          %142 = affine.load %alloca_25[] : memref<f32>
          affine.store %142, %alloca_19[0] : memref<1xf32>
          ...
          affine.store %148, %alloca_25[] : memref<f32>
          %149 = affine.load %alloca_19[0] : memref<1xf32>
          affine.store %149, %alloca_24[] : memref<f32>
          %150 = affine.load %arg4[%136, %105] : memref<?x64xf32>
          affine.store %150, %alloca_14[] : memref<f32>
          %151 = affine.apply #map5(%106)
          %152 = affine.load %arg4[%151, %105] : memref<?x64xf32>
          %153 = arith.mulf %84, %152 : f32
          %154 = affine.load %alloca_14[] : memref<f32>
          %155 = arith.mulf %85, %154 : f32
          %156 = arith.addf %153, %155 : f32
          %157 = affine.load %alloca_25[] : memref<f32>
          affine.store %157, %alloca_19[0] : memref<1xf32>
          ...
          affine.store %163, %alloca_25[] : memref<f32>
          %164 = affine.load %alloca_19[0] : memref<1xf32>
          affine.store %164, %alloca_24[] : memref<f32>
          %165 = affine.load %arg4[%151, %105] : memref<?x64xf32>
          affine.store %165, %alloca_14[] : memref<f32>
        }
      }
    }
    %88 = affine.load %alloca_12[0] : memref<1xf32>
    %89 = affine.load %alloca_13[0] : memref<1xf32>
    %90 = affine.load %alloca_15[0] : memref<1xf32>
    %91 = affine.load %alloca_6[0] : memref<1xf32>
    %92 = affine.load %alloca_12[0] : memref<1xf32>
    %93 = affine.load %alloca_13[0] : memref<1xf32>
    %94 = affine.load %alloca_15[0] : memref<1xf32>
    %95 = affine.load %alloca_6[0] : memref<1xf32>
    %96 = affine.load %alloca_12[0] : memref<1xf32>
    %97 = affine.load %alloca_13[0] : memref<1xf32>
    %98 = affine.load %alloca_15[0] : memref<1xf32>
    %99 = affine.load %alloca_6[0] : memref<1xf32>
    %100 = affine.load %alloca_12[0] : memref<1xf32>
    %101 = affine.load %alloca_13[0] : memref<1xf32>
    %102 = affine.load %alloca_15[0] : memref<1xf32>
    %103 = affine.load %alloca_6[0] : memref<1xf32>
    affine.for %arg7 = 0 to 2 {
      %104 = affine.apply #map(%arg7)
      affine.for %arg8 = 0 to 32 {
        %105 = affine.apply #map1(%104, %arg8)
        ...
        affine.for %arg9 = 0 to 16 {
          %106 = affine.apply #map2(%arg9)
          %107 = affine.load %alloca_10[] : memref<f32>
          affine.store %107, %alloca_16[0] : memref<1xf32>
          %108 = arith.mulf %88, %107 : f32
          %109 = affine.load %alloca_22[] : memref<f32>
          %110 = arith.mulf %89, %109 : f32
          %111 = arith.addf %108, %110 : f32
          %112 = affine.load %alloca_23[] : memref<f32>
          affine.store %112, %alloca_20[0] : memref<1xf32>
          ...
          affine.store %118, %alloca_23[] : memref<f32>
          %119 = affine.load %alloca_20[0] : memref<1xf32>
          affine.store %119, %alloca[] : memref<f32>
          %120 = affine.load %arg4[-%106 + 63, %105] : memref<?x64xf32>
          affine.store %120, %alloca_10[] : memref<f32>
          %121 = affine.load %alloca_16[0] : memref<1xf32>
          affine.store %121, %alloca_22[] : memref<f32>
          %122 = affine.apply #map3(%106)
          %123 = affine.load %alloca_10[] : memref<f32>
          affine.store %123, %alloca_16[0] : memref<1xf32>
          %124 = arith.mulf %92, %123 : f32
          %125 = affine.load %alloca_22[] : memref<f32>
          %126 = arith.mulf %93, %125 : f32
          %127 = arith.addf %124, %126 : f32
          %128 = affine.load %alloca_23[] : memref<f32>
          affine.store %128, %alloca_20[0] : memref<1xf32>
          ...
          affine.store %134, %alloca_23[] : memref<f32>
          %135 = affine.load %alloca_20[0] : memref<1xf32>
          affine.store %135, %alloca[] : memref<f32>
          %136 = affine.load %arg4[-%122 + 63, %105] : memref<?x64xf32>
          affine.store %136, %alloca_10[] : memref<f32>
          %137 = affine.load %alloca_16[0] : memref<1xf32>
          affine.store %137, %alloca_22[] : memref<f32>
          %138 = affine.apply #map4(%106)
          %139 = affine.load %alloca_10[] : memref<f32>
          affine.store %139, %alloca_16[0] : memref<1xf32>
          %140 = arith.mulf %96, %139 : f32
          %141 = affine.load %alloca_22[] : memref<f32>
          %142 = arith.mulf %97, %141 : f32
          %143 = arith.addf %140, %142 : f32
          %144 = affine.load %alloca_23[] : memref<f32>
          affine.store %144, %alloca_20[0] : memref<1xf32>
          ...
          affine.store %150, %alloca_23[] : memref<f32>
          %151 = affine.load %alloca_20[0] : memref<1xf32>
          affine.store %151, %alloca[] : memref<f32>
          %152 = affine.load %arg4[-%138 + 63, %105] : memref<?x64xf32>
          affine.store %152, %alloca_10[] : memref<f32>
          %153 = affine.load %alloca_16[0] : memref<1xf32>
          affine.store %153, %alloca_22[] : memref<f32>
          %154 = affine.apply #map5(%106)
          %155 = affine.load %alloca_10[] : memref<f32>
          affine.store %155, %alloca_16[0] : memref<1xf32>
          %156 = arith.mulf %100, %155 : f32
          %157 = affine.load %alloca_22[] : memref<f32>
          %158 = arith.mulf %101, %157 : f32
          %159 = arith.addf %156, %158 : f32
          %160 = affine.load %alloca_23[] : memref<f32>
          affine.store %160, %alloca_20[0] : memref<1xf32>
          ...
          affine.store %166, %alloca_23[] : memref<f32>
          %167 = affine.load %alloca_20[0] : memref<1xf32>
          affine.store %167, %alloca[] : memref<f32>
          %168 = affine.load %arg4[-%154 + 63, %105] : memref<?x64xf32>
          affine.store %168, %alloca_10[] : memref<f32>
          %169 = affine.load %alloca_16[0] : memref<1xf32>
          affine.store %169, %alloca_22[] : memref<f32>
        }
      }
    }
    affine.parallel (%arg7) = (0) to (2) {
