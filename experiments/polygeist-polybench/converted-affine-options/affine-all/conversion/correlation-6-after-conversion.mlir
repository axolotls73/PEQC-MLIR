module {
  func.func @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) {
      ...
      %token = async.execute {
        scf.for %arg9 = %c0 to %c1 step %c1 {
          ...
          scf.for %arg10 = %c0 to %21 step %c1 {
            %38 = arith.muli %arg10, %c4 : index
            %39 = arith.addi %11, %38 : index
            %40 = arith.addi %39, %c1 : index
            memref.store %cst_0, %arg4[%11, %40] : memref<?x28xf64>
            %41 = arith.addi %40, %c1 : index
            memref.store %cst_0, %arg4[%11, %41] : memref<?x28xf64>
            %42 = arith.addi %40, %c2 : index
            memref.store %cst_0, %arg4[%11, %42] : memref<?x28xf64>
            %43 = arith.addi %40, %c3 : index
            memref.store %cst_0, %arg4[%11, %43] : memref<?x28xf64>
          }
          ...
          scf.for %arg10 = %c0 to %37 step %c1 {
            %38 = arith.addi %11, %arg10 : index
            %39 = arith.muli %11, %c-1 : index
            ...
            memref.store %cst_0, %arg4[%11, %49] : memref<?x28xf64>
          }
        }
        async.yield
      }
    ...
    %6 = scf.for %arg7 = %c0 to %c32 step %c1 iter_args(%arg8 = %c0) -> (index) {
      %token = async.execute {
        %11 = memref.load %alloca[%c0] : memref<1xf64>
        %12 = memref.load %alloca[%c0] : memref<1xf64>
        %13 = memref.load %alloca[%c0] : memref<1xf64>
      ...
      %token = async.execute {
        scf.for %arg9 = %c0 to %c32 step %c1 {
          scf.for %arg10 = %c0 to %c1 step %c1 {
            ...
            scf.for %arg11 = %c0 to %c1 step %c1 {
              %12 = arith.addi %arg9, %arg11 : index
              %13 = memref.load %arg3[%12, %11] : memref<?x28xf64>
              %14 = memref.load %arg3[%12, %11] : memref<?x28xf64>
              %15 = memref.load %arg3[%12, %11] : memref<?x28xf64>
              %16 = memref.load %arg3[%12, %11] : memref<?x28xf64>
              %17 = arith.muli %arg7, %c-1 : index
              %18 = arith.muli %arg10, %c-1 : index
              %19 = arith.addi %17, %18 : index
              %20 = arith.addi %19, %c27 : index
              ...
              scf.for %arg12 = %c0 to %26 step %c1 {
                %44 = arith.muli %arg12, %c4 : index
                %45 = arith.addi %11, %44 : index
                %46 = arith.addi %45, %c1 : index
                %47 = memref.load %arg4[%11, %46] : memref<?x28xf64>
                %48 = memref.load %arg3[%12, %46] : memref<?x28xf64>
                %49 = arith.mulf %13, %48 : f64
                %50 = arith.addf %47, %49 : f64
                memref.store %50, %arg4[%11, %46] : memref<?x28xf64>
                %51 = arith.addi %46, %c1 : index
                %52 = memref.load %arg4[%11, %51] : memref<?x28xf64>
                %53 = memref.load %arg3[%12, %51] : memref<?x28xf64>
                %54 = arith.mulf %14, %53 : f64
                %55 = arith.addf %52, %54 : f64
                memref.store %55, %arg4[%11, %51] : memref<?x28xf64>
                %56 = arith.addi %46, %c2 : index
                %57 = memref.load %arg4[%11, %56] : memref<?x28xf64>
                %58 = memref.load %arg3[%12, %56] : memref<?x28xf64>
                %59 = arith.mulf %15, %58 : f64
                %60 = arith.addf %57, %59 : f64
                memref.store %60, %arg4[%11, %56] : memref<?x28xf64>
                %61 = arith.addi %46, %c3 : index
                %62 = memref.load %arg4[%11, %61] : memref<?x28xf64>
                %63 = memref.load %arg3[%12, %61] : memref<?x28xf64>
                %64 = arith.mulf %16, %63 : f64
                %65 = arith.addf %62, %64 : f64
                memref.store %65, %arg4[%11, %61] : memref<?x28xf64>
              }
              %27 = memref.load %arg3[%12, %11] : memref<?x28xf64>
              %28 = arith.muli %arg7, %c-1 : index
              ...
              %41 = arith.muli %40, %c-4 : index
              %42 = arith.addi %30, %41 : index
              %43 = arith.addi %42, %c27 : index
              scf.for %arg12 = %c0 to %43 step %c1 {
                %44 = arith.addi %11, %arg12 : index
                %45 = arith.muli %11, %c-1 : index
                %46 = arith.addi %45, %c27 : index
                ...
                %54 = arith.addi %44, %53 : index
                %55 = arith.addi %54, %c1 : index
                %56 = memref.load %arg4[%11, %55] : memref<?x28xf64>
                %57 = memref.load %arg3[%12, %55] : memref<?x28xf64>
                %58 = arith.mulf %27, %57 : f64
                %59 = arith.addf %56, %58 : f64
                memref.store %59, %arg4[%11, %55] : memref<?x28xf64>
              }
            }
          }
        }
    ...
    scf.for %arg7 = %c0 to %c27 step %c1 {
      ...
      %10 = scf.for %arg8 = %c0 to %c1 step %c1 iter_args(%arg9 = %c0) -> (index) {
        %token = async.execute {
          ...
          scf.for %arg10 = %c0 to %39 step %c1 {
            %40 = arith.addi %13, %arg10 : index
            ...
            %52 = memref.load %arg4[%13, %51] : memref<?x28xf64>
            memref.store %52, %arg4[%51, %13] : memref<?x28xf64>
          }
          async.yield
        }
