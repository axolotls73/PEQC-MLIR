module {
  func.func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x20xf64>, %arg4: memref<?x30xf64>) {
    ...
    scf.for %arg5 = %c0 to %c30 step %c1 {
      ...
      scf.for %arg6 = %c0_2 to %c19 step %c1_3 {
        %c1_4 = arith.constant 1 : index
        %0 = arith.addi %arg6, %c1_4 : index
        %c20_5 = arith.constant 20 : index
        %c1_6 = arith.constant 1 : index
        scf.for %arg7 = %0 to %c20_5 step %c1_6 {
          %1 = memref.load %arg4[%arg6, %arg5] : memref<?x30xf64>
          %2 = memref.load %arg3[%arg7, %arg6] : memref<?x20xf64>
          %3 = memref.load %arg4[%arg7, %arg5] : memref<?x30xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = arith.addf %1, %4 : f64
          memref.store %5, %arg4[%arg6, %arg5] : memref<?x30xf64>
        }
      }
    }
    ...
    scf.for %arg5 = %c0_0 to %c20 step %c1_1 {
      ...
      %c1_4 = arith.constant 1 : index
      scf.for %arg6 = %c0_2 to %c30_3 step %c1_4 {
