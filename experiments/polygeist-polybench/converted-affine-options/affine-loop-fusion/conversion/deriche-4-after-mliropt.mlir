  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
      ...
      affine.for %arg8 = 0 to 2 {
        affine.for %arg9 = #map(%arg7) to #map1(%arg7) {
          affine.for %arg10 = #map(%arg8) to #map1(%arg8) {
            ...
            affine.store %cst, %alloca_4[] : memref<f32>
            %40 = affine.load %alloca_11[0] : memref<1xf32>
            %41 = affine.load %arg3[%arg9, %arg10] : memref<?x64xf32>
            %42 = arith.mulf %40, %41 : f32
            %43 = affine.load %alloca_16[0] : memref<1xf32>
            %44 = affine.load %alloca_5[] : memref<f32>
            %45 = arith.mulf %43, %44 : f32
            ...
            %53 = arith.mulf %51, %52 : f32
            %54 = arith.addf %50, %53 : f32
            affine.store %54, %arg5[%arg9, %arg10] : memref<?x64xf32>
            %55 = affine.load %arg5[%arg9, %arg10] : memref<?x64xf32>
            affine.store %55, %alloca_4[] : memref<f32>
            %56 = affine.load %alloca_9[0] : memref<1xf32>
            affine.store %56, %alloca_24[] : memref<f32>
            %57 = affine.load %arg3[%arg9, %arg10] : memref<?x64xf32>
            affine.store %57, %alloca_5[] : memref<f32>
            affine.store %cst, %alloca_21[] : memref<f32>
            affine.store %cst, %alloca_3[] : memref<f32>
            affine.store %cst, %alloca[] : memref<f32>
            affine.store %cst, %alloca_23[] : memref<f32>
            %58 = affine.apply #map2(%arg10)
            %59 = affine.load %alloca_12[0] : memref<1xf32>
            %60 = affine.load %alloca_3[] : memref<f32>
            affine.store %60, %alloca_7[0] : memref<1xf32>
            %61 = arith.mulf %59, %60 : f32
            %62 = affine.load %alloca_14[0] : memref<1xf32>
            %63 = affine.load %alloca_21[] : memref<f32>
            %64 = arith.mulf %62, %63 : f32
            %65 = arith.addf %61, %64 : f32
            %66 = affine.load %alloca_15[0] : memref<1xf32>
            %67 = affine.load %alloca_23[] : memref<f32>
            affine.store %67, %alloca_18[0] : memref<1xf32>
            %68 = arith.mulf %66, %67 : f32
            %69 = arith.addf %65, %68 : f32
            %70 = affine.load %alloca_6[0] : memref<1xf32>
            %71 = affine.load %alloca[] : memref<f32>
            %72 = arith.mulf %70, %71 : f32
            %73 = arith.addf %69, %72 : f32
            affine.store %73, %arg6[%arg9, -%58 + 63] : memref<?x64xf32>
            %74 = affine.load %arg6[%arg9, -%58 + 63] : memref<?x64xf32>
            affine.store %74, %alloca_23[] : memref<f32>
            %75 = affine.load %alloca_18[0] : memref<1xf32>
            affine.store %75, %alloca[] : memref<f32>
            %76 = affine.load %arg3[%arg9, -%58 + 63] : memref<?x64xf32>
            affine.store %76, %alloca_3[] : memref<f32>
            %77 = affine.load %alloca_7[0] : memref<1xf32>
            affine.store %77, %alloca_21[] : memref<f32>
            %78 = affine.load %arg5[%arg9, %arg10] : memref<?x64xf32>
            %79 = affine.load %arg6[%arg9, %arg10] : memref<?x64xf32>
            %80 = arith.addf %78, %79 : f32
            affine.store %80, %arg4[%arg9, %arg10] : memref<?x64xf32>
          }
        }
      }
    }
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        %42 = arith.mulf %40, %41 : f32
        %43 = affine.load %alloca_16[0] : memref<1xf32>
        %44 = affine.load %alloca_13[] : memref<f32>
        %45 = arith.mulf %43, %44 : f32
        %46 = arith.addf %42, %45 : f32
        %47 = affine.load %alloca_15[0] : memref<1xf32>
        %48 = affine.load %alloca_4[] : memref<f32>
        ...
        affine.store %57, %alloca_13[] : memref<f32>
      }
    }
    affine.for %arg7 = 0 to 64 {
      affine.store %cst, %alloca[] : memref<f32>
      ...
      affine.for %arg8 = 0 to 2 {
        affine.for %arg9 = #map(%arg7) to #map1(%arg7) {
          affine.for %arg10 = #map(%arg8) to #map1(%arg8) {
            ...
            affine.store %cst, %alloca_13[] : memref<f32>
            %40 = affine.load %alloca_11[0] : memref<1xf32>
            %41 = affine.load %arg4[%arg9, %arg10] : memref<?x64xf32>
            %42 = arith.mulf %40, %41 : f32
            %43 = affine.load %alloca_16[0] : memref<1xf32>
            %44 = affine.load %alloca_13[] : memref<f32>
            %45 = arith.mulf %43, %44 : f32
            ...
            %56 = affine.load %alloca_19[0] : memref<1xf32>
            affine.store %56, %alloca_24[] : memref<f32>
            %57 = affine.load %arg4[%arg9, %arg10] : memref<?x64xf32>
            affine.store %57, %alloca_13[] : memref<f32>
            affine.store %cst, %alloca[] : memref<f32>
            affine.store %cst, %alloca_23[] : memref<f32>
            affine.store %cst, %alloca_22[] : memref<f32>
            affine.store %cst, %alloca_10[] : memref<f32>
            %58 = affine.apply #map2(%arg9)
            %59 = affine.load %alloca_12[0] : memref<1xf32>
            %60 = affine.load %alloca_10[] : memref<f32>
            affine.store %60, %alloca_17[0] : memref<1xf32>
            %61 = arith.mulf %59, %60 : f32
            %62 = affine.load %alloca_14[0] : memref<1xf32>
            ...
            %66 = affine.load %alloca_15[0] : memref<1xf32>
            %67 = affine.load %alloca_23[] : memref<f32>
            affine.store %67, %alloca_20[0] : memref<1xf32>
            %68 = arith.mulf %66, %67 : f32
            %69 = arith.addf %65, %68 : f32
            %70 = affine.load %alloca_6[0] : memref<1xf32>
            %71 = affine.load %alloca[] : memref<f32>
            %72 = arith.mulf %70, %71 : f32
            %73 = arith.addf %69, %72 : f32
            affine.store %73, %arg6[-%58 + 63, %arg10] : memref<?x64xf32>
            %74 = affine.load %arg6[-%58 + 63, %arg10] : memref<?x64xf32>
            affine.store %74, %alloca_23[] : memref<f32>
            %75 = affine.load %alloca_20[0] : memref<1xf32>
            affine.store %75, %alloca[] : memref<f32>
            %76 = affine.load %arg4[-%58 + 63, %arg10] : memref<?x64xf32>
            affine.store %76, %alloca_10[] : memref<f32>
            %77 = affine.load %alloca_17[0] : memref<1xf32>
            affine.store %77, %alloca_22[] : memref<f32>
            %78 = affine.load %arg5[%arg9, %arg10] : memref<?x64xf32>
            %79 = affine.load %arg6[%arg9, %arg10] : memref<?x64xf32>
            %80 = arith.addf %78, %79 : f32
            affine.store %80, %arg4[%arg9, %arg10] : memref<?x64xf32>
