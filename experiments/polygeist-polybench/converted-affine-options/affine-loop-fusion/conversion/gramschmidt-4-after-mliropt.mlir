...
module {
  func.func @kernel_gramschmidt(%arg0: i32, %arg1: i32, %arg2: memref<?x30xf64>, %arg3: memref<?x30xf64>, %arg4: memref<?x30xf64>) {
    ...
    affine.for %arg5 = 0 to 30 {
      ...
      affine.for %arg6 = 0 to 2 {
        affine.for %arg7 = #map3(%arg5) to 10 {
          affine.if #set(%arg6) {
            affine.for %arg8 = 0 to 19 {
              affine.for %arg9 = max #map4(%arg7, %arg5) to #map5(%arg7) {
                affine.if #set1(%arg9) {
          ...
          affine.if #set(%arg6) {
            affine.for %arg8 = max #map4(%arg7, %arg5) to #map5(%arg7) {
              affine.if #set1(%arg8) {
          ...
          affine.for %arg8 = max #map6(%arg6) to min #map2(%arg6) {
            affine.for %arg9 = max #map4(%arg7, %arg5) to #map5(%arg7) {
              affine.if #set1(%arg9) {
