...
void kernel_durbin(int func_arg_0, double* func_arg_1, double* func_arg_2)
{
  ...
  for (int for_iter_29 = arith_const_12; for_iter_29 < arith_const_11; for_iter_29 += arith_const_12) {
    ...
    memref_alloca_16[0] = arith_addf_35; 
    ...
    for (int for_iter_42 = arith_const_12; for_iter_42 < for_iter_29; for_iter_42 += arith_const_12) {
      double memref_load_43 = memref_alloca_16[0]; 
      ...
      memref_alloca_16[0] = arith_addf_50; 
    }
    ...
    if (arith_cmpi_52) {
      ...
      double memref_load_54 = memref_alloca_16[0]; 
      ...
      memref_alloca_17[arith_const_13] = arith_divf_58; 
      double memref_load_59 = func_arg_2[arith_const_13]; 
      double memref_load_60 = memref_alloca_17[arith_const_13]; 
      ...
      double memref_load_65 = memref_alloca_17[arith_const_13]; 
    ...
    if (arith_cmpi_68) {
      ...
      double memref_load_70 = memref_alloca_16[0]; 
      ...
      memref_alloca_17[arith_const_13] = arith_divf_74; 
      double memref_load_75 = func_arg_2[arith_const_13]; 
      double memref_load_76 = memref_alloca_17[arith_const_13]; 
    ...
    int arith_addi_83 = (for_iter_29 + arith_const_7); 
    for (int for_iter_84 = arith_const_8; for_iter_84 < arith_addi_83; for_iter_84 += arith_const_12) {
      int arith_addi_85 = (for_iter_84 + arith_const_6); 
      double memref_load_86 = func_arg_2[arith_addi_85]; 
      double memref_load_87 = memref_alloca_17[arith_const_13]; 
      int arith_muli_88 = (for_iter_84 * arith_const_10); 
      ...
      double arith_mulf_92 = (memref_load_87 * memref_load_91); 
      double arith_addf_93 = (memref_load_86 + arith_mulf_92); 
      int arith_addi_94 = (for_iter_84 + arith_const_6); 
    ...
    if (arith_cmpi_96) {
      ...
      double memref_load_99 = memref_alloca_17[arith_const_13]; 
