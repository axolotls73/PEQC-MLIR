...
void kernel_gemver(int func_arg_0, double func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  for (int for_iter_17 = arith_const_14; for_iter_17 < arith_const_15; for_iter_17 += arith_const_16) {
    ...
    for (int for_iter_22 = arith_muli_18; for_iter_22 < arith_minsi_21; for_iter_22 += arith_const_16) {
      for (int for_iter_23 = arith_const_14; for_iter_23 < arith_const_15; for_iter_23 += arith_const_16) {
        int arith_muli_24 = (for_iter_23 * arith_const_13); 
        int arith_muli_25 = (for_iter_23 * arith_const_13); 
        ...
        for (int for_iter_28 = arith_muli_24; for_iter_28 < arith_minsi_27; for_iter_28 += arith_const_16) {
          double memref_load_29 = func_arg_3[for_iter_28][for_iter_22]; 
          double memref_load_30 = func_arg_4[for_iter_28]; 
          double memref_load_31 = func_arg_5[for_iter_22]; 
          double arith_mulf_32 = (memref_load_30 * memref_load_31); 
          double arith_addf_33 = (memref_load_29 + arith_mulf_32); 
          double memref_load_34 = func_arg_6[for_iter_28]; 
          double memref_load_35 = func_arg_7[for_iter_22]; 
          double arith_mulf_36 = (memref_load_34 * memref_load_35); 
          double arith_addf_37 = (arith_addf_33 + arith_mulf_36); 
          func_arg_3[for_iter_28][for_iter_22] = arith_addf_37; 
          double memref_load_38 = func_arg_9[for_iter_22]; 
          double memref_load_39 = func_arg_3[for_iter_28][for_iter_22]; 
          double arith_mulf_40 = (func_arg_2 * memref_load_39); 
          double memref_load_41 = func_arg_10[for_iter_28]; 
          double arith_mulf_42 = (arith_mulf_40 * memref_load_41); 
          double arith_addf_43 = (memref_load_38 + arith_mulf_42); 
          func_arg_9[for_iter_22] = arith_addf_43; 
        }
      }
    }
  }
  ...
  for (int for_iter_53 = arith_const_14; for_iter_53 < arith_const_15; for_iter_53 += arith_const_16) {
    ...
    for (int for_iter_58 = arith_muli_54; for_iter_58 < arith_minsi_57; for_iter_58 += arith_const_16) {
      for (int for_iter_59 = arith_const_14; for_iter_59 < arith_const_15; for_iter_59 += arith_const_16) {
        int arith_muli_60 = (for_iter_59 * arith_const_13); 
        int arith_muli_61 = (for_iter_59 * arith_const_13); 
        ...
        for (int for_iter_64 = arith_muli_60; for_iter_64 < arith_minsi_63; for_iter_64 += arith_const_16) {
          double memref_load_65 = func_arg_8[for_iter_58]; 
          double memref_load_66 = func_arg_3[for_iter_58][for_iter_64]; 
          ...
          func_arg_8[for_iter_58] = arith_addf_70; 
        }
      }
    }
  }
