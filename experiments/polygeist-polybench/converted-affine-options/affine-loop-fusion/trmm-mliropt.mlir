  ...
  func.func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x20xf64>, %arg4: memref<?x30xf64>) {
    affine.for %arg5 = 0 to 30 {
      affine.for %arg6 = 0 to 19 {
        affine.for %arg7 = #map(%arg6) to 20 {
          %0 = affine.load %arg4[%arg6, %arg5] : memref<?x30xf64>
          %1 = affine.load %arg3[%arg7, %arg6] : memref<?x20xf64>
          %2 = affine.load %arg4[%arg7, %arg5] : memref<?x30xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = arith.addf %0, %3 : f64
          affine.store %4, %arg4[%arg6, %arg5] : memref<?x30xf64>
        }
      }
    }
