        ...
        affine.for %arg12 = 0 to 16 {
          affine.for %arg13 = 0 to 18 {
            affine.for %arg14 = 0 to 22 {
              ...
              %2 = affine.load %arg7[%arg12, %arg14] : memref<?x22xf64>
              %3 = arith.mulf %arg4, %2 : f64
              %4 = affine.load %arg8[%arg14, %arg13] : memref<?x18xf64>
              %5 = arith.mulf %3, %4 : f64
              %6 = arith.addf %1, %5 : f64
              affine.store %6, %arg6[%arg12, %arg13] : memref<?x18xf64>
            }
            %0 = affine.load %arg6[%arg12, %arg13] : memref<?x18xf64>
            affine.for %arg14 = 21 to 32 {
              %1 = affine.load %arg10[%arg12, %arg14 - 21] : memref<?x24xf64>
