...
void kernel_doitgen(int func_arg_0, int func_arg_1, int func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_18 = arith_const_15; for_iter_18 < arith_const_16; for_iter_18 += arith_const_17) {
    ...
    int arith_cmpi_21 = (arith_addi_20 <= arith_const_15); 
    ...
    int arith_cmpi_32 = (arith_addi_31 < arith_const_15); 
    ...
    for (int for_iter_40 = arith_maxsi_29; for_iter_40 < arith_minsi_39; for_iter_40 += arith_const_17) {
      ...
      for (int for_iter_49 = arith_maxsi_43; for_iter_49 < arith_minsi_48; for_iter_49 += arith_const_17) {
        ...
        for (int for_iter_51 = arith_const_15; for_iter_51 < arith_const_6; for_iter_51 += arith_const_17) {
          int arith_muli_52 = (for_iter_40 * arith_const_12); 
          int arith_addi_53 = (arith_muli_52 + for_iter_49); 
          double memref_load_54 = func_arg_3[for_iter_40][arith_addi_53][for_iter_51]; 
          for (int for_iter_55 = arith_const_15; for_iter_55 < arith_const_6; for_iter_55 += arith_const_17) {
            double memref_load_56 = func_arg_5[for_iter_55]; 
            double memref_load_57 = func_arg_4[for_iter_51][for_iter_55]; 
            double arith_mulf_58 = (memref_load_54 * memref_load_57); 
            double arith_addf_59 = (memref_load_56 + arith_mulf_58); 
            func_arg_5[for_iter_55] = arith_addf_59; 
          }
        }
