...
void kernel_3mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, int func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  for (int for_iter_30 = arith_const_23; for_iter_30 < arith_const_20; for_iter_30 += arith_const_25) {
    for (int for_iter_31 = arith_const_23; for_iter_31 < arith_const_19; for_iter_31 += arith_const_25) {
      double memref_load_32 = func_arg_9[for_iter_30][for_iter_31]; 
      for (int for_iter_33 = arith_const_23; for_iter_33 < arith_const_21; for_iter_33 += arith_const_25) {
        double memref_load_34 = func_arg_8[for_iter_30][for_iter_33]; 
        double memref_load_35 = func_arg_10[for_iter_31][for_iter_33]; 
        double arith_mulf_36 = (memref_load_32 * memref_load_35); 
        double arith_addf_37 = (memref_load_34 + arith_mulf_36); 
        func_arg_8[for_iter_30][for_iter_33] = arith_addf_37; 
      }
    }
  }
  ...
  for (int for_iter_40 = arith_const_23; for_iter_40 < arith_const_18; for_iter_40 += arith_const_25) {
    int arith_cmpi_41 = ((for_iter_40 == arith_const_23) ? 1 : 0); 
    if (arith_cmpi_41) {
      for (int for_iter_42 = arith_const_23; for_iter_42 < arith_const_24; for_iter_42 += arith_const_25) {
        for (int for_iter_43 = arith_const_23; for_iter_43 < arith_const_20; for_iter_43 += arith_const_25) {
          ...
          double memref_load_50 = func_arg_5[for_iter_42][for_iter_43]; 
          for (int for_iter_51 = arith_const_16; for_iter_51 < arith_const_15; for_iter_51 += arith_const_25) {
            int arith_addi_52 = (for_iter_51 + arith_const_14); 
            double memref_load_53 = func_arg_11[for_iter_42][arith_addi_52]; 
            int arith_addi_54 = (for_iter_51 + arith_const_14); 
            double memref_load_55 = func_arg_8[for_iter_43][arith_addi_54]; 
            double arith_mulf_56 = (memref_load_50 * memref_load_55); 
            double arith_addf_57 = (memref_load_53 + arith_mulf_56); 
            int arith_addi_58 = (for_iter_51 + arith_const_14); 
    ...
    int arith_cmpi_60 = ((arith_addi_59 == arith_const_23) ? 1 : 0); 
    if (arith_cmpi_60) {
      for (int for_iter_61 = arith_const_23; for_iter_61 < arith_const_24; for_iter_61 += arith_const_25) {
        for (int for_iter_62 = arith_const_23; for_iter_62 < arith_const_20; for_iter_62 += arith_const_25) {
          double memref_load_63 = func_arg_5[for_iter_61][for_iter_62]; 
          for (int for_iter_64 = arith_const_15; for_iter_64 < arith_const_12; for_iter_64 += arith_const_25) {
            int arith_addi_65 = (for_iter_64 + arith_const_14); 
            double memref_load_66 = func_arg_11[for_iter_61][arith_addi_65]; 
            int arith_addi_67 = (for_iter_64 + arith_const_14); 
            double memref_load_68 = func_arg_8[for_iter_62][arith_addi_67]; 
            double arith_mulf_69 = (memref_load_63 * memref_load_68); 
            double arith_addf_70 = (memref_load_66 + arith_mulf_69); 
            int arith_addi_71 = (for_iter_64 + arith_const_14); 
