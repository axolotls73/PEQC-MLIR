...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_10 = arith_const_7; for_iter_10 < arith_const_8; for_iter_10 += arith_const_9) {
    ...
    for (int for_iter_12 = arith_addi_11; for_iter_12 < arith_const_6; for_iter_12 += arith_const_9) {
      double memref_load_13 = func_arg_3[for_iter_12][for_iter_10]; 
      for (int for_iter_14 = arith_const_7; for_iter_14 < arith_const_5; for_iter_14 += arith_const_9) {
        double memref_load_15 = func_arg_4[for_iter_10][for_iter_14]; 
        double memref_load_16 = func_arg_4[for_iter_12][for_iter_14]; 
        double arith_mulf_17 = (memref_load_13 * memref_load_16); 
        double arith_addf_18 = (memref_load_15 + arith_mulf_17); 
        func_arg_4[for_iter_10][for_iter_14] = arith_addf_18; 
      }
    }
  }
