  ...
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    affine.for %arg6 = 0 to 32 {
      affine.for %arg7 = 0 to 28 {
        ...
        %3 = affine.load %arg3[%arg6, %arg7] : memref<?x28xf64>
    ...
    affine.for %arg6 = 0 to 32 {
      affine.for %arg7 = 0 to 28 {
        ...
        affine.store %4, %arg3[%arg6, %arg7] : memref<?x28xf64>
      }
    }
    affine.for %arg6 = 0 to 28 {
      affine.for %arg7 = 0 to 32 {
        ...
        affine.for %arg8 = #map(%arg6) to 28 {
          %3 = affine.load %arg4[%arg6, %arg8] : memref<?x28xf64>
          %4 = affine.load %arg3[%arg7, %arg8] : memref<?x28xf64>
          %5 = arith.mulf %2, %4 : f64
          %6 = arith.addf %3, %5 : f64
          affine.store %6, %arg4[%arg6, %arg8] : memref<?x28xf64>
        }
      }
    }
