  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %67, %alloca_23[] : memref<f32>
    ...
    affine.store %43, %alloca[] : memref<f32>
    %44 = affine.load %alloca_11[0] : memref<1xf32>
    %45 = affine.load %alloca_10[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        %63 = arith.addf %60, %62 : f32
        %64 = affine.load %alloca[] : memref<f32>
        ...
        affine.store %68, %alloca[] : memref<f32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        %58 = affine.load %alloca_13[] : memref<f32>
        ...
        affine.store %69, %alloca_13[] : memref<f32>
      }
    }
    %52 = affine.load %alloca_11[0] : memref<1xf32>
    %53 = affine.load %alloca_10[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        ...
        affine.store %56, %alloca_16[0] : memref<1xf32>
