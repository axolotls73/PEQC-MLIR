        ...
        affine.if #set(%arg8) {
          affine.for %arg9 = max #map(%arg7) to 20 {
            affine.if #set(%arg7) {
              ...
              affine.store %1, %arg4[0, 0] : memref<?x30xf64>
            }
            ...
            affine.for %arg10 = #map3(%arg9) to min #map4(%arg9) {
              affine.if #set(%arg7) {
                %1 = affine.load %arg4[-%arg10 + %arg9, 0] : memref<?x30xf64>
                %2 = affine.load %arg5[-%arg10 + %arg9, 0] : memref<?x30xf64>
                %3 = affine.load %arg5[-%arg10 + %arg9 - 1, 0] : memref<?x30xf64>
                %4 = arith.subf %2, %3 : f64
                %5 = arith.mulf %4, %cst_0 : f64
                %6 = arith.subf %1, %5 : f64
                affine.store %6, %arg4[-%arg10 + %arg9, 0] : memref<?x30xf64>
              }
              affine.for %arg11 = max #map1(%arg7, %arg9) to min #map2(%arg7, %arg9) {
                %1 = affine.load %arg4[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %2 = affine.load %arg5[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %3 = affine.load %arg5[-%arg10 + %arg9 - 1, -%arg9 + %arg11] : memref<?x30xf64>
                %4 = arith.subf %2, %3 : f64
                %5 = arith.mulf %4, %cst_0 : f64
                %6 = arith.subf %1, %5 : f64
                affine.store %6, %arg4[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %7 = affine.load %arg3[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %8 = affine.load %arg5[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %9 = affine.load %arg5[-%arg10 + %arg9, -%arg9 + %arg11 - 1] : memref<?x30xf64>
                %10 = arith.subf %8, %9 : f64
                %11 = arith.mulf %10, %cst_0 : f64
                %12 = arith.subf %7, %11 : f64
                affine.store %12, %arg3[-%arg10 + %arg9, -%arg9 + %arg11] : memref<?x30xf64>
                %13 = affine.load %arg5[-%arg10 + %arg9 - 1, -%arg9 + %arg11 - 1] : memref<?x30xf64>
                %14 = affine.load %arg3[-%arg10 + %arg9 - 1, -%arg9 + %arg11] : memref<?x30xf64>
                %15 = affine.load %arg3[-%arg10 + %arg9 - 1, -%arg9 + %arg11 - 1] : memref<?x30xf64>
                %16 = arith.subf %14, %15 : f64
                %17 = affine.load %arg4[-%arg10 + %arg9, -%arg9 + %arg11 - 1] : memref<?x30xf64>
                %18 = arith.addf %16, %17 : f64
                %19 = affine.load %arg4[-%arg10 + %arg9 - 1, -%arg9 + %arg11 - 1] : memref<?x30xf64>
                %20 = arith.subf %18, %19 : f64
                %21 = arith.mulf %20, %cst : f64
                %22 = arith.subf %13, %21 : f64
                affine.store %22, %arg5[-%arg10 + %arg9 - 1, -%arg9 + %arg11 - 1] : memref<?x30xf64>
              }
            }
          }
        }
