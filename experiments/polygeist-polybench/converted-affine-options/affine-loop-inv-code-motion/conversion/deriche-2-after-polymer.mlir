...
module {
  ...
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    call @S11(%alloca_12, %arg2, %alloca_5, %alloca_3, %alloca_22) : (memref<1xf32>, f32, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    call @S13(%alloca_7, %arg2, %alloca_22) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S12(%alloca_8, %arg2, %alloca_3) : (memref<1xf32>, f32, memref<1xf32>) -> ()
    call @S9(%alloca_1) : (memref<f32>) -> ()
    call @S8(%alloca_10) : (memref<f32>) -> ()
    call @S7(%alloca_20) : (memref<f32>) -> ()
    call @S6(%alloca_21) : (memref<f32>) -> ()
    affine.for %arg7 = 0 to 64 {
      func.call @S18(%alloca_1) : (memref<f32>) -> ()
      func.call @S17(%alloca_21) : (memref<f32>) -> ()
      func.call @S16(%alloca_20) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S19(%arg5, %arg7, %arg8, %alloca_21, %alloca_2, %alloca_20, %alloca_11, %alloca_1, %alloca_12, %arg3, %alloca_5, %alloca_4) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S22(%alloca_20, %arg5, %arg7, %arg8) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S27(%arg6, %arg7, %arg8, %alloca, %alloca_2, %alloca_18, %alloca_11, %alloca_17, %alloca_7, %alloca_0, %alloca_8, %alloca_9, %alloca_14) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      func.call @S34(%alloca_20) : (memref<f32>) -> ()
      func.call @S33(%alloca_10) : (memref<f32>) -> ()
      affine.for %arg8 = 0 to 64 {
        func.call @S36(%arg5, %arg8, %arg7, %alloca_21, %alloca_2, %alloca_20, %alloca_11, %alloca_10, %alloca_12, %arg4, %alloca_5, %alloca_15) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<?x64xf32>, memref<1xf32>, memref<1xf32>) -> ()
        func.call @S39(%alloca_20, %arg5, %arg8, %arg7) : (memref<f32>, memref<?x64xf32>, index, index) -> ()
    ...
    affine.for %arg7 = 0 to 64 {
      ...
      affine.for %arg8 = 0 to 64 {
        func.call @S44(%arg6, %arg8, %arg7, %alloca, %alloca_2, %alloca_18, %alloca_11, %alloca_19, %alloca_7, %alloca_6, %alloca_8, %alloca_13, %alloca_16) : (memref<?x64xf32>, index, index, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<f32>, memref<1xf32>, memref<1xf32>, memref<1xf32>) -> ()
