...
void kernel_gramschmidt(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_28 = arith_const_21; for_iter_28 < arith_const_18; for_iter_28 += arith_const_19) {
    double memref_load_29 = func_arg_3[for_iter_28][for_iter_28]; 
    for (int for_iter_30 = arith_const_21; for_iter_30 < arith_const_17; for_iter_30 += arith_const_19) {
      int arith_cmpi_31 = (for_iter_30 == arith_const_21); 
      if (arith_cmpi_31) {
        for (int for_iter_32 = arith_const_21; for_iter_32 < arith_const_16; for_iter_32 += arith_const_19) {
          double memref_load_33 = memref_alloca_23[0]; 
          double memref_load_34 = func_arg_2[for_iter_32][for_iter_28]; 
          double arith_mulf_35 = (memref_load_34 * memref_load_34); 
          double arith_addf_36 = (memref_load_33 + arith_mulf_35); 
          memref_alloca_23[0] = arith_addf_36; 
        }
      }
      int arith_muli_37 = (for_iter_30 * arith_const_14); 
      int arith_maxsi_38 = max(arith_muli_37, arith_const_15); 
      int arith_muli_39 = (for_iter_30 * arith_const_14); 
      int arith_addi_40 = (arith_muli_39 + arith_const_14); 
      int arith_minsi_41 = min(arith_addi_40, arith_const_13); 
      for (int for_iter_42 = arith_maxsi_38; for_iter_42 < arith_minsi_41; for_iter_42 += arith_const_19) {
        int arith_addi_43 = (for_iter_42 + arith_const_12); 
        double memref_load_44 = func_arg_2[arith_addi_43][for_iter_28]; 
        double arith_divf_45 = (memref_load_44 / memref_load_29); 
        int arith_addi_46 = (for_iter_42 + arith_const_12); 
        func_arg_4[arith_addi_46][for_iter_28] = arith_divf_45; 
      }
      int arith_cmpi_47 = (for_iter_30 == arith_const_21); 
      if (arith_cmpi_47) {
        memref_alloca_23[0] = arith_const_22; 
      }
    }
    int arith_muli_48 = (for_iter_28 * arith_const_11); 
    int arith_addi_49 = (arith_muli_48 + arith_const_10); 
    int arith_cmpi_50 = (arith_addi_49 <= arith_const_21); 
    int arith_subi_51 = (arith_const_21 - arith_addi_49); 
    int arith_subi_52 = (arith_addi_49 - arith_const_19); 
    int arith_select_53 = (arith_cmpi_50 ? arith_subi_51 : arith_subi_52); 
    int arith_divi_54 = (arith_select_53 / arith_const_9); 
    int arith_subi_55 = (arith_const_21 - arith_divi_54); 
    int arith_addi_56 = (arith_divi_54 + arith_const_19); 
    int arith_select_57 = (arith_cmpi_50 ? arith_subi_55 : arith_addi_56); 
    for (int for_iter_58 = arith_select_57; for_iter_58 < arith_const_8; for_iter_58 += arith_const_19) {
      for (int for_iter_59 = arith_const_21; for_iter_59 < arith_const_17; for_iter_59 += arith_const_19) {
        int arith_cmpi_60 = (for_iter_59 == arith_const_21); 
        if (arith_cmpi_60) {
          for (int for_iter_61 = arith_const_21; for_iter_61 < arith_const_15; for_iter_61 += arith_const_19) {
            int arith_muli_62 = (for_iter_58 * arith_const_14); 
            ...
            int arith_muli_66 = (for_iter_58 * arith_const_14); 
        ...
        int arith_cmpi_107 = (for_iter_59 == arith_const_21); 
        if (arith_cmpi_107) {
          int arith_muli_108 = (for_iter_58 * arith_const_14); 
          ...
          int arith_muli_112 = (for_iter_58 * arith_const_14); 
        ...
        int arith_muli_191 = (for_iter_59 * arith_const_14); 
        int arith_maxsi_192 = max(arith_muli_191, arith_const_16); 
        int arith_muli_193 = (for_iter_59 * arith_const_14); 
        ...
        for (int for_iter_196 = arith_maxsi_192; for_iter_196 < arith_minsi_195; for_iter_196 += arith_const_19) {
          int arith_muli_197 = (for_iter_58 * arith_const_14); 
          ...
          int arith_muli_201 = (for_iter_58 * arith_const_14); 
