...
#map2 = affine_map<(d0, d1) -> (2, d0 * 32, d1 * 32 + 1)>
      ...
      affine.for %arg3 = 0 to #map(%arg2) {
        affine.for %arg4 = 0 to #map(%arg3) {
          ...
          affine.if #set3(%arg3, %arg4) {
            affine.for %arg5 = max #map2(%arg2, %arg3) to min #map3(%arg2, %arg3) {
              affine.if #set4(%arg3) {
              ...
              affine.for %arg6 = max #map4(%arg3) to #map5(%arg5) {
                affine.for %arg7 = max #map4(%arg3) to #map1(%arg6) {
