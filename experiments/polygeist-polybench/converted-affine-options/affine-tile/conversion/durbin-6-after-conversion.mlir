    ...
    scf.for %arg3 = %c1 to %c40 step %c32 {
      ...
      scf.for %arg4 = %arg3 to %6 step %c1 {
        ...
        scf.if %20 {
          ...
          memref.store %34, %alloca[%c0] : memref<1xf64>
        ...
        scf.for %arg5 = %c39 to %23 step %c1 {
          ...
          %38 = arith.addi %arg5, %c-38 : index
          memref.store %37, %alloca_2[%38] : memref<40xf64>
        }
        %24 = arith.addi %arg4, %c-2 : index
        %25 = arith.cmpi sge, %24, %c0 : index
        scf.if %25 {
          %29 = arith.addi %arg4, %c-1 : index
          %30 = memref.load %arg2[%29] : memref<?xf64>
          %31 = memref.load %alloca[%c0] : memref<1xf64>
