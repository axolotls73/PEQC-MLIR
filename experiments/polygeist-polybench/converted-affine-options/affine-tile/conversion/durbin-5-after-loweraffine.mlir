    ...
    scf.for %arg3 = %c1 to %c40 step %c32 {
      ...
      scf.for %arg4 = %arg3 to %8 step %c1_10 {
        ...
        scf.if %22 {
          ...
          memref.store %36, %alloca_1[%c0_23] : memref<1xf64>
          ...
          %43 = memref.load %alloca_1[%c0_30] : memref<1xf64>
        ...
        scf.if %24 {
          ...
          memref.store %36, %alloca_1[%c0_22] : memref<1xf64>
          %c0_23 = arith.constant 0 : index
          %37 = memref.load %arg2[%c0_23] : memref<?xf64>
          %c0_24 = arith.constant 0 : index
          %38 = memref.load %alloca_1[%c0_24] : memref<1xf64>
          ...
          %c0_27 = arith.constant 0 : index
          %43 = memref.load %alloca_1[%c0_27] : memref<1xf64>
          %c0_28 = arith.constant 0 : index
        ...
        scf.for %arg5 = %c39 to %25 step %c1_17 {
          ...
          %c0_22 = arith.constant 0 : index
          %33 = memref.load %alloca_1[%c0_22] : memref<1xf64>
          %c-1_23 = arith.constant -1 : index
        ...
        scf.if %27 {
          ...
          %32 = memref.load %arg2[%31] : memref<?xf64>
          %c0_23 = arith.constant 0 : index
          %33 = memref.load %alloca_1[%c0_23] : memref<1xf64>
          %c0_24 = arith.constant 0 : index
