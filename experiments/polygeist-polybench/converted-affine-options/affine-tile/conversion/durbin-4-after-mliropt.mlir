  ...
  func.func @kernel_durbin(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) {
    ...
    affine.for %arg3 = 1 to 40 step 32 {
      affine.for %arg4 = #map(%arg3) to min #map1(%arg3) {
        ...
        %6 = affine.load %arg1[%arg4 - 1] : memref<?xf64>
        ...
        affine.for %arg5 = 1 to #map(%arg4) {
          ...
          %18 = affine.load %arg2[%arg5] : memref<?xf64>
        ...
        affine.if #set1(%arg4) {
          %16 = affine.load %arg1[%arg4] : memref<?xf64>
          %17 = affine.load %alloca_1[] : memref<f64>
          %18 = arith.addf %16, %17 : f64
          %19 = arith.negf %18 : f64
          %20 = affine.load %alloca_3[] : memref<f64>
          ...
          %22 = affine.load %arg2[0] : memref<?xf64>
          %23 = affine.load %alloca[0] : memref<1xf64>
          %24 = affine.load %arg2[%arg4 - 1] : memref<?xf64>
          %25 = arith.mulf %23, %24 : f64
          %26 = arith.addf %22, %25 : f64
          affine.store %26, %alloca_2[0] : memref<40xf64>
          ...
          affine.store %28, %arg2[%arg4] : memref<?xf64>
        }
        affine.for %arg5 = 39 to #map2(%arg4) {
          %16 = affine.load %arg2[%arg5 - 38] : memref<?xf64>
          %17 = affine.load %alloca[0] : memref<1xf64>
          %18 = affine.load %arg2[-%arg5 + %arg4 + 37] : memref<?xf64>
          %19 = arith.mulf %17, %18 : f64
          %20 = arith.addf %16, %19 : f64
          affine.store %20, %alloca_2[%arg5 - 38] : memref<40xf64>
        }
        affine.if #set1(%arg4) {
          %16 = affine.load %arg2[%arg4 - 1] : memref<?xf64>
          %17 = affine.load %alloca[0] : memref<1xf64>
          %18 = affine.load %arg2[0] : memref<?xf64>
          %19 = arith.mulf %17, %18 : f64
          %20 = arith.addf %16, %19 : f64
          affine.store %20, %alloca_2[%arg4 - 1] : memref<40xf64>
          %21 = affine.load %alloca_2[0] : memref<40xf64>
          affine.store %21, %arg2[0] : memref<?xf64>
        }
        affine.for %arg5 = #map3(%arg4) to #map4(%arg4) {
          %16 = affine.load %alloca_2[-%arg4 + %arg5 - 37] : memref<40xf64>
          affine.store %16, %arg2[-%arg4 + %arg5 - 37] : memref<?xf64>
        }
      }
    }
    return
