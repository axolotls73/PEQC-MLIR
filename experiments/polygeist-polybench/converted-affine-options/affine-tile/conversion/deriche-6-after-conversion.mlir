    ...
    scf.for %arg7 = %c0 to %c64 step %c32 {
      ...
      scf.for %arg8 = %arg7 to %31 step %c1 {
        ...
        scf.for %arg9 = %c0 to %c64 step %c1 {
          ...
          %35 = memref.load %alloca_16[%c0] : memref<1xf32>
    ...
    scf.for %arg7 = %c0 to %c64 step %c32 {
      ...
      scf.for %arg8 = %arg7 to %31 step %c1 {
        ...
        scf.for %arg9 = %c0 to %c64 step %c1 {
          ...
          memref.store %33, %alloca_7[%c0] : memref<1xf32>
          %34 = arith.mulf %32, %33 : f32
          ...
          %52 = memref.load %alloca_18[%c0] : memref<1xf32>
          ...
          %56 = memref.load %alloca_7[%c0] : memref<1xf32>
