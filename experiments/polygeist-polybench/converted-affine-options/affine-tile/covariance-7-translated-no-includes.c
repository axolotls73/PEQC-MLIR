...
void kernel_covariance(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_26 = arith_const_18; for_iter_26 < arith_const_17; for_iter_26 += arith_const_15) {
    int arith_addi_27 = (for_iter_26 + arith_const_17); 
  ...
  for (int for_iter_29 = arith_const_18; for_iter_29 < arith_const_15; for_iter_29 += arith_const_15) {
    for (int for_iter_30 = arith_const_18; for_iter_30 < arith_const_17; for_iter_30 += arith_const_15) {
      int arith_addi_31 = (for_iter_29 + arith_const_15); 
      for (int for_iter_32 = for_iter_29; for_iter_32 < arith_addi_31; for_iter_32 += arith_const_16) {
        int arith_addi_33 = (for_iter_30 + arith_const_17); 
  ...
  for (int for_iter_38 = arith_const_18; for_iter_38 < arith_const_17; for_iter_38 += arith_const_15) {
    int arith_addi_39 = (for_iter_38 + arith_const_17); 
  ...
  for (int for_iter_43 = arith_const_18; for_iter_43 < arith_const_15; for_iter_43 += arith_const_15) {
    for (int for_iter_44 = arith_const_18; for_iter_44 < arith_const_17; for_iter_44 += arith_const_15) {
      int arith_addi_45 = (for_iter_43 + arith_const_15); 
      for (int for_iter_46 = for_iter_43; for_iter_46 < arith_addi_45; for_iter_46 += arith_const_16) {
        int arith_addi_47 = (for_iter_44 + arith_const_17); 
