...
void kernel_3mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, int func_arg_4, double* func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10, double* func_arg_11)
{
  ...
  for (int for_iter_26 = arith_const_23; for_iter_26 < arith_const_24; for_iter_26 += arith_const_25) {
    for (int for_iter_27 = arith_const_23; for_iter_27 < arith_const_21; for_iter_27 += arith_const_25) {
      int arith_addi_28 = (for_iter_26 + arith_const_25); 
      for (int for_iter_29 = for_iter_26; for_iter_29 < arith_addi_28; for_iter_29 += arith_const_25) {
        int arith_addi_30 = (for_iter_27 + arith_const_25); 
        for (int for_iter_31 = for_iter_27; for_iter_31 < arith_addi_30; for_iter_31 += arith_const_25) {
  ...
  for (int for_iter_32 = arith_const_24; for_iter_32 < arith_const_20; for_iter_32 += arith_const_25) {
    for (int for_iter_33 = arith_const_23; for_iter_33 < arith_const_21; for_iter_33 += arith_const_25) {
      int arith_addi_34 = (for_iter_32 + arith_const_25); 
      for (int for_iter_35 = for_iter_32; for_iter_35 < arith_addi_34; for_iter_35 += arith_const_25) {
        int arith_addi_36 = (for_iter_33 + arith_const_25); 
        for (int for_iter_37 = for_iter_33; for_iter_37 < arith_addi_36; for_iter_37 += arith_const_25) {
          func_arg_8[for_iter_35][for_iter_37] = arith_const_22; 
        }
      }
    }
  }
  for (int for_iter_38 = arith_const_23; for_iter_38 < arith_const_20; for_iter_38 += arith_const_25) {
    for (int for_iter_39 = arith_const_23; for_iter_39 < arith_const_19; for_iter_39 += arith_const_25) {
      for (int for_iter_40 = arith_const_23; for_iter_40 < arith_const_21; for_iter_40 += arith_const_25) {
        int arith_addi_41 = (for_iter_38 + arith_const_25); 
        for (int for_iter_42 = for_iter_38; for_iter_42 < arith_addi_41; for_iter_42 += arith_const_25) {
          int arith_addi_43 = (for_iter_39 + arith_const_25); 
          for (int for_iter_44 = for_iter_39; for_iter_44 < arith_addi_43; for_iter_44 += arith_const_25) {
            int arith_addi_45 = (for_iter_40 + arith_const_25); 
            for (int for_iter_46 = for_iter_40; for_iter_46 < arith_addi_45; for_iter_46 += arith_const_25) {
  ...
  for (int for_iter_52 = arith_const_23; for_iter_52 < arith_const_24; for_iter_52 += arith_const_25) {
    for (int for_iter_53 = arith_const_23; for_iter_53 < arith_const_20; for_iter_53 += arith_const_25) {
      int arith_addi_54 = (for_iter_52 + arith_const_25); 
      for (int for_iter_55 = for_iter_52; for_iter_55 < arith_addi_54; for_iter_55 += arith_const_25) {
        int arith_addi_56 = (for_iter_53 + arith_const_25); 
        for (int for_iter_57 = for_iter_53; for_iter_57 < arith_addi_56; for_iter_57 += arith_const_25) {
  ...
  for (int for_iter_58 = arith_const_23; for_iter_58 < arith_const_18; for_iter_58 += arith_const_25) {
    int arith_addi_59 = (for_iter_58 + arith_const_25); 
    for (int for_iter_60 = for_iter_58; for_iter_60 < arith_addi_59; for_iter_60 += arith_const_25) {
      int arith_cmpi_61 = ((for_iter_60 == arith_const_23) ? 1 : 0); 
      if (arith_cmpi_61) {
        for (int for_iter_62 = arith_const_23; for_iter_62 < arith_const_24; for_iter_62 += arith_const_25) {
          for (int for_iter_63 = arith_const_23; for_iter_63 < arith_const_20; for_iter_63 += arith_const_25) {
            for (int for_iter_64 = arith_const_23; for_iter_64 < arith_const_17; for_iter_64 += arith_const_25) {
            ...
            for (int for_iter_70 = arith_const_16; for_iter_70 < arith_const_15; for_iter_70 += arith_const_25) {
      ...
      int arith_cmpi_80 = ((arith_addi_79 == arith_const_23) ? 1 : 0); 
      if (arith_cmpi_80) {
        for (int for_iter_81 = arith_const_23; for_iter_81 < arith_const_24; for_iter_81 += arith_const_25) {
          for (int for_iter_82 = arith_const_23; for_iter_82 < arith_const_20; for_iter_82 += arith_const_25) {
            for (int for_iter_83 = arith_const_15; for_iter_83 < arith_const_12; for_iter_83 += arith_const_25) {
