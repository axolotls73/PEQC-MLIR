    ...
    scf.for %arg4 = %c0 to %c2 step %c1 {
      ...
      scf.for %arg5 = %c0_1 to %c2_2 step %c1_3 {
        ...
        scf.for %arg6 = %c0_4 to %c2_5 step %c1_6 {
          ...
          %0 = arith.addi %arg4, %c1_7 : index
          %c1_8 = arith.constant 1 : index
          scf.for %arg7 = %arg4 to %0 step %c1_8 {
            %c1_9 = arith.constant 1 : index
            %1 = arith.addi %arg5, %c1_9 : index
            %c1_10 = arith.constant 1 : index
            scf.for %arg8 = %arg5 to %1 step %c1_10 {
              %c1_11 = arith.constant 1 : index
              %2 = arith.addi %arg6, %c1_11 : index
              %c1_12 = arith.constant 1 : index
              scf.for %arg9 = %arg6 to %2 step %c1_12 {
                ...
                %5 = arith.muli %arg8, %c16_14 : index
                %c-4_15 = arith.constant -4 : index
                %6 = arith.addi %5, %c-4_15 : index
                %c16_16 = arith.constant 16 : index
                %7 = arith.muli %arg9, %c16_16 : index
                %c-4_17 = arith.constant -4 : index
                %8 = arith.addi %7, %c-4_17 : index
                %9 = arith.maxsi %c1_13, %4 : index
                %10 = arith.maxsi %9, %6 : index
                %11 = arith.maxsi %10, %8 : index
                %c21 = arith.constant 21 : index
                %c16_18 = arith.constant 16 : index
                %12 = arith.muli %arg7, %c16_18 : index
                %c15 = arith.constant 15 : index
                %13 = arith.addi %12, %c15 : index
                %c16_19 = arith.constant 16 : index
                %14 = arith.muli %arg8, %c16_19 : index
                %c15_20 = arith.constant 15 : index
                %15 = arith.addi %14, %c15_20 : index
                %c16_21 = arith.constant 16 : index
                %16 = arith.muli %arg9, %c16_21 : index
                %c15_22 = arith.constant 15 : index
                %17 = arith.addi %16, %c15_22 : index
                %18 = arith.minsi %c21, %13 : index
                %19 = arith.minsi %18, %15 : index
                %20 = arith.minsi %19, %17 : index
                %c1_23 = arith.constant 1 : index
                scf.for %arg10 = %11 to %20 step %c1_23 {
                  %c0_28 = arith.constant 0 : index
                  %c16_29 = arith.constant 16 : index
                  %c0_30 = arith.constant 0 : index
                  %c-1_31 = arith.constant -1 : index
                  %28 = arith.cmpi slt, %arg10, %c0_30 : index
                  %29 = arith.subi %c-1_31, %arg10 : index
                  %30 = arith.select %28, %29, %arg10 : index
                  %31 = arith.divsi %30, %c16_29 : index
                  %32 = arith.subi %c-1_31, %31 : index
                  %33 = arith.select %28, %32, %31 : index
                  %c-1_32 = arith.constant -1 : index
                  %34 = arith.muli %arg7, %c-1_32 : index
                  %35 = arith.addi %33, %34 : index
                  %36 = arith.cmpi sge, %35, %c0_28 : index
                  scf.if %36 {
                ...
                %22 = arith.muli %arg9, %c-1_25 : index
                %23 = arith.addi %21, %22 : index
                %c-1_26 = arith.constant -1 : index
                %24 = arith.muli %arg7, %c-1_26 : index
                %25 = arith.addi %23, %24 : index
                %c2_27 = arith.constant 2 : index
                %26 = arith.addi %25, %c2_27 : index
                %27 = arith.cmpi sge, %26, %c0_24 : index
                scf.if %27 {
