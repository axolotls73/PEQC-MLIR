...
void kernel_2mm(int func_arg_0, int func_arg_1, int func_arg_2, int func_arg_3, double func_arg_4, double func_arg_5, double* func_arg_6, double* func_arg_7, double* func_arg_8, double* func_arg_9, double* func_arg_10)
{
  ...
  for (int for_iter_24 = arith_const_21; for_iter_24 < arith_const_22; for_iter_24 += arith_const_23) {
    ...
    for (int for_iter_26 = for_iter_24; for_iter_26 < arith_addi_25; for_iter_26 += arith_const_23) {
      for (int for_iter_27 = arith_const_21; for_iter_27 < arith_const_19; for_iter_27 += arith_const_23) {
      ...
      for (int for_iter_30 = arith_const_19; for_iter_30 < arith_const_18; for_iter_30 += arith_const_23) {
  ...
  for (int for_iter_33 = arith_const_21; for_iter_33 < arith_const_17; for_iter_33 += arith_const_23) {
    int arith_addi_34 = (for_iter_33 + arith_const_23); 
    for (int for_iter_35 = for_iter_33; for_iter_35 < arith_addi_34; for_iter_35 += arith_const_23) {
      int arith_cmpi_36 = ((for_iter_35 == arith_const_21) ? 1 : 0); 
      if (arith_cmpi_36) {
        for (int for_iter_37 = arith_const_21; for_iter_37 < arith_const_22; for_iter_37 += arith_const_23) {
          for (int for_iter_38 = arith_const_21; for_iter_38 < arith_const_19; for_iter_38 += arith_const_23) {
            for (int for_iter_39 = arith_const_21; for_iter_39 < arith_const_16; for_iter_39 += arith_const_23) {
            ...
            for (int for_iter_46 = arith_const_15; for_iter_46 < arith_const_14; for_iter_46 += arith_const_23) {
      ...
      int arith_cmpi_56 = ((arith_addi_55 == arith_const_21) ? 1 : 0); 
      if (arith_cmpi_56) {
        for (int for_iter_57 = arith_const_21; for_iter_57 < arith_const_22; for_iter_57 += arith_const_23) {
          for (int for_iter_58 = arith_const_21; for_iter_58 < arith_const_19; for_iter_58 += arith_const_23) {
            for (int for_iter_59 = arith_const_14; for_iter_59 < arith_const_11; for_iter_59 += arith_const_23) {
