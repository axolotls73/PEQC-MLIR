    ...
    for (int for_iter_19 = arith_const_15; for_iter_19 < arith_const_16; for_iter_19 += arith_const_17) {
      ...
      for (int for_iter_21 = for_iter_18; for_iter_21 < arith_addi_20; for_iter_21 += arith_const_17) {
        ...
        for (int for_iter_23 = for_iter_19; for_iter_23 < arith_addi_22; for_iter_23 += arith_const_17) {
          ...
          if (arith_cmpi_24) {
            int arith_muli_25 = (for_iter_21 * arith_const_12); 
            int arith_addi_26 = (arith_muli_25 + arith_const_11); 
            int arith_maxsi_27 = max(arith_addi_26, arith_const_15); 
            for (int for_iter_28 = arith_maxsi_27; for_iter_28 < arith_const_10; for_iter_28 += arith_const_17) {
              ...
              int arith_muli_31 = (for_iter_21 * arith_const_12); 
              int arith_addi_32 = (for_iter_28 + arith_const_17); 
              int arith_maxsi_33 = max(arith_muli_31, arith_addi_32); 
              int arith_muli_34 = (for_iter_21 * arith_const_12); 
              int arith_addi_35 = (arith_muli_34 + arith_const_12); 
              int arith_addi_36 = (for_iter_28 + arith_const_9); 
              int arith_minsi_37 = min(arith_addi_35, arith_addi_36); 
              for (int for_iter_38 = arith_maxsi_33; for_iter_38 < arith_minsi_37; for_iter_38 += arith_const_17) {
              ...
              int arith_addi_57 = (for_iter_28 + arith_const_17); 
              int arith_addi_58 = (for_iter_28 + arith_const_10); 
              int arith_minsi_59 = min(arith_addi_58, arith_const_12); 
              for (int for_iter_60 = arith_addi_57; for_iter_60 < arith_minsi_59; for_iter_60 += arith_const_17) {
                ...
                int arith_muli_77 = (for_iter_21 * arith_const_12); 
                int arith_addi_78 = (for_iter_28 + arith_const_17); 
                int arith_maxsi_79 = max(arith_muli_77, arith_addi_78); 
                int arith_muli_80 = (for_iter_21 * arith_const_12); 
                ...
                for (int for_iter_84 = arith_maxsi_79; for_iter_84 < arith_minsi_83; for_iter_84 += arith_const_17) {
          ...
          if (arith_cmpi_176) {
            for (int for_iter_177 = arith_const_7; for_iter_177 < arith_const_10; for_iter_177 += arith_const_17) {
              int arith_addi_178 = (for_iter_177 + arith_const_10); 
              for (int for_iter_179 = arith_const_12; for_iter_179 < arith_addi_178; for_iter_179 += arith_const_17) {
                ...
                int arith_muli_196 = (for_iter_21 * arith_const_12); 
                int arith_addi_197 = (for_iter_177 + arith_const_17); 
                int arith_maxsi_198 = max(arith_muli_196, arith_addi_197); 
                int arith_muli_199 = (for_iter_21 * arith_const_12); 
                int arith_addi_200 = (arith_muli_199 + arith_const_12); 
                int arith_addi_201 = (for_iter_177 + arith_const_9); 
                int arith_minsi_202 = min(arith_addi_200, arith_addi_201); 
                for (int for_iter_203 = arith_maxsi_198; for_iter_203 < arith_minsi_202; for_iter_203 += arith_const_17) {
