...
void kernel_trmm(int func_arg_0, int func_arg_1, double func_arg_2, double* func_arg_3, double* func_arg_4)
{
  ...
  for (int for_iter_19 = arith_const_7; for_iter_19 < arith_const_6; for_iter_19 += arith_const_9) {
    for (int for_iter_20 = arith_const_7; for_iter_20 < arith_const_5; for_iter_20 += arith_const_9) {
      int arith_addi_21 = (for_iter_19 + arith_const_9); 
      for (int for_iter_22 = for_iter_19; for_iter_22 < arith_addi_21; for_iter_22 += arith_const_9) {
        int arith_addi_23 = (for_iter_20 + arith_const_9); 
        for (int for_iter_24 = for_iter_20; for_iter_24 < arith_addi_23; for_iter_24 += arith_const_9) {
          double memref_load_25 = func_arg_4[for_iter_22][for_iter_24]; 
          double arith_mulf_26 = (func_arg_2 * memref_load_25); 
          func_arg_4[for_iter_22][for_iter_24] = arith_mulf_26; 
        }
      }
    }
  }
