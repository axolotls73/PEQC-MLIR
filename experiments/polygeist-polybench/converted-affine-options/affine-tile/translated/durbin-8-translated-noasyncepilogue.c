...
void kernel_durbin(int func_arg_0, double* func_arg_1, double* func_arg_2)
{
  ...
  for (int for_iter_30 = arith_const_13; for_iter_30 < arith_const_12; for_iter_30 += arith_const_11) {
    ...
    for (int for_iter_33 = for_iter_30; for_iter_33 < arith_minsi_32; for_iter_33 += arith_const_13) {
      ...
      double memref_load_34 = memref_alloca_17[0]; 
      ...
      memref_alloca_17[0] = arith_addf_39; 
      ...
      for (int for_iter_46 = arith_const_13; for_iter_46 < for_iter_33; for_iter_46 += arith_const_13) {
        double memref_load_47 = memref_alloca_17[0]; 
        ...
        memref_alloca_17[0] = arith_addf_54; 
      }
      ...
      if (arith_cmpi_56) {
        ...
        memref_alloca_18[arith_const_14] = arith_divf_62; 
        ...
        double memref_load_69 = memref_alloca_18[arith_const_14]; 
      ...
      if (arith_cmpi_72) {
        ...
        double memref_load_74 = memref_alloca_17[0]; 
        ...
        memref_alloca_18[arith_const_14] = arith_divf_78; 
        ...
        double memref_load_85 = memref_alloca_18[arith_const_14]; 
      ...
      for (int for_iter_88 = arith_const_8; for_iter_88 < arith_addi_87; for_iter_88 += arith_const_13) {
        ...
        double memref_load_91 = memref_alloca_18[arith_const_14]; 
