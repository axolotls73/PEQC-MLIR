  ...
  func.func @kernel_3mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: i32, %arg5: memref<?x18xf64>, %arg6: memref<?x20xf64>, %arg7: memref<?x18xf64>, %arg8: memref<?x22xf64>, %arg9: memref<?x24xf64>, %arg10: memref<?x22xf64>, %arg11: memref<?x22xf64>) {
    ...
    scf.for %arg12 = %c0_2 to %c18_3 step %c1_4 {
      ...
      scf.for %arg13 = %c0_10 to %c24 step %c1_11 {
        ...
        scf.for %arg14 = %c0_12 to %c22 step %c1_13 {
          %c1_14 = arith.constant 1 : index
          %0 = arith.addi %arg12, %c1_14 : index
          %c1_15 = arith.constant 1 : index
          scf.for %arg15 = %arg12 to %0 step %c1_15 {
            %c1_16 = arith.constant 1 : index
            %1 = arith.addi %arg13, %c1_16 : index
            %c1_17 = arith.constant 1 : index
            scf.for %arg16 = %arg13 to %1 step %c1_17 {
              %c1_18 = arith.constant 1 : index
              %2 = arith.addi %arg14, %c1_18 : index
              %c1_19 = arith.constant 1 : index
              scf.for %arg17 = %arg14 to %2 step %c1_19 {
    ...
    scf.for %arg12 = %c0_5 to %c16_6 step %c1_7 {
      ...
      scf.for %arg13 = %c0_10 to %c18_11 step %c1_12 {
        %c1_13 = arith.constant 1 : index
        %0 = arith.addi %arg12, %c1_13 : index
        %c1_14 = arith.constant 1 : index
        scf.for %arg14 = %arg12 to %0 step %c1_14 {
          %c1_15 = arith.constant 1 : index
          %1 = arith.addi %arg13, %c1_15 : index
          %c1_16 = arith.constant 1 : index
          scf.for %arg15 = %arg13 to %1 step %c1_16 {
    ...
    scf.for %arg12 = %c0_8 to %c2 step %c1_9 {
      ...
      %0 = arith.addi %arg12, %c1_10 : index
      %c1_11 = arith.constant 1 : index
      scf.for %arg13 = %arg12 to %0 step %c1_11 {
        %c0_12 = arith.constant 0 : index
        %1 = arith.cmpi eq, %arg13, %c0_12 : index
        scf.if %1 {
          %c0_14 = arith.constant 0 : index
          %c16_15 = arith.constant 16 : index
          %c1_16 = arith.constant 1 : index
          scf.for %arg14 = %c0_14 to %c16_15 step %c1_16 {
            %c0_17 = arith.constant 0 : index
            %c18_18 = arith.constant 18 : index
            %c1_19 = arith.constant 1 : index
            scf.for %arg15 = %c0_17 to %c18_18 step %c1_19 {
              %c0_20 = arith.constant 0 : index
              %c20 = arith.constant 20 : index
              %c1_21 = arith.constant 1 : index
              scf.for %arg16 = %c0_20 to %c20 step %c1_21 {
              ...
              scf.for %arg16 = %c19 to %c32 step %c1_22 {
        ...
        scf.if %3 {
          ...
          scf.for %arg14 = %c0_14 to %c16_15 step %c1_16 {
            ...
            scf.for %arg15 = %c0_17 to %c18_18 step %c1_19 {
              ...
              scf.for %arg16 = %c32 to %c41 step %c1_20 {
                %c-19 = arith.constant -19 : index
                %4 = arith.addi %arg16, %c-19 : index
                %5 = memref.load %arg11[%arg14, %4] : memref<?x22xf64>
                %6 = memref.load %arg5[%arg14, %arg15] : memref<?x18xf64>
                %c-19_21 = arith.constant -19 : index
                %7 = arith.addi %arg16, %c-19_21 : index
                %8 = memref.load %arg8[%arg15, %7] : memref<?x22xf64>
                %9 = arith.mulf %6, %8 : f64
                %10 = arith.addf %5, %9 : f64
                %c-19_22 = arith.constant -19 : index
                %11 = arith.addi %arg16, %c-19_22 : index
                memref.store %10, %arg11[%arg14, %11] : memref<?x22xf64>
              }
            }
          }
