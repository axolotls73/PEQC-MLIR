...
#map3 = affine_map<(d0) -> (0, (d0 * 16 - 13) ceildiv 13)>
#map4 = affine_map<(d0) -> ((d0 * 32 + 31) floordiv 27 + 1)>
#map5 = affine_map<(d0, d1) -> (d0 * 32, d1 * 27)>
#map6 = affine_map<(d0, d1) -> (d0 * 32 + 32, d1 * 26 + 28)>
module {
  func.func @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x28xf64>, %arg4: memref<?x28xf64>, %arg5: memref<?xf64>) {
    ...
    affine.for %arg6 = 0 to 23 {
      affine.for %arg7 = max #map3(%arg6) to #map4(%arg6) {
        affine.for %arg8 = max #map5(%arg6, %arg7) to min #map6(%arg6, %arg7) {
