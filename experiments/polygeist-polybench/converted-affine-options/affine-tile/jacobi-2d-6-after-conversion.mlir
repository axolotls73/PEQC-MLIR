      ...
      scf.for %arg5 = %1 to %3 step %c1 {
        ...
        scf.for %arg6 = %9 to %15 step %c1 {
          ...
          scf.if %29 {
            ...
            scf.for %arg7 = %54 to %59 step %c1 {
              %60 = arith.muli %arg6, %c-2 : index
              %61 = arith.addi %60, %arg7 : index
              %62 = memref.load %arg2[%c1, %61] : memref<?x30xf64>
          ...
          scf.if %50 {
            ...
            scf.for %arg7 = %54 to %59 step %c1 {
              ...
              %76 = memref.load %arg3[%c29, %75] : memref<?x30xf64>
              %77 = arith.addf %72, %76 : f64
              %78 = arith.muli %arg6, %c-2 : index
              ...
              %84 = arith.muli %arg6, %c-2 : index
              %85 = arith.addi %84, %arg7 : index
              %86 = arith.addi %85, %c-1 : index
              memref.store %83, %arg2[%c28, %86] : memref<?x30xf64>
            }
          }
        }
        ...
        scf.if %20 {
          ...
          scf.for %arg6 = %22 to %25 step %c1 {
            %26 = arith.muli %arg5, %c32 : index
            %27 = arith.maxsi %26, %c31 : index
            %28 = arith.muli %arg5, %c32 : index
            %29 = arith.addi %28, %c32 : index
            %30 = arith.minsi %29, %c59 : index
            scf.for %arg7 = %27 to %30 step %c1 {
              %31 = arith.addi %arg6, %c-30 : index
              %32 = arith.addi %arg7, %c-30 : index
              %33 = memref.load %arg2[%31, %32] : memref<?x30xf64>
              %34 = arith.addi %arg6, %c-30 : index
