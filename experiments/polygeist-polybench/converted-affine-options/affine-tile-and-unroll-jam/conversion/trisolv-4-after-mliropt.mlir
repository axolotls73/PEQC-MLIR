...
#map2 = affine_map<(d0, d1) -> (d0 * 32, d1 * 32 + 1)>
#map3 = affine_map<(d0, d1) -> (40, d0 * 32 + 32, d1 * 32 + 33)>
  ...
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x40xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    affine.for %arg4 = 0 to 2 {
      affine.for %arg5 = 0 to min #map(%arg4) {
        %0 = affine.load %arg3[%arg4 * 32 + %arg5] : memref<?xf64>
        affine.store %0, %arg2[%arg4 * 32 + %arg5] : memref<?xf64>
      }
    }
    affine.for %arg4 = 0 to 2 {
      affine.for %arg5 = 0 to #map1(%arg4) {
        ...
        affine.for %arg6 = max #map2(%arg4, %arg5) to min #map3(%arg4, %arg5) {
          affine.for %arg7 = max #map4(%arg5) to #map5(%arg6) {
        ...
        affine.if #set4(%arg4, %arg5) {
          affine.for %arg6 = 0 to 7 {
            affine.for %arg7 = 0 to 31 {
              %0 = affine.load %arg2[%arg6 + 33] : memref<?xf64>
              %1 = affine.load %arg1[%arg6 + 33, %arg7] : memref<?x40xf64>
              %2 = affine.load %arg2[%arg7] : memref<?xf64>
              %3 = arith.mulf %1, %2 : f64
              %4 = arith.subf %0, %3 : f64
              affine.store %4, %arg2[%arg6 + 33] : memref<?xf64>
            }
          }
        }
        affine.if #set(%arg4, %arg5) {
