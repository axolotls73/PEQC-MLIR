    ...
    affine.for %arg7 = 0 to 27 {
      affine.for %arg8 = 0 to 32 {
        affine.for %arg9 = 0 to #map(%arg7) {
          %1 = affine.load %arg4[%arg7, %arg7 + %arg9 + 1] : memref<?x28xf64>
          %2 = affine.load %arg3[%arg8, %arg7] : memref<?x28xf64>
          %3 = affine.load %arg3[%arg8, %arg7 + %arg9 + 1] : memref<?x28xf64>
          %4 = arith.mulf %2, %3 : f64
          %5 = arith.addf %1, %4 : f64
          affine.store %5, %arg4[%arg7, %arg7 + %arg9 + 1] : memref<?x28xf64>
        }
      }
    }
    affine.for %arg7 = 0 to 27 {
