  ...
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x40xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) {
    ...
    scf.for %arg4 = %c0 to %c2 step %c1 {
      ...
      scf.for %arg5 = %c0_3 to %2 step %c1_4 {
        ...
        %6 = arith.muli %arg4, %c32_6 : index
        %7 = arith.addi %6, %arg5 : index
        memref.store %5, %arg2[%7] : memref<?xf64>
      }
    }
      ...
      scf.for %arg5 = %c0_3 to %0 step %c1_5 {
        ...
        scf.if %19 {
          ...
          scf.for %arg6 = %c0_19 to %c7 step %c1_20 {
            ...
            %c31 = arith.constant 31 : index
            %c1_22 = arith.constant 1 : index
            scf.for %arg7 = %c0_21 to %c31 step %c1_22 {
              %c33_23 = arith.constant 33 : index
              %25 = arith.addi %arg6, %c33_23 : index
              %26 = memref.load %arg2[%25] : memref<?xf64>
              %c33_24 = arith.constant 33 : index
              %27 = arith.addi %arg6, %c33_24 : index
              %28 = memref.load %arg1[%27, %arg7] : memref<?x40xf64>
              %29 = memref.load %arg2[%arg7] : memref<?xf64>
              %30 = arith.mulf %28, %29 : f64
              %31 = arith.subf %26, %30 : f64
              %c33_25 = arith.constant 33 : index
              %32 = arith.addi %arg6, %c33_25 : index
              memref.store %31, %arg2[%32] : memref<?xf64>
            }
          }
        }
