...
module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.store %30, %alloca_23[] : memref<f32>
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          %40 = affine.load %alloca_10[0] : memref<1xf32>
          ...
          %47 = affine.load %alloca_14[0] : memref<1xf32>
          %48 = affine.load %alloca_3[] : memref<f32>
          affine.store %48, %alloca_6[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          %41 = affine.load %alloca_25[] : memref<f32>
          affine.store %41, %alloca_12[0] : memref<1xf32>
          %42 = arith.mulf %40, %41 : f32
          %43 = affine.load %alloca_13[0] : memref<1xf32>
          %44 = affine.load %alloca_20[] : memref<f32>
          %45 = arith.mulf %43, %44 : f32
          %46 = arith.addf %42, %45 : f32
          %47 = affine.load %alloca_14[0] : memref<1xf32>
          ...
          %58 = affine.load %alloca_12[0] : memref<1xf32>
          affine.store %58, %alloca_20[] : memref<f32>
        }
      }
    }
              ...
              affine.for %arg12 = #map(%arg8) to #map2(%arg8) {
                affine.for %arg13 = #map(%arg9) to #map1(%arg9) {
                  affine.for %arg14 = #map(%arg10) to #map1(%arg10) {
                    %40 = affine.load %arg5[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                    %41 = affine.load %arg6[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                    %42 = arith.addf %40, %41 : f32
                    affine.store %42, %arg4[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                  }
                }
              }
            }
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          %42 = arith.mulf %40, %41 : f32
          %43 = affine.load %alloca_15[0] : memref<1xf32>
          %44 = affine.load %alloca_8[] : memref<f32>
          %45 = arith.mulf %43, %44 : f32
          %46 = arith.addf %42, %45 : f32
          %47 = affine.load %alloca_14[0] : memref<1xf32>
          %48 = affine.load %alloca_3[] : memref<f32>
          ...
          affine.store %57, %alloca_8[] : memref<f32>
        }
      }
    }
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          %40 = affine.load %alloca_11[0] : memref<1xf32>
          %41 = affine.load %alloca_9[] : memref<f32>
          ...
          affine.store %57, %alloca_9[] : memref<f32>
