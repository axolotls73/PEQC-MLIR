...
module {
  func.func @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x64xf32>, %arg4: memref<?x64xf32>, %arg5: memref<?x64xf32>, %arg6: memref<?x64xf32>) {
    ...
    affine.store %16, %alloca_9[0] : memref<1xf32>
    %17 = affine.load %alloca_9[0] : memref<1xf32>
    affine.store %17, %alloca_23[0] : memref<1xf32>
    %18 = arith.negf %arg2 : f32
    %19 = math.exp %18 : f32
    %20 = arith.mulf %17, %19 : f32
    affine.store %20, %alloca_6[0] : memref<1xf32>
    %21 = arith.subf %arg2, %cst_0 : f32
    %22 = arith.mulf %20, %21 : f32
    affine.store %22, %alloca_17[0] : memref<1xf32>
    %23 = affine.load %alloca_23[0] : memref<1xf32>
    %24 = arith.negf %23 : f32
    %25 = arith.mulf %arg2, %cst_2 : f32
    %26 = math.exp %25 : f32
    %27 = arith.mulf %24, %26 : f32
    affine.store %27, %alloca_13[0] : memref<1xf32>
    %28 = affine.load %alloca_6[0] : memref<1xf32>
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          affine.store %46, %alloca_3[] : memref<f32>
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          %37 = arith.addf %33, %36 : f32
          %38 = affine.load %alloca_14[0] : memref<1xf32>
          %39 = affine.load %alloca_21[] : memref<f32>
          affine.store %39, %alloca_15[0] : memref<1xf32>
          %40 = arith.mulf %38, %39 : f32
          %41 = arith.addf %37, %40 : f32
          %42 = affine.load %alloca_5[0] : memref<1xf32>
          ...
          affine.store %46, %alloca_21[] : memref<f32>
              ...
              affine.for %arg12 = #map(%arg8) to #map2(%arg8) {
                affine.for %arg13 = #map(%arg9) to #map1(%arg9) {
                  affine.for %arg14 = #map(%arg10) to #map1(%arg10) {
                    %31 = affine.load %arg5[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                    %32 = affine.load %arg6[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                    %33 = arith.addf %31, %32 : f32
                    affine.store %33, %arg4[%arg11 * 32 + %arg13, %arg12 * 32 + %arg14] : memref<?x64xf32>
                  }
                }
              }
            }
    ...
    affine.for %arg7 = 0 to 64 step 32 {
      affine.for %arg8 = #map(%arg7) to #map1(%arg7) {
        ...
        affine.for %arg9 = 0 to 64 {
          ...
          affine.store %48, %alloca_8[] : memref<f32>
