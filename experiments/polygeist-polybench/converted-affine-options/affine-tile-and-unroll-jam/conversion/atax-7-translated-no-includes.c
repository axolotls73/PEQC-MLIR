...
void kernel_atax(int func_arg_0, int func_arg_1, double* func_arg_2, double* func_arg_3, double* func_arg_4, double* func_arg_5)
{
  ...
  for (int for_iter_21 = arith_const_11; for_iter_21 < arith_const_12; for_iter_21 += arith_const_13) {
    for (int for_iter_22 = arith_const_11; for_iter_22 < arith_const_12; for_iter_22 += arith_const_13) {
      ...
      for (int for_iter_26 = arith_const_11; for_iter_26 < arith_minsi_25; for_iter_26 += arith_const_13) {
        int arith_muli_27 = (for_iter_22 * arith_const_9); 
        ...
        for (int for_iter_30 = arith_const_11; for_iter_30 < arith_minsi_29; for_iter_30 += arith_const_13) {
          ...
          int arith_addi_45 = (arith_muli_44 + for_iter_26); 
  ...
  for (int for_iter_53 = arith_const_11; for_iter_53 < arith_const_12; for_iter_53 += arith_const_13) {
    for (int for_iter_54 = arith_const_11; for_iter_54 < arith_const_12; for_iter_54 += arith_const_13) {
      int arith_muli_55 = (for_iter_54 * arith_const_9); 
      ...
      for (int for_iter_58 = arith_const_11; for_iter_58 < arith_minsi_57; for_iter_58 += arith_const_13) {
        int arith_muli_59 = (for_iter_53 * arith_const_9); 
        int arith_addi_60 = (arith_muli_59 + arith_const_6); 
        ...
        for (int for_iter_62 = arith_const_11; for_iter_62 < arith_minsi_61; for_iter_62 += arith_const_13) {
          ...
          int arith_muli_66 = (for_iter_54 * arith_const_7); 
          int arith_addi_67 = (arith_muli_66 + for_iter_58); 
          int arith_muli_68 = (for_iter_53 * arith_const_7); 
          int arith_addi_69 = (arith_muli_68 + for_iter_62); 
          double memref_load_70 = func_arg_2[arith_addi_67][arith_addi_69]; 
          int arith_muli_71 = (for_iter_54 * arith_const_7); 
          int arith_addi_72 = (arith_muli_71 + for_iter_58); 
