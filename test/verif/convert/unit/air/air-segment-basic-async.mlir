...
//
// air-segment-basic-async.mlir: This file is part of the PEQC-MLIR project.
//
...
// CHECK: scf.parallel ([[IV1:%.*]], [[IV2:%.*]]) = ({{.*}}) to ([[C2]], [[C2]])
  %token = air.segment @segment_0 async unroll (%arg0, %arg1) in (%arg2=%c2, %arg3=%c2) args(%arg4=%alloc) : memref<1x1x64x64xi32, 1> {
