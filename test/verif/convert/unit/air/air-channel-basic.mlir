...
// CHECK-DAG: memref.global "private" @[[SEM_ARR:.*]] : memref<1x1x1x1x!verif.semaphore>
...
// CHECK: [[SIZE3:%.*]] = arith.constant 1 : index
// CHECK: scf.for [[I3:%.*]] = [[CST0]] to [[SIZE3]] step [[CST1]]
// CHECK: [[SIZE4:%.*]] = arith.constant 1 : index
// CHECK: scf.for [[I4:%.*]] = [[CST0]] to [[SIZE4]] step [[CST1]]
// CHECK:   [[SEMINIT:%.*]] = verif.semaphore
// CHECK:   verif.semaphore.set [[SEMINIT]], [[CST0]]
// CHECK:   memref.store [[SEMINIT]], [[SEM_ARR_CH]][[[I1]], [[I2]], [[I3]], [[I4]]]
...
// CHECK:   [[PUTSEM:%.*]] = memref.load [[SEM_ARR_PUT]][[[PUT_CST0]], [[PUT_CST0]], [[PUT_CST0]], [[PUT_CST0]]]
...
// CHECK:   [[GETSEM:%.*]] = memref.load [[SEM_ARR_GET]][[[GET_CST0]], [[GET_CST0]], [[GET_CST0]], [[GET_CST0]]]
// CHECK:   [[GETWAIT:%.*]] = arith.constant 1
// CHECK:   verif.semaphore.wait [[GETSEM]], [[GETWAIT]]
// CHECK:   [[GETVAL:%.*]] = memref.load [[BUF_ARR_GET]][[[GET_CST0]], [[GET_CST0]], [[GET_CST0]], [[GET_CST0]]]
