...
module {
// CHECK-DAG: memref.global "private" @[[DMA_GLOBAL_14_IN:.*]] :
// CHECK-DAG: memref.global "private" @[[DMA_GLOBAL_14_OUT:.*]] :
// CHECK-NOT: aie.tile
  %tile14 = aie.tile(1, 4)
// CHECK-DAG: memref.global "private" @[[DMA_GLOBAL_34_IN:.*]] :
// CHECK-DAG: memref.global "private" @[[DMA_GLOBAL_34_OUT:.*]] :
// CHECK-NOT: aie.tile
  %tile34 = aie.tile(3, 4)
