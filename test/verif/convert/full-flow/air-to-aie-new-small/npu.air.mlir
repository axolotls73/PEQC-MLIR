...
module {
  aie.device(npu1_4col) {
    ...
    %buf22 = aie.buffer(%mem_tile_0_1) {sym_name = "buf22"} : memref<8x8xi32, 1>
    %buf21 = aie.buffer(%mem_tile_1_1) {sym_name = "buf21"} : memref<8x16xi32, 1>
    %buf20 = aie.buffer(%mem_tile_2_1) {sym_name = "buf20"} : memref<16x8xi32, 1>
    ...
    aiex.npu.dma_memcpy_nd(%a[0, 0, 0, 0][2, 1, 1, 128][0, 0, 0, 1]) {id = 0 : i64, metadata = @airMemcpyId4} : memref<16x16xi32>
    aiex.npu.dma_memcpy_nd(%a[0, 0, 0, 128][2, 1, 1, 128][0, 0, 0, 1]) {id = 1 : i64, metadata = @airMemcpyId4} : memref<16x16xi32>
    aiex.npu.dma_memcpy_nd(%b[0, 0, 0, 0][2, 2, 16, 8][0, 8, 16, 1]) {id = 0 : i64, metadata = @airMemcpyId5} : memref<16x16xi32>
    aiex.npu.dma_memcpy_nd(%c[0, 0, 0, 0][2, 2, 8, 8][128, 8, 16, 1]) {id = 0 : i64, metadata = @airMemcpyId23} : memref<16x16xi32>
    ...
    //   aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][2, 1, 1, 128][0, 0, 0, 1]) {id = 0 : i64, metadata = @airMemcpyId4} : memref<16x16xi32>
    //   aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 128][2, 1, 1, 128][0, 0, 0, 1]) {id = 1 : i64, metadata = @airMemcpyId4} : memref<16x16xi32>
    //   aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][2, 2, 16, 8][0, 8, 16, 1]) {id = 0 : i64, metadata = @airMemcpyId5} : memref<16x16xi32>
    //   aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][2, 2, 8, 8][128, 8, 16, 1]) {id = 0 : i64, metadata = @airMemcpyId23} : memref<16x16xi32>
