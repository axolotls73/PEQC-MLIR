        ...
        %15 = air.herd @herd_0 async [%async_token_13, %5, %6]  tile (%arg10, %arg11) in (%arg12=%c1_9, %arg13=%c4) attributes {id = 3 : i32, x_loc = 1 : i64, y_loc = 2 : i64} {
          ...
          %19:3 = scf.for %arg14 = %c0_23 to %c16_22 step %c8_24 iter_args(%arg15 = %async_token_35, %arg16 = %async_token_37, %arg17 = %async_token_37) -> (!air.async.token, !air.async.token, !air.async.token) {
            %21 = affine.if #set()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_35]  @channel_0[%18, %17] (%results_36[] [] []) {id = 14 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_35]  @channel_1[%18, %17] (%results_36[] [] []) {id = 15 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %22 = affine.if #set1()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_37]  @channel_2[%18, %17] (%results_38[] [] []) {id = 16 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg17, %arg15, %async_token_37]  @channel_3[%18, %17] (%results_38[] [] []) {id = 17 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            }
              ...
              scf.for %arg18 = %c0_23 to %c4_25 step %c1_26 {
                scf.for %arg19 = %c0_23 to %c4_25 step %c1_26 {
                  scf.for %arg20 = %c0_23 to %c4_25 step %c1_26 {
                    %26 = memref.load %results_36[%arg18, %arg20] : memref<4x4xi32, 2>
                    %27 = memref.load %results_38[%arg20, %arg19] : memref<4x4xi32, 2>
                    %28 = memref.load %results_29[%arg18, %arg19] : memref<4x4xi32, 2>
                    %29 = arith.muli %26, %27 : i32
                    %30 = arith.addi %28, %29 : i32
                    memref.store %30, %results_29[%arg18, %arg19] : memref<4x4xi32, 2>
                  }
                }
              }
            }
            %23 = affine.if #set()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg16]  @channel_0[%18, %17] (%results_34[] [] []) {id = 18 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg16]  @channel_1[%18, %17] (%results_34[] [] []) {id = 19 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %24 = affine.if #set1()[%18, %17] -> !air.async.token {
              %26 = air.channel.get async [%arg16]  @channel_2[%18, %17] (%results_32[] [] []) {id = 20 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            } else {
              %26 = air.channel.get async [%arg16]  @channel_3[%18, %17] (%results_32[] [] []) {id = 21 : i32} : (memref<4x4xi32, 2>)
              affine.yield %26 : !air.async.token
            }
            %async_token_45 = air.execute [%async_token_44, %24, %23] {
              scf.for %arg18 = %c0_23 to %c4_25 step %c1_26 {
                scf.for %arg19 = %c0_23 to %c4_25 step %c1_26 {
                  scf.for %arg20 = %c0_23 to %c4_25 step %c1_26 {
                    %26 = memref.load %results_34[%arg18, %arg20] : memref<4x4xi32, 2>
                    %27 = memref.load %results_32[%arg20, %arg19] : memref<4x4xi32, 2>
                    %28 = memref.load %results_29[%arg18, %arg19] : memref<4x4xi32, 2>
                    %29 = arith.muli %26, %27 : i32
                    %30 = arith.addi %28, %29 : i32
                    memref.store %30, %results_29[%arg18, %arg19] : memref<4x4xi32, 2>
