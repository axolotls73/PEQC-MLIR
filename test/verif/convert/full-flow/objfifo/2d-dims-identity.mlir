...
//
// 2d-dims-identity.mlir: This file is part of the PEQC-MLIR project.
//
...
module @tutorial_4 {
    aie.device(xcvc1902) {
        ...
        aie.objectfifo @of (%tile14 dimensionsToStream [<size = 4, stride = 16>, <size = 1, stride = 4>, <size = 4, stride = 4>, <size = 4, stride = 1>],
