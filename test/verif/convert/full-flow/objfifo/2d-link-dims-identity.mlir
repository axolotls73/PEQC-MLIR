...
//
// 2d-link-dims-identity.mlir: This file is part of the PEQC-MLIR project.
//
...
module @tutorial_4 {
    aie.device(xcvc1902) {
        ...
        aie.objectfifo @of1 (%tile14, {%tile24}, 1 : i32) : !aie.objectfifo<memref<8x8xi32>>
        aie.objectfifo @of2 (%tile24 dimensionsToStream [<size = 4, stride = 16>, <size = 1, stride = 4>, <size = 4, stride = 4>, <size = 4, stride = 1>],
            {%tile34}, 1 : i32) : !aie.objectfifo<memref<8x8xi32>>
        aie.objectfifo.link [@of1] -> [@of2]([] [])

        %core14 = aie.core(%tile14) {
            %inputSubview = aie.objectfifo.acquire @of1 (Produce, 1) : !aie.objectfifosubview<memref<8x8xi32>>
        ...
        %core34 = aie.core(%tile34) {
            ...
            %inputSubview = aie.objectfifo.acquire @of2 (Consume, 1) : !aie.objectfifosubview<memref<8x8xi32>>
            %input = aie.objectfifo.subview.access %inputSubview[0] : !aie.objectfifosubview<memref<8x8xi32>> -> memref<8x8xi32>
