...
//
// aircc_input.mlir: This file is part of the PEQC-MLIR project.
//
...
// RUN: verif-opt --verif-air-to-scf-par --verif-scf-parallel-to-async --verif-air-convert-channel --verif-air-execute-to-async --verif-air-dma-to-memref --verif-scf-parallel-to-async %t/input-lowered.mlir > %t/conversion.mlir && \
