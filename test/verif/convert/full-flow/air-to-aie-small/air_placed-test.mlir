...
module {
  ...
  air.channel @channel_0 [1, 1] {broadcast_shape = [2, 2]}
  air.channel @channel_1 [1, 1] {broadcast_shape = [2, 2]}
  air.channel @channel_2 [1, 1] {broadcast_shape = [2, 2]}
  air.channel @channel_3 [1, 1] {broadcast_shape = [2, 2]}
