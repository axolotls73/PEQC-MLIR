...
// RUN: verif-opt --verif-air-to-scf-par --verif-scf-parallel-to-async --verif-air-dma-to-memref %t/input-lowered.mlir > %t/conversion.mlir && \
...
// COM: old transform script: expect a bug in this one
