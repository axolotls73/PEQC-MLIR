...
// RUN: %pastchecker %t/translation.c %t/translation.c aie_buffer_a34,aie_buffer_a14 | grep YES

// RUN: %pastchecker %t/translation.c %t/compare.c aie_buffer_a34,aie_buffer_a14 | grep YES
